...
use App\Http\Controllers\Prof        Route::get('/data-warga/export/excel', [DataWargaController::class, 'exportExcel'])->name('data-warga.export.excel');
        ...
        Route::post('/data-warga/fix-family-heads', [DataWargaController::class, 'fixFamilyHeads'])->name('data-warga.fix-family-heads');Controller;
...
Route::middleware(['auth'])->group(function () {
    Route::resource('manajemen-data-warga', DataWargaController::class)->names([
