...
Route::prefix('admin')->name('admin.')->middleware(['auth'])->group(function () {
    ...
    Route::prefix('pengajuan-surat')->name('pengajuan-surat.')->group(function () {
        ...
        // Test route for debugging TTD update
        Route::get('/test-update-ttd', function() {
            return view('admin.pengajuan-surat.test-update-ttd');
        })->name('test-update-ttd');

        // Test endpoint for TTD update
        Route::post('/test-ttd-update/{id}', function($id) {
            \Illuminate\Support\Facades\Log::info('Test TTD Update called with ID: ' . $id);
