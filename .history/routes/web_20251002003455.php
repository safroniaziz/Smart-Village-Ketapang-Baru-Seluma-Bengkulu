...
use App\Http\Controller// Public Potensi Wisata Routes
Route::prefix('potensi-wisata')->name('potensi-wisata.')->group(function () {
    ...
    Route::post('/{id}/increment-views', [App\Http\Controllers\PotensiWisataPublicController::class, 'incrementViews'])->name('increment-views');
