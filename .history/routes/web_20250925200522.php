...
Route::middleware(['auth'])->group(function () {
    ...
    // Utility Routes
    Route::post('data-warga/fix-family-heads', [DataWargaController::class, 'fixFamilyHeads'])->name('data-warga.fix-family-heads');
    Route::post('data-warga/fix-gender-format', [DataWargaController::class, 'fixGenderFormat'])->name('data-warga.fix-gender-format');
});
