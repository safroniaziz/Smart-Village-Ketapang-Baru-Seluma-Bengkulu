...
use App\Http\Con// Data Warga CRUD Routes
Route::resource('data-warga', DataWargaController::class)->parameters([
    'data-warga' => 'dataWarga'
]);
// Keep the old route for backward compatibility
Route::get('/data-warga-legacy', [HomeController::class, 'dataWarga'])->name('data.warga.legacy');lers\ProfileController;
