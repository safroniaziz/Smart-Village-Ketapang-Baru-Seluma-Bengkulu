...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" data-aos="fade-in">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <!-- Wave Layer 1 - Slow Animation -->
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="absolute bottom-0 left-0 w-full h-16 opacity-80">
            <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" class="animate-wave-slow"></path>
        </svg>
        
        <!-- Wave Layer 2 - Medium Animation -->
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="absolute bottom-0 left-0 w-full h-16 opacity-60">
            <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" class="animate-wave-medium"></path>
        </svg>
        
        <!-- Wave Layer 3 - Fast Animation -->
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="absolute bottom-0 left-0 w-full h-16 opacity-40">
            <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" class="animate-wave-fast"></path>
        </svg>
    </div>
</section>
...
@keyframes wave-fast {
    ...
    50% {
        transform: scaleY(1.18) scaleX(1.09);
        transform-origin: bottom center;
    }
    100% {
        transform: scaleY(1) scaleX(1);
...
.animate-wave-medium {
    animation: wave-medium 4.5s ease-in-out infinite;
    transform-origin: bottom center;
