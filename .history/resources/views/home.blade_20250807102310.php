        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                <div class="relative z-10 animate-float">
                    <div class="w-full h-96 lg:h-[500px] rounded-2xl shadow-2xl overflow-hidden relative bg-gradient-to-br from-blue-500 to-blue-700">
                        <!-- Card Content -->
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white p-8">
                                <div class="w-32 h-32 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-white/30">
                                    <i class="fas fa-map-marker-alt text-white text-4xl"></i>
                                </div>
                                <h3 class="text-3xl font-bold mb-4">Desa Ketapang Baru</h3>
                                <p class="text-xl text-blue-100 mb-6">Kecamatan Semidang Alas Maras</p>
