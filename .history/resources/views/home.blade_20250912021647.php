            ...
            <div class="lg:col-span-2" data-aos="fade-right" data-aos-duration="800">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                    ...
                    <div class="relative" style="height: 450px;" id="street-view-container">
                        ...
                        <div id="street-view-preview" class="w-full h-full rounded-b-2xl bg-gray-100 flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-gray-50" onclick="loadStreetView()">
                            <div class="text-center">
                                <div class="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <i class="fas fa-street-view text-white text-2xl"></i>
                                </div>
                                <h3 class="text-lg font-semibold text-gray-800 mb-2">Street View Balai Desa</h3>
                                <p class="text-gray-600 mb-4">Klik untuk melihat tampilan 360° dari Balai Desa Ketapang Baru</p>
                                <div class="inline-flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
