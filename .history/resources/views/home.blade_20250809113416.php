        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-[420px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="group text-center p-6 bg-white/95 backdrop-blur-sm border-2 border-blue-200 rounded-2xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-blue-300 hover:bg-white hover:shadow-blue-500/10">
                        <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-blue-500/30">
                            <i class="fas fa-users text-white text-lg"></i>
                        </div>
                        <div class="text-3xl font-black text-gray-800 mb-2">
                            <span class="counter" data-count="2847">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-sm mb-2">Total Warga</div>
                    ...
                    <div class="group text-center p-6 bg-white/95 backdrop-blur-sm border-2 border-green-200 rounded-2xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-green-300 hover:bg-white hover:shadow-green-500/10">
                        <div class="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-green-500/30">
                            <i class="fas fa-map-marked-alt text-white text-lg"></i>
                        </div>
                        <div class="text-3xl font-black text-gray-800 mb-2">
                            <span class="counter" data-count="8">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-sm mb-2">Dusun</div>
                        <div class="text-xs text-gray-600 font-semibold bg-gray-50 rounded-full px-2 py-1">24 RT/RW Aktif</div>
                    </div>

                    <div class="group text-center p-6 bg-white/95 backdrop-blur-sm border-2 border-purple-200 rounded-2xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-purple-300 hover:bg-white hover:shadow-purple-500/10">
                        <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-purple-500/30">
                            <i class="fas fa-home text-white text-lg"></i>
                        </div>
                        <div class="text-3xl font-black text-gray-800 mb-2">
                            <span class="counter" data-count="1250">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-sm mb-2">Keluarga</div>
                        <div class="text-xs text-green-600 flex items-center justify-center font-semibold bg-green-50 rounded-full px-2 py-1">
                            <i class="fas fa-arrow-up mr-1"></i>KK Aktif
                        </div>
                    </div>

                    <div class="group text-center p-6 bg-white/95 backdrop-blur-sm border-2 border-orange-200 rounded-2xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-orange-300 hover:bg-white hover:shadow-orange-500/10">
                        <div class="w-14 h-14 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-orange-500/30">
                            <i class="fas fa-seedling text-white text-lg"></i>
                        </div>
                        <div class="text-3xl font-black text-gray-800 mb-2">
                            <span class="counter" data-count="450">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-sm mb-2">Hektar</div>
                        <div class="text-xs text-gray-600 font-semibold bg-gray-50 rounded-full px-2 py-1">Luas Wilayah</div>
                    </div>
                </div>

                <!-- Info Summary Card -->
                <div class="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 shadow-lg" data-aos="fade-up" data-aos-delay="800">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Desa Ketapang Baru</h3>
                        <p class="text-sm text-gray-600 mb-4">Kecamatan Semidang Alas Maras, Kabupaten Seluma, Bengkulu</p>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center text-sm text-gray-700">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-500">H. Ahmad Supriyadi, S.Pd</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center text-sm text-gray-700">
                            ...
                            <div>
                                <div class="font-semibold">Periode Jabatan</div>
                                <div class="text-xs text-gray-500">2021 - 2027</div>
                            </div>
                        </div>

                        <div class="flex items-center text-sm text-gray-700">
                            <i class="fas fa-phone text-indigo-500 w-5 mr-3"></i>
                            <div>
                                <div class="font-semibold">Kontak Desa</div>
                                <div class="text-xs text-gray-500">(0736) 123456</div>
                            </div>
                        </div>
                    </div>

                    <div class="mt-4 pt-4 border-t border-gray-200 text-center">
                        <div class="inline-flex items-center bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-3 py-2 rounded-full text-xs font-semibold shadow-md">
