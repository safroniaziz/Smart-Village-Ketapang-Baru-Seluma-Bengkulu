        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8" data-aos="fade-up" data-aos-delay="700">
                    <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 text-center">
                        <div class="text-2xl font-black text-white mb-1">{{ $wisata ? 1 : 0 }}</div>
                        <div class="text-blue-100 text-sm">Total Wisata</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 text-center">
                        <div class="text-2xl font-black text-white mb-1">{{ $galleryCategories->count() ?? 0 }}</div>
                        <div class="text-blue-100 text-sm">Kategori</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 text-center">
                        <div class="text-2xl font-black text-white mb-1">{{ $galleryCount ?? 0 }}</div>
            ...
            <div class="lg:w-[480px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="300">
                <div class="wisata-card group">
                    @php
                        $firstFeatured = $wisata;
                        $featuredImage = is_array($firstFeatured->gambar) && count($firstFeatured->gambar) > 0
                                        ? (is_array($firstFeatured->gambar[0]) ? $firstFeatured->gambar[0]['url'] : $firstFeatured->gambar[0])
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-3xl mx-auto">
                <p class="text-xl text-gray-700 leading-relaxed">
                    Temukan 1 destinasi wisata menarik yang siap memukau Anda dengan keindahan alam dan budaya lokal.
                </p>
            </div>
        </div>
        ...
        <div class="card-grid" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            ...
            <div class="wisata-card group">
                ...
                @endphp
                <div class="card-image" style="background-image: url('{{ $mainImage }}');" onclick="window.location='{{ route('potensi-wisata.show', $item->id) }}'">
                    <!-- Category Badge -->
                    <div class="category-badge">
                        Pantai
                    </div>
                    ...
                    <div class="gallery-preview">
                        ...
                        <div class="gallery-preview-thumb">
                            <img src="{{ is_array($thumbnail) ? $thumbnail['url'] : $thumbnail }}" alt="{{ $item->nama }}">
                        </div>
                        @endforeach
                    </div>
                    @endif
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex items-center gap-2 text-gray-500">
                            ...
                            <span class="text-sm">{{ $item->jam_buka }}</span>
                        </div>
                        @endif
                        @if($item->harga_tiket)
                        <div class="flex items-center gap-2 text-gray-500">
                            <i class="fas fa-ticket-alt text-sm text-green-500"></i>
                            <span class="text-sm">{{ $item->harga_tiket }}</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs text-gray-500">{{ number_format($item->views ?? 0) }} views</span>
                        </div>
                        <a href="{{ route('potensi-wisata.show', $item->id) }}" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                            Jelajahi
                        </a>
                    </div>
                </div>
