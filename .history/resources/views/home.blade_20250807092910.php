                ...
                <div class="relative z-10 animate-float">
                    <div class="w-full h-96 lg:h-[500px] bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl shadow-2xl flex items-center justify-center overflow-hidden">
                        ...
                        <div class="text-center text-white relative z-10">
                            <!-- Large Profile Image -->
                            <div class="w-48 h-48 lg:w-56 lg:h-56 rounded-full mx-auto mb-6 border-4 border-white/30 overflow-hidden bg-white/20 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=400&q=80"
                                     ...
                                     onerror="this.src='https://ui-avatars.com/api/?name=Kepala+Desa&background=1e40af&color=ffffff&size=224&bold=true'">
                            </div>

                            <!-- Title -->
                            <h3 class="text-3xl lg:text-4xl font-bold mb-2">Kepala Desa</h3>
                            <p class="text-xl text-blue-100 mb-4">Ketapang Baru</p>

                            <!-- Name -->
                            <div class="bg-white/20 rounded-xl px-6 py-3 inline-block backdrop-blur-sm">
