...
<section class="relative text-white overflow-hidden py-12 lg:py-16" style="background-color: #0086c9;">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-24" viewBox="0 0 1200 200" preserveAspectRatio="none">
            ...
            <path fill="#ffffff" fill-opacity="0.5" d="M0,160 C200,120 400,180 600,140 C800,100 1000,160 1200,120 L1200,200 L0,200 Z" class="animate-wave-medium" style="animation-delay: -1s;"></path>
            <path fill="#ffffff" fill-opacity="0.8" d="M0,170 C250,130 450,190 650,150 C850,110 1050,170 1200,130 L1200,200 L0,200 Z" class="animate-wave-fast" style="animation-delay: -2s;"></path>
        </svg>
    </div>
</section>
...
.animate-wave-medium {
    animation: ripple-medium 3s ease-in-out infinite;
}

.animate-wave-fast {
    animation: ripple-fast 2s ease-in-out infinite;
}
