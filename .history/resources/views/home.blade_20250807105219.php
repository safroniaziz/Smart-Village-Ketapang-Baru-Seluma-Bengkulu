        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 slide-up">
                    <a href="{{ route('surat.online') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center text-lg hover-scale">
                        <i class="fas fa-envelope mr-2"></i>Layanan Surat Online
                    </a>
                    <a href="{{ route('tentang') }}" class="bg-white/20 hover:bg-white/30 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center backdrop-blur-sm text-lg hover-scale">
