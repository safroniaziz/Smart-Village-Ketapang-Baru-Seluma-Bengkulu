...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-40" style="background-color: #0086c9;">
    <!-- Background Pattern -->
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-16">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            <!-- Hero Content (Left Side) -->
            <div class="flex-1 space-y-6 relative z-10">
                <div class="space-y-4">
                    <!-- Badge -->
                    <div class="flex items-center space-x-3 mb-3" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <!-- Main Title -->
                    <h1 class="text-4xl lg:text-6xl font-black leading-tight mb-4" data-aos="fade-up" data-aos-delay="400">
                ...
                <!-- Enhanced Search Bar -->
                <div class="max-w-xl mb-4 relative z-20" data-aos="fade-up" data-aos-delay="700">
                    <div class="relative">
