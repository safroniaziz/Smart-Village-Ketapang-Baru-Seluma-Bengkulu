            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="chart-card-modern">
                    <div class="chart-header-modern">
                        <div class="chart-icon-modern bg-gradient-to-br from-pink-500 to-rose-600">
                            <i class="fas fa-venus-mars text-white text-xl"></i>
                        </div>
                        <div>
                            <h3 class="chart-title-modern">Berdasarkan Jenis Kelamin</h3>
                            <p class="chart-subtitle-modern">Data penduduk per jenis kelamin</p>
                        </div>
                    </div>
                    ...
                    <div class="chart-content-modern">
                        ...
                        <div class="flex flex-col lg:flex-row items-center gap-6">
                            ...
                            <div class="pie-chart-container">
                                <svg class="pie-chart" viewBox="0 0 200 200" width="180" height="180">
                                    <!-- Background circle -->
                                    <circle cx="100" cy="100" r="80" fill="#f8fafc" stroke="#e2e8f0" stroke-width="2"/>

                                    <!-- Laki-laki slice (51.5%) -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#blueGradient)" stroke-width="20"
                                            stroke-dasharray="228.5 215.5" stroke-dashoffset="25"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>

                                    <!-- Perempuan slice (48.5%) -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#pinkGradient)" stroke-width="20"
                                            stroke-dasharray="215.5 228.5" stroke-dashoffset="-203.5"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>

                                    <!-- Center circle -->
                                    <circle cx="100" cy="100" r="45" fill="white" stroke="#f1f5f9" stroke-width="2"/>

                                    <!-- Center text -->
                                    <text x="100" y="95" text-anchor="middle" class="pie-center-text-large">2,500</text>
                                    <text x="100" y="110" text-anchor="middle" class="pie-center-text-small">Total Warga</text>
                            ...
                            <div class="pie-legend">
                                <div class="legend-item">
                                    ...
                                    <div class="legend-text">
                                        <div class="legend-label">Laki-laki</div>
                                        <div class="legend-value">1,287 (51.5%)</div>
                                    </div>
                                </div>
                                <div class="legend-item">
                                    <div class="legend-color bg-gradient-to-r from-pink-500 to-pink-600"></div>
                                    <div class="legend-text">
                                        <div class="legend-label">Perempuan</div>
                                        <div class="legend-value">1,213 (48.5%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="chart-card-modern">
                    <div class="chart-header-modern">
                        <div class="chart-icon-modern bg-gradient-to-br from-indigo-500 to-purple-600">
                            <i class="fas fa-chart-line text-white text-xl"></i>
                        </div>
                        <div>
                            <h3 class="chart-title-modern">Berdasarkan Rentang Umur</h3>
                            <p class="chart-subtitle-modern">Distribusi penduduk per kelompok umur</p>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col lg:flex-row items-center gap-6">
                            ...
                            <div class="pie-chart-container">
                                <svg class="pie-chart" viewBox="0 0 200 200" width="180" height="180">
                                    ...
                                    <!-- 18-39 tahun slice (38%) - largest, start from top -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#blueAgeGradient)" stroke-width="20"
                                            stroke-dasharray="168.2 271.8" stroke-dashoffset="25"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>

                                    <!-- 0-17 tahun slice (30%) -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#greenGradient)" stroke-width="20"
                                            stroke-dasharray="132.7 307.3" stroke-dashoffset="-143.2"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>

                                    <!-- 40-59 tahun slice (23%) -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#orangeGradient)" stroke-width="20"
                                            stroke-dasharray="101.8 338.2" stroke-dashoffset="-275.9"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>

                                    <!-- 60+ tahun slice (9%) -->
                                    <circle cx="100" cy="100" r="70" fill="none" stroke="url(#purpleGradient)" stroke-width="20"
                                            stroke-dasharray="39.8 400.2" stroke-dashoffset="-377.7"
                                            transform="rotate(-90 100 100)" class="pie-slice">
                                    </circle>
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="blueAgeGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                            <stop offset="0%" style="stop-color:#3b82f6"/>
                                            <stop offset="100%" style="stop-color:#1d4ed8"/>
                                        </linearGradient>
                            ...
                            <div class="pie-legend">
                                <div class="legend-item">
                                    ...
                                    <div class="legend-text">
                                        <div class="legend-label">0-17 tahun</div>
                                        <div class="legend-value">750 (30%)</div>
                                    </div>
                                </div>
                                <div class="legend-item">
                                    <div class="legend-color bg-gradient-to-r from-blue-500 to-blue-600"></div>
                                    <div class="legend-text">
                                        <div class="legend-label">18-39 tahun</div>
                                        <div class="legend-value">950 (38%)</div>
                                    </div>
                                </div>
                                <div class="legend-item">
                                    <div class="legend-color bg-gradient-to-r from-orange-500 to-orange-600"></div>
                                    <div class="legend-text">
                                        <div class="legend-label">40-59 tahun</div>
                                        <div class="legend-value">575 (23%)</div>
                                    </div>
                                </div>
                                <div class="legend-item">
                                    <div class="legend-color bg-gradient-to-r from-purple-500 to-purple-600"></div>
                                    <div class="legend-text">
                                        <div class="legend-label">60+ tahun</div>
                                        <div class="legend-value">225 (9%)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
.chart-card-modern:hover {
    ...
    box-shadow: 0 8px 30px rgba(0, 0, 0, 0.12), 0 16px 50px rgba(0, 0, 0, 0.08);
    border-color: #e2e8f0;
}
