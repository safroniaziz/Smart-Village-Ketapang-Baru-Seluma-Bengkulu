...
<head>
    ...
    <style>
        ...
        .document-number { font-size: 11pt; font-family: 'Courier New', monospace; }
        ...
        .data-table td {
            padding: 6px 8px; vertical-align: top; border-bottom: 1px dashed #bbb;
        }
        .data-table td:first-child { width: 160px; font-weight: 600; }
