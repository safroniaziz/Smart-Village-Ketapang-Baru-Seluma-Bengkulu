            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 50%; vertical-align: top; text-align: center;">
                        ...
                        <!-- DEBUG: jenis_ttd = "{{ $jenis_ttd ?? 'null' }}", ttd_image_path = "{{ $ttd_image_path ?? 'null' }}" -->
                        @if($jenis_ttd == 'gambar')
                            <!-- Gambar TTD -->
                            <div style="margin-bottom: 15px;">
                                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path($ttd_image_path ?? 'assets/images/ttd.png'))) }}" style="width: 150px; height: auto;" alt="TTD Gambar">
                            </div>
