...
<body>
    <div class="page">
        ...
        <div class="section">
            ...
            <div class="data-grid">
                <div class="data-item data-label">Nama Lengkap :</div>
                <div class="data-item data-value">{{ $nama_pemohon ?? 'HELESMI' }}</div>
                <div class="data-item data-label">NIK :</div>
                <div class="data-item data-value">{{ $nik ?? '1701115607870003' }}</div>
                <div class="data-item data-label">Tempat, Tanggal Lahir :</div>
                <div class="data-item data-value">{{ $tempat_lahir ?? 'Muara Dua' }}, {{ $tanggal_lahir ?? '16 Juli 1987' }}</div>
                <div class="data-item data-label">Jenis Kelamin :</div>
                <div class="data-item data-value">{{ $jenis_kelamin ?? 'Perempuan' }}</div>
                <div class="data-item data-label">Agama :</div>
                <div class="data-item data-value">{{ $agama ?? 'Islam' }}</div>
                <div class="data-item data-label">Pekerjaan :</div>
                <div class="data-item data-value">{{ $pekerjaan ?? 'Mengurus Rumah Tangga' }}</div>
                <div class="data-item data-label">Alamat :</div>
                <div class="data-item data-value">{{ $alamat ?? 'Desa Ketapang Baru, Kecamatan Semidang Alas Maras, Kabupaten Seluma' }}</div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="data-grid">
                <div class="data-item data-label">Dokumen/Barang :</div>
                <div class="data-item data-value">{{ $jenis_dokumen ?? 'KARTU KELUARGA' }}</div>
                <div class="data-item data-label">Nomor Dokumen :</div>
                <div class="data-item data-value">{{ $nomor_dokumen ?? '1705052511190005' }}</div>
                <div class="data-item data-label">Tempat Kehilangan :</div>
                <div class="data-item data-value">{{ $tempat_kehilangan ?? 'Desa Ketapang Baru' }}</div>
                <div class="data-item data-label">Waktu Kehilangan :</div>
                <div class="data-item data-value">{{ $waktu_kehilangan ?? '6 Bulan yang lalu' }}</div>
                <div class="data-item data-label">Keperluan :</div>
                <div class="data-item data-value">{{ $keperluan ?? 'Pengurusan administrasi kependudukan' }}</div>
            </div>
        </div>
