        ...
        <div class="data-pemohon">
            ...
            <div class="data-row">
                ...
                <div class="data-value">{{ $alamat }}</div>
                    ...
                    <div class="isi-surat">
            <p>Orang tersebut adalah benar penduduk Desa Ketapang Baru, Kecamatan Semidang Alas Maras, Kabupaten Seluma dan memang mempunyai usaha <strong>{{ $nama_usaha }}</strong>.</p>
        </div>
        </div>
