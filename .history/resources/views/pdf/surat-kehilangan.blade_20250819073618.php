    ...
    <style>
        ...
        * {
        ...
        .section-title::before {
            ...
            right: 0;
            bottom: 0;
            background: radial-gradient(circle at 10px 10px, rgba(255,255,255,0.3) 0%, transparent 2px),
                        radial-gradient(circle at 30px 30px, rgba(255,255,255,0.3) 0%, transparent 2px),
                        radial-gradient(circle at 50px 50px, rgba(255,255,255,0.3) 0%, transparent 2px);
