            ...
            <div class="signature-right">
                ...
                <div class="signature-space">
                    @if($jenis_ttd == 'qrcode')
                        ...
                        <img src="data:image/png;base64,{{ $qr_ttd_base64 }}" alt="QR Code TTD" style="width: 80px; height: 80px; margin: 10px auto;">
                        <p style="font-size: 8pt; color: #666;">*Scan QR untuk verifikasi tanda tangan</p>
                    @elseif($jenis_ttd == 'gambar')
                        <!-- Gambar TTD -->
                        <img src="{{ $ttd_image_path ?? asset('images/ttd-kepala-desa.png') }}" alt="TTD Gambar" style="width: 120px; height: auto; margin: 10px auto;">
                    @else
