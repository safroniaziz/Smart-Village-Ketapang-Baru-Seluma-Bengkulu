        ...
        <div class="footer">
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 30px;">
                ...
                <div style="text-align: center; margin-right: 50px;">
                    ...
                    <div style="font-weight: 700; text-decoration: underline;">{{ $nama_kepala ?? 'ZULTAN ALHARA' }}</div>
                    ...
                    <div style="margin-top: 15px;">
                        ...
                        <div style="font-size:9pt; text-align:center; margin-top: 5px;">Verifikasi Online</div>
                    </div>
                    @endif
                </div>
            </div>
