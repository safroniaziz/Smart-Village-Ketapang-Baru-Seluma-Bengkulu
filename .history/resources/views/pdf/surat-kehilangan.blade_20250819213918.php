...
apa        .document-number { font-size: 9.5pt; font-family: 'DejaVu Sans', Arial, sans-serif; }
        ...
        .data-table { width: 100%; border-collapse: collapse; border: 1px solid #000; }
                .data-table td {
            padding: 4px 4px;  /* padding diperkecil agar tanpa indent */
            vertical-align: top;
            border: 1px solid #000;  /* garis solid pada semua sisi */
...
.data-table td:first-child {
    ...
    font-weight: 600;       /* label sedikit bold */
}
