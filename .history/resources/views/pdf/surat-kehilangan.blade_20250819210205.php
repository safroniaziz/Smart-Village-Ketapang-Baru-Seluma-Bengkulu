...
<head>
    ...
    <style>
        /* Use local PDF-safe fonts; avoid remote imports for dompdf */
        ...
        * {
        ...
        /* Enforce DejaVu Sans on common elements to avoid Times fallback in dompdf */
        html, body, .page, .header, .content, .footer, table, thead, tbody, tfoot, tr, td, th, p, span, div, li, h1, h2, h3, h4, h5, h6 {
