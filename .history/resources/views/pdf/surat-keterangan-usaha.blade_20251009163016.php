    ...
    <div class="content">
        ...
        <div class="data-pemohon">
            ...
            <div class="data-row">
                ...
                <div class="data-separator">:</div>
                <div class="data-value">{{ $nama_usaha ?? 'N/A' }}</div>
            </div>
            <div class="data-row">
                <div class="data-label">Jenis Usaha</div>
                <div class="data-separator">:</div>
                <div class="data-value">{{ $jenis_usaha ?? 'N/A' }}</div>
            </div>
            <div class="data-row">
                <div class="data-label">Alamat Usaha</div>
                <div class="data-separator">:</div>
                <div class="data-value">{{ $alamat_usaha ?? 'N/A' }}</div>
            </div>
            <div class="data-row">
                <div class="data-label">Lama Usaha</div>
                <div class="data-separator">:</div>
                <div class="data-value">{{ $lama_usaha ?? 'N/A' }}</div>
            </div>
        </div>

        <p>Nama tersebut diatas adalah benar warga Desa Ketapang Baru Kecamatan Semidang Alas Maras Kabupaten Seluma dan benar mempunyai usaha {{ $jenis_usaha ?? 'usaha' }} dengan nama "{{ $nama_usaha ?? 'N/A' }}" yang beralamat di {{ $alamat_usaha ?? 'alamat tersebut diatas' }}.</p>

        <p>Surat keterangan ini dibuat berdasarkan keterangan yang bersangkutan dan untuk dapat dipergunakan sebagaimana mestinya.</p>
    </div>
