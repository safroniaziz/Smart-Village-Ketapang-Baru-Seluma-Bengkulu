            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 50%; vertical-align: top; text-align: center;">
                        ...
                        <!-- TTD berdasarkan pilihan admin: {{ $jenis_ttd ?? 'tidak ada' }} -->
                        @if($jenis_ttd == 'gambar')
                            <!-- Gambar TTD -->
                            <div style="margin-bottom: 15px;">
                                <img src="{{ public_path('assets/images/ttd.png') }}" style="width: 150px; height: auto;" alt="TTD Gambar">
                            </div>
                        ...
                        @else
                            <!-- Manual TTD - Ruang kosong (jenis_ttd: {{ $jenis_ttd ?? 'null' }}) -->
                            <div style="height: 80px; margin-bottom: 15px;">
                                <!-- Ruang kosong untuk TTD manual -->
                            </div>
                        @endif

                        <!-- QR Code Verifikasi Surat (berbeda dengan QR TTD) -->
                        @if(isset($qr_base64))
                        <div style="margin-bottom: 15px;">
                            <img class="qr-code" src="data:image/png;base64,{{ $qr_base64 }}" alt="QR Code Verifikasi Surat" style="width: 80px; height: 80px;">
                        </div>
                        @endif

                        <div style="font-weight: 700; text-decoration: underline; font-size: 10pt;">{{ $nama_kepala ?? 'Desmerti Mustika Sari' }}</div>
