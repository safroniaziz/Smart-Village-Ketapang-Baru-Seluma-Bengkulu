...
<head>
    ...
    <style>
        ...
        .data-table td {
            ...
            font-size: 9.5pt;  /* ukuran font disesuaikan dengan body */
            line-height: 1.4;  /* line height disesuaikan */
            letter-spacing: 0;  /* letter spacing dihilangkan */
        }
    ...
    <div class="page">
        ...
        <div class="approval-section">
            <div class="approval-item">
                <div class="approval-title">MENGETAHUI :</div>
                ...
                <div style="margin-top: 15px; font-weight: 700;">Camat SAM</div>
                <div style="margin-top: 40px; font-weight: 700;">{{ $nama_camat ?? 'Nama Camat' }}</div>
                <div style="margin-top: 5px;">NIP. {{ $nip_camat ?? '........................' }}</div>
            </div>
            ...
            <div class="approval-item">
                ...
                <div style="margin-top: 15px; font-weight: 700;">DANRAMIL SAM</div>
                <div style="margin-top: 40px; font-weight: 700;">{{ $nama_danramil ?? 'Nama Danramil' }}</div>
                <div style="margin-top: 5px;">NRP. {{ $nrp_danramil ?? '........................' }}</div>
            </div>
            ...
            <div class="approval-item">
                ...
                <div style="margin-top: 15px; font-weight: 700;">POLSEK SAM</div>
                <div style="margin-top: 40px; font-weight: 700;">{{ $nama_kapolsek ?? 'Nama Kapolsek' }}</div>
                <div style="margin-top: 5px;">NRP. {{ $nrp_kapolsek ?? '........................' }}</div>
            </div>
        </div>
