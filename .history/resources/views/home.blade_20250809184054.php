...
<section class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" style="background-color: #0086c9;">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            ...
            <!-- Compact Statistics (Right Side) -->
            <div class="lg:w-[420px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                <!-- Compact Stats Grid - 2 Main Cards -->
                <div class="grid grid-cols-1 gap-4 mb-4">
                    <!-- Population & Community Card -->
                    <div class="group relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 backdrop-blur-sm border-2 border-blue-200/50 rounded-3xl p-5 hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-blue-300 hover:shadow-blue-500/20 overflow-hidden">
                        <!-- Background Pattern -->
                        <div class="absolute inset-0 opacity-10 group-hover:opacity-15 transition-opacity duration-500">
                            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full -translate-y-12 translate-x-12"></div>
                            <div class="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-tr from-cyan-400 to-blue-500 rounded-full translate-y-8 -translate-x-8"></div>
                        </div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center space-x-3">
                                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 group-hover:shadow-blue-500/40">
                                        <i class="fas fa-users text-white text-lg"></i>
                                    </div>
                                    <div>
                                        <h4 class="text-lg font-black text-gray-800">Populasi & Komunitas</h4>
                                        <p class="text-xs text-gray-600 font-medium">Data Real-time</p>
                                    </div>
                                </div>
                                <div class="text-xs text-green-600 flex items-center font-semibold bg-green-50 rounded-full px-3 py-1.5 border border-green-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center">
                                    ...
                                    <div class="text-xs text-gray-700 font-bold">Total Warga</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-black text-emerald-600 mb-1">
                                        <span class="counter" data-count="1250">0</span>
                                    </div>
                                    <div class="text-xs text-gray-700 font-bold">Keluarga</div>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Territory & Infrastructure Card -->
                    <div class="group relative bg-gradient-to-br from-white via-emerald-50 to-green-100 backdrop-blur-sm border-2 border-emerald-200/50 rounded-3xl p-5 hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-emerald-300 hover:shadow-emerald-500/20 overflow-hidden">
                        <!-- Background Pattern -->
                        <div class="absolute inset-0 opacity-10 group-hover:opacity-15 transition-opacity duration-500">
                            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-emerald-400 to-green-600 rounded-full -translate-y-12 translate-x-12"></div>
                            <div class="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-tr from-teal-400 to-emerald-500 rounded-full translate-y-8 -translate-x-8"></div>
                        </div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center space-x-3">
                                    <div class="w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 group-hover:shadow-emerald-500/40">
                                        <i class="fas fa-map-marked-alt text-white text-lg"></i>
                                    </div>
                                    <div>
                                        <h4 class="text-lg font-black text-gray-800">Wilayah & Infrastruktur</h4>
                                        <p class="text-xs text-gray-600 font-medium">Geografis</p>
                                    </div>
                                </div>
                                <div class="text-xs text-gray-600 flex items-center font-semibold bg-gray-50 rounded-full px-3 py-1.5 border border-gray-200">
                                    <i class="fas fa-map mr-1"></i>24 RT/RW
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center">
                                    ...
                                    <div class="text-xs text-gray-700 font-bold">Dusun</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-black text-green-600 mb-1">
                                        <span class="counter" data-count="450">0</span>
                                    </div>
                                    <div class="text-xs text-gray-700 font-bold">Hektar</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-6 shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-delay="800">
                    <!-- Background Pattern -->
                    ...
                    <div class="relative z-10 grid grid-cols-1 gap-3 mb-4">
                        <div class="bg-white/70 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100/50">
                            <div class="flex items-center justify-center text-xs">
                                <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center mr-3 shadow-sm">
                                    <i class="fas fa-user-tie text-white text-xs"></i>
                                </div>
                                <div class="text-center">
                                    <p class="font-bold text-gray-800">H. Ahmad Supriyadi, S.Pd</p>
                        ...
                        <div class="bg-white/70 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100/50">
                            <div class="flex items-center justify-center text-xs">
                                <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-3 shadow-sm">
                                    <i class="fas fa-calendar text-white text-xs"></i>
                                </div>
                                <div class="text-center">
                                    <p class="font-bold text-gray-800">2021 - 2027</p>
                    ...
                    <!-- QR Code Section -->
                    <div class="relative z-10 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 rounded-2xl p-4 shadow-xl">
                        ...
                        <div class="flex flex-col items-center space-y-3">
                            <div class="relative">
                                <!-- QR Code Glow Effect -->
                                <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/30 to-blue-500/30 rounded-2xl blur-lg"></div>
                                <div class="relative bg-white p-3 rounded-2xl shadow-2xl border-2 border-white/20">
                                    <div id="qr-code-container" class="w-20 h-20 flex items-center justify-center bg-gray-50 rounded-xl overflow-hidden">
                            ...
                            <div class="text-center">
                                <div class="flex items-center justify-center space-x-2 mb-1">
                                    ...
                                    <p class="text-sm text-white font-bold">Scan untuk Virtual Tour</p>
                        ...
                        <div class="flex justify-center mt-3">
                            <div class="inline-flex items-center bg-gradient-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-full px-3 py-1">
                                <i class="fas fa-qrcode text-cyan-400 text-xs mr-2"></i>
                                <span class="text-xs text-cyan-100 font-medium">Smart QR Technology</span>
                            </div>
                        </div>
                    </div>
                </div>
...
// QR Code Generation untuk Street View
function generateQRCode() {
    // URL Google Street View untuk Balai Desa Ketapang Baru
    const streetViewUrl = 'https://www.google.com/maps/@-4.3221828,102.7635049,3a,75y,82.05h,79.18t/data=!3m7!1e1!3m5!1sPFCbe1x0vFzhf8kg4ySPRA!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D10.816205003909786%26panoid%3DPFCbe1x0vFzhf8kg4ySPRA%26yaw%3D82.05321278048778!7i16384!8i8192';

    // Generate QR Code menggunakan public API
    const qrApiUrl = `https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent(streetViewUrl)}`;

    const container = document.getElementById('qr-code-container');
    if (container) {
        container.innerHTML = `
            <img src="${qrApiUrl}"
                 alt="QR Code Street View"
