        ...
        <div data-aos="fade-up" data-aos-duration="600">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="chart-card-modern">
                    ...
                    <div class="chart-content-modern">
                        <!-- 0-17 tahun -->
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    <div class="w-4 h-4 bg-green-500 rounded-full mr-3"></div>
                                    <span class="text-gray-700 font-medium">0-17 tahun</span>
                                </div>
                                <span class="text-green-700 font-bold">750 (30%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-green-400 to-green-600" style="width: 30%"></div>
                            </div>
                        </div>
                        ...
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-700 font-medium">18-39 tahun</span>
                                </div>
                                <span class="text-blue-700 font-bold">950 (38%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-blue-400 to-blue-600" style="width: 38%"></div>
                            </div>
                        </div>
                        ...
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-700 font-medium">40-59 tahun</span>
                                </div>
                                <span class="text-orange-700 font-bold">575 (23%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-orange-400 to-orange-600" style="width: 23%"></div>
                            </div>
                        </div>
                        ...
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-700 font-medium">60+ tahun</span>
                                </div>
                                <span class="text-purple-700 font-bold">225 (9%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-purple-400 to-purple-600" style="width: 9%"></div>
                            </div>
                        </div>
                    </div>
                </div>
