        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="group text-center p-8 bg-gradient-to-br from-blue-500/20 to-blue-600/10 backdrop-blur-md border border-blue-400/30 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-blue-500/30 hover:to-blue-600/20">
                        ...
                        <div class="text-blue-100 font-bold mb-2">Total Warga</div>
                    ...
                    <div class="group text-center p-8 bg-gradient-to-br from-green-500/20 to-emerald-600/10 backdrop-blur-md border border-green-400/30 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-green-500/30 hover:to-emerald-600/20">
                        <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                            <i class="fas fa-map-marked-alt text-white text-xl"></i>
                        </div>
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="8">0</span>
                        </div>
                        <div class="text-blue-100 font-bold mb-2">Dusun</div>
                        <div class="text-xs text-blue-200 font-semibold">24 RT/RW Aktif</div>
                    </div>

                    <div class="group text-center p-8 bg-gradient-to-br from-purple-500/20 to-purple-600/10 backdrop-blur-md border border-purple-400/30 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-purple-500/30 hover:to-purple-600/20">
                        ...
                        <div class="text-blue-100 font-bold mb-2">Keluarga</div>
                        <div class="text-xs text-green-300 flex items-center justify-center font-semibold">
                            <i class="fas fa-arrow-up mr-1"></i>KK Aktif
                        </div>
                    </div>

                    <div class="group text-center p-8 bg-gradient-to-br from-orange-500/20 to-red-600/10 backdrop-blur-md border border-orange-400/30 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-orange-500/30 hover:to-red-600/20">
                        <div class="w-16 h-16 bg-gradient-to-br from-orange-400 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                            <i class="fas fa-seedling text-white text-xl"></i>
                        </div>
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="450">0</span>
                        </div>
                        <div class="text-blue-100 font-bold mb-2">Hektar</div>
