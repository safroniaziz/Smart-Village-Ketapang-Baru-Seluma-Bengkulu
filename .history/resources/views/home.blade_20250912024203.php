...
$(document).ready(function() {
    ...
    function generateQRCode() {
        ...
        if (container) {
            ...
            container.innerHTML = '<div class="w-full h-full flex items-center justify-center"><i class="fas fa-spinner fa-spin text-gray-400"></i></div>';
            
            // Create and load QR code image
            const img = new Image();
            img.onload = function() {
                container.innerHTML = `
                    <img src="${qrApiUrl}"
