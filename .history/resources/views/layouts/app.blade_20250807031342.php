        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h5>Kontak</h5>
                    <ul class="list-unstyled">
                        <li><i class="fas fa-map-marker-alt me-2"></i>Desa Ketapang Baru, Kecamatan Semidang Alas Maras</li>
                        <li><i class="fas fa-phone me-2"></i>(022) 1234567</li>
                        <li><i class="fas fa-envelope me-2"></i>info@ketapangbaru.desa.id</li>
                    </ul>
                </div>
            </div>
            <hr class="my-4">
