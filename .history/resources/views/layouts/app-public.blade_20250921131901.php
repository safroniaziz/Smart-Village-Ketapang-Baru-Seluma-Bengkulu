            ...
            <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div class="pt-4 border-t border-gray-200">
                    <div class="flex space-x-3">
                        <a href="{{ route('login') }}" class="group relative overflow-hidden flex-1 flex items-center justify-center px-4 py-3 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:from-yellow-500 hover:via-orange-600 hover:to-red-600 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-500/25">
                            <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <div class="relative flex items-center justify-center">
