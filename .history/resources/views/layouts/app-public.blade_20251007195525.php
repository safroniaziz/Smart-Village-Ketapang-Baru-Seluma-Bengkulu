                ...
                <div class="hidden xl:flex items-center space-x-3 flex-shrink-0">
                    @auth
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="px-3 py-2 bg-white/10 text-white font-medium rounded-lg">
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="inline">
                                @csrf
                                <button type="submit" class="px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-all duration-200 shadow-sm">
                                    <svg class="w-4 h-4 mr-2 inline" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="space-y-3">
                            <div class="text-center p-3 bg-blue-50 rounded-xl">
                                <div class="flex items-center justify-center mb-2">
                                    ...
                                    <span class="font-medium text-blue-900">{{ auth()->user()->nama_lengkap ?? auth()->user()->email }}</span>
                                </div>
                            </div>
                            <div class="flex justify-center">
                                <form method="POST" action="{{ route('logout') }}" class="w-full">
                                    @csrf
                                    <button type="submit" class="w-full flex items-center justify-center px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-all duration-300 font-medium shadow-sm">
