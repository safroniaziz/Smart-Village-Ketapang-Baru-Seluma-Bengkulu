...
<head>
    ...
    <meta http-equiv="Permissions-Policy" content="accelerometer=(), gyroscope=(), magnetometer=(), camera=(), microphone=(), battery=(), display-capture=(), document-domain=(), gamepad=(), publickey-credentials-get=(), screen-wake-lock=(), xr-spatial-tracking=()">
...
<body class="font-sans antialiased bg-white">
    <script>
        // Remove aos-disabled class to enable AOS animations
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (typeof AOS !== 'undefined') {
                ...
                // Remove aos-disabled class if exists
                document.documentElement.classList.remove('aos-disabled');
            } else {
...
.section-badge {
    @apply inline-flex items-center relative mb-6;
}

.section-badge .badge-blur {
    @apply absolute inset-0 rounded-full blur-lg opacity-20;
}

.section-badge .badge-content {
    @apply relative text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg;
}
...
.section-title {
    @apply text-5xl lg:text-6xl font-black mb-4;
}
...
.section-description p {
    @apply text-xl lg:text-2xl text-gray-700 leading-relaxed;
}
...
.section-description .highlight-underline {
    @apply absolute bottom-0 left-0 w-full h-3 opacity-60 rounded;
}
...
/* AOS Animation defaults for sections */
.section-header[data-aos] {
    @apply data-[aos]:opacity-0;
}

/* Predefined Color Schemes */
.section-blue .badge-blur {
    @apply bg-gradient-to-r from-blue-600 to-indigo-600;
}

.section-blue .badge-content {
    @apply bg-gradient-to-r from-blue-600 to-indigo-600;
}

.section-blue .section-title-gradient {
    @apply bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-800;
}

.section-blue .section-title-underline {
    @apply bg-gradient-to-r from-blue-500 to-indigo-500;
}

.section-blue .highlight-underline {
    @apply bg-gradient-to-r from-blue-200 to-indigo-200;
}

.section-emerald .badge-blur {
    @apply bg-gradient-to-r from-emerald-600 to-teal-600;
}

.section-emerald .badge-content {
    @apply bg-gradient-to-r from-emerald-600 to-teal-600;
}

.section-emerald .section-title-gradient {
    @apply bg-gradient-to-r from-gray-900 via-slate-800 to-emerald-800;
}

.section-emerald .section-title-underline {
    @apply bg-gradient-to-r from-emerald-500 to-teal-500;
}

.section-emerald .highlight-underline {
    @apply bg-gradient-to-r from-emerald-200 to-teal-200;
}

.section-purple .badge-blur {
    @apply bg-gradient-to-r from-purple-600 to-indigo-600;
}

.section-purple .badge-content {
    @apply bg-gradient-to-r from-purple-600 to-indigo-600;
}

.section-purple .section-title-gradient {
    @apply bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-800;
}

.section-purple .section-title-underline {
    @apply bg-gradient-to-r from-purple-500 to-indigo-500;
}

.section-purple .highlight-underline {
    @apply bg-gradient-to-r from-purple-200 to-indigo-200;
}

.section-slate .badge-blur {
    @apply bg-gradient-to-r from-slate-600 to-blue-600;
}

.section-slate .badge-content {
    @apply bg-gradient-to-r from-slate-600 to-blue-600;
}

.section-slate .section-title-gradient {
    @apply bg-gradient-to-r from-gray-900 via-slate-800 to-blue-800;
}

.section-slate .section-title-underline {
    @apply bg-gradient-to-r from-slate-500 to-blue-500;
}

.section-slate .highlight-underline {
    @apply bg-gradient-to-r from-slate-200 to-blue-200;
}
</style>
