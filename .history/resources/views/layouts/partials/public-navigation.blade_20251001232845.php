    ...
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="mobile-menu" class="lg:hidden hidden bg-white border-t border-gray-200">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('potensi-wisata.index') }}" class="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium transition-colors {{ request()->routeIs('potensi-wisata.*') ? 'text-blue-600 bg-blue-50' : '' }}">
                    Potensi Wisata
                </a>
