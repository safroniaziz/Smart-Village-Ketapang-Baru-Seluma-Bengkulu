...
<body class="font-sans antialiased bg-white">
    ...
    <!-- Navigation -->
    <nav class="fixed top-0 left-0 right-0 z-40 shadow-lg overflow-hidden" style="background-color: #0086c9;" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex items-center justify-between h-16 lg:h-20 min-w-0 nav-container">
                ...
                <a href="{{ route('home') }}" class="flex items-center space-x-2 sm:space-x-3 group flex-shrink-0 min-w-0 logo-container">
                    ...
                    <div class="hidden sm:block min-w-0 flex-1 overflow-hidden">
                        ...
                        <p class="text-xs lg:text-sm text-blue-100 truncate">Sistem Informasi Pemerintahan Desa</p>
                    </div>
                </a>
        ...
        <!-- Mobile Menu -->
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-2" class="lg:hidden bg-gradient-to-b from-white to-gray-50 border-t border-blue-200 shadow-xl">
