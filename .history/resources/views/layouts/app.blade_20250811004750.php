...
.stat-tab { display: inline-flex; align-items: center; white-space: nowrap; padding: 0.5rem 0.875rem; border-radius: 9999px; font-size: 0.875rem; font-weight: 600; color: #334155; transition: all 200ms ease; border: 1px solid transparent; }
.stat-tab:hover { background: #f1f5f9; color: #0f172a; }
.stat-tab.active { background: #0f172a; color: #fff; box-shadow: 0 6px 16px -6px rgba(2, 6, 23, 0.4); border-color: #0f172a; }
.stat-tab i { opacity: 0.9; }
.stat-target { scroll-margin-top: 140px; }
