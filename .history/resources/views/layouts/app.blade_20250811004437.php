...
<style>
.stat-tab { @apply px-3 sm:px-4 py-1.5 rounded-full text-sm font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-100 transition-colors; }
.stat-tab.active { @apply bg-slate-900 text-white shadow; }
