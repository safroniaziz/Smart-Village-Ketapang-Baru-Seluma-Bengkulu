    ...
    <nav class="fixed top-0 left-0 right-0 z-40 shadow-lg" style="background-color: #0086c9;" x-data="{ mobileMenuOpen: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20 min-w-0">
                <!-- Logo -->
                <a href="{{ route('home') }}" class="flex items-center space-x-2 sm:space-x-3 group flex-shrink-0 min-w-0">
                ...
                <!-- Mobile Menu Button -->
                <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden p-2 rounded-lg text-white hover:bg-white/10 transition-colors flex-shrink-0 ml-2">
