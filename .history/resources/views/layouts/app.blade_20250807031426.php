...
<body class="font-sans antialiased bg-gradient-bg">
    ...
    <div class="loading-screen fixed inset-0 bg-white z-50 flex items-center justify-center">
        <div class="text-center">
            ...
            <h3 class="text-lg font-semibold text-primary-600">Smart Village Ketapang Baru</h3>
        ...
        <div class="container-custom">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <a href="{{ route('home') }}" class="flex items-center space-x-3 group">
                    <div class="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-primary-600 to-accent-500 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-glow transition-all duration-300">
                        <i class="fas fa-home text-white text-lg lg:text-xl"></i>
                    </div>
                    <div>
                        <h1 class="text-lg lg:text-xl font-bold text-gray-900">Smart Village</h1>
                        <p class="text-xs lg:text-sm text-primary-600 font-medium">Ketapang Baru</p>
                    </div>
                </a>
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <div class="relative group" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute top-full left-0 mt-2 w-48 bg-white rounded-xl shadow-large border border-gray-100 py-2">
                            <a href="{{ route('surat.online') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                                <i class="fas fa-envelope mr-2"></i>Surat Online
                            </a>
                            <a href="{{ route('data.warga') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                                <i class="fas fa-users mr-2"></i>Data Warga
                            </a>
                            <a href="{{ route('peta.desa') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                                <i class="fas fa-map mr-2"></i>Peta Desa
                            </a>
                            <a href="{{ route('pengaduan') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                    ...
                    <div class="relative group" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute top-full left-0 mt-2 w-48 bg-white rounded-xl shadow-large border border-gray-100 py-2">
                            <a href="{{ route('berita') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                                <i class="fas fa-newspaper mr-2"></i>Berita
                            </a>
                            <a href="{{ route('pengumuman') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
                                <i class="fas fa-bullhorn mr-2"></i>Pengumuman
                            </a>
                            <a href="{{ route('statistik') }}" class="block px-4 py-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors">
