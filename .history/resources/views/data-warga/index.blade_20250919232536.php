                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_warga">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="{{ route('data-warga.show', $warga) }}">
                                                ...
                                                @else
                                                    <div class="symbol-label fs-3 {{ $warga->jenis_kelamin == 'Laki-laki' ? 'bg-light-primary text-primary' : 'bg-light-danger text-danger' }}">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('data-warga.show', $warga) }}" class="text-gray-800 text-hover-primary mb-1">
                                                {{ $warga->nama_lengkap }}
                                            </a>
                                    ...
                                    <td>
                                        <div class="badge badge-light fw-bold">{{ $warga->nik }}</div>
                                    </td>
                                    <td>
                                        <div class="badge {{ $warga->jenis_kelamin == 'Laki-laki' ? 'badge-light-primary' : 'badge-light-danger' }}">
                                            {{ $warga->jenis_kelamin }}
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>{{ $warga->dusun ?? '-' }}</td>
                                    <td>{{ Str::limit($warga->pekerjaan ?? '-', 20) }}</td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" onclick="deleteWarga({{ $warga->id }})">
                                                    Hapus
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-10">
                                        <div class="d-flex flex-column align-items-center">
                                            <i class="ki-duotone ki-file-down fs-3x text-muted mb-4">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
...
function deleteWarga(id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            form.method = 'POST';
            form.action = `{{ route('data-warga.destroy', '') }}/${id}`;
