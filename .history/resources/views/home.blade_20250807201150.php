...
@section('content')
<!-- Hero Section -->
ma<section class="relative text-white overflow-hidden py-12 lg:py-16 mb-8" style="background-color: #0086c9;">
            <!-- Background Pattern -->
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-40" viewBox="0 0 1200 200" preserveAspectRatio="none">
            <path fill="#ffffff" fill-opacity="0.3" d="M0,150 C300,100 400,200 600,150 C800,100 900,200 1200,150 L1200,200 L0,200 Z" class="animate-wave-slow"></path>
            <path fill="#ffffff" fill-opacity="0.5" d="M0,160 C200,120 400,180 600,140 C800,100 1000,160 1200,120 L1200,200 L0,200 Z" class="animate-wave-medium" style="animation-delay: -3s;"></path>
            <path fill="#ffffff" fill-opacity="0.8" d="M0,170 C250,130 450,190 650,150 C850,110 1050,170 1200,130 L1200,200 L0,200 Z" class="animate-wave-fast" style="animation-delay: -6s;"></path>
        </svg>
    </div>
</section>

<!-- Services Section -->
<section class="py-24 bg-white mt-8">
...
.animate-wave-medium {
    animation: wave-medium 1.5s ease-in-out infinite;
}
