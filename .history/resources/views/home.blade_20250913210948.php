                    ...
                    <div class="chart-container-premium">
                        <div id="genderChartLoading" class="absolute inset-0 flex items-center justify-center bg-gray-50 rounded-lg">
                            <div class="text-center">
                                ...
                                <p class="text-sm text-gray-600">Memuat grafik gender...</p>
                            </div>
                        </div>
                        <div class="h-64 relative">
                            <canvas id="genderChart"></canvas>
                            <!-- Center Total for Doughnut Chart -->
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <div class="text-center">
                                    <div class="text-3xl font-black text-gray-800">2,500</div>
                ...
                <div class="chart-card-premium xl:col-span-2" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="chart-container-premium">
                        <div id="ageChartLoading" class="absolute inset-0 flex items-center justify-center bg-gray-50 rounded-lg">
                            <div class="text-center">
                                <i class="fas fa-spinner fa-spin text-4xl text-gray-400 mb-2"></i>
                                <p class="text-sm text-gray-600">Memuat grafik usia...</p>
                            </div>
                        </div>
                        <div class="h-64">
...
/* Enhanced gender chart center total */
.chart-container-premium .absolute.inset-0 {
    z-index: 15;
}

.chart-container-premium .absolute.inset-0 .text-center {
    background: rgba(255, 255, 255, 0.95);
    backdrop-filter: blur(10px);
    border-radius: 50%;
    width: 120px;
...
.chart-container-premium .absolute.inset-0 .text-3xl {
...
.chart-container-premium .absolute.inset-0 .text-sm {
    color: #6b7280;
    font-weight: 600;
    margin-top: 4px;
    text-transform: uppercase;
