    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <!-- Direct Statistics Grid -->
                <div class="grid grid-cols-2 gap-6 mb-8">
                    <div class="text-center p-6 bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl hover:scale-105 transition-all duration-300 hover:bg-white/20 shadow-xl">
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="2847">0</span>
                        </div>
                        <div class="text-blue-100 font-semibold mb-2">Total Warga</div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl hover:scale-105 transition-all duration-300 hover:bg-white/20 shadow-xl">
                        ...
                        <div class="text-blue-100 font-semibold mb-2">Dusun</div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl hover:scale-105 transition-all duration-300 hover:bg-white/20 shadow-xl">
                        ...
                        <div class="text-blue-100 font-semibold mb-2">Keluarga</div>
                        <div class="text-xs text-green-300 flex items-center justify-center">
                    ...
                    <div class="text-center p-6 bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl hover:scale-105 transition-all duration-300 hover:bg-white/20 shadow-xl">
                        ...
                        <div class="text-blue-100 font-semibold mb-2">Hektar</div>
