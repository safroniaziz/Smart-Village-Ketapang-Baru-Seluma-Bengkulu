                ...
                <div class="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 shadow-lg" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="mt-3 pt-3 border-t border-gray-100">
                        <div class="flex items-center justify-center space-x-2 text-xs text-gray-600">
                            ...
                            <span class="font-medium">Kantor Desa Ketapang Baru</span>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div data-aos="fade-up" data-aos-duration="600">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 mt-16">
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <div class="max-w-4xl mx-auto mb-12" data-aos="fade-up" data-aos-delay="400">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    <span class="font-semibold text-teal-700">Jelajahi Desa Ketapang Baru</span> secara virtual melalui
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-cyan-700">Google Street View</span>
                        <span class="absolute bottom-0 left-0 w-full h-3 bg-gradient-to-r from-teal-200 to-cyan-200 opacity-60 rounded"></span>
                    </span>
                    dan rasakan keindahan desa kami
                </p>
            </div>
        </div>
            ...
            <div class="lg:col-span-2" data-aos="fade-right" data-aos-duration="800">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                    ...
                    <div class="relative" style="height: 450px;">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63459.89!2d102.2607!3d-3.7928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e36b0b1234567890%3A0x1234567890abcdef!2sKetapang%20Baru%2C%20Semidang%20Alas%20Maras%2C%20Seluma%20Regency%2C%20Bengkulu!5e0!3m2!1sen!2sid!4v1234567890!5m2!1sen!2sid"
                            class="w-full h-full rounded-b-2xl border-0"
                            allowfullscreen=""
                            loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade"
                            title="Peta Desa Ketapang Baru">
                        </iframe>
            ...
            <div class="space-y-6" data-aos="fade-left" data-aos-duration="800">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-center text-gray-700">
                            ...
                            <span class="ml-2">-3.7928</span>
                        </div>
                        <div class="flex items-center text-gray-700">
                            <i class="fas fa-compass text-cyan-500 w-5 mr-3"></i>
                            <span class="font-medium">Longitude:</span>
                            <span class="ml-2">102.2607</span>
                        </div>
                        <div class="flex items-center text-gray-700">
                            <i class="fas fa-mountain text-teal-500 w-5 mr-3"></i>
                            <span class="font-medium">Altitude:</span>
                            <span class="ml-2">~25m</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-bold text-gray-900">Navigasi</h3>
                            <p class="text-gray-600 text-sm">Cara ke Desa</p>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <a href="https://www.google.com/maps/dir//Ketapang+Baru,+Semidang+Alas+Maras,+Seluma+Regency,+Bengkulu/@-3.7928,102.2607" target="_blank" class="flex items-center justify-center w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                            <i class="fab fa-google mr-2"></i>
                            Buka di Google Maps
                        </a>
                        <a href="https://waze.com/ul/hw2374t5v2" target="_blank" class="flex items-center justify-center w-full bg-gradient-to-r from-cyan-500 to-teal-600 hover:from-cyan-600 hover:to-teal-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                            <i class="fab fa-waze mr-2"></i>
                            Buka di Waze
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-bold text-gray-900">Virtual Tour</h3>
                            <p class="text-gray-600 text-sm">360° Experience</p>
                        </div>
                    </div>
                    <p class="text-gray-700 text-sm mb-4">
                        Nikmati pengalaman virtual tour 360° untuk menjelajahi keindahan dan fasilitas Desa Ketapang Baru
                    </p>
                    <button class="w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
...
<!-- CTA Section -->
<section class="py-24 text-white bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<!-- Street View Initialization Script -->
<script>
// Global function untuk callback Google Maps API
window.initStreetView = function() {
    try {
        // Koordinat Desa Ketapang Baru, Semidang Alas Maras, Seluma, Bengkulu
        const desaKetapangBaru = { lat: -3.7928, lng: 102.2607 };

        // Clear loading indicator
        const streetViewContainer = document.getElementById('street-view');
        if (!streetViewContainer) {
            console.error('Street View container tidak ditemukan');
            return;
        }

        // Inisialisasi Street View
        const streetView = new google.maps.StreetViewPanorama(streetViewContainer, {
            position: desaKetapangBaru,
            pov: {
                heading: 34,
                pitch: 10
            },
        ...
        // Event listener untuk status changes
        ...
        console.log('Street View berhasil diinisialisasi');

    } catch (error) {
        console.error('Error inisialisasi Street View:', error);
        showFallbackContent();
    }
};

// Function untuk menampilkan fallback content
function showFallbackContent() {
    const container = document.getElementById('street-view');
    if (container) {
        container.innerHTML = `
            <div class="flex items-center justify-center h-full bg-gradient-to-br from-teal-100 to-cyan-100">
                <div class="text-center p-8">
                    <i class="fas fa-map-marked-alt text-6xl text-teal-600 mb-4"></i>
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Street View Tidak Tersedia</h3>
                    <p class="text-gray-600 mb-6">
                        Maaf, Google Street View belum tersedia untuk lokasi ini.
                        Silakan gunakan Google Maps untuk melihat lokasi desa.
                    </p>
                    <a href="https://www.google.com/maps/place/Ketapang+Baru,+Semidang+Alas+Maras,+Seluma+Regency,+Bengkulu/@-3.7928,102.2607,15z"
                       target="_blank"
                       class="inline-flex items-center bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                        <i class="fab fa-google mr-2"></i>
                        Buka di Google Maps
                    </a>
                </div>
        ...
        container.innerHTML = `
            <div class="flex items-center justify-center h-full bg-gradient-to-br from-teal-100 to-cyan-100">
                <div class="text-center">
                    ...
                    <p class="text-teal-700 font-medium">Memuat Street View...</p>
                </div>
            </div>
        `;
    }
...
// Error handler untuk Google Maps API
window.gm_authFailure = function() {
    console.error('Google Maps API Authentication Failed');
    const container = document.getElementById('street-view');
    if (container) {
        container.innerHTML = `
            <div class="flex items-center justify-center h-full bg-gradient-to-br from-red-100 to-orange-100">
                <div class="text-center p-8">
                    <i class="fas fa-exclamation-triangle text-6xl text-red-600 mb-4"></i>
                    <h3 class="text-xl font-bold text-gray-800 mb-2">API Key Tidak Valid</h3>
                    <p class="text-gray-600 mb-6">
                        Google Maps API key tidak valid atau tidak memiliki izin yang diperlukan.
                    </p>
                    <a href="https://www.google.com/maps/place/Ketapang+Baru,+Semidang+Alas+Maras,+Seluma+Regency,+Bengkulu/@-3.7928,102.2607,15z"
                       target="_blank"
                       class="inline-flex items-center bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                        <i class="fab fa-google mr-2"></i>
                        Buka di Google Maps
                    </a>
                </div>
...
// Initialize loading state saat DOM ready
document.addEventListener('DOMContentLoaded', function() {
    showLoadingState();

    // Timeout handler untuk API yang tidak load
    setTimeout(function() {
        if (typeof google === 'undefined') {
            console.warn('Google Maps API tidak berhasil dimuat dalam 10 detik');
            const container = document.getElementById('street-view');
            if (container && container.innerHTML.includes('Memuat Street View')) {
                container.innerHTML = `
                    <div class="flex items-center justify-center h-full bg-gradient-to-br from-yellow-100 to-orange-100">
                        <div class="text-center p-8">
                            <i class="fas fa-wifi text-6xl text-yellow-600 mb-4"></i>
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Koneksi Lambat</h3>
                            <p class="text-gray-600 mb-6">
                                Google Maps API membutuhkan waktu lebih lama untuk dimuat.
                                Silakan refresh halaman atau gunakan link di bawah.
                            </p>
                            <div class="space-y-3">
                                <button onclick="location.reload()"
                                        class="block w-full bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                                    <i class="fas fa-refresh mr-2"></i>
                                    Muat Ulang Halaman
                                </button>
                                <a href="https://www.google.com/maps/place/Ketapang+Baru,+Semidang+Alas+Maras,+Seluma+Regency,+Bengkulu/@-3.7928,102.2607,15z"
                                   target="_blank"
                                   class="block w-full bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                                    <i class="fab fa-google mr-2"></i>
                                    Buka Google Maps
                                </a>
                            </div>
...
<!-- Google Maps API - Load tanpa API key untuk demo -->
<script>
// Untuk demo, kita akan langsung menampilkan fallback
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        showFallbackContent();
    }, 2000);
