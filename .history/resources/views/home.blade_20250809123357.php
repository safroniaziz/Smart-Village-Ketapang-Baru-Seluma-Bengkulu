            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
                ...
                <div class="chart-card-modern">
                    <div class="chart-header-modern">
                        ...
                        <div>
                            <h3 class="chart-title-modern">Distribusi Gender</h3>
                            <p class="chart-subtitle-modern">Data demografi berdasarkan jenis kelamin</p>
                        </div>
                    </div>
                ...
                <div class="chart-card-modern">
                    <div class="chart-header-modern">
                        <div class="chart-icon-modern bg-gradient-to-br from-blue-500 to-indigo-600">
                            <i class="fas fa-users text-white text-xl"></i>
                        </div>
                        <div>
                            <h3 class="chart-title-modern">Distribusi Usia</h3>
                            <p class="chart-subtitle-modern">Data demografi berdasarkan kelompok usia</p>
                        </div>
                    </div>
                    <div class="chart-container-modern">
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    return `${context.label} tahun: ${context.parsed.y} orang`;
                                }
                            }
                        }
                    },
