...
$(document).ready(function() {
    ...
    function generateQRCode() {
        // URL yang lebih sederhana untuk Google Maps lokasi desa
        const mapsUrl = 'https://maps.google.com/?q=-4.3221828,102.7635049';
        const qrApiUrl = `https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=${encodeURIComponent(mapsUrl)}`;
        ...
        if (container) {
            ...
            // Langsung masukkan gambar QR code
            container.innerHTML = `
                <img src="${qrApiUrl}"
                     alt="QR Code Maps"
                     class="w-full h-full object-contain rounded"
                     title="Scan untuk membuka lokasi di Google Maps"
                     onload="console.log('QR Code berhasil dimuat')"
                     onerror="console.error('Error loading QR code'); this.parentElement.innerHTML='<div class=\\'w-full h-full flex flex-col items-center justify-center text-gray-400\\'><i class=\\'fas fa-qrcode text-lg mb-1\\'></i><span class=\\'text-xs\\'>QR Code</span></div>';">
            `;
        } else {
    ...
    // Generate QR code segera setelah DOM ready
