                        ...
                        <div class="flex flex-col items-center space-y-3">
                            <div class="relative group-hover:scale-110 transition-transform duration-500">
                                ...
                                <div class="relative bg-white p-3 rounded-2xl shadow-2xl border-2 border-white/20 group-hover:shadow-3xl group-hover:border-white/40 transition-all duration-500">
                                    <div id="qr-code-container" class="w-20 h-20 flex items-center justify-center bg-gray-50 rounded-xl overflow-hidden group-hover:bg-white transition-colors duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2" data-aos="fade-right" data-aos-duration="800">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                    ...
                    <div class="relative" style="height: 450px;" id="street-view-container">
                        <!-- Preview Image with Click to Load -->
                        <div id="street-view-preview" class="w-full h-full rounded-b-2xl bg-gradient-to-br from-blue-50 to-cyan-50 flex items-center justify-center cursor-pointer transition-all duration-300 hover:from-blue-100 hover:to-cyan-100 border border-blue-100" onclick="loadStreetView()">
                            <div class="text-center p-6">
                                <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg hover:shadow-xl transition-shadow">
                                    <i class="fas fa-street-view text-white text-3xl"></i>
                                </div>
                                <h3 class="text-xl font-bold text-gray-800 mb-3">Street View Balai Desa</h3>
                                <p class="text-gray-600 mb-6 max-w-sm mx-auto leading-relaxed">Klik untuk melihat tampilan 360° interaktif dari Balai Desa Ketapang Baru</p>
                                <div class="space-y-3">
                                    <div class="inline-flex items-center bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg">
                                ...
                                <div class="flex items-center justify-center space-x-6 text-sm text-gray-500 mt-4">
                                    <span class="flex items-center">
                                        <i class="fas fa-mouse-pointer mr-1 text-blue-500"></i>
                                        Interaktif
                                    </span>
                                    <span class="flex items-center">
                                        <i class="fas fa-expand mr-1 text-green-500"></i>
                                        360°
                                    </span>
                                    <span class="flex items-center">
                        ...
                        <div id="street-view-iframe" style="display: none;" class="w-full h-full">
                        </div>
...
$(document).ready(function() {
    ...
    // Initialize Particles.js - SUBTLE BACKGROUND EFFECT
    ...
    // Console warning suppression for Google Maps sensor access
    ...
    console.error = function(...args) {
        if (args[0] && typeof args[0] === 'string' && 
            ...
            // Suppress Google Maps sensor warnings
            return;
        }
    ...
    // Street View Lazy Loading Function with Intersection Observer
    let streetViewLoaded = false;
    
    function loadStreetView() {
        if (streetViewLoaded) return;
        
        const preview = document.getElementById('street-view-preview');
        const iframeContainer = document.getElementById('street-view-iframe');
        ...
        if (preview && iframeContainer) {
            ...
            preview.innerHTML = `
                <div class="text-center p-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Memuat Street View...</h3>
                    <p class="text-gray-600">Mohon tunggu sebentar</p>
                </div>
            `;
            
            // Create iframe with proper restrictions after delay
            setTimeout(() => {
    ...
    if ('IntersectionObserver' in window) {
        const streetViewObserver = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting && !streetViewLoaded) {
                    // Add visual indicator that street view is ready to load
                    const preview = document.getElementById('street-view-preview');
                    if (preview) {
        ...
        // Observe the street view container
