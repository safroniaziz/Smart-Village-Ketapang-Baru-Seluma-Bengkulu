...
<section class="py-20 bg-gradient-to-br from-blue-50 via-white to-indigo-50">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
            <!-- Row 1 -->
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="150">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="250">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="300">
            ...
            <!-- Row 2 -->
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="350">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="450">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="service-card-modern group" data-aos="fade-up" data-aos-delay="550">
...
.service-card-modern {
    @apply bg-white rounded-2xl p-6 text-center shadow-lg border border-gray-100;
    @apply transition-all duration-300 transform hover:scale-105 hover:shadow-xl cursor-pointer;
...
.service-title-modern {
    @apply text-sm font-bold text-gray-900 mb-1;
    @apply leading-tight;
    line-height: 1.2;
}
