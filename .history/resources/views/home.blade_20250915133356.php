...
<style>
    ...
    /* Ocean Wave Animations - More dramatic curves */
    @keyframes ocean-wave-1 {
        0% {
            transform: translateX(0) scaleY(1) skewX(0deg);
        }
        25% {
            transform: translateX(-100px) scaleY(1.3) skewX(-2deg);
        }
        50% {
            transform: translateX(-200px) scaleY(0.8) skewX(1deg);
        }
        75% {
            transform: translateX(-300px) scaleY(1.2) skewX(-1deg);
        }
        100% {
            transform: translateX(-400px) scaleY(1) skewX(0deg);
        }
    }
    ...
    @keyframes ocean-wave-2 {
        ...
        25% {
            transform: translateX(-80px) scaleY(1.4) skewX(2deg);
        }
        50% {
            transform: translateX(-160px) scaleY(0.7) skewX(-1deg);
        }
        75% {
            transform: translateX(-240px) scaleY(1.3) skewX(1deg);
        }
        100% {
            transform: translateX(-320px) scaleY(1) skewX(0deg);
        }
    }
    ...
    @keyframes ocean-wave-3 {
        ...
        25% {
            transform: translateX(-60px) scaleY(1.5) skewX(-3deg);
        }
        50% {
            transform: translateX(-120px) scaleY(0.6) skewX(2deg);
        }
        75% {
            transform: translateX(-180px) scaleY(1.4) skewX(-1deg);
        }
        100% {
            transform: translateX(-240px) scaleY(1) skewX(0deg);
        }
    }
    ...
    @keyframes ocean-wave-4 {
        ...
        25% {
            transform: translateX(-40px) scaleY(1.6) skewX(3deg);
        }
        50% {
            transform: translateX(-80px) scaleY(0.5) skewX(-2deg);
        }
        75% {
            transform: translateX(-120px) scaleY(1.5) skewX(2deg);
        }
        100% {
            transform: translateX(-160px) scaleY(1) skewX(0deg);
        }
    }

    /* Wave Animation Classes */
    .animate-ocean-wave-1 {
        animation: ocean-wave-1 8s ease-in-out infinite;
    }

    .animate-ocean-wave-2 {
        animation: ocean-wave-2 7s ease-in-out infinite 0.5s;
    }

    .animate-ocean-wave-3 {
        animation: ocean-wave-3 6s ease-in-out infinite 1s;
    }

    .animate-ocean-wave-4 {
        animation: ocean-wave-4 5s ease-in-out infinite 1.5s;
    }
</style>
@endpush
...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-20 lg:pb-24" data-aos="fade-in">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-white/5" data-aos="fade-in"></div>

    <!-- Particle.js Container -->
    <div id="particles-js" class="absolute inset-0" data-aos="fade-in"></div>

    <div class="relative w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20" data-aos="fade-up">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                <div class="space-y-8">
                    ...
                    <!-- Main Title -->
                    <h1 class="text-4xl lg:text-6xl font-black leading-tight mb-6" data-aos="fade-up">
                    ...
                    <!-- Description -->
                    <p class="text-lg lg:text-xl text-blue-100 leading-relaxed max-w-2xl font-light" data-aos="fade-up">
                ...
                <!-- Enhanced Search Bar -->
                <div class="max-w-xl mb-8 relative z-20" data-aos="fade-up">
                    <div class="relative">
                ...
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-3 relative z-20 mb-20" data-aos="fade-up">
            ...
            <div class="lg:w-[480px] flex-shrink-0 relative z-10" data-aos="fade-left">
                <!-- Enhanced Info Summary Card dengan class konsisten -->
                <div class="info-card group relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-6 shadow-2xl overflow-hidden hover:shadow-3xl hover:scale-105 hover:border-blue-300/70 cursor-pointer" data-aos="fade-up">
                    <!-- Background Pattern -->
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-24" viewBox="0 0 1200 160" preserveAspectRatio="none">
            <!-- Wave Layer 1 - Back wave -->
            <path fill="#f8f9fa" fill-opacity="1" d="M-200,80 C50,60 150,100 300,80 C450,60 550,100 700,80 C850,60 950,100 1100,80 C1250,60 1350,100 1500,80 L1500,160 L-200,160 Z" class="animate-ocean-wave-1"></path>
            <!-- Wave Layer 2 - Middle wave -->
            <path fill="#f1f3f4" fill-opacity="1" d="M-150,95 C0,75 100,115 250,95 C400,75 500,115 650,95 C800,75 900,115 1050,95 C1200,75 1300,115 1450,95 L1450,160 L-150,160 Z" class="animate-ocean-wave-2"></path>
            <!-- Wave Layer 3 - Front wave -->
            <path fill="#f8f9fa" fill-opacity="1" d="M-100,110 C50,90 150,130 300,110 C450,90 550,130 700,110 C850,90 950,130 1100,110 C1250,90 1350,130 1500,110 L1500,160 L-100,160 Z" class="animate-ocean-wave-3"></path>
            <!-- Wave Layer 4 - Foam layer -->
            <path fill="#ffffff" fill-opacity="1" d="M-50,125 C100,105 200,145 350,125 C500,105 600,145 750,125 C900,105 1000,145 1150,125 C1300,105 1400,145 1550,125 L1550,160 L-50,160 Z" class="animate-ocean-wave-4"></path>
            <!-- Solid base layer -->
            <rect x="-300" y="140" width="2000" height="30" fill="#ffffff"></rect>
        </svg>
    </div>
</section>
        ...
        <div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="stat-card-modern">
                    ...
                    <div class="stat-content-modern">
                        <div class="text-purple-700 text-4xl font-black">0</div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-5 gap-8 mt-16" data-aos="fade-up" data-aos-delay="600">
                <!-- Gender Distribution - Data Only -->
                <div class="chart-card-premium xl:col-span-2" data-aos="fade-up" data-aos-delay="700">
                ...
                <div class="chart-card-premium xl:col-span-3" data-aos="fade-up" data-aos-delay="800">
                    <div class="chart-header-premium">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
...
@push('styles')
<style>
/* Ocean Wave Animation - Realistic Sea Waves */
@keyframes ocean-wave-1 {
    0% {
        transform: translateX(0px) translateY(0px) scaleY(1);
    }
    20% {
        transform: translateX(-30px) translateY(-2px) scaleY(1.1);
    }
    40% {
        transform: translateX(-60px) translateY(1px) scaleY(0.9);
    }
    60% {
        transform: translateX(-90px) translateY(-1px) scaleY(1.05);
    }
    80% {
        transform: translateX(-120px) translateY(2px) scaleY(0.95);
    }
    100% {
        transform: translateX(-150px) translateY(0px) scaleY(1);
    }
}
...
@keyframes ocean-wave-2 {
    ...
    25% {
        transform: translateX(-20px) translateY(1px) scaleY(1.08);
    }
    50% {
        transform: translateX(-40px) translateY(-1px) scaleY(0.92);
    }
    75% {
        transform: translateX(-60px) translateY(2px) scaleY(1.03);
    }
    100% {
        transform: translateX(-80px) translateY(0px) scaleY(1);
    }
}
...
@keyframes ocean-wave-3 {
    ...
    30% {
        transform: translateX(-15px) translateY(-1px) scaleY(1.12);
    }
    60% {
        transform: translateX(-30px) translateY(1px) scaleY(0.88);
    }
    100% {
        transform: translateX(-45px) translateY(0px) scaleY(1);
    }
}
...
@keyframes ocean-wave-4 {
    ...
    35% {
        transform: translateX(-10px) translateY(0.5px) scaleY(1.15);
    }
    70% {
        transform: translateX(-20px) translateY(-0.5px) scaleY(0.85);
    }
    100% {
        transform: translateX(-30px) translateY(0px) scaleY(1);
    }
}
...
.animate-ocean-wave-4 {
    animation: ocean-wave-4 3.5s ease-in-out infinite;
    animation-delay: -1s;
}
