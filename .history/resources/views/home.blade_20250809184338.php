        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            ...
            <div class="lg:w-[420px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <div class="grid grid-cols-4 gap-2 mb-4">
                    <div class="group text-center p-2 bg-white/95 backdrop-blur-sm border border-blue-200 rounded-lg hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg hover:border-blue-300">
                        <div class="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-1 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                            <i class="fas fa-users text-white text-xs"></i>
                        </div>
                        <div class="text-lg font-black text-gray-800 mb-1">
                            <span class="counter" data-count="2847">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-xs">Warga</div>
                    </div>

                    <div class="group text-center p-2 bg-white/95 backdrop-blur-sm border border-emerald-200 rounded-lg hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg hover:border-emerald-300">
                        <div class="w-6 h-6 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center mx-auto mb-1 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                    ...
                    <div class="group text-center p-2 bg-white/95 backdrop-blur-sm border border-purple-200 rounded-lg hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg hover:border-purple-300">
                        <div class="w-6 h-6 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-1 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                    ...
                    <div class="group text-center p-2 bg-white/95 backdrop-blur-sm border border-orange-200 rounded-lg hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg hover:border-orange-300">
                        <div class="w-6 h-6 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center mx-auto mb-1 group-hover:scale-110 transition-transform duration-300 shadow-sm">
