...
<section class="relative text-white overflow-hidden py-12 lg:py-16" style="background-color: #0086c9;">
    ...
    <div class="absolute inset-0">
        ...
        <div class="absolute top-1/4 right-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
        <div class="absolute bottom-0 left-1/3 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
    </div>
