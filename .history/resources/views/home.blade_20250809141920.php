    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            ...
            <div class="flex-1 space-y-8 relative z-10">
                ...
                <!-- Additional Info Section untuk balance tinggi -->
                <div class="mt-8 space-y-4 relative z-20" data-aos="fade-up" data-aos-delay="900">
                    <!-- Contact Info Quick -->
                    <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 shadow-lg">
                        <div class="flex items-center space-x-3 mb-3">
                            <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                                <i class="fas fa-phone text-white text-sm"></i>
                            </div>
                            <div>
                                <h4 class="text-white font-semibold text-sm">Layanan 24/7</h4>
                                <p class="text-blue-100 text-xs">Hubungi Kami Kapan Saja</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <a href="https://wa.me/6282177123456" target="_blank" class="flex items-center justify-center bg-green-600 hover:bg-green-700 text-white text-xs font-medium py-2 px-3 rounded-lg transition-all duration-300 transform hover:scale-105">
                                <i class="fab fa-whatsapp mr-1"></i>
                                WhatsApp
                            </a>
                            <a href="tel:+6282177123456" class="flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium py-2 px-3 rounded-lg transition-all duration-300 transform hover:scale-105">
                    ...
                    <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 shadow-lg">
                        ...
                        <div class="space-y-2 text-xs text-blue-100">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-green-300 font-medium">24/7</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:w-[420px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <div class="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 shadow-lg" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="mt-3 pt-3 border-t border-gray-100">
                        <div class="flex items-center justify-center space-x-2 text-xs text-gray-600 mb-3">
                            <i class="fas fa-building text-indigo-500"></i>
                            <span class="font-medium">Kantor Desa Ketapang Baru</span>
                        </div>

                        <!-- QR Code for Street View -->
                        <div class="flex flex-col items-center space-y-2">
                            <div class="bg-white p-2 rounded-lg border border-gray-200 shadow-sm">
                                <div id="qr-code-container" class="w-16 h-16 flex items-center justify-center bg-gray-50 rounded">
                                    <!-- QR Code will be generated here -->
                                </div>
                            </div>
                            <div class="text-center">
                                <p class="text-xs text-gray-600 font-medium">Scan untuk Virtual Tour</p>
                                <p class="text-xs text-gray-500">Street View 360°</p>
                            </div>
                        </div>
                    </div>
                </div>
