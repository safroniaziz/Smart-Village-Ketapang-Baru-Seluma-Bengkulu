...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden min-h-screen flex items-center" style="background-color: #0086c9;">
    <!-- Background Pattern -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                <div class="relative z-10 animate-float">
                    <div class="w-full h-96 lg:h-[500px] rounded-2xl shadow-2xl overflow-hidden relative bg-gradient-to-br from-blue-600 to-blue-800">
                        <!-- Background Pattern -->
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white p-8 relative z-10">
                                <!-- Village Logo/Icon -->
                                <div class="w-40 h-40 bg-white/25 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-8 border-4 border-white/40 shadow-2xl">
                                    <div class="text-center">
                                        <i class="fas fa-map-marker-alt text-white text-5xl mb-2"></i>
                                        <div class="text-sm font-semibold">DESA</div>
                                    </div>
                                </div>

                                <!-- Village Name -->
                                <h3 class="text-4xl font-bold mb-2 text-white drop-shadow-lg">Ketapang Baru</h3>
                                <p class="text-xl text-blue-100 mb-8 font-medium">Kecamatan Semidang Alas Maras</p>

                                <!-- Info Cards -->
                                <div class="grid grid-cols-2 gap-6 max-w-md mx-auto">
                                    <div class="bg-white/25 backdrop-blur-sm rounded-xl p-4 border border-white/30 shadow-lg">
                                        <div class="text-3xl font-bold text-white mb-1">2,500+</div>
                                ...
                                <div class="mt-6 text-center">
                                    <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2">
                                        ...
                                        <span class="text-sm font-medium">Smart Village Terbaik</span>
                                    </div>
                                </div>
                            </div>
                        </div>
