    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div data-aos="fade-up" data-aos-duration="600">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                <!-- Kepala Desa -->
                <div class="aparatur-card featured" data-aos="fade-up" data-aos-delay="100">
                    <div class="aparatur-badge">Kepala Desa</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-blue-500 to-blue-600 rounded-t-2xl flex items-center justify-center">
                    ...
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">H. Ahmad Supriyadi, S.Pd</h3>
                        <p class="aparatur-position">Kepala Desa</p>
                        <p class="aparatur-period">Periode: 2021 - 2027</p>
                        <div class="aparatur-contact">
                ...
                <!-- Sekretaris Desa -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="aparatur-badge">Sekdes</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-green-500 to-green-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-user-edit text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Drs. Bambang Wijaya</h3>
                        <p class="aparatur-position">Sekretaris Desa</p>
                        <p class="aparatur-period">NIP: 196512101990031004</p>
                        <div class="aparatur-contact">
                ...
                <!-- Kaur Keuangan -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="300">
                    <div class="aparatur-badge">Kaur</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-purple-500 to-purple-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-calculator text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Sri Wahyuni, SE</h3>
                        <p class="aparatur-position">Kaur Keuangan</p>
                        <p class="aparatur-period">NIP: 197803151999032007</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567892" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
                ...
                <!-- Kaur Perencanaan -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="400">
                    <div class="aparatur-badge">Kaur</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-orange-500 to-orange-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-clipboard-list text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">M. Iqbal Rahman, ST</h3>
                        <p class="aparatur-position">Kaur Perencanaan</p>
                        <p class="aparatur-period">NIP: 198506251010031009</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567893" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
                ...
                <!-- Kasi Pemerintahan -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="500">
                    <div class="aparatur-badge">Kasi</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-red-500 to-red-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                    ...
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Agus Setiawan, S.Sos</h3>
                        <p class="aparatur-position">Kasi Pemerintahan</p>
                        <p class="aparatur-period">NIP: 197912141999031008</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567894" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
                ...
                <!-- Kasi Kesejahteraan -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="600">
                    <div class="aparatur-badge">Kasi</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-teal-500 to-teal-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-heart text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Siti Nurhasanah, S.Sos</h3>
                        <p class="aparatur-position">Kasi Kesejahteraan</p>
                        <p class="aparatur-period">NIP: 198209101999032009</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567895" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
                ...
                <!-- Kasi Pelayanan -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="700">
                    <div class="aparatur-badge">Kasi</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-handshake text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Rudi Hartono, A.Md</h3>
                        <p class="aparatur-position">Kasi Pelayanan</p>
                        <p class="aparatur-period">NIP: 198703201999031012</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567896" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
                ...
                <!-- Staf IT -->
                <div class="aparatur-card" data-aos="fade-up" data-aos-delay="800">
                    <div class="aparatur-badge">Staf</div>
                    <div class="aparatur-photo">
                        <div class="w-full h-48 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-t-2xl flex items-center justify-center">
                            <div class="text-center text-white">
                                <i class="fas fa-laptop-code text-6xl mb-2"></i>
                                <p class="text-sm font-medium">Foto Profil</p>
                            </div>
                        </div>
                    </div>
                    <div class="aparatur-content">
                        <h3 class="aparatur-name">Joko Priyanto, S.Kom</h3>
                        <p class="aparatur-position">Staf IT & Digital</p>
                        <p class="aparatur-period">NRKS: 2019001001</p>
                        <div class="aparatur-contact">
                            <a href="tel:+6281234567897" class="contact-btn">
                                <i class="fas fa-phone mr-2"></i>
                                Hubungi
                            </a>
                        </div>
...
.aparatur-card.featured {
    border: 2px solid #3b82f6;
    box-shadow: 0 4px 6px -1px rgba(59, 130, 246, 0.1), 0 2px 4px -1px rgba(59, 130, 246, 0.06);
}

.aparatur-card.featured:hover {
    border-color: #2563eb;
...
.aparatur-card.featured .aparatur-badge {
...
.aparatur-card.featured .contact-btn {
    background: linear-gradient(135deg, #3b82f6, #2563eb);
    color: white;
    border-color: #2563eb;
}

.aparatur-card.featured .contact-btn:hover {
    background: linear-gradient(135deg, #2563eb, #1d4ed8);
    border-color: #1d4ed8;
}

/* Responsive adjustments for aparatur cards */
@media (max-width: 768px) {
    .aparatur-card {
        border-radius: 16px;
    }
