...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" data-aos="fade-in">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-32" viewBox="0 0 1200 200" preserveAspectRatio="none">
            ...
            <path fill="#ffffff" fill-opacity="1" d="M-200,140 C100,120 300,160 500,140 C700,120 900,160 1100,140 C1300,120 1500,160 1700,140 L1700,200 L-200,200 Z" class="animate-ocean-wave-1"></path>
            <!-- Wave Layer 2 - Middle wave -->
            <path fill="#ffffff" fill-opacity="1" d="M-150,155 C150,135 350,175 550,155 C750,135 950,175 1150,155 C1350,135 1550,175 1750,155 L1750,200 L-150,200 Z" class="animate-ocean-wave-2"></path>
            <!-- Wave Layer 3 - Front wave -->
            <path fill="#ffffff" fill-opacity="1" d="M-100,165 C200,145 400,185 600,165 C800,145 1000,185 1200,165 C1400,145 1600,185 1800,165 L1800,200 L-100,200 Z" class="animate-ocean-wave-3"></path>
