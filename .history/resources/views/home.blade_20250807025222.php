        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="text-center">
                                    <img src="https://via.placeholder.com/600x400/2c5530/ffffff?text=Smart+Village+Ketapang+Baru"
                     alt="Smart Village Ketapang Baru" class="img-fluid rounded-3 shadow">
                </div>
            </div>
        </div>
    </div>
