...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" data-aos="fade-in">
    ...
    <!-- Animated Wave - Continuous 3 Layer -->
    <div class="absolute bottom-0 left-0 w-full overflow-hidden" style="height: 100px;">
        <!-- Wave 1 - Continuous -->
        <div class="absolute bottom-0 left-0" style="height: 100px; width: 300%;">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-full">
                <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" fill-opacity="0.4" class="wave-1"></path>
            </svg>
        </div>
        ...
        <div class="absolute bottom-0 left-0" style="height: 100px; width: 300%;">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-full">
                <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" fill-opacity="0.7" class="wave-2"></path>
            </svg>
        </div>
        ...
        <div class="absolute bottom-0 left-0" style="height: 100px; width: 300%;">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-full">
                <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" fill="white" class="wave-3"></path>
            </svg>
        </div>
    </div>
</section>
...
@push('styles')
<style>
/* Wave Continuous Movement Animation - True Seamless Loop */
@keyframes waveMove1 {
    0% {
