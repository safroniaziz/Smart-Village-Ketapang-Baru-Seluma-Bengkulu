                    ...
                    <div class="chart-content-modern">
                        ...
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-blue-700 font-bold">1,287 (51.5%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-blue-400 to-blue-600" style="width: 51.5%"></div>
                            </div>
                        </div>
                        ...
                        <div class="chart-item-modern">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-pink-700 font-bold">1,213 (48.5%)</span>
                            </div>
                            <div class="chart-bar-bg">
                                <div class="chart-bar-fill bg-gradient-to-r from-pink-400 to-pink-600" style="width: 48.5%"></div>
                            </div>
                        </div>
                    </div>
                </div>
