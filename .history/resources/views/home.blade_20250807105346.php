    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                ...
                <!-- Quick Stats -->
                <div class="flex flex-wrap gap-3 pt-6 max-w-3xl slide-up">
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover-lift">
