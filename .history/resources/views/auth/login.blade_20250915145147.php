<x-guest-layout>
    ...
    <div class="hidden lg:flex lg:w-1/2 auth-container relative items-center justify-center">
        ...
        <div class="relative z-10 text-center text-white px-12 max-w-lg">
            <!-- Logo & Branding -->
            <div class="mb-8">
                <div class="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6 backdrop-blur-sm border border-white/30 logo-animation overflow-hidden">
                    <img src="{{ asset('assets/images/seluma.png') }}" alt="Logo Desa Ketapang Baru" class="w-16 h-16 object-contain">
                </div>
