        ...
        <div class="relative z-10 text-center text-white px-12 max-w-lg">
            ...
            <div class="mb-8">
                <div class="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6 backdrop-blur-sm border border-white/30 logo-animation">
                    <i class="fas fa-mountain-city text-4xl text-white"></i>
                </div>
                ...
                <p class="text-lg text-white/80 max-w-md mx-auto leading-relaxed">
                    Sistem Informasi Desa Digital untuk pelayanan administrasi yang lebih baik
                </p>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 text-center">
                <div class="feature-card rounded-xl p-4">
                    ...
                    <div class="text-sm text-white/90 font-medium">Surat Digital</div>
                </div>
                <div class="feature-card rounded-xl p-4">
                    <i class="fas fa-chart-bar text-2xl mb-2 text-white"></i>
                    <div class="text-sm text-white/90 font-medium">Data Desa</div>
                </div>
                <div class="feature-card rounded-xl p-4">
                    <i class="fas fa-users text-2xl mb-2 text-white"></i>
                    <div class="text-sm text-white/90 font-medium">Info Warga</div>
                </div>
            </div>
        </div>
    </div>
