    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center" style="background: linear-gradient(135deg, #7C3AED 0%, #EC4899 50%, #F59E0B 100%);">
        ...
        <div class="relative z-10 text-center text-white px-12 max-w-2xl">
            ...
            <div class="mb-12">
                ...
                <h1 class="text-5xl font-black mb-4 text-white font-['Playfair_Display'] text-shadow">Keuntungan Bergabung</h1>
                <h2 class="text-2xl font-semibold mb-4 text-white/90 font-['Playfair_Display']">Smart Village Ketapang Baru</h2>
