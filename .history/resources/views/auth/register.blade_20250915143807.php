    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 relative">
        ...
        <div class="w-full max-w-md relative z-10 slide-in">
            ...
            <div class="text-center mb-10">
                <h2 class="text-5xl font-black text-gray-900 mb-4 text-display text-shadow-lg">Bergabung Bersama Kami</h2>
                <p class="text-gray-600 text-lg font-medium text-body-premium">Daftarkan diri Anda untuk mengakses semua layanan desa digital</p>
            </div>
            ...
            <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Full Name -->
                    <div class="space-y-2">
                        <label for="name" class="block text-label-premium text-gray-800 tracking-wide">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center" style="background: linear-gradient(135deg, #7C3AED 0%, #EC4899 50%, #F59E0B 100%);">
        ...
        <div class="relative z-10 text-center text-white px-12 max-w-2xl">
            ...
            <div class="mb-12">
                ...
                <h1 class="text-6xl font-black mb-4 text-white text-display text-shadow-lg">Keuntungan Bergabung</h1>
                <h2 class="text-2xl font-semibold mb-4 text-white/90 text-headline">Smart Village Ketapang Baru</h2>
                <p class="text-xl text-white/80 font-medium max-w-lg mx-auto leading-relaxed text-subhead">
