    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 relative">
        ...
        <div class="w-full max-w-md relative z-10 slide-in">
            ...
            <div class="text-center mb-10">
                <h2 class="text-4xl font-black text-gray-900 mb-3 font-['Playfair_Display'] text-shadow">Selamat Datang</h2>
                <p class="text-gray-600 text-lg font-medium">Masuk ke akun Anda untuk mengakses layanan desa digital</p>
            </div>
