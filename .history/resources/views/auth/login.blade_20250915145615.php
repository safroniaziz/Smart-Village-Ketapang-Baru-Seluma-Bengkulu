<x-guest-layout>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 relative">
        ...
        <div class="absolute top-6 left-6 z-20">
            <a href="{{ route('home') }}" class="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl text-gray-700 hover:bg-white hover:shadow-md transition-all duration-200 group">
