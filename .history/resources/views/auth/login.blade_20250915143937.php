                    ...
                    <div class="flex items-center justify-between pt-2">
                        <label for="remember_me" class="flex items-center space-x-3">
                            <input id="remember_me" type="checkbox" 
                                   ...
                                   name="remember">
                            <span class="text-sm font-medium text-gray-700 text-body-premium">Ingat saya</span>
                        </label>
    ...
    <div class="hidden lg:flex lg:w-1/2 auth-container relative items-center justify-center">
        ...
        <div class="relative z-10 text-center text-white px-12 max-w-2xl">
            ...
            <div class="mb-12">
                ...
                <h1 class="text-6xl font-black mb-4 text-white text-display text-shadow-lg">Smart Village</h1>
                <h2 class="text-2xl font-semibold mb-4 text-white/90 text-headline">Ketapang Baru</h2>
            ...
            <div class="grid gap-6 max-w-lg mx-auto">
                <div class="feature-card rounded-3xl p-6 text-left">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white mb-1 text-subhead">Surat Digital</h3>
                            <p class="text-sm text-white/80 text-body-premium">Proses cepat & mudah</p>
                        </div>
                    </div>
                    <p class="text-sm text-white/90 leading-relaxed text-body-premium">
