        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card-body p-8 position-relative">
                            <div class="row align-items-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="text-white fs-4 fw-semibold mb-4" style="text-shadow: 0 1px 3px rgba(0,0,0,0.3);">Sistem Informasi Desa Ketapang Baru, Kecamatan Semidang Alas Maras</h2>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-auto">
                                            <div class="rounded-4 px-4 py-3 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                                <div class="text-white fs-8 fw-bold mb-1" style="opacity: 0.9;">TOTAL WARGA</div>
                                                <div class="text-white fs-5 fw-bold">{{ $totalUsers }}</div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="rounded-4 px-4 py-3 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                                <div class="text-white fs-8 fw-bold mb-1" style="opacity: 0.9;">PENGADUAN</div>
                                                <div class="text-white fs-5 fw-bold">{{ $totalPengaduan }}</div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="rounded-4 px-4 py-3 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                                <div class="text-white fs-8 fw-bold mb-1" style="opacity: 0.9;">SURAT</div>
                                                <div class="text-white fs-5 fw-bold">{{ $totalSurat }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        icon="ki-duotone ki-information"
                        color="warning"
                        percentage="85"
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="success"
                        percentage="92"
                        description="Surat yang diajukan"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        value="{{ $totalPenerimaBantuan }}"
                        icon="ki-duotone ki-heart"
                        color="info"
                        percentage="78"
                        description="Warga penerima bantuan"
                    />
                </div>
            </div>
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="dark"
                        percentage="78"
                        description="Program pembangunan desa"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="primary"
                        percentage="89"
                        description="Survei kepuasan warga"
                    />
                </div>
            ...
            <div class="row g-5 g-xl-8 mb-8">
                    ...
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column">
                                <h3 class="fw-bold text-dark">Distribusi Warga per Dusun</h3>
                                <span class="text-gray-600 fw-semibold fs-6">Jumlah warga di setiap dusun</span>
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card card-flush border-0 bg-white shadow-sm h-100">
                        <div class="card-header pt-5">
                            <h3 class="card-title fw-bold text-dark">Status Surat Online</h3>
                        </div>
                        <div class="card-body pt-0">
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-6">
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
                            <h3 class="card-title fw-bold text-dark">Indikator Kinerja Desa</h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Tingkat Kelengkapan Data</span>
                                            <span class="fw-bold text-primary">92%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Data warga yang lengkap dan terverifikasi</div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Tingkat Respons Layanan</span>
                                            <span class="fw-bold text-success">89%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Layanan yang ditanggapi dalam 24 jam</div>
                                        <div class="progress h-6px w-100">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Aktivitas Warga</span>
                                            <span class="fw-bold text-info">85%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Warga yang aktif dalam 7 hari terakhir</div>
                                        <div class="progress h-6px w-100">
                ...
                <div class="col-xl-6">
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
                            <h3 class="card-title fw-bold text-dark">Distribusi Wilayah Administratif</h3>
                        </div>
                        <div class="card-body pt-0">
