...
<section class="relative text-white overflow-hidden py-12 lg:py-16 mb-8" style="background-color: #0086c9;">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8 relative z-10">
                <div class="space-y-6">
                    ...
                    <div class="mb-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-full font-semibold shadow-xl">
                ...
                <!-- Enhanced Search Bar -->
                <div class="max-w-2xl mb-8 relative z-20" data-aos="fade-up" data-aos-delay="700">
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-white/10 rounded-2xl blur-xl"></div>
                        <div class="relative bg-white/15 backdrop-blur-md border border-white/30 rounded-2xl p-2 shadow-2xl z-20">
                ...
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 relative z-20" data-aos="fade-up" data-aos-delay="800">
            ...
            <div class="lg:w-96 flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                <!-- Enhanced Statistics Grid -->
                <div class="grid grid-cols-2 gap-6">
                    <div class="group text-center p-8 bg-gradient-to-br from-blue-500/40 to-blue-600/30 backdrop-blur-md border-2 border-blue-400/50 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-blue-500/50 hover:to-blue-600/40">
                        ...
                        <div class="text-white font-bold mb-2">Total Warga</div>
                        <div class="text-xs text-green-300 flex items-center justify-center font-semibold">
                            <i class="fas fa-arrow-up mr-1"></i>+5.2% tahun ini
                        </div>
                    </div>

                    <div class="group text-center p-8 bg-gradient-to-br from-green-500/40 to-emerald-600/30 backdrop-blur-md border-2 border-green-400/50 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-green-500/50 hover:to-emerald-600/40">
                        <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-map-marked-alt text-white text-xl"></i>
                        </div>
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="8">0</span>
                        </div>
                        <div class="text-white font-bold mb-2">Dusun</div>
                        <div class="text-xs text-blue-200 font-semibold">24 RT/RW Aktif</div>
                    </div>

                    <div class="group text-center p-8 bg-gradient-to-br from-purple-500/40 to-purple-600/30 backdrop-blur-md border-2 border-purple-400/50 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-purple-500/50 hover:to-purple-600/40">
                        <div class="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-home text-white text-xl"></i>
                        </div>
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="1250">0</span>
                        </div>
                        <div class="text-white font-bold mb-2">Keluarga</div>
                        <div class="text-xs text-green-300 flex items-center justify-center font-semibold">
                            <i class="fas fa-arrow-up mr-1"></i>KK Aktif
                        </div>
                    </div>

                    <div class="group text-center p-8 bg-gradient-to-br from-orange-500/40 to-red-600/30 backdrop-blur-md border-2 border-orange-400/50 rounded-3xl hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:from-orange-500/50 hover:to-red-600/40">
                        <div class="w-16 h-16 bg-gradient-to-br from-orange-400 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <i class="fas fa-seedling text-white text-xl"></i>
                        </div>
                        <div class="text-4xl font-black text-white mb-3">
                            <span class="counter" data-count="450">0</span>
                        </div>
                        <div class="text-white font-bold mb-2">Hektar</div>
                        <div class="text-xs text-blue-200 font-semibold">Luas Wilayah</div>
                    </div>
                </div>
            </div>
        </div>
