        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6" data-aos="fade-left" data-aos-duration="800">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div class="space-y-3">
                        <a href="https://www.google.com/maps/place/Balai+Desa+Ketapang+Baru/@-4.3221828,102.7635049,17z" target="_blank" class="flex items-center justify-center w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                            <i class="fab fa-google mr-2"></i>
                            Buka di Google Maps
                        </a>
                        <a href="https://waze.com/ul?ll=-4.3221828,102.7635049&navigate=yes" target="_blank" class="flex items-center justify-center w-full bg-gradient-to-r from-cyan-500 to-teal-600 hover:from-cyan-600 hover:to-teal-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
