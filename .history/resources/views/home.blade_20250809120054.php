    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Stats Row -->
                <div class="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 mt-8">
                    <div class="flex items-center bg-white rounded-xl px-4 py-3 shadow-md border border-gray-100">
                        ...
                        <div class="text-left">
                            ...
                            <div class="text-sm text-gray-600">Layanan Digital</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center bg-white rounded-xl px-4 py-3 shadow-md border border-gray-100">
                        ...
                        <div class="text-left">
                            ...
                            <div class="text-sm text-gray-600">Akses Online</div>
                        </div>
                    </div>
