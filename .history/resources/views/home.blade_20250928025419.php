...
<section class="hero-section relative text-white overflow-hidden min-h-screen flex items-center" data-aos="fade-in">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 min-h-[80vh] flex items-center" data-aos="fade-up" data-aos-delay="150">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10"></div>
