        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="group text-center p-8 bg-white/95 backdrop-blur-sm border-2 border-blue-200 rounded-3xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-blue-300 hover:bg-white">
                        ...
                        <div class="text-4xl font-black text-gray-800 mb-3">
                            <span class="counter" data-count="2847">0</span>
                        </div>
                        <div class="text-gray-700 font-bold mb-2">Total Warga</div>
                        <div class="text-sm text-green-600 flex items-center justify-center font-semibold">
                            <i class="fas fa-arrow-up mr-1"></i>+5.2% tahun ini
                        </div>
                    </div>

                    <div class="group text-center p-8 bg-white/95 backdrop-blur-sm border-2 border-green-200 rounded-3xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-green-300 hover:bg-white">
                        ...
                        <div class="text-gray-700 font-bold mb-2">Dusun</div>
                        <div class="text-sm text-gray-600 font-semibold">24 RT/RW Aktif</div>
                    </div>

                    <div class="group text-center p-8 bg-white/95 backdrop-blur-sm border-2 border-purple-200 rounded-3xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-purple-300 hover:bg-white">
                        ...
                        <div class="text-gray-700 font-bold mb-2">Keluarga</div>
                        <div class="text-sm text-green-600 flex items-center justify-center font-semibold">
                            <i class="fas fa-arrow-up mr-1"></i>KK Aktif
                        </div>
                    </div>

                    <div class="group text-center p-8 bg-white/95 backdrop-blur-sm border-2 border-orange-200 rounded-3xl hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl hover:border-orange-300 hover:bg-white">
                        ...
                        <div class="text-gray-700 font-bold mb-2">Hektar</div>
                        <div class="text-sm text-gray-600 font-semibold">Luas Wilayah</div>
                    </div>
                </div>
            </div>
        </div>
