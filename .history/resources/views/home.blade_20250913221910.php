                    ...
                    <div class="flex-1 text-center lg:text-left text-white">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-xl font-black">2,500</div>
                                <div class="text-blue-100 text-xs">Jiwa Penduduk</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-xl font-black">3</div>
                                <div class="text-blue-100 text-xs">Dusun</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-xl font-black">6</div>
                                <div class="text-blue-100 text-xs">Tahun Jabatan</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-xl font-black">95%</div>
                                <div class="text-blue-100 text-xs">Kepuasan</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/20">
                            <p class="text-blue-100 text-sm italic leading-relaxed">
                                ...
                                "Melayani dengan hati, membangun bersama masyarakat untuk Ketapang Baru yang maju dan sejahtera."
                                <i class="fas fa-quote-right text-yellow-300 ml-2"></i>
                            </p>
                        </div>

                        <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                            <a href="{{ route('struktur') }}" class="inline-flex items-center bg-white/20 backdrop-blur-sm border-2 border-white/30 hover:bg-white/30 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 hover:scale-105 text-sm">
                                <i class="fas fa-sitemap mr-2"></i>
                                Struktur Organisasi
                            </a>
                            <a href="mailto:kades@ketapangbaru.desa.id" class="inline-flex items-center bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 hover:bg-white/30 text-sm">
