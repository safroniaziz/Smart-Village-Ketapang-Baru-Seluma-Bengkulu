...
$(document).ready(function() {
    console.log('📊 Document ready, Chart.js available:', typeof Chart !== 'undefined');
    ...
    // Charts are now handled by the chartConfigs system above
    // Old chart code removed - using new chartConfigs system
    // Old chart code removed

    // All old chart code removed - using new chartConfigs system above
            ...
            console.log('📊 Gender chart instance:', genderChart);
        } catch (error) {
    ...
    if (ageCtx) {
        ...
        try {
            ...
            console.log('📊 Age chart instance:', ageChart);
        } catch (error) {
