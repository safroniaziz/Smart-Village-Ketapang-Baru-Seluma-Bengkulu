            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6">
                    <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-2xl font-bold text-yellow-400 mb-1">2,847</div>
                        <div class="text-sm text-blue-100 font-medium">Total Warga</div>
                        <div class="text-xs text-blue-200 mt-1">1,432 L + 1,415 P</div>
                    </div>
                    <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-2xl font-bold text-yellow-400 mb-1">8</div>
                        <div class="text-sm text-blue-100 font-medium">Dusun</div>
                        <div class="text-xs text-blue-200 mt-1">24 RT/RW</div>
                    </div>
                    <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-2xl font-bold text-yellow-400 mb-1">1,250</div>
                        <div class="text-sm text-blue-100 font-medium">Keluarga</div>
                        <div class="text-xs text-blue-200 mt-1">KK Aktif</div>
                    </div>
                    <div class="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-2xl font-bold text-yellow-400 mb-1">450</div>
                        <div class="text-sm text-blue-100 font-medium">Hektar</div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl shadow-2xl p-8 text-gray-900">
                    <div class="text-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">Desa Ketapang Baru</h3>
                        <p class="text-gray-600">Kabupaten Seluma, Provinsi Bengkulu</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <div class="font-semibold text-gray-900">Kepala Desa</div>
