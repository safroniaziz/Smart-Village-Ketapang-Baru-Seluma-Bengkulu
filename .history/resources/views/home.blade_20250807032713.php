        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8" data-aos="fade-right">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('surat.online') }}" class="btn-accent text-lg px-8 py-4">
                        <i class="fas fa-envelope mr-2"></i>Surat Online
                    </a>
                    <a href="{{ route('tentang') }}" class="btn-secondary text-lg px-8 py-4">
...
<section class="section-padding bg-white">
    <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Surat Online -->
            <div class="card-hover p-6 text-center group" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="{{ route('surat.online') }}" class="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center">
            ...
            <!-- Data Warga -->
            <div class="card-hover p-6 text-center group" data-aos="fade-up" data-aos-delay="200">
                ...
                <a href="{{ route('data.warga') }}" class="text-green-600 hover:text-green-700 font-medium inline-flex items-center">
                    Pelajari Lebih Lanjut
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
            ...
            <!-- Peta Desa -->
            <div class="card-hover p-6 text-center group" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="{{ route('peta.desa') }}" class="text-purple-600 hover:text-purple-700 font-medium inline-flex items-center">
                    Pelajari Lebih Lanjut
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
            ...
            <!-- Pengaduan -->
            <div class="card-hover p-6 text-center group" data-aos="fade-up" data-aos-delay="400">
                ...
                <a href="{{ route('pengaduan') }}" class="text-red-600 hover:text-red-700 font-medium inline-flex items-center">
                    Pelajari Lebih Lanjut
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
...
<!-- CTA Section -->
<section class="section-padding bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white">
    <div class="container-custom text-center">
        <div class="max-w-4xl mx-auto" data-aos="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('kontak') }}" class="btn-secondary text-lg px-8 py-4">
