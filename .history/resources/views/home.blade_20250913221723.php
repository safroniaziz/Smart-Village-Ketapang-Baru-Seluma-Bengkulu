                    ...
                    <div class="flex-1 text-center lg:text-left text-white">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/20">
                            <div class="flex items-center mb-3">
                                <i class="fas fa-bullseye text-yellow-300 mr-3 text-lg"></i>
                                <h3 class="text-lg font-bold text-white">Visi Kepemimpinan</h3>
                            </div>
                            <p class="text-blue-100 text-sm leading-relaxed italic">
                                "Mewujudkan Desa Ketapang Baru yang maju, mandiri, dan sejahtera melalui tata kelola pemerintahan yang transparan dan pelayanan prima kepada masyarakat."
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-2xl font-black">2,500</div>
                                <div class="text-blue-100 text-xs font-medium">Jiwa Penduduk</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-2xl font-black">3</div>
                                <div class="text-blue-100 text-xs font-medium">Dusun</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-2xl font-black">6</div>
                                <div class="text-blue-100 text-xs font-medium">Tahun Memimpin</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                                <div class="text-yellow-300 text-2xl font-black">100+</div>
                                <div class="text-blue-100 text-xs font-medium">Program Terlaksana</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/20">
                            <div class="flex items-center mb-3">
                                <i class="fas fa-star text-yellow-300 mr-3 text-lg"></i>
                                <h3 class="text-lg font-bold text-white">Program Unggulan</h3>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="{{ route('struktur') }}" class="inline-flex items-center bg-white/20 backdrop-blur-sm border-2 border-white/30 hover:bg-white/30 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105">
