...
<!-- Wave Section - Separated from Hero -->
<div class="relative w-full h-40 overflow-hidden -mt-20">
    <svg class="relative w-full h-full" viewBox="0 0 1200 240" preserveAspectRatio="none">
        <!-- Wave Layer 1 - Back wave (Deep curves) -->
        <path fill="#f8f9fa" fill-opacity="1" d="M-200,140 C50,120 150,160 300,140 C450,120 550,160 700,140 C850,120 950,160 1100,140 C1250,120 1350,160 1500,140 L1500,240 L-200,240 Z" class="animate-ocean-wave-1"></path>
        <!-- Wave Layer 2 - Middle wave (Medium curves) -->
        <path fill="#f1f3f4" fill-opacity="1" d="M-150,155 C0,135 100,175 250,155 C400,135 500,175 650,155 C800,135 900,175 1050,155 C1200,135 1300,175 1450,155 L1450,240 L-150,240 Z" class="animate-ocean-wave-2"></path>
        <!-- Wave Layer 3 - Front wave (Higher curves) -->
        <path fill="#f8f9fa" fill-opacity="1" d="M-100,170 C50,150 150,190 300,170 C450,150 550,190 700,170 C850,150 950,190 1100,170 C1250,150 1350,190 1500,170 L1500,240 L-100,240 Z" class="animate-ocean-wave-3"></path>
        <!-- Wave Layer 4 - Foam layer (Highest position) -->
        <path fill="#ffffff" fill-opacity="1" d="M-50,185 C100,165 200,205 350,185 C500,165 600,205 750,185 C900,165 1000,205 1150,185 C1300,165 1400,205 1550,185 L1550,240 L-50,240 Z" class="animate-ocean-wave-4"></path>
        <!-- Additional solid base layer to ensure no gaps -->
        <rect x="-300" y="220" width="2000" height="30" fill="#ffffff"></rect>
    </svg>
</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="stat-card-modern">
                    ...
                    <div class="stat-content-modern">
                        <div class="text-blue-700 counter" data-count="{{ $totalWarga }}">0</div>
                ...
                <div class="stat-card-modern">
                    ...
                    <div class="stat-content-modern">
                        <div class="text-green-700 counter" data-count="{{ $totalDusun }}">0</div>
                ...
                <div class="stat-card-modern">
                    ...
                    <div class="stat-content-modern">
                        <div class="text-purple-700 counter" data-count="0">0</div>
                ...
                <div class="stat-card-modern">
                    ...
                    <div class="stat-content-modern">
                        <div class="text-orange-700 counter" data-count="{{ $totalKepalaKeluarga }}">0</div>
