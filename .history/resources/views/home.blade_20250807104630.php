...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden py-12 lg:py-16" style="background: linear-gradient(135deg, #0086c9 0%, #0056b3 50%, #003d82 100%);">
    <!-- Animated Background Elements -->
    <div class="absolute inset-0">
        <div class="absolute top-0 left-0 w-72 h-72 bg-white/5 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute top-1/4 right-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div class="absolute bottom-0 left-1/3 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl animate-pulse delay-2000"></div>
    </div>
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                <div class="space-y-6">
                    <!-- Badge -->
                    <div class="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 text-sm font-medium text-blue-100">
                    ...
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-white">PEMERINTAHAN DESA</h2>
                            <p class="text-sm text-blue-100 font-medium">Kecamatan Semidang Alas Maras</p>
                        </div>
                    </div>

                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight">
                        Smart Village<br>
                        <span class="bg-gradient-to-r from-yellow-400 via-orange-400 to-red-500 bg-clip-text text-transparent animate-pulse">Ketapang Baru</span>
                    </h1>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-sm border border-white/20">🚀 Digital First</span>
                        <span class="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-sm border border-white/20">⚡ Real-time</span>
                        <span class="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-sm border border-white/20">🔒 Secure</span>
                    </div>
                </div>

                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('surat.online') }}" class="group relative bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                        <i class="fas fa-envelope mr-3 text-xl"></i>
                        <span>Layanan Surat Online</span>
                        <i class="fas fa-arrow-right ml-3 group-hover:translate-x-1 transition-transform duration-300"></i>
                    </a>
                    <a href="{{ route('tentang') }}" class="group relative bg-white/10 hover:bg-white/20 text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center backdrop-blur-sm text-lg border border-white/20 hover:border-white/30 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                ...
                <!-- Quick Stats -->
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 max-w-3xl">
                    <div class="group relative text-center p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-yellow-400/10 to-orange-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative">
                            <div class="text-2xl font-bold text-yellow-400 mb-1 group-hover:text-yellow-300 transition-colors">2,847</div>
                            <div class="text-xs text-blue-100 font-semibold">Total Warga</div>
                            <div class="text-xs text-blue-200 mt-1">1,432 L + 1,415 P</div>
                        </div>
                    </div>
                    <div class="group relative text-center p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-green-400/10 to-emerald-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative">
                            <div class="text-2xl font-bold text-green-400 mb-1 group-hover:text-green-300 transition-colors">8</div>
                            <div class="text-xs text-blue-100 font-semibold">Dusun</div>
                            <div class="text-xs text-blue-200 mt-1">24 RT/RW</div>
                        </div>
                    </div>
                    <div class="group relative text-center p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-indigo-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative">
                            <div class="text-2xl font-bold text-blue-400 mb-1 group-hover:text-blue-300 transition-colors">1,250</div>
                            <div class="text-xs text-blue-100 font-semibold">Keluarga</div>
                            <div class="text-xs text-blue-200 mt-1">KK Aktif</div>
                        </div>
                    </div>
                    <div class="group relative text-center p-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-purple-400/10 to-violet-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div class="relative">
                            <div class="text-2xl font-bold text-purple-400 mb-1 group-hover:text-purple-300 transition-colors">450</div>
                            <div class="text-xs text-blue-100 font-semibold">Hektar</div>
            ...
            <div class="lg:w-80 flex-shrink-0">
                <div class="relative bg-gradient-to-br from-white via-gray-50 to-blue-50 rounded-2xl shadow-2xl p-4 text-gray-900 sticky top-8 border border-gray-200 overflow-hidden">
                    <!-- Decorative Elements -->
                    <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400/10 to-purple-400/10 rounded-full blur-2xl"></div>
                    <div class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-yellow-400/10 to-orange-400/10 rounded-full blur-xl"></div>

                    <div class="relative">
                        <div class="text-center mb-4">
                            <div class="relative w-16 h-16 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                        ...
                        <div class="space-y-3">
                            <div class="group flex items-center space-x-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100 hover:border-blue-200 transition-all duration-300 hover:shadow-md">
                            ...
                            <div class="group flex items-center space-x-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100 hover:border-green-200 transition-all duration-300 hover:shadow-md">
                                <div class="w-8 h-8 bg-gradient-to-br from-green-600 to-green-700 rounded-lg flex items-center justify-center shadow-sm">
                            ...
                            <div class="group flex items-center space-x-3 p-3 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-100 hover:border-purple-200 transition-all duration-300 hover:shadow-md">
                                <div class="w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg flex items-center justify-center shadow-sm">
                            ...
                            <div class="group flex items-center space-x-3 p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-100 hover:border-orange-200 transition-all duration-300 hover:shadow-md">
                                <div class="w-8 h-8 bg-gradient-to-br from-orange-600 to-orange-700 rounded-lg flex items-center justify-center shadow-sm">
                        ...
                        <div class="mt-4 pt-3 border-t border-gray-200">
                            <div class="text-center">
                                <div class="inline-flex items-center bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white px-4 py-2 rounded-full text-xs font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
