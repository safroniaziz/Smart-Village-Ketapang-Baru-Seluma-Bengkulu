    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-4 slide-up">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight slide-up">
                        Smart Village<br>
                        <span class="text-yellow-400 pulse-slow">Ketapang Baru</span>
                    </h1>

                    <p class="text-xl text-blue-100 leading-relaxed max-w-2xl slide-up">
