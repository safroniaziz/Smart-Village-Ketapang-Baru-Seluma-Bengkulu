...
<!-- Google Maps API -->
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBZ8VrXgGZ5fEZfZqZ5Z5Z5Z5Z5Z5Z5Z5Z&libraries=streetview&callback=initStreetView"></script>
...
function initStreetView() {
    ...
    // Error handling jika Street View tidak tersedia
    streetView.addListener('status_changed', function() {
        if (streetView.getStatus() !== 'OK') {
            // Fallback ke regular map jika Street View tidak tersedia
...
// Fallback jika Google Maps API gagal load
            ...
            document.getElementById('street-view').innerHTML = `
                <div class="flex items-center justify-center h-full bg-gradient-to-br from-teal-100 to-cyan-100">
                    <div class="text-center p-8">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Koneksi Terputus</h3>
                        <p class="text-gray-600 mb-6">
                            Tidak dapat memuat Google Street View. Periksa koneksi internet Anda.
                        </p>
