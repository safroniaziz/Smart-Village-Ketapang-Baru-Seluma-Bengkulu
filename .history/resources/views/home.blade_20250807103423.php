...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden py-16 lg:py-20" style="background-color: #0086c9;">
    <!-- Background Pattern -->
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0">
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-8 text-gray-900 sticky top-8 border border-gray-100">
