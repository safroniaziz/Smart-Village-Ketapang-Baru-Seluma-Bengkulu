...
@section('title', 'Admin - Edit Pengumuman')
...
@section('link')
    ...
    <li class="breadcrumb-item text-muted">Edit Pengumuman</li>
@endsection
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h2 class="fw-bold text-gray-900 mb-1">Edit Pengumuman</h2>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="judul" class="form-control form-control-solid @error('judul') is-invalid @enderror" 
                                           placeholder="Masukkan judul pengumuman yang jelas" value="{{ old('judul', $pengumuman->judul) }}" required>
                                    @error('judul')
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="excerpt" class="form-control form-control-solid @error('excerpt') is-invalid @enderror" 
                                              rows="3" placeholder="Tulis ringkasan singkat tentang pengumuman ini" required>{{ old('excerpt', $pengumuman->excerpt) }}</textarea>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="konten" id="konten" class="form-control form-control-solid @error('konten') is-invalid @enderror" 
                                              rows="15" placeholder="Tulis konten pengumuman lengkap di sini" required>{{ old('konten', $pengumuman->konten) }}</textarea>
                                    @error('konten')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch mb-4">
                                            <input class="form-check-input" type="checkbox" name="published" id="published" 
                                                   {{ old('published', $pengumuman->published) ? 'checked' : '' }}>
                                            <label class="form-check-label fw-bold" for="published">
                                                Publikasikan Pengumuman
                                            </label>
                                            <div class="form-text">Centang untuk mempublikasikan pengumuman</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <select name="prioritas" class="form-select form-select-solid @error('prioritas') is-invalid @enderror" required>
                                                ...
                                                <option value="tinggi" {{ old('prioritas', $pengumuman->prioritas) == 'tinggi' ? 'selected' : '' }}>Tinggi - Sangat Penting</option>
                                                <option value="sedang" {{ old('prioritas', $pengumuman->prioritas) == 'sedang' ? 'selected' : '' }}>Sedang - Penting</option>
                                                <option value="rendah" {{ old('prioritas', $pengumuman->prioritas) == 'rendah' ? 'selected' : '' }}>Rendah - Informasi</option>
                                            </select>
                                            @error('prioritas')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="tanggal_berakhir" class="form-control form-control-solid @error('tanggal_berakhir') is-invalid @enderror" 
                                                   value="{{ old('tanggal_berakhir', $pengumuman->tanggal_berakhir) }}" min="{{ date('Y-m-d', strtotime('+1 day')) }}" required>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="penulis" class="form-control form-control-solid @error('penulis') is-invalid @enderror" 
                                                   placeholder="Nama penulis" value="{{ old('penulis', $pengumuman->penulis) }}">
                                            @error('penulis')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card bg-light-success">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <div class="text-center">
                                                    <div class="fw-bold text-success fs-3">{{ number_format($pengumuman->views) }}</div>
                                                    <div class="text-muted fs-7">Views</div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="text-center">
                                                    <div class="fw-bold text-info fs-3">{{ ucfirst($pengumuman->prioritas) }}</div>
                                        ...
                                        @endif
                                        <div class="text-center mt-2">
                                            <div class="text-muted fs-7">Berakhir</div>
                                            <div class="fw-bold">{{ \Carbon\Carbon::parse($pengumuman->tanggal_berakhir)->format('d M Y') }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
