            ...
            <td>
                <div class="d-flex align-items-center">
                    <div class="symbol symbol-40px me-3">
                        <div class="symbol-label overflow-hidden" style="border-radius: 8px !important;">
                            @if($warga->foto)
                                <img src="{{ asset('storage/' . $warga->foto) }}" alt="{{ $warga->nama_lengkap }}" class="w-100 h-100 object-fit-cover" style="border-radius: 8px !important;" />
                            @else
                                <div class="symbol-label fs-6 fw-bold {{ in_array($warga->jenis_kelamin, ['Laki-laki', 'L']) ? 'bg-light-primary text-primary' : 'bg-light-danger text-danger' }}" style="border-radius: 8px !important;">
