            ...
            <form action="{{ route('data-warga.store') }}" method="POST" enctype="multipart/form-data" id="kt_warga_form">
                ...
                <div class="wizard-content">
                    ...
                    <div class="step-content" id="step-4">
                        ...
                        <div class="row g-5">
                            <div class="col-md-6">
                                <div class="photo-upload-area text-center">
                                    <div class="upload-content">
                                        ...
                                        <p class="text-muted mb-3">Klik tombol di bawah untuk pilih foto</p>
                                        ...
                                        <!-- Main photo upload button - same as edit page approach -->
                                        <button type="button" class="btn btn-primary btn-lg" onclick="$('#foto').click()">
                                            <i class="ki-duotone ki-camera fs-4 me-2">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            Pilih Foto
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    if (originalWidth < 300 || originalHeight < 400 || originalWidth !== 300 || originalHeight !== 400) {
                        ...
                        canvas.toBlob(function(blob) {
                            ...
                            // Show preview after cropping is done
                            showPreview();
                        }, 'image/jpeg', 0.9);
                    } else {
                        // No cropping needed, show preview immediately
                        showPreview();
                    }
                    ...
                    function showPreview() {
                        ...
                        $('.preview-content').html(`
                            <div class="photo-preview-container text-center">
                                <div class="mb-3">
                                    <img class="photo-preview border rounded"
                                         id="photo-preview"
                                         src="${finalImageSrc}"
                                         alt="Preview Foto Pas Foto"
                                         style="width: 150px; height: 200px; object-fit: cover; object-position: center;">
                                </div>
                                <div class="mb-3">
                                    <span class="badge bg-success">
                                        ...
                                        Foto siap digunakan (300x400px - Portrait)
                                    </span>
                                </div>
                                <button type="button" class="btn btn-sm btn-light-danger" onclick="removePhoto()">
