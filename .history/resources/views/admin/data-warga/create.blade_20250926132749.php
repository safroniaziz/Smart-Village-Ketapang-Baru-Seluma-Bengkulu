...
.photo-preview {
    width: 206px;
    height: 295px; /* Ratio 4:6 = 206:295 px */
    border-radius: 0.75rem;
    object-fit: cover;
                            ...
                            <div class="col-md-6">
                                <div class="photo-upload-area" id="photo-upload">
                                    <div class="upload-content">
                                        ...
                                        <h4 class="fw-bold text-gray-800 mb-2">Upload Foto Pas Foto 4x6</h4>
                                        ...
                                        <div class="alert alert-info p-3 mb-4">
                                            ...
                                            • Pastikan foto berukuran pas foto 4x6 cm<br>
                                            • Minimal resolusi 300x400 pixel untuk hasil terbaik<br>
                                            • Foto akan otomatis disesuaikan ke ukuran 4x6 cm
                                        </div>
                                    ...
                                    <div class="preview-content d-none">
                                        <div class="photo-preview-container">
                                            <img class="photo-preview" id="photo-preview" src="" alt="Preview Foto 4x6">
                                            <div class="mt-2 text-muted small">
                                                <i class="ki-duotone ki-check-circle text-success me-1">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i>
                                                Foto 4x6 siap digunakan
                                            </div>
                                        </div>
                                        <div class="mt-3">
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                setTimeout(() => {
                    $('.preview-content').html(`
                        <div class="photo-preview-container">
                            <img class="photo-preview" id="photo-preview" src="${e.target.result}" alt="Preview Foto 4x6">
                            <div class="mt-2 text-muted small">
                                <i class="ki-duotone ki-check-circle text-success me-1">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    toastr.success('Foto berhasil diupload dan akan disesuaikan ke ukuran 4x6 cm');
                }, 800);
            };
