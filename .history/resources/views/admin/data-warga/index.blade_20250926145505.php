...
/* Make profile photos square instead of circle - Force override */
#kt_table_warga .symbol .symbol-label,
...
#kt_table_warga .symbol .symbol-label img,
.table .symbol .symbol-label img,
.symbol.symbol-40px .symbol-label img {
    border-radius: 8px !important;
    -webkit-border-radius: 8px !important;
    -moz-border-radius: 8px !important;
}
...
/* Additional overrides for rounded elements */
.table .symbol *,
.symbol-40px *,
tbody .symbol *,
td .symbol * {
...
/* Force all symbol elements to be square */
[class*="symbol"] {
    border-radius: 8px !important;
}

/* Specific styling for foto squares */
.foto-square,
.foto-square *,
.foto-square-inner,
.foto-square-inner *,
.foto-square-img,
.foto-square-placeholder {
    border-radius: 8px !important;
    -webkit-border-radius: 8px !important;
    -moz-border-radius: 8px !important;
...
$(document).ready(function() {
    ...
    // Force square photos after page load
    function makePhotosSquare() {
        // Force all symbol elements to be square
        $('.symbol, .symbol-label, .symbol img').each(function() {
            $(this).css({
                'border-radius': '8px !important',
                '-webkit-border-radius': '8px !important',
                '-moz-border-radius': '8px !important'
        ...
        // Add specific class styling
        $('<style>')
            .prop('type', 'text/css')
            .html(`
                .symbol, .symbol *, .symbol-label, .symbol-label *, 
                .symbol img, .foto-square, .foto-square * {
                    border-radius: 8px !important;
                }
            `)
            .appendTo('head');
    ...
    $(document).ready(function() {
        ...
        setTimeout(makePhotosSquare, 1000);
    });
});
</script>
@endpush
