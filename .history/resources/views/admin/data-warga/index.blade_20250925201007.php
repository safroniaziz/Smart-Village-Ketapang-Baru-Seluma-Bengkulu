                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where(function($q) { $q->where('jenis_kelamin', 'Laki-laki')->orWhere('jenis_kelamin', 'L'); })->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where(function($q) { $q->where('jenis_kelamin', 'Perempuan')->orWhere('jenis_kelamin', 'P'); })->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
