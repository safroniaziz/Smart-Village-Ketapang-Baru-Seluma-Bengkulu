                        ...
                        <div class="profile-section">
                            ...
                            <div class="photo-upload-wrapper mb-4 text-center">
                                ...
                                <button type="button" class="btn btn-primary change-photo-btn d-flex align-items-center justify-content-center" onclick="$('#foto').click()">
                                    ...
                                    <span class="fw-semibold">{{ $dataWarga->foto ? 'Ganti Foto 4x6' : 'Pilih Foto 4x6' }}</span>
                                </button>
                                ...
                                <div class="alert alert-info p-2 mt-3 small">
                                    ...
                                    <strong>Petunjuk:</strong> Pastikan foto pas foto 4x6 cm, minimal 300x400px. 
                                    Foto akan otomatis disesuaikan ke ukuran standar.
                                </div>
                            </div>
                    ...
                    if (this.width < 300 || this.height < 400) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                toastr.success('Foto berhasil diupload! Akan disesuaikan ke ukuran 4x6 cm saat disimpan.');
                            } else {
                                // Reset to original
                        ...
                        $('#current-photo').attr('src', e.target.result);
                        toastr.success('Foto pas foto 4x6 berhasil diupload!');
                    }
                };
