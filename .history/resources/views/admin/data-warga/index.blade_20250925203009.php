                    ...
                    <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-5">
                                    <div class="symbol-label bg-light-warning">
                                        <i class="ki-duotone ki-question fs-2x text-warning">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                    </div>
                                ...
                                <div class="flex-grow-1">
                                    <div class="text-dark fw-bold fs-6 mb-2">Tidak Diketahui</div>
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNull('jenis_kelamin')->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
