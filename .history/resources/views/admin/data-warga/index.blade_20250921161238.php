...
.table th:nth-child(3) { min-width: 100px; } /* Gender */
.table th:nth-child(4) { min-width: 80px; } /* Umur */
.table th:nth-child(5) { min-width: 100px; } /* Dusun */
.table th:nth-child(6) { min-width: 120px; } /* Mata Pencaharian */
.table th:nth-child(7) { min-width: 80px; } /* Status */
.table th:nth-child(8) { min-width: 160px; } /* Aksi */
...
.family-header {
    background: linear-gradient(135deg, rgba(54, 153, 255, 0.1) 0%, rgba(6, 101, 208, 0.1) 100%);
    border-left: 4px solid var(--kt-primary);
}

.family-header:hover {
    background: linear-gradient(135deg, rgba(54, 153, 255, 0.15) 0%, rgba(6, 101, 208, 0.15) 100%);
}
...
.family-member:before {
    ...
    bottom: 0;
    width: 2px;
    background: linear-gradient(to bottom, var(--kt-primary), transparent);
    opacity: 0.3;
}
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end align-items-center flex-wrap" data-kt-user-table-toolbar="base">
                            ...
                            <!--begin::Family Grouping Toggle-->
                            <div class="me-4">
                                <button type="button" id="familyGroupToggle" class="btn btn-sm {{ request('group_by_family') ? 'btn-primary' : 'btn-light-primary' }}" onclick="toggleFamilyGroup()">
                                    <i class="ki-duotone ki-people fs-5 me-1">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                                        <span class="path4"></span>
                                    ...
                                    {{ request('group_by_family') ? 'Batal Kelompok' : 'Kelompok Keluarga' }}
                                </button>
                            </div>
                            <!--end::Family Grouping Toggle-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-rounded table-striped border gy-7 gs-7" id="kt_table_warga">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                @if(request('group_by_family') && isset($familyGroups) && $familyGroups->count() > 0)
                                    {{-- Family Grouped View --}}
                                    @foreach($familyGroups as $noKK => $familyMembers)
                                        {{-- Family Header Row --}}
                                        <tr class="bg-light-primary family-header">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-auto">
                                                        <button class="btn btn-sm btn-light-primary family-toggle" data-family="{{ $noKK }}">
                                                            <i class="ki-duotone ki-up fs-4"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="border-bottom border-gray-300 family-member" data-family="{{ $noKK }}" data-warga-id="{{ $warga->id }}">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-4">{{-- Indentation for family members --}}</div>
                                                    <div class="symbol symbol-35px me-3">
                                                        <div class="symbol-label overflow-hidden">
                                                            ...
                                                            @else
                                                                <div class="symbol-label fs-7 fw-bold {{ $warga->jenis_kelamin == 'Laki-laki' ? 'bg-light-primary text-primary' : 'bg-light-danger text-danger' }}">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex align-items-center">
                                                            @if($warga->is_kepala_keluarga)
                                                                <div class="badge badge-light-success fs-8 me-2">
                                                                    <i class="ki-duotone ki-crown fs-6 me-1"></i>
                                                                    Kepala Keluarga
                                                                </div>
                                                            @endif
                                                            <a href="{{ route('data-warga.show', $warga) }}" class="text-gray-800 text-hover-primary fw-bold">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="text-muted fs-7">{{ Str::limit($warga->nik ?? 'Tidak diketahui', 12) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="d-none d-lg-table-cell">
                                                @if($warga->jenis_kelamin == 'Laki-laki')
                                                    <div class="badge badge-light-primary fs-8 fw-bold">
                                                        <i class="ki-duotone ki-profile-user fs-6 me-1"></i>
                                                        L
                                                    </div>
                                            ...
                                            <td class="d-none d-md-table-cell">
                                                @if($warga->calculated_age)
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 fw-bold">{{ $warga->calculated_age }} th</span>
                                                        <span class="text-muted fs-8">{{ $warga->calculated_birth_date_formatted }}</span>
                                                    </div>
                                                @else
                                                    <span class="text-muted">-</span>
                                                @endif
                                            ...
                                            <td class="d-none d-lg-table-cell">
                                                @if($warga->dusun)
                                                    <div class="badge badge-light-info fs-8">{{ $warga->dusun }}</div>
                                                @else
                                                    <span class="text-muted">-</span>
                                                @endif
                                            </td>
                                            <td class="d-none d-xl-table-cell">
                                                @if($warga->mata_pencaharian)
                                                    <span class="text-gray-700 fs-8">{{ Str::limit($warga->mata_pencaharian, 12) }}</span>
                                                @else
                                                    <span class="text-muted">-</span>
                                                @endif
                                            </td>
                                            <td>
                                                @if($warga->status_aktif)
                                                    <div class="badge badge-light-success fs-8">Aktif</div>
                                                @else
                                                    <div class="badge badge-light-danger fs-8">Tidak Aktif</div>
                                                @endif
                                            </td>
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end gap-1">
                                                    <a href="{{ route('data-warga.show', $warga) }}" class="btn btn-sm btn-success" title="Lihat Detail">
                                                        <i class="ki-duotone ki-eye fs-7"></i>
                                                    </a>
                                                    <a href="{{ route('data-warga.edit', $warga) }}" class="btn btn-sm btn-warning" title="Edit Data">
                                                        <i class="ki-duotone ki-pencil fs-7"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger" title="Hapus Data" onclick="deleteWarga({{ $warga->id }})">
                                ...
                                <tr class="border-bottom border-gray-300" data-warga-id="{{ $warga->id }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-muted fs-7">{{ Str::limit($warga->nik ?? 'Tidak diketahui', 15) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="d-none d-md-table-cell">
                                        @if($warga->calculated_age)
                                            <div class="d-flex flex-column">
                                                <span class="text-gray-800 fw-bold">{{ $warga->calculated_age }} tahun</span>
                                                <span class="text-muted fs-7">{{ $warga->calculated_birth_date_formatted }}</span>
                                            </div>
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
                                    ...
                                    <td class="d-none d-xl-table-cell">
                                        @if($warga->mata_pencaharian)
                                            <span class="text-gray-700">{{ Str::limit($warga->mata_pencaharian, 15) }}</span>
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end gap-1">
                                            <a href="{{ route('data-warga.show', $warga) }}" class="btn btn-sm btn-success d-flex align-items-center" title="Lihat Detail">
                                            ...
                                            <a href="{{ route('data-warga.edit', $warga) }}" class="btn btn-sm btn-warning d-flex align-items-center" title="Edit Data">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger d-flex align-items-center" title="Hapus Data" onclick="deleteWarga({{ $warga->id }})">
...
function toggleFamilyGroup() {
    ...
    const isGrouped = currentUrl.searchParams.get('group_by_family');
    
    if (isGrouped) {
        currentUrl.searchParams.delete('group_by_family');
    } else {
        currentUrl.searchParams.set('group_by_family', '1');
    }
