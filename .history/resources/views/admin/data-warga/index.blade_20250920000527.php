                    ...
                    <div class="d-flex flex-stack flex-wrap pt-10">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @if ($wargas->onFirstPage())
                                <span class="btn btn-sm btn-light btn-active-light-primary disabled me-2">
                                    <i class="ki-duotone ki-left fs-5"></i>
                                    Previous
                                </span>
                            @else
                                <a href="{{ $wargas->previousPageUrl() }}" class="btn btn-sm btn-light btn-active-light-primary me-2">
                                    <i class="ki-duotone ki-left fs-5"></i>
                                    Previous
                                </a>
                            @endif
                            ...
                            <div class="d-flex align-items-center me-2">
                                @foreach ($wargas->getUrlRange(1, $wargas->lastPage()) as $page => $url)
                                    ...
                                    @elseif($page == 1 || $page == $wargas->lastPage() || ($page >= $wargas->currentPage() - 2 && $page <= $wargas->currentPage() + 2))
                                        <a href="{{ $url }}" class="btn btn-sm btn-light btn-active-light-primary me-1">{{ $page }}</a>
                                    @elseif($page == $wargas->currentPage() - 3 || $page == $wargas->currentPage() + 3)
                            ...
                            @if ($wargas->hasMorePages())
                                <a href="{{ $wargas->nextPageUrl() }}" class="btn btn-sm btn-light btn-active-light-primary">
                                    Next
                                    <i class="ki-duotone ki-right fs-5"></i>
                                </a>
                            @else
                                <span class="btn btn-sm btn-light btn-active-light-primary disabled">
                                    Next
                                    <i class="ki-duotone ki-right fs-5"></i>
                                </span>
                            @endif
