...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereIn('jenis_kelamin', ['Laki-laki', 'L'])->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereIn('jenis_kelamin', ['Perempuan', 'P'])->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--begin::Debug Info (Temporary)-->
            <div class="alert alert-info mb-5">
                <strong>Debug Info:</strong><br>
                Total User: {{ \App\Models\User::count() }}<br>
                Laki-laki: {{ \App\Models\User::where('jenis_kelamin', 'Laki-laki')->count() }}<br>
                L: {{ \App\Models\User::where('jenis_kelamin', 'L')->count() }}<br>
                Perempuan: {{ \App\Models\User::where('jenis_kelamin', 'Perempuan')->count() }}<br>
                P: {{ \App\Models\User::where('jenis_kelamin', 'P')->count() }}<br>
                NULL: {{ \App\Models\User::whereNull('jenis_kelamin')->count() }}<br>
                Empty (''): {{ \App\Models\User::where('jenis_kelamin', '')->count() }}<br>
                Other values: {{ \App\Models\User::whereNotIn('jenis_kelamin', ['Laki-laki', 'L', 'Perempuan', 'P'])->whereNotNull('jenis_kelamin')->where('jenis_kelamin', '!=', '')->count() }}
            </div>
            <!--end::Debug Info-->
