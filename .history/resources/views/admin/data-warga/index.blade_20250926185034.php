...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        // Family header rows are now clickable via onclick in HTML
...
// Family detail functions removed - now using dedicated page


// Modal functions removed - now using dedicated family detail page
</script>
@endpush
