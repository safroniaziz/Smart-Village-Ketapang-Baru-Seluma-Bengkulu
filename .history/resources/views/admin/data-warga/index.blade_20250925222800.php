                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            <form method="GET" action="{{ route('data-warga.index') }}" class="d-flex align-items-center position-relative" id="search-form">
                                ...
                                @if(request('q'))
                                    <a href="{{ route('data-warga.index', request()->except(['q', 'page'])) }}" class="btn btn-sm btn-light ms-2" title="Clear search">
