                                ...
                                <div class="d-flex flex-column flex-grow-1 pe-8">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                @if($dataWarga->status_aktif)
                                                    <i class="ki-duotone ki-verify fs-3 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                @else
                                            ...
                                            <div class="fw-semibold text-gray-400">Status Warga</div>
                                        </div>
                                        <!--end::Stat-->
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="ki-duotone ki-home-2 fs-3 text-primary me-2">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                    <span class="path3"></span>
                                            ...
                                            <div class="fw-semibold text-gray-400">Jiwa dalam KK</div>
                                        </div>
                                        <!--end::Stat-->
                                    </div>
                                    <!--end::Stats-->
