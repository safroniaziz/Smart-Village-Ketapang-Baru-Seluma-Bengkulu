            ...
            <div class="card mb-5">
                <div class="card-body py-4">
                    <div class="d-flex flex-wrap align-items-center">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0 me-5">
                            Detail Data Warga: {{ $dataWarga->nama_lengkap }}
                        </h1>
                        
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('data-warga.index') }}" class="btn btn-sm btn-light-primary me-3">
                            ...
                            <a href="{{ url('manajemen-data-warga/' . $dataWarga->id . '/edit') }}" class="btn btn-sm btn-primary me-3">
