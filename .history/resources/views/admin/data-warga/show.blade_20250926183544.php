                                ...
                                @else
                                    <div class="symbol-label fs-2 fw-semibold text-success bg-light-success rounded-3 d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="text-center">
                                            <i class="ki-duotone ki-user fs-2x text-success mb-2">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            <div class="fs-7 text-success">{{ strtoupper(substr($dataWarga->nama_lengkap, 0, 2)) }}</div>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="d-flex flex-column flex-grow-1 pe-8">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="stats-glass min-w-150px py-4 px-5 me-6 mb-4">
                                            ...
                                            <div class="text-center">
                                                <div class="fw-bold text-white fs-7" style="opacity: 0.8;">JIWA</div>
                                                <div class="fw-semibold text-white fs-8" style="opacity: 0.6;">Dalam KK</div>
                                            </div>
                                        </div>
                                        <!--end::Stat-->
                                    </div>
