...
$(document).ready(function() {
    ...
    $('.export-btn').on('click', function(e) {
        ...
        $button.html('<i class="spinner-border spinner-border-sm me-2"></i>Memproses Export ' + type.toUpperCase() + '...');
        ...
        Swal.fire({
            ...
            text: `Sedang menyiapkan file ${type.toUpperCase()}...`,
            icon: 'info',
        ...
        setTimeout(() => {
            Swal.fire({
                ...
                text: `File ${type.toUpperCase()} sedang diunduh...`,
                icon: 'success',
                timer: 2000,
                toast: true,
                position: 'top-end',
