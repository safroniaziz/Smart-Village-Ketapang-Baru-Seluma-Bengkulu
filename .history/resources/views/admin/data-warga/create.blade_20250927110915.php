                ...
                <div class="wizard-content">
                    ...
                    <div class="step-content" id="step-3">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                           ...
                                           value="{{ old('pekerjaan') }}" placeholder="Contoh: Petani, Pedagang, PNS">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <select class="form-select @error('status_sosial') is-invalid @enderror"
                                            id="status_sosial" name="status_sosial" required>
                                        <option value="">-- Pilih Status --</option>
                                    ...
                                    <label for="status_sosial" style="color: #7e8299; font-weight: 400;">Status Sosial Ekonomi <span style="color: #dc3545;">*</span></label>
                                    @error('status_sosial')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <select class="form-select @error('kelayakan_rumah') is-invalid @enderror"
                                            id="kelayakan_rumah" name="kelayakan_rumah" required>
                                    ...
                                    <label for="kelayakan_rumah" style="color: #7e8299; font-weight: 400;">Kelayakan Rumah <span style="color: #dc3545;">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" class="form-control @error('jumlah_jiwa_kk') is-invalid @enderror"
                                           id="jumlah_jiwa_kk" name="jumlah_jiwa_kk"
                                           value="{{ old('jumlah_jiwa_kk', 1) }}" min="1" max="20">
                                    <label for="jumlah_jiwa_kk" style="color: #7e8299; font-weight: 400;">Jumlah Jiwa dalam KK</label>
                                    @error('jumlah_jiwa_kk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="status" style="color: #7e8299; font-weight: 400;">Status Kependudukan <span style="color: #dc3545;">*</span></label>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('lat') is-invalid @enderror"
                                           id="lat" name="lat"
                                           value="{{ old('lat') }}" placeholder="Contoh: -4.321303">
                                    <label for="lat" style="color: #7e8299; font-weight: 400;">Latitude (GPS)</label>
                                    @error('lat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('long') is-invalid @enderror"
                                           id="long" name="long"
                                           value="{{ old('long') }}" placeholder="Contoh: 102.765089">
                                    <label for="long" style="color: #7e8299; font-weight: 400;">Longitude (GPS)</label>
                                    @error('long')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
