...
/* Red asterisk for required fields when validation fails */
.form-control.is-invalid + label,
.form-select.is-invalid + label {
    color: #e74c3c !important;
}

/* Make asterisk more visible for required fields */
.form-floating label:after {
    content: "";
}

/* Specific styling for asterisk in required field labels */
.form-floating label[for] {
    position: relative;
}

/* When field is invalid, make the whole label red including asterisk */
.is-invalid + label {
    color: #e74c3c !important;
    font-weight: 500 !important;
}

/* Normal state asterisk */
label:contains('*') {
    color: #7e8299;
}

/* Invalid state - make asterisk red and bold - override inline styles */
.is-invalid + label {
    animation: shake 0.5s ease-in-out;
}

/* More specific CSS to override inline styles for asterisk color */
...
/* Red asterisk - use pseudo-element to make asterisk red */
.form-floating .form-control.is-invalid + label[for],
.form-floating .form-select.is-invalid + label[for] {
    position: relative;
}

/* Create red asterisk overlay for required fields when invalid */
.form-floating .form-control.is-invalid + label[for]:after,
.form-floating .form-select.is-invalid + label[for]:after {
    content: "*";
    position: absolute;
    right: 0;
                        ...
                        <div class="row g-5 mt-3">
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="password" style="color: #7e8299; font-weight: 400;">Password Login *</label>
                                    <div class="form-text">
...
$(document).ready(function() {
    ...
    // Photo upload functionality - safe native click with loop prevention
    $('#photo-upload').off('click').on('click', function(e) {
        ...
        // Use native click instead of jQuery trigger to prevent loops
...
function showValidationErrors() {
    ...
    if (invalidFields.length > 0) {
        ...
        Swal.fire({
            ...
            html: `
                <div class="text-center">
                    <p class="mb-3">Mohon pastikan semua field yang wajib diisi sudah lengkap sebelum melanjutkan ke step berikutnya.</p>
