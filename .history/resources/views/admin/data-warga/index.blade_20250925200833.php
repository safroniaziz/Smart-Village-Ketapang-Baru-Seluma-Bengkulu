                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where('nik', '!=', '-')->whereNotNull('nik')->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where('nik', '!=', '-')->whereNotNull('nik')->where('status_aktif', true)->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where('nik', '!=', '-')->whereNotNull('nik')->where(function($q) { $q->where('jenis_kelamin', 'Laki-laki')->orWhere('jenis_kelamin', 'L'); })->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::where('nik', '!=', '-')->whereNotNull('nik')->where(function($q) { $q->where('jenis_kelamin', 'Perempuan')->orWhere('jenis_kelamin', 'P'); })->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end align-items-center flex-wrap" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-warning btn-sm me-2" onclick="fixFamilyHeads()">
                            ...
                            <!--begin::Fix Gender Format-->
                            <button type="button" class="btn btn-info btn-sm me-3" onclick="fixGenderFormat()">
                                <i class="ki-duotone ki-user-edit fs-5 me-1">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                    <span class="path3"></span>
                                </i>
                                Perbaiki Format Gender
                            </button>
                            <!--end::Fix Gender Format-->
...
// Fix gender format function
function fixGenderFormat() {
    Swal.fire({
        title: 'Perbaiki Format Jenis Kelamin?',
        text: 'Sistem akan mengubah semua data jenis kelamin dari format singkat (L/P) ke format lengkap (Laki-laki/Perempuan).',
        icon: 'question',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                title: 'Memproses...',
                text: 'Sedang memperbaiki format jenis kelamin',
                allowOutsideClick: false,
                showConfirmButton: false,
                didOpen: () => {
                    Swal.showLoading();
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '{{ route("data-warga.fix-gender-format") }}';
