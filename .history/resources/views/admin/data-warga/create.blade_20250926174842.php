        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    // Always show preview immediately, crop will happen on save
                    finalImageSrc = e.target.result;
                    processMessage = `Foto berhasil dipilih (${originalWidth}x${originalHeight}px)`;
...
function submitFormData() {
    ...
    // Auto-crop photo to 3x4 ratio (300x400px) before sending
    ...
    if (fileInput.files && fileInput.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            img.onload = function() {
                ...
                // Only crop if not already 300x400
                if (originalWidth !== 300 || originalHeight !== 400) {
                    ...
                    // Convert to blob and replace in form data
                    canvas.toBlob(function(blob) {
                        formData.delete('foto');
                        formData.append('foto', blob, 'foto.jpg');
                        console.log('Photo cropped to 300x400px for upload');
                        
                        // Continue with AJAX submission
                        submitFormWithData(formData);
                    }, 'image/jpeg', 0.9);
                } else {
                    // Already correct size, submit as is
                    submitFormWithData(formData);
                }
            };
            img.src = e.target.result;
