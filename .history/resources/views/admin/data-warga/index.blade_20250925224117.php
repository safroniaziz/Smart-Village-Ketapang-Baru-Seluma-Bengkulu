                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="kt_table_search"
                                   ...
                                   autocomplete="off" />
                            <button type="button" id="clear-search-btn" class="btn btn-sm btn-light ms-2 d-none" title="Clear search">
...
$(document).ready(function() {
    ...
    function performSearch(searchTerm) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Re-initialize family toggle functionality
    ...
    initializeFamilyToggle();    // Per page selector functionality
