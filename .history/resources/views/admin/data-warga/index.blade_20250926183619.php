...
#familyDetailModal .modal-dialog {
    max-width: 95%;
    margin: 1rem auto;
}

#familyDetailModal .modal-content {
    border: none;
    border-radius: 1rem;
    overflow: hidden;
...
#familyDetailModal .modal-header {
    padding: 2rem;
    border: none;
}

#familyDetailModal .modal-body {
    padding: 0;
}

#familyDetailModal .modal-footer {
    padding: 1.5rem 2rem;
    border: none;
}
...
/* Modal Animation */
#familyDetailModal.fade .modal-dialog {
    transition: transform 0.4s ease-out;
    transform: translate(0, -50px) scale(0.95);
}

#familyDetailModal.show .modal-dialog {
    transform: none;
}
...
#familyDetailModal .modal-body::-webkit-scrollbar {
    width: 6px;
}

#familyDetailModal .modal-body::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 10px;
}

#familyDetailModal .modal-body::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 10px;
}

#familyDetailModal .modal-body::-webkit-scrollbar-thumb:hover {
    background: #555;
}
...
{{-- Family Detail Modal --}}
<div class="modal fade" id="familyDetailModal" tabindex="-1" aria-labelledby="familyDetailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-gradient-to-r" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="d-flex align-items-center w-100">
                    <i class="ki-duotone ki-home-2 fs-2x text-white me-3">
                        <span class="path1"></span>
                        <span class="path2"></span>
                    </i>
                    <div>
                        <h1 class="modal-title fs-3 text-white fw-bold" id="familyDetailModalLabel">Detail Keluarga</h1>
                        <p class="text-white-75 mb-0 fs-6" id="familySubtitle">Informasi lengkap anggota keluarga</p>
                    </div>
            ...
            <div class="modal-body p-0">
                {{-- Loading State --}}
                <div id="familyModalLoading" class="d-flex justify-content-center align-items-center" style="min-height: 300px;">
                    <div class="text-center">
                        <div class="spinner-border text-primary mb-3" role="status" style="width: 3rem; height: 3rem;">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        <p class="text-muted">Memuat data keluarga...</p>
                    </div>
                </div>

                {{-- Family Content --}}
                <div id="familyModalContent" class="d-none">
                    {{-- Family Overview Card --}}
                    <div class="card border-0 shadow-sm m-5 mb-3">
                            ...
                            <div class="row g-4">
                                <div class="col-md-8">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <h3 class="text-primary mb-2 fw-bold" id="familyName">Keluarga -</h3>
                                            <div class="d-flex flex-wrap gap-3 mb-3">
                                                <div class="d-flex align-items-center">
                                                    <i class="ki-duotone ki-abstract-41 fs-6 text-primary me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    <span class="text-muted fs-6">No. KK: </span>
                                                    <span class="fw-semibold ms-1" id="familyKK">-</span>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-muted fs-6">Alamat: </span>
                                                    <span class="fw-semibold ms-1" id="familyAddress">-</span>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-wrap gap-2" id="familyStats">
                                ...
                                <div class="col-md-4 text-end">
                                    <div class="d-flex flex-column gap-2">
                                        <button class="btn btn-sm btn-light-success" onclick="exportFamilyData()">
                                        ...
                                        <button class="btn btn-sm btn-light-primary" onclick="printFamilyCard()">
