                    ...
                    <div class="col-lg-4">
                        <div class="profile-section">
                            ...
                            <div class="photo-upload-wrapper mb-4 text-center">
                                ...
                                <div id="photo-status" class="mt-2 text-center" style="display: none;">
                                    <span class="badge badge-light-success">
                                        <i class="ki-duotone ki-check fs-6 me-1">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                        Foto baru dipilih - Klik Simpan untuk menyimpan
                                    </span>
                                </div>
...
function previewPhoto(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            // Update button text
            $('.change-photo-btn span').text('Ganti Foto');
            ...
            Swal.fire({
                ...
                text: 'Preview foto telah dimuat. Klik Simpan untuk menyimpan perubahan.',
                timer: 2000,
