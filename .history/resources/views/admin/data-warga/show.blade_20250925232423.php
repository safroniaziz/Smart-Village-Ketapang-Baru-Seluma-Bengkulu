                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                ...
                                @else
                                    <img src="https://via.placeholder.com/300x300/3E97FF/FFFFFF?text=FOTO" alt="{{ $dataWarga->nama_lengkap }}" class="rounded-3" style="object-fit: cover; width: 100%; height: 100%;">
                                @endif
