...
function previewPhoto(input) {
    if (input.files && input.files[0]) {
        ...
        // Check image dimensions (warning only, not blocking)
        const img = new Image();
        img.onload = function() {
            ...
            if (width < 300 || height < 400) {
                dimensionWarning = `
                    <div class="alert alert-warning mt-3">
                        <strong>⚠️ Perhatian:</strong> Foto berukuran ${width}x${height}px. 
                        Untuk hasil terbaik, gunakan foto minimal 300x400px.
                    </div>
                `;
            }
            
            // Show success message with dimension info
            Swal.fire({
                icon: 'success',
                ...
                html: `
                    <div class="text-center">
                        ...
                        <p>Preview foto telah dimuat (${width}x${height}px).</p>
                        ${dimensionWarning}
