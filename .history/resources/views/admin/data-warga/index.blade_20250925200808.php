                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->where('status_aktif', true)->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
