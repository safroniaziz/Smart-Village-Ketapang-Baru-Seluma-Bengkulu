        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <div class="row text-center text-lg-start">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="text-white fw-bold fs-4">{{ $dataWarga->pekerjaan }}</div>
                            </div>
                            <div class="col-md-4 mb-3">
                    ...
                    <div class="info-card animate-in animate-delay-3">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <div class="fw-bold text-dark fs-5">{{ $dataWarga->pekerjaan }}</div>
                            </div>
                    ...
                    <div class="info-card animate-in animate-delay-4">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="text-muted">{{ $dataWarga->created_at->format('d F Y, H:i') }}</div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="text-muted">{{ $dataWarga->updated_at->format('d F Y, H:i') }}</div>
                                <div class="text-gray-600 fs-7 mt-1">
                                    @if($dataWarga->updated_at->gt($dataWarga->created_at))
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="text-muted">{{ $dataWarga->email_verified_at ? $dataWarga->email_verified_at->format('d F Y, H:i') : 'Email belum diverifikasi' }}</div>
                                <div class="text-gray-600 fs-7 mt-1">
            ...
            <div class="action-buttons animate-in animate-delay-4">
                <div class="d-flex justify-content-center gap-4 flex-wrap">
                    ...
                    <a href="{{ route('data-warga.edit', $dataWarga) }}" class="btn btn-primary btn-enhanced">
...
function generatePrintableContent() {
    ...
    const wargaAge = "{{ $dataWarga->tanggal_lahir ? $dataWarga->tanggal_lahir->age : '-' }}";
    const wargaJob = "{{ $dataWarga->pekerjaan }}";
...
$(document).on('keydown', function(e) {
    ...
    if (e.ctrlKey && e.key === 'e') {
        e.preventDefault();
        window.location.href = "{{ route('data-warga.edit', $dataWarga) }}";
    }
