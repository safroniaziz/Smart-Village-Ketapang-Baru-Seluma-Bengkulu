...
.table th:nth-child(2) { min-width: 150px; } /* Nama */
.table th:nth-child(3) { min-width: 120px; } /* NIK */
.table th:nth-child(4) { min-width: 100px; } /* Gender */
.table th:nth-child(5) { min-width: 80px; } /* Umur */
.table th:nth-child(6) { min-width: 100px; } /* Dusun */
.table th:nth-child(7) { min-width: 120px; } /* Mata Pencaharian */
.table th:nth-child(8) { min-width: 80px; } /* Status */
.table th:nth-child(9) { min-width: 160px; } /* Aksi */
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr class="border-bottom border-gray-300" data-warga-id="{{ $warga->id }}">
                                    ...
                                    <td class="d-none d-md-table-cell">
                                        @if($warga->nik && strlen($warga->nik) >= 12)
                                            @php
                                                // Extract birth date from NIK (digit 7-12: DDMMYY)
                                                $nikDate = substr($warga->nik, 6, 6);
                                                $day = substr($nikDate, 0, 2);
                                                $month = substr($nikDate, 2, 2);
                                                $year = substr($nikDate, 4, 2);
                                                ...
                                                try {
                                                    $birthDate = \Carbon\Carbon::createFromFormat('d-m-Y', sprintf('%02d-%02d-%s', $day, $month, $year));
                                                    $age = $birthDate->age;
                                            ...
                                            @if(isset($age))
                                                <div class="d-flex flex-column">
                                                    <span class="text-gray-800 fw-bold">{{ $age }} tahun</span>
                                                    <span class="text-muted fs-7">{{ $birthDateFormatted }}</span>
                                                </div>
                                            @else
                                                <span class="text-muted">NIK Invalid</span>
                                            @endif
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
