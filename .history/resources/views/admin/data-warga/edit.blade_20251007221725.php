                            ...
                            <div class="card bg-light-info mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="fw-bold">{{ $dataWarga->mata_pencaharian }}</div>
                                    </div>
                                    <div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="no_hp" style="color: #7e8299; font-weight: 400;">Nomor HP</label>
                                        <i class="ki-duotone ki-phone fs-6 floating-icon">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                        @error('no_hp')
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-light-info d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-1">Informasi Password Login</h6>
                                            <p class="mb-0">
                                                Password untuk login adalah <strong>NIK warga ({{ $dataWarga->nik }})</strong> dan tidak dapat diubah di halaman edit.
                                                <br>Gunakan tombol <strong>Reset Password</strong> di halaman daftar warga jika diperlukan.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            img.onload = function() {
                ...
                if (originalWidth < 300 || originalHeight < 400 || originalWidth !== 300 || originalHeight !== 400) {
                    ...
                    canvas.toBlob(function(blob) {
                        ...
                        $currentPhoto.html(`
                            <img src="${finalImageSrc}" alt="Preview Foto"
                                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                        `);

                        statusMessage = `Foto telah dipotong otomatis dari ${originalWidth}x${originalHeight}px menjadi 300x400px.`;
                        warningIcon = 'info';

                        showSuccessMessage();
                    }, 'image/jpeg', 0.9);
                } else {
                    // Update photo preview with original
                    const $currentPhoto = $('#current-photo');
                    $currentPhoto.html(`
                        <img src="${finalImageSrc}" alt="Preview Foto"
                             style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                        ...
                        html: `
                            <div class="text-center">
                                ...
                                <div class="alert alert-light-success">
                                    <strong>💡 Jangan lupa:</strong> Klik tombol <strong>Simpan Perubahan</strong> untuk menyimpan foto.
                                </div>
                            </div>
                        `,
                        timer: 2000,
...
function initializeValidation() {
    ...
    // Password info - no longer editable, handled via reset button in list page
}
