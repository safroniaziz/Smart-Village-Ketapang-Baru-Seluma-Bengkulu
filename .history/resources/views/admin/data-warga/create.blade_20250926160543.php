                        ...
                        <div class="row g-5 mt-3">
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="password" style="color: #7e8299; font-weight: 400;">Password *</label>
                                    <div class="form-text">Default: NIK warga (bisa diubah sesuai kebutuhan)</div>
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    function showPreview() {
                        // Quick processing for better UX
                        setTimeout(() => {
                            $('.preview-content').html(`
                                <div class="photo-preview-container">
