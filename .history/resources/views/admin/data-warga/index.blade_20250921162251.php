...
/* Allow wrapping only for name column */
...
.table th:nth-child(2) { min-width: 150px; max-width: 180px; } /* Nama + NIK */
.table th:nth-child(3) { min-width: 80px; max-width: 100px; } /* Gender - Always visible */
.table th:nth-child(4) { min-width: 70px; max-width: 90px; } /* Umur - Always visible */
.table th:nth-child(5) { min-width: 80px; max-width: 100px; } /* Dusun */
.table th:nth-child(6) { min-width: 100px; max-width: 120px; } /* Mata Pencaharian */
.table th:nth-child(7) { min-width: 70px; max-width: 90px; } /* Status */
.table th:nth-child(8) { min-width: 120px; width: 120px; } /* Aksi - Fixed width */
                        ...
                        <table class="table table-hover table-rounded table-striped border gy-7 gs-7" id="kt_table_warga">
                            <thead>
                                <tr class="fw-bold fs-6 text-white border-bottom-3 border-primary">
                                    ...
                                    <th class="min-w-80px cursor-pointer" data-column="umur">
                                        <div class="d-flex align-items-center">
                                            Umur
                                            <i class="ki-duotone ki-up-down fs-5 ms-1 sort-icon">
                                                <span class="path1"></span>
                                        ...
                                        <tr class="border-bottom border-gray-300 family-member" data-family="{{ $noKK }}" data-warga-id="{{ $warga->id }}">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex align-items-center mb-1">
                                                            @if($warga->is_kepala_keluarga)
                                                                <div class="badge badge-light-success fs-9 me-1 px-2 py-1">
                                                                    <i class="ki-duotone ki-crown fs-7 me-1"></i>
                                                                    KK
                                                                </div>
                                                            @endif
                                                            <a href="{{ route('data-warga.show', $warga) }}" class="text-gray-800 text-hover-primary fw-bold fs-7">
                                                                {{ Str::limit($warga->nama_lengkap, 15) }}
                                                            </a>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <i class="ki-duotone ki-geolocation fs-8 text-muted me-1">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span>
                                                            </i>
                                                            <span class="text-muted fs-8">{{ Str::limit($warga->nik ?? 'Tidak diketahui', 10) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                @if($warga->jenis_kelamin == 'Laki-laki')
                                                    <div class="badge badge-light-primary fs-9 fw-bold px-2 py-1">
                                                        <i class="ki-duotone ki-profile-user fs-7 me-1"></i>
                                                        L
                                                    </div>
                                                @elseif($warga->jenis_kelamin == 'Perempuan')
                                                    <div class="badge badge-light-danger fs-9 fw-bold px-2 py-1">
                                                        <i class="ki-duotone ki-profile-user fs-7 me-1"></i>
                                                        P
                                                    </div>
                                                @else
                                            ...
                                            <td>
                                                @if($warga->calculated_age)
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 fw-bold fs-8">{{ $warga->calculated_age }}</span>
                                                        <span class="text-muted fs-9">tahun</span>
                                                    </div>
                                                @else
                                                    <span class="text-muted">-</span>
                                                @endif
