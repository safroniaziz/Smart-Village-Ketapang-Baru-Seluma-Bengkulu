...
.page-loading-overlay.active .loading-content {
...
.loading-progress-bar {
    height: 100%;
    background: linear-gradient(90deg, #2196f3, #3f51b5, #673ab7);
    width: 0%;
    border-radius: 10px;
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->where('nik', '!=', '')->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->where('nik', '!=', '')->where('status_aktif', true)->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->where('nik', '!=', '')->whereIn('jenis_kelamin', ['Laki-laki', 'L'])->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold text-muted fs-7">{{ \App\Models\User::whereNotNull('nik')->where('nik', '!=', '')->whereIn('jenis_kelamin', ['Perempuan', 'P'])->count() }} orang</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    // Handle export buttons with full page loading
    $('.export-btn').on('click', function(e) {
        ...
        showPageLoading(type);

        // Disable all interactive elements and prevent scrolling
        $('button, a, input, select').prop('disabled', true);
        ...
        // Hide loading after delay (simulating download completion)
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                // Re-enable all elements and restore scrolling
                $('button, a, input, select').prop('disabled', false);
    ...
    // Full page loading functions
    function showPageLoading(type) {
        const typeLabels = {
            'excel': 'Excel (XLSX)',
            'pdf': 'PDF',
            'csv': 'CSV'
        ...
        const overlay = `
            <div class="page-loading-overlay" id="pageLoadingOverlay">
                <div class="loading-content">
                    ...
                    <div class="loading-text">Memproses Export</div>
                    <div class="loading-subtext">Sedang menyiapkan file ${typeLabels[type] || type.toUpperCase()}...</div>
