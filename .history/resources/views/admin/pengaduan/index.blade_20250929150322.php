                    ...
                    <div class="card-title">
                        <form method="get" class="d-flex align-items-center gap-3">
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <input type="text" name="q" value="{{ request('q') }}" class="form-control form-control-lg form-control-solid w-300px ps-12" placeholder="Cari judul / tracking" />
                            </div>
                            <select name="status" class="form-select form-select-solid w-200px" data-control="select2" data-placeholder="Semua Status" data-hide-search="true">
                                <option value="">Semua Status</option>
                                @foreach(['Diterima','Dalam Proses','Selesai','Ditolak'] as $s)
                                    <option value="{{ $s }}" @selected(request('status')===$s)>{{ $s }}</option>
                                @endforeach
                            </select>
                            <select name="asal" class="form-select form-select-solid w-200px" data-control="select2" data-placeholder="Semua Asal" data-hide-search="true">
                                <option value="">Semua Asal</option>
                                @foreach(['Warga Desa','Eksternal'] as $a)
                                    <option value="{{ $a }}" @selected(request('asal')===$a)>{{ $a }}</option>
                                @endforeach
                            </select>
                            <select name="fu" class="form-select form-select-solid w-200px" data-control="select2" data-placeholder="Followup" data-hide-search="true">
                            ...
                            <select name="sort" class="form-select form-select-solid w-200px" data-control="select2" data-hide-search="true">
