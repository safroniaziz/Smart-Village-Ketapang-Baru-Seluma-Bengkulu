        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-10">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stats-widget" style="--widget-color: #667eea; --widget-bg: rgba(102, 126, 234, 0.1);">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stats-widget" style="--widget-color: #f093fb; --widget-bg: rgba(240, 147, 251, 0.1);">
                        <div class="widget-icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stats-widget" style="--widget-color: #4facfe; --widget-bg: rgba(79, 172, 254, 0.1);">
                        <div class="widget-icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stats-widget" style="--widget-color: #43e97b; --widget-bg: rgba(67, 233, 123, 0.1);">
                        <div class="widget-icon">
