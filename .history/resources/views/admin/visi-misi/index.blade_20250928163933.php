            ...
            <div class="card shadow-sm mb-8">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#visiModal" title="Edit data visi desa">
...
$(document).ready(function() {
    ...
    const pendekatanIcons = [
        'ki-target', 'ki-abstract-26', 'ki-calendar', 'ki-chart-simple', 'ki-gear',
        'ki-abstract-39', 'ki-abstract-44', 'ki-abstract-47', 'ki-abstract-48',
        'ki-abstract-49', 'ki-abstract-50', 'ki-abstract-51', 'ki-abstract-52'
    ];

    const tahapanIcons = [
        'ki-calendar', 'ki-clock', 'ki-time', 'ki-calendar-2', 'ki-calendar-3',
        'ki-calendar-4', 'ki-calendar-5', 'ki-calendar-6', 'ki-calendar-7',
        'ki-calendar-8', 'ki-calendar-9', 'ki-calendar-10', 'ki-calendar-11'
    ];
    ...
    function assignStaticIcons() {
        ...
        $('.pendekatan-item').each(function() {
            if (!$(this).data('icon-assigned')) {
                ...
                $(this).find('.pendekatan-icon').removeClass().addClass('ki-duotone ' + randomIcon);
        ...
        $('.tahapan-item').each(function() {
            if (!$(this).data('icon-assigned')) {
                ...
                $(this).find('.tahapan-icon').removeClass().addClass('ki-duotone ' + randomIcon);
                $(this).data('icon-assigned', true);
            }
        });
    }
