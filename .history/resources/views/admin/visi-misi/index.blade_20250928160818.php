...
$(document).ready(function() {
    ...
    function loadVisiData() {
        console.log('Loading visi data...'); // Debug log
        $.get('/visi-misi/visi-data', function(response) {
            console.log('Visi data loaded:', response); // Debug log
            ...
            console.error('Failed to load visi data:', xhr); // Debug log
        });
    }

    function loadMisiData() {
        console.log('Loading misi data...'); // Debug log
        $.get('/visi-misi/misi', function(response) {
            console.log('Misi data loaded:', response); // Debug log
            $('#misi-content').html(response);
            $('[data-bs-toggle="tooltip"]').tooltip();
        }).fail(function(xhr) {
            console.error('Failed to load misi data:', xhr); // Debug log
        });
    }

    function loadPendekatanData() {
        console.log('Loading pendekatan data...'); // Debug log
        $.get('/visi-misi/pendekatan', function(response) {
            console.log('Pendekatan data loaded:', response); // Debug log
            $('#pendekatan-content').html(response);
            $('[data-bs-toggle="tooltip"]').tooltip();
        }).fail(function(xhr) {
            console.error('Failed to load pendekatan data:', xhr); // Debug log
        });
    }

    function loadTahapanData() {
        console.log('Loading tahapan data...'); // Debug log
        $.get('/visi-misi/tahapan', function(response) {
            console.log('Tahapan data loaded:', response); // Debug log
            $('#tahapan-content').html(response);
            $('[data-bs-toggle="tooltip"]').tooltip();
        }).fail(function(xhr) {
            console.error('Failed to load tahapan data:', xhr); // Debug log
        });
    }
});
</script>
