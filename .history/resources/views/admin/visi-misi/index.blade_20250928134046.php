        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-5">
                                    <div class="symbol-label" style="background: rgba(240, 147, 251, 0.1);">
                                        <i class="ki-duotone ki-target fs-2x" style="color: #f093fb;">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                    </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-visi-table-filter="status" data-hide-search="true">
                                            <option></option>
            ...
            <div class="card shadow-sm mb-8">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="fw-bold m-0">
                            <i class="ki-duotone ki-target me-3" style="color: #f093fb;">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                            Misi Desa
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-semibold">Status:</label>
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-misi-table-filter="status" data-hide-search="true">
                                            <option></option>
                                            <option value="1">Aktif</option>
                                            <option value="0">Tidak Aktif</option>
                                        </select>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-misi-table-filter="reset">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-misi-table-filter="filter">Apply</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-header pt-5 border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-misi-table-toolbar="selected">
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-misi-table-select="selected_count"></span>Selected
                            </div>
                            <button type="button" class="btn btn-danger" data-kt-misi-table-select="delete_selected">Delete Selected</button>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
            ...
            <div class="card shadow-sm mb-8">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-semibold">Status:</label>
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-pendekatan-table-filter="status" data-hide-search="true">
                                            <option></option>
                                            <option value="1">Aktif</option>
                                            <option value="0">Tidak Aktif</option>
                                        </select>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-pendekatan-table-filter="reset">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-pendekatan-table-filter="filter">Apply</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-header pt-5 border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-pendekatan-table-toolbar="selected">
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-pendekatan-table-select="selected_count"></span>Selected
                            </div>
                            <button type="button" class="btn btn-danger" data-kt-pendekatan-table-select="delete_selected">Delete Selected</button>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
            ...
            <div class="card shadow-sm mb-8">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-semibold">Status:</label>
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-tahapan-table-filter="status" data-hide-search="true">
                                            <option></option>
                                            <option value="1">Aktif</option>
                                            <option value="0">Tidak Aktif</option>
                                        </select>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-tahapan-table-filter="reset">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-tahapan-table-filter="filter">Apply</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-header pt-5 border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-tahapan-table-toolbar="selected">
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-tahapan-table-select="selected_count"></span>Selected
                            </div>
                            <button type="button" class="btn btn-danger" data-kt-tahapan-table-select="delete_selected">Delete Selected</button>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
