                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stat-card animate-slide-up" style="animation-delay: 0.1s;">
                        <div class="icon-wrapper" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <i class="ki-duotone ki-eye text-white">
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                            </i>
                        </div>
                        <h3 class="fw-bold text-dark mb-2">Visi Desa</h3>
                        <div class="fs-2 fw-bold gradient-text">{{ \App\Models\VisiDesa::count() }}</div>
                        <p class="text-muted mb-0">Data visi tersimpan</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stat-card animate-slide-up" style="animation-delay: 0.2s;">
                        <div class="icon-wrapper" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                            <i class="ki-duotone ki-target text-white">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </div>
                        <h3 class="fw-bold text-dark mb-2">Misi Desa</h3>
                        <div class="fs-2 fw-bold gradient-text">{{ \App\Models\MisiDesa::count() }}</div>
                        <p class="text-muted mb-0">Data misi tersimpan</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stat-card animate-slide-up" style="animation-delay: 0.3s;">
                        ...
                        <h3 class="fw-bold text-dark mb-2">Pendekatan</h3>
                        <div class="fs-2 fw-bold gradient-text">{{ \App\Models\PendekatanDesa::count() }}</div>
                        <p class="text-muted mb-0">Strategi partisipatif</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stat-card animate-slide-up" style="animation-delay: 0.4s;">
                        ...
                        <h3 class="fw-bold text-dark mb-2">Tahapan</h3>
                        <div class="fs-2 fw-bold gradient-text">{{ \App\Models\TahapanDesa::count() }}</div>
                        <p class="text-muted mb-0">Implementasi pembangunan</p>
                    </div>
                </div>
            </div>
