...
$(document).ready(function() {
    ...
    $('#pendekatanForm').on('submit', function(e) {
        e.preventDefault();
        console.log('Pendekatan form submitted!'); // Debug log
        ...
        console.log('Pendekatan URL:', url, 'Method:', method); // Debug log
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('Pendekatan success response:', response); // Debug log
                if (response.success) {
                    Swal.fire({
                        title: 'Berhasil!',
            ...
            error: function(xhr) {
                console.log('Pendekatan error response:', xhr); // Debug log
