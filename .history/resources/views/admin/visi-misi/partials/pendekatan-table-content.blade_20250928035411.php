...
<tr>
    ...
    <td>
        <div class="d-flex flex-column">
            <span class="fw-bold text-dark mb-1">{{ $item->nama_pendekatan }}</span>
        </div>
    </td>
    <td>
...
<tr>
    <td colspan="6" class="text-center">
        <div class="empty-state">
            ...
            <h4 class="fw-bold text-dark mb-2">Belum Ada Data Pendekatan</h4>
            <p class="text-muted mb-4">Mulai dengan menambahkan pendekatan partisipatif pertama Anda</p>
