                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="icon" id="tahapan_icon_input" class="form-control form-control-lg border-0 shadow-sm" placeholder="Masukkan nama icon (contoh: ki-calendar)..." style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                            </div>
                        </div>
...
(function() {
    ...
    window.editTahapan = function(id) {
        ...
        $.get(`/visi-misi/tahapan/${id}/edit`, function(data) {
            ...
            $('#tahapan_icon_input').val(data.icon);
        });
    };
        });
    }
