...
<div class="modal fade" id="misiModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form id="misiForm">
                <div class="modal-header" id="kt_modal_add_misi_header">
                    <h2 class="fw-bold" id="misiModalTitle">
                        <i class="ki-duotone ki-target me-3 text-danger">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" name="judul" id="judul_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Masukkan judul misi" required />
                    </div>
                    <div class="fv-row mb-7">
                        <label class="required fw-semibold fs-6 mb-2">Deskripsi</label>
                        <textarea name="deskripsi" id="deskripsi_input" class="form-control form-control-solid" rows="4" placeholder="Masukkan deskripsi misi" required></textarea>
                    </div>
                    <div class="fv-row mb-7">
                        <label class="fw-semibold fs-6 mb-2">Indikator</label>
                        <textarea name="indikator" id="indikator_input" class="form-control form-control-solid" rows="3" placeholder="Masukkan indikator pencapaian misi"></textarea>
                    </div>
                    <div class="fv-row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="misiSubmitBtn" data-kt-misi-modal-action="submit">
