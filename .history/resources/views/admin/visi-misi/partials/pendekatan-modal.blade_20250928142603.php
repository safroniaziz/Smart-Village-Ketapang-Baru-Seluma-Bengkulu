        ...
        <div class="modal-content" style="border: none; border-radius: 2rem; overflow: hidden; box-shadow: 0 30px 60px rgba(0,0,0,0.3); background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">
            <form id="pendekatanForm">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" id="deskripsi_input" class="form-control form-control-lg border-0 shadow-sm" rows="4" placeholder="Masukkan deskripsi pendekatan..." required style="border-radius: 1rem; background: #ffffff;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label fw-bold text-gray-900 mb-3">
                                            <i class="ki-duotone ki-picture fs-5 text-info me-2">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            Icon
                                        </label>
                                        <input type="text" name="icon" id="icon_input" class="form-control form-control-lg border-0 shadow-sm" placeholder="Masukkan nama icon (contoh: ki-target)..." style="border-radius: 1rem; background: #ffffff;">
                                        <div class="form-text mt-2">Gunakan icon dari KTIcons. Contoh: ki-target, ki-abstract-26, ki-calendar</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer" style="background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%); border-top: 1px solid #e9ecef; padding: 2rem;">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg" id="pendekatanSubmitBtn" style="border-radius: 1rem; padding: 0.75rem 2rem; font-weight: 600; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border: none;">
