        ...
        <div class="d-flex align-items-center">
            <div class="symbol symbol-45px me-5">
                <div class="symbol-label" style="background: rgba(240, 147, 251, 0.1);">
                    <i class="ki-duotone ki-target fs-2" style="color: #f093fb;">
        ...
        <div class="d-flex flex-column align-items-center">
            <div class="symbol symbol-100px symbol-circle mb-7">
                <div class="symbol-label bg-light-danger">
                    <i class="ki-duotone ki-target fs-1 text-danger">
                        <span class="path1"></span>
                        <span class="path2"></span>
                    </i>
                </div>
            ...
            <div class="text-center">
                <h5 class="fw-bold text-dark mb-3">Belum Ada Data Misi</h5>
                <div class="text-muted fw-semibold fs-6 mb-4">Mulai dengan menambahkan misi desa pertama Anda</div>
