...
$(document).ready(function() {
    ...
    $('#visiForm').on('submit', function(e) {
        e.preventDefault();
        console.log('Visi form submitted!'); // Debug log
        ...
        console.log('Visi URL:', url, 'Method:', method); // Debug log
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('Visi success response:', response); // Debug log
                if (response.success) {
                    Swal.fire({
                        title: 'Berhasil!',
            ...
            error: function(xhr) {
                console.log('Visi error response:', xhr); // Debug log
