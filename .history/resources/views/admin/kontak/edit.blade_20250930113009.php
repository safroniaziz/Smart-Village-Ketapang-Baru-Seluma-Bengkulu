...
@section('title', 'Edit Kontak - Smart Village')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Kontak Desa</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Edit Kontak</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <h3 class="fw-bold m-0">Form Edit Kontak Desa</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('admin.kontak.update', $kontak->id) }}" method="POST" id="kt_kontak_form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="text" name="nama_desa" class="form-control form-control-solid @error('nama_desa') is-invalid @enderror"
                                       value="{{ old('nama_desa', $kontak->nama_desa) }}" placeholder="Masukkan nama desa" required>
                                @error('nama_desa')
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="text" name="kode_pos" class="form-control form-control-solid @error('kode_pos') is-invalid @enderror"
                                       value="{{ old('kode_pos', $kontak->kode_pos) }}" placeholder="Masukkan kode pos">
                                @error('kode_pos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-6">
                                ...
                                <textarea name="alamat" class="form-control form-control-solid @error('alamat') is-invalid @enderror"
                                          rows="3" placeholder="Masukkan alamat lengkap desa" required>{{ old('alamat', $kontak->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="text" name="telepon" class="form-control form-control-solid @error('telepon') is-invalid @enderror"
                                       value="{{ old('telepon', $kontak->telepon) }}" placeholder="Contoh: (0534) 1234567">
                                @error('telepon')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="email" name="email" class="form-control form-control-solid @error('email') is-invalid @enderror"
                                       value="{{ old('email', $kontak->email) }}" placeholder="Contoh: desa@ketapangbaru.id">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="url" name="website" class="form-control form-control-solid @error('website') is-invalid @enderror"
                                       value="{{ old('website', $kontak->website) }}" placeholder="Contoh: https://ketapangbaru.desa.id">
                                @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="aktif" value="1"
                                           {{ old('aktif', $kontak->aktif) ? 'checked' : '' }} id="aktif">
                            ...
                            <div class="col-md-4 mb-6">
                                ...
                                <input type="text" name="kepala_desa" class="form-control form-control-solid @error('kepala_desa') is-invalid @enderror"
                                       value="{{ old('kepala_desa', $kontak->kepala_desa) }}" placeholder="Nama kepala desa">
                                @error('kepala_desa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-6">
                                ...
                                <input type="text" name="sekretaris_desa" class="form-control form-control-solid @error('sekretaris_desa') is-invalid @enderror"
                                       value="{{ old('sekretaris_desa', $kontak->sekretaris_desa) }}" placeholder="Nama sekretaris desa">
                            ...
                            <div class="col-md-4 mb-6">
                                ...
                                <input type="text" name="bendahara_desa" class="form-control form-control-solid @error('bendahara_desa') is-invalid @enderror"
                                       value="{{ old('bendahara_desa', $kontak->bendahara_desa) }}" placeholder="Nama bendahara desa">
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="text" name="latitude" class="form-control form-control-solid @error('latitude') is-invalid @enderror"
                                       value="{{ old('latitude', $kontak->latitude) }}" placeholder="Contoh: -1.8312">
                                @error('latitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-6">
                                ...
                                <input type="text" name="longitude" class="form-control form-control-solid @error('longitude') is-invalid @enderror"
                                       value="{{ old('longitude', $kontak->longitude) }}" placeholder="Contoh: 109.9811">
                                @error('longitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-6">
                                ...
                                <textarea name="deskripsi" class="form-control form-control-solid @error('deskripsi') is-invalid @enderror"
                                          rows="4" placeholder="Deskripsi singkat tentang desa">{{ old('deskripsi', $kontak->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="jam_operasional[{{ $key }}]"
                                           ...
                                           value="{{ old('jam_operasional.'.$key, $jamOperasional[$key] ?? '') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                title: 'Update Kontak?',
                text: "Data kontak akan diperbarui di database",
                icon: 'question',
