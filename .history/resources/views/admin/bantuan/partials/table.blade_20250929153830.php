                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.bantuan.show', $bantuan->id) }}" class="btn btn-sm btn-light-info">
                                <i class="ki-duotone ki-eye fs-5"><span class="path1"></span><span class="path2"></span></i>
                            </a>
