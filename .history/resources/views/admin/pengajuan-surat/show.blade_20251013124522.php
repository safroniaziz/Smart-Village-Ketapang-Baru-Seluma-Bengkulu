...
$(document).ready(function() {
    ...
    $('.approve-btn').on('click', function(e) {
        ...
        const jenisTtd = $('#current_jenis_ttd').val() || $('.jenis-ttd-select').val() || 'gambar';
                ...
                <div class="text-start">
                    ...
                    <div class="mb-4 border rounded p-3 bg-light">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="ttd_option" id="ttd_manual" value="manual" ${jenisTtd === 'manual' ? 'checked' : ''}>
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="ttd_option" id="ttd_gambar" value="gambar" ${jenisTtd === 'gambar' ? 'checked' : ''}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="ttd_option" id="ttd_qrcode" value="qrcode" ${jenisTtd === 'qrcode' ? 'checked' : ''}>
