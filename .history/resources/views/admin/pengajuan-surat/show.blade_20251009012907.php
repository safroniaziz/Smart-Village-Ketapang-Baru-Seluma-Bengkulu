        ...
        Swal.fire({
            ...
            html: `
                <div class="text-start">
                    ...
                    <!-- Tembusan Section -->
                    <div class="mb-4">
                        <label class="form-label fw-bold">Tembusan Surat (Opsional)</label>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="addTembusan" onchange="toggleTembusanInput()">
                            <label class="form-check-label" for="addTembusan">
                                Tambahkan tembusan pada surat
                            </label>
                        </div>
                        
                        <div id="tembusanContainer" style="display: none;">
                            <textarea id="tembusanText" class="form-control" rows="3" placeholder="Contoh:&#10;1. Sekretaris Desa&#10;2. Bendahara Desa&#10;3. Ketua BPD"></textarea>
                            <small class="text-muted">Masukkan daftar tembusan, satu per baris</small>
                        </div>
                    </div>
