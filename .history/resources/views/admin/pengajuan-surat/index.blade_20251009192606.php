                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form method="GET" action="{{ route('admin.pengajuan-surat.index') }}" class="d-flex align-items-center">
                                ...
                                <select name="jenis_surat" class="form-select form-select-solid w-200px me-3">
                                    ...
                                    <option value="surat_menikah" {{ request('jenis_surat') == 'surat_menikah' ? 'selected' : '' }}>Surat Keterangan Menikah</option>
                                    <option value="surat_miskin" {{ request('jenis_surat') == 'surat_miskin' ? 'selected' : '' }}>Surat Keterangan Miskin</option>
                                    <option value="surat_penghasilan_ortu" {{ request('jenis_surat') == 'surat_penghasilan_ortu' ? 'selected' : '' }}>Surat Keterangan Penghasilan Orang Tua</option>
                                </select>
