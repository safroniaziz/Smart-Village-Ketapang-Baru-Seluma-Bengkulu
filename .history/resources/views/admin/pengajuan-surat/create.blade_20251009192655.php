                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="jenis_surat" name="jenis_surat" required>
                                    ...
                                    <option value="surat_menikah">Surat Keterangan Menikah</option>
                                    <option value="surat_miskin">Surat Keterangan Miskin</option>
                                    <option value="surat_penghasilan_ortu">Surat Keterangan Penghasilan Orang Tua</option>
                                </select>
                            </div>
                        </div>
...
<div id="template-surat_menikah" style="display: none;">
...
<!-- Template untuk Surat Keterangan Miskin -->
<div id="template-surat_miskin" style="display: none;">
    <h5 class="mb-3"><i class="fas fa-file-alt"></i> Data Surat Keterangan Miskin</h5>
    <div class="mb-3">
        <label for="keperluan" class="form-label">Keperluan <span class="text-danger">*</span></label>
        <textarea class="form-control" name="keperluan" rows="3" required
...
<div id="template-surat_penghasilan_ortu" style="display: none;">
    ...
    $('#jenis_surat').change(function() {
        ...
        if (jenisSurat) {
            ...
            if (template) {
                ...
                if (jenisSurat === 'surat_penghasilan_ortu') {
                    setTimeout(function() {
