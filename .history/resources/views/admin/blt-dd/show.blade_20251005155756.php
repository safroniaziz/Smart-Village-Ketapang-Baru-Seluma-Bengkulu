            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-green-600">Rp {{ number_format($bltDd->nominal_bantuan, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 p-6 rounded-lg">
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-green-600">Rp {{ number_format($bltDd->nominal_bantuan, 0, ',', '.') }}</p>
                    <p class="text-sm text-green-600 mt-2">Dana Desa Tahun {{ $bltDd->tahun_anggaran }}</p>
                </div>
            </div>
        </div>
    </div>
