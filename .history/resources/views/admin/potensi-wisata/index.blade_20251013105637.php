                                    ...
                                    <div class="card-header flex-nowrap border-0 pt-9">
                                        <div class="card-title m-0">
                                            ...
                                            <div class="symbol symbol-40px w-40px bg-light">
                                                <img src="{{ $item->main_image }}" alt="{{ $item->nama }}" class="w-100 h-100 object-fit-cover rounded" style="max-width: 30px; max-height: 30px;" />
                                            </div>
                                        </div>
                                        <div class="card-toolbar">
                                            <div class="dropdown">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                @if(count($item->gambar) > 0)
                                                    @foreach($item->gambar as $index => $image)
                                                        ...
                                                        <div class="symbol symbol-25px symbol-circle" data-bs-toggle="tooltip" title="{{ $image['judul'] ?? 'Gambar ' . ($index + 1) }}">
                                                            <img alt="Pic" src="{{ $image['url'] }}" class="w-100 h-100 object-fit-cover" style="max-width: 20px; max-height: 20px;" />
                                                        </div>
                                                        @endif
                                                    @endforeach
