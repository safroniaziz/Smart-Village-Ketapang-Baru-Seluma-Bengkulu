                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-header flex-nowrap border-0 pt-9">
                                        <div class="card-title m-0">
                                            ...
                                            <div class="symbol bg-light" style="width: 20px; height: 20px;"></div>
                                                <img src="{{ $item->main_image }}" alt="{{ $item->nama }}" class="w-100 h-100 object-fit-cover rounded" />
                                            </div>
                                        </div>
                                        <div class="card-toolbar">
                                            <div class="dropdown">
                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                @if(count($item->gambar) > 0)
                                                    @foreach($item->gambar as $index => $image)
                                                        @if($index < 3 && isset($image['url']))
                                                        <div class="symbol symbol-circle" style="width: 18px; height: 18px;" data-bs-toggle="tooltip" title="{{ $image['judul'] ?? 'Gambar ' . ($index + 1) }}">
                                                            <img alt="Pic" src="{{ $image['url'] }}" class="w-100 h-100 object-fit-cover" />
                                                        </div>
                                                        @endif
                                                    @endforeach
                                                    @if(count($item->gambar) > 3)
                                                    <div class="symbol symbol-circle" style="width: 18px; height: 18px;" data-bs-toggle="tooltip" title="+{{ count($item->gambar) - 3 }} foto lainnya">
                                                        <div class="symbol-label bg-light-primary text-primary fs-8 fw-bold">
                                                            +{{ count($item->gambar) - 3 }}
                                                        </div>
                                                    </div>
                                                    @endif
                                                @else
                                                    <div class="symbol symbol-circle" style="width: 18px; height: 18px;">
                                                        <div class="symbol-label bg-light-secondary text-muted">
                                                            <i class="ki-duotone ki-picture fs-7">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span>
                                                            </i>
                                                        </div>
