                                            ...
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                @if(count($item->gambar) > 0)
                                                    @foreach($item->gambar as $index => $image)
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="{{ $image['judul'] ?? 'Gambar ' . ($index + 1) }}">
                                                            <img alt="Pic" src="{{ $image['url'] }}" class="w-100 h-100 object-fit-cover" />
                                                        </div>
                                                        @endif
                                                    @endforeach
                                                    @if(count($item->gambar) > 3)
                                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="+{{ count($item->gambar) - 3 }} foto lainnya">
