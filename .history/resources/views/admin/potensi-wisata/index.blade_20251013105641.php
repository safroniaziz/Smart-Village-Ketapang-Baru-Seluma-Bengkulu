                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <div class="symbol-group symbol-hover flex-nowrap">
                                                @if(count($item->gambar) > 0)
                                                    ...
                                                    <div class="symbol symbol-25px symbol-circle" data-bs-toggle="tooltip" title="+{{ count($item->gambar) - 3 }} foto lainnya">
                                                    ...
                                                    @endif
                                                @else
                                                    <div class="symbol symbol-circle" style="width: 18px; height: 18px;"></div>
