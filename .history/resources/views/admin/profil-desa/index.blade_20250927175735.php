    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.monografi) {
                ...
                $('#topografi').val(data.topografi || '');
                $('#iklim').val(data.iklim || '');
                $('#suhu_rata_rata').val(data.suhu_rata_rata || '');
                $('#jarak_ke_kecamatan').val(data.jarak_ke_kecamatan || '');
                $('#waktu_ke_kecamatan').val(data.waktu_ke_kecamatan || '');
                $('#jarak_ke_kabupaten').val(data.jarak_ke_kabupaten || '');
                $('#waktu_ke_kabupaten').val(data.waktu_ke_kabupaten || '');
                $('#latitude').val(data.latitude || '');
                $('#longitude').val(data.longitude || '');
                $('#google_street_view_url').val(data.google_street_view_url || '');
