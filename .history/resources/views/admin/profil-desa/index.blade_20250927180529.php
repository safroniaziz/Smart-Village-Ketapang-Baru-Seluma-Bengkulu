        ...
        <div class="row g-5 g-xxl-8">
            ...
            <div class="col-12 col-xl-6 col-xxl-6">
                <div class="card card-xxl-stretch mb-5 mb-xxl-8">
                    ...
                    <div class="card-body py-3">
                        {{-- Debug: Show count and data --}}
                        @if(config('app.debug'))
                            <small class="text-muted">Debug: Total batas wilayah records: {{ $batasWilayah->count() }}</small>
                        @endif
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                @if(config('app.debug'))
                                    <small class="text-muted d-block mt-2">Debug: No batas wilayah records found in database</small>
                                @endif
                            </div>
                        @endif
                    </div>
