    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content" style="border: none; border-radius: 2rem; overflow: hidden; box-shadow: 0 30px 60px rgba(0,0,0,0.3); background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">
            ...
            <div class="modal-body" style="padding: 3rem 2rem; background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">
                <form id="potensiForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card card-flush shadow-sm border-0 mb-6" style="border-radius: 1.5rem; background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">
                        <div class="card-header bg-transparent border-0" style="padding: 1.5rem 2rem 0.5rem;">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="card-title text-gray-900 fw-bold mb-1">Media dan Visual</h4>
                                    <p class="text-muted fs-6 mb-0">Icon dan foto potensi desa</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label fw-bold text-gray-900 mb-3">
                                            <i class="ki-duotone ki-star fs-5 text-warning me-2">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            Icon (FontAwesome)
                                        </label>
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="icon" id="potensi_icon" placeholder="Contoh: fas fa-wheat-awn" style="border-radius: 1rem; background: #ffffff;">
                                        <div class="form-text">
                                            <i class="ki-duotone ki-information-2 fs-6 text-muted me-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            Gunakan class FontAwesome (fas fa-*)
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control form-control-lg border-0 shadow-sm" name="foto" id="potensi_foto" accept="image/*" style="border-radius: 1rem; background: #ffffff;">
                                        <div class="form-text">
                                            <i class="ki-duotone ki-information-2 fs-6 text-muted me-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="urutan" id="potensi_urutan" min="0" value="0" style="border-radius: 1rem; background: #ffffff;">
                                        <div class="form-text">
                                            <i class="ki-duotone ki-information-2 fs-6 text-muted me-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                            Urutan tampil di halaman (0 = otomatis)
                                        </div>
                                    </div>
                                </div>
                            </div>
