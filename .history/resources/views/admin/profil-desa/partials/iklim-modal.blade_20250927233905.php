                ...
                <form id="iklimForm">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-lg" name="jenis_iklim" id="jenis_iklim" value="Tropis Pesisir" placeholder="Contoh: Tropis Pesisir" required>
                            <div class="form-text">Contoh: Tropis, Tropis Pesisir, Tropis Basah, Subtropis</div>
                        </div>
                        <div class="col-md-6">
