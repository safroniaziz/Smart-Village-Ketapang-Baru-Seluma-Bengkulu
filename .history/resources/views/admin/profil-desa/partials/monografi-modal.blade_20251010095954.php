                                    ...
                                    <div class="row g-4">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="nama_desa" id="nama_desa" required placeholder="Masukkan nama desa..." value="Ketapang Baru" style="border-radius: 1rem; background: #ffffff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kecamatan" id="kecamatan" required placeholder="Masukkan nama kecamatan..." value="Semidang Alas Maras" style="border-radius: 1rem; background: #ffffff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kabupaten" id="kabupaten" required placeholder="Masukkan nama kabupaten..." value="Seluma" style="border-radius: 1rem; background: #ffffff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="provinsi" id="provinsi" required placeholder="Masukkan nama provinsi..." value="Bengkulu" style="border-radius: 1rem; background: #ffffff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
            ...
            <div class="modal-footer" style="background: linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 100%); border: none; padding: 2.5rem; border-top: 1px solid rgba(0,0,0,0.05);">
                <div class="d-flex justify-content-end w-100">
                    ...
                    <button type="button" class="btn btn-lg px-6" onclick="saveMonografi()" data-kt-indicator="off"
                            style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; color: white; font-weight: 600; box-shadow: 0 8px 20px rgba(102, 126, 234, 0.3);">
