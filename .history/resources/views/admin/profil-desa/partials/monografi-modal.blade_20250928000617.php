                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="nama_desa" id="nama_desa" required style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kecamatan" id="kecamatan" required style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kabupaten" id="kabupaten" required style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="provinsi" id="provinsi" required style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kode_pos" id="kode_pos" pattern="[0-9]{5}" maxlength="5" style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="kode_area" id="kode_area" style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Card: Data Administratif -->\n                    <div class="card card-flush shadow-sm border-0 mb-6" style="border-radius: 1.5rem; background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">\n                        <div class="card-header bg-transparent border-0" style="padding: 1.5rem 2rem 0.5rem;">\n                            <div class="d-flex align-items-center">\n                                <div class="symbol symbol-50px me-3">\n                                    <div class="symbol-label bg-light-warning">\n                                        <i class="ki-duotone ki-setting-2 fs-2x text-warning">\n                                            <span class="path1"></span>\n                                            <span class="path2"></span>\n                                        </i>\n                                    </div>\n                                </div>\n                                <div>\n                                    <h4 class="card-title text-gray-900 fw-bold mb-1">Data Administratif</h4>\n                                    <p class="text-muted fs-6 mb-0">Status dan informasi geografis</p>\n                                </div>\n                            </div>\n                        </div>\n                        <div class="card-body pt-0">\n                            <div class="row g-4">\n                                <div class="col-md-6">\n                                    <div class="form-group">\n                                        <label class="form-label fw-bold text-gray-900 mb-3">\n                                            <i class="ki-duotone ki-award fs-5 text-warning me-2">\n                                                <span class="path1"></span>\n                                                <span class="path2"></span>\n                                            </i>\n                                            Status Desa <span class="text-danger">*</span>\n                                        </label>\n                                        <select class="form-select form-select-lg border-0 shadow-sm" name="status_desa" id="status_desa" required style="border-radius: 1rem; background: #ffffff;">\n                                            <option value="">Pilih Status</option>\n                                            <option value="Swadaya">Swadaya</option>\n                                            <option value="Swakarya">Swakarya</option>\n                                            <option value="Swasembada">Swasembada</option>\n                                        </select>\n                                    </div>\n                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="tahun_berdiri" id="tahun_berdiri" min="1800" max="{{ date('Y') }}" style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="luas_wilayah" id="luas_wilayah" step="0.01" min="0" style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="ketinggian_mdpl" id="ketinggian_mdpl" min="0" style="border-radius: 1rem; background: #ffffff;">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-lg border-0 shadow-sm" name="sejarah" id="sejarah" rows="4" placeholder="Ceritakan sejarah singkat desa..." style="border-radius: 1rem; background: #ffffff;"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-lg border-0 shadow-sm" name="visi" id="visi" rows="3" placeholder="Visi desa untuk masa depan..." style="border-radius: 1rem; background: #ffffff;"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-lg border-0 shadow-sm" name="misi" id="misi" rows="4" placeholder="Misi dan program desa..." style="border-radius: 1rem; background: #ffffff;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
