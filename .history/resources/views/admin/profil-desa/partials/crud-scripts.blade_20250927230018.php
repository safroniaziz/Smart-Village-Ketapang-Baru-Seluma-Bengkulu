...
function editIklim(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#jenis_iklim').val(response.jenis_iklim);
            $('#suhu_min').val(response.suhu_min);
            $('#suhu_max').val(response.suhu_max);
            $('#kelembaban_rata').val(response.kelembaban_rata);
            $('#curah_hujan_tahunan').val(response.curah_hujan_tahunan);
            $('#hari_hujan_pertahun').val(response.hari_hujan_pertahun);
            $('#musim_kering').val(response.musim_kering);
            $('#musim_hujan').val(response.musim_hujan);
            $('#angin_dominan').val(response.angin_dominan);
            $('#karakteristik_iklim').val(response.karakteristik_iklim);
            $('#iklimModal').modal('show');
        },
        error: function() {
            Swal.fire({
