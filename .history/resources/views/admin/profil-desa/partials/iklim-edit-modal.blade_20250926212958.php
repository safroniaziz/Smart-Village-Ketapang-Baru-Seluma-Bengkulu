                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <div class="card-header bg-light-primary">
                                    <h5 class="card-title text-primary fw-bold mb-0">Januari</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Curah Hujan (mm)</label>
                                        <input type="number" class="form-control" name="januari_curah_hujan" step="0.01" min="0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Suhu (Celsius)</label>
                                        <input type="number" class="form-control" name="januari_suhu" step="0.1" min="0" max="50">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Kelembaban (%)</label>
                                        <input type="number" class="form-control" name="januari_kelembaban" step="0.1" min="0" max="100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <div class="card-header bg-light-danger">
                                    <h5 class="card-title text-danger fw-bold mb-0">Februari</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Curah Hujan (mm)</label>
                                        <input type="number" class="form-control" name="februari_curah_hujan" step="0.01" min="0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Suhu (Celsius)</label>
                                        <input type="number" class="form-control" name="februari_suhu" step="0.1" min="0" max="50">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Kelembaban (%)</label>
                                        <input type="number" class="form-control" name="februari_kelembaban" step="0.1" min="0" max="100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <div class="card-header bg-light-success">
                                    <h5 class="card-title text-success fw-bold mb-0">Maret</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Curah Hujan (mm)</label>
                                        <input type="number" class="form-control" name="maret_curah_hujan" step="0.01" min="0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Suhu (Celsius)</label>
                                        <input type="number" class="form-control" name="maret_suhu" step="0.1" min="0" max="50">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Kelembaban (%)</label>
                                        <input type="number" class="form-control" name="maret_kelembaban" step="0.1" min="0" max="100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <div class="card-header bg-light-warning">
                                    <h5 class="card-title text-warning fw-bold mb-0">April</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Curah Hujan (mm)</label>
