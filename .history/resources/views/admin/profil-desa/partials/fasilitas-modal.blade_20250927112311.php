                                ...
                                <div class="card-body pt-0">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-resize fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Luas Bangunan (m²)
                                                </label>
                                                <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="luas_bangunan" id="fasilitas_luas_bangunan" step="0.01" min="0" placeholder="Luas bangunan..." style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-abstract-35 fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Luas Tanah (m²)
                                                </label>
                                                <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="luas_tanah" id="fasilitas_luas_tanah" step="0.01" min="0" placeholder="Luas tanah..." style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-security-user fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Status Kepemilikan
                                                </label>
                                                <select class="form-select form-select-lg border-0 shadow-sm" name="status_kepemilikan" id="fasilitas_status_kepemilikan" style="border-radius: 1rem; background: #ffffff;">
                                                    <option value="">Pilih Status Kepemilikan</option>
                                                    <option value="milik_desa">Milik Desa</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-people fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Kapasitas (orang/unit)
                                                </label>
                                                <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="kapasitas" id="fasilitas_kapasitas" min="0" placeholder="Kapasitas maksimal..." style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-profile-user fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Pengelola
                                                </label>
                                                <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="pengelola" id="fasilitas_pengelola" placeholder="Nama pengelola..." style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-geolocation fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Koordinat GPS
                                                </label>
                                                <input type="text" class="form-control form-control-lg border-0 shadow-sm" name="koordinat" id="fasilitas_koordinat" placeholder="Contoh: -4.321303, 102.765089" style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-toggle-on fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Status Aktif
                                                </label>
                                                <select class="form-select form-select-lg border-0 shadow-sm" name="is_active" id="fasilitas_is_active" style="border-radius: 1rem; background: #ffffff;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label fw-bold text-gray-900 mb-3">
                                                    <i class="ki-duotone ki-sort fs-5 text-success me-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i>
                                                    Urutan Tampil
                                                </label>
                                                <input type="number" class="form-control form-control-lg border-0 shadow-sm" name="urutan" id="fasilitas_urutan" min="0" value="0" placeholder="Urutan tampil..." style="border-radius: 1rem; background: #ffffff;">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-lg border-0 shadow-sm" name="fasilitas_yang_tersedia" id="fasilitas_yang_tersedia" rows="3" placeholder="Sebutkan fasilitas yang tersedia..." style="border-radius: 1rem; background: #ffffff; resize: none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
