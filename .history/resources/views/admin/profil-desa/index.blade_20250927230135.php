                    ...
                    <div class="card-body py-3">
                        @if($iklim->count() > 0)
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4 pt-4 border-top">
                                <button class="btn btn-sm btn-light-warning" onclick="editIklim({{ $iklimData->id }})">
                                ...
                                <button class="btn btn-sm btn-light-danger" onclick="deleteIklim({{ $iklimData->id }})">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-muted fs-7 mb-4">
                                    Isi data iklim untuk memberikan informasi kondisi cuaca dan iklim di wilayah desa Anda
                                </p>
