                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        <div class="card-body p-0">
                            ...
                            <div class="px-9 pt-5 pb-8 bg-body rounded">
                                ...
                                <div class="d-flex pt-5">
                                    <a href="{{ route('admin.peta-desa.batas.index') }}" class="btn btn-success fw-semibold me-2">
            ...
            <div class="col-xl-6">
                <div class="card card-xl-stretch mb-xl-8">
                    <div class="card-body p-0">
                        <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-info">
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-info fw-bold fs-3">Google Street View</h3>
                                <div class="ms-1">
                        ...
                        <div class="px-9 pt-5 pb-8 bg-body rounded">
                            ...
                            <div class="d-flex pt-5">
                                <a href="{{ route('profil-desa.index') }}" class="btn btn-info fw-semibold me-2">
...
$(document).ready(function() {
    loadStatistics();
        ...
        function loadStatistics() {
            ...
            $.get('{{ route("admin.peta-desa.batas.data") }}', function(response) {
                if(response.total !== undefined) {
