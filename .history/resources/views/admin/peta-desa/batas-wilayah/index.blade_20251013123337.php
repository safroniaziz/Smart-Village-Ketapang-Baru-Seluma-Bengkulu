...
<div class="modal fade" id="kt_modal_add_batas" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <form id="kt_modal_add_batas_form" class="form" action="{{ route('admin.peta-desa.batas-wilayah.store') }}" method="POST">
                @csrf
...
function showBatasWilayah(id) {
    ...
    $.get(`{{ route('admin.peta-desa.batas-wilayah.show', '') }}/${id}`, function(response) {
        if (response.success) {
...
function editBatasWilayah(id) {
    ...
    $.get(`{{ route('admin.peta-desa.batas-wilayah.show', '') }}/${id}`, function(response) {
        if (response.success) {
            ...
            $('#kt_modal_add_batas_form').attr('action', `{{ route('admin.peta-desa.batas-wilayah.update', '') }}/${id}`);
...
function deleteBatasWilayah(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `{{ route('admin.peta-desa.batas-wilayah.destroy', '') }}/${id}`,
                type: 'DELETE',
...
$('#kt_modal_add_batas').on('hidden.bs.modal', function() {
    ...
    $('#kt_modal_add_batas_form').attr('action', '{{ route('admin.peta-desa.batas-wilayah.store') }}');
