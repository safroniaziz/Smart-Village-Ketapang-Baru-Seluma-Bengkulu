    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div class="card-body p-0">
                            <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-primary">
                                ...
                                <div class="d-flex text-center flex-column text-primary pt-8">
                                    ...
                                    <span class="fw-bold fs-2x pt-1" id="lahanCount">{{ $lahanCount }}</span>
                        ...
                        <div class="card-body p-0">
                            <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-success">
                                ...
                                <div class="d-flex text-center flex-column text-success pt-8">
                                    ...
                                    <span class="fw-bold fs-2x pt-1" id="batasWilayahCount">{{ $batasWilayahCount }}</span>
                        ...
                        <div class="card-body p-0">
                            <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-info">
                                ...
                                <div class="d-flex text-center flex-column text-info pt-8">
                                    ...
                                    <span class="fw-bold fs-2x pt-1" id="wargaCount">{{ $wargaCount }}</span>
                        ...
                        <div class="card-body p-0">
                            <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-warning">
                                ...
                                <div class="d-flex text-center flex-column text-warning pt-8">
                                    ...
                                    <span class="fw-bold fs-2x pt-1" id="desaCount">{{ $desaCount }}</span>
        ...
        <div class="row g-5 g-xl-8 mb-8">
            ...
            <div class="col-xl-6">
                <div class="card card-xl-stretch mb-xl-8">
                    <div class="card-body p-0">
                        <div class="px-9 pt-7 card-rounded h-275px w-100 bg-light-google">
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-google fw-bold fs-3">Google Street View</h3>
                                <div class="ms-1">
                                    <i class="fab fa-google fs-2x text-google"></i>
                                </div>
                            </div>
                            <div class="d-flex text-center flex-column text-google pt-8">
                                <span class="fw-semibold fs-7">Kelola koordinat Google Street View</span>
                                <span class="fw-bold fs-2x pt-1" id="streetViewCount">{{ $streetViewCount }}</span>
                                <span class="fw-semibold fs-7">Street View URL</span>
                            </div>
                        </div>
                        <div class="px-9 pt-5 pb-8 bg-body rounded">
                            <div class="text-dark fw-bold fs-6 mt-2">Fitur Tersedia:</div>
                            <div class="text-muted fw-semibold fs-7 mt-1">• Update koordinat Street View</div>
                            <div class="text-muted fw-semibold fs-7">• Kelola URL Google Maps</div>
                            <div class="text-muted fw-semibold fs-7">• Preview lokasi 360°</div>
                            <div class="d-flex pt-5">
                                <a href="{{ route('profil-desa.index') }}" class="btn btn-google fw-semibold me-2">
                                    <i class="fab fa-google fs-4 me-2"></i>
                                    Kelola Street View
                                </a>
                            </div>
                        </div>
        ...
        <!-- Additional Management Cards Row 3 -->
        <div class="row g-5 g-xl-8 mb-8">
    ...
    loadStatistics();
        ...
        function loadStatistics() {
            ...
            $.get('{{ route("admin.peta-desa.lahan.data") }}', function(response) {
                ...
                console.log('Lahan data error:', xhr.responseText);
                $('#lahanCount').text('0');
            });
            ...
            $.get('{{ route("admin.peta-desa.batas-wilayah.data") }}', function(response) {
                ...
                console.log('Batas wilayah data error:', xhr.responseText);
                $('#batasWilayahCount').text('0');
            });
            ...
            $.get('{{ route("admin.peta-desa.warga.data") }}', function(response) {
                ...
                console.log('Warga data error:', xhr.responseText);
