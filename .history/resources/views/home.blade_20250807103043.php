        ...
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('surat.online') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center">
                        <i class="fas fa-envelope mr-2"></i>Layanan Surat Online
                    </a>
                    <a href="{{ route('tentang') }}" class="bg-white/20 hover:bg-white/30 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center backdrop-blur-sm">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-6">
                    <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-3xl font-bold text-yellow-400 mb-2">2,847</div>
                        <div class="text-base text-blue-100 font-medium">Total Warga</div>
                        <div class="text-sm text-blue-200 mt-2">1,432 L + 1,415 P</div>
                    </div>
                    <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-3xl font-bold text-yellow-400 mb-2">8</div>
                        <div class="text-base text-blue-100 font-medium">Dusun</div>
                        <div class="text-sm text-blue-200 mt-2">24 RT/RW</div>
                    </div>
                    <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-3xl font-bold text-yellow-400 mb-2">1,250</div>
                        <div class="text-base text-blue-100 font-medium">Keluarga</div>
                        <div class="text-sm text-blue-200 mt-2">KK Aktif</div>
                    </div>
                    <div class="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                        <div class="text-3xl font-bold text-yellow-400 mb-2">450</div>
                        <div class="text-base text-blue-100 font-medium">Hektar</div>
                        <div class="text-sm text-blue-200 mt-2">Sawah & Ladang</div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:w-80 flex-shrink-0">
                <div class="bg-white rounded-xl shadow-xl p-6 text-gray-900 sticky top-8">
                    <div class="text-center mb-4">
                        <div class="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                            <i class="fas fa-map-marker-alt text-white text-xl"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900">Desa Ketapang Baru</h3>
                        <p class="text-sm text-gray-600">Kabupaten Seluma, Provinsi Bengkulu</p>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center space-x-3 p-2 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <div class="font-semibold text-gray-900 text-sm">Kepala Desa</div>
                        ...
                        <div class="flex items-center space-x-3 p-2 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <div class="font-semibold text-gray-900 text-sm">Periode</div>
