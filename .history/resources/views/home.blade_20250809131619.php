...
<!-- Statistics Section -->
<section class="py-20 bg-gradient-to-br from-slate-100 via-gray-100 to-blue-100">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <!-- Modern Badge with Gradient -->
            <div class="inline-flex items-center relative mb-6">
                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div class="flex-1 text-center lg:text-left text-white">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="tel:+6281234567890" class="inline-flex items-center bg-white text-blue-600 font-semibold px-6 py-3 rounded-xl transition-all duration-300 hover:bg-blue-50 hover:scale-105">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567891" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:sekdes@ketapangbaru.desa.id" class="contact-btn-pro">
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567892" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:keuangan@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567893" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:perencanaan@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567894" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:pemerintahan@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567896" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:pelayanan@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <p class="aparatur-title-pro">Kepala Urusan Perencanaan</p>
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567895" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:kesejahteraan@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="700">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567897" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:dusun1@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <p class="aparatur-title-pro">Kepala Dusun</p>
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567898" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:dusun2@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="900">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <p class="aparatur-title-pro">Kepala Dusun</p>
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567899" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:dusun3@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="aparatur-card-pro" data-aos="fade-up" data-aos-delay="1000">
                    ...
                    <div class="aparatur-info-pro">
                        ...
                        <div class="aparatur-contact-pro">
                            <a href="tel:+6281234567900" class="contact-btn-pro">
                                <i class="fas fa-phone"></i>
                            </a>
                            <a href="mailto:heru@ketapangbaru.desa.id" class="contact-btn-pro">
                                <i class="fas fa-envelope"></i>
                            </a>
                        </div>
                    </div>
...
<!-- News Section -->
<section class="py-24 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section class="py-24 bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20" data-aos="fade-up" data-aos-duration="800">
...
.aparatur-card-pro:nth-child(1):hover .contact-btn-pro:hover {
    background: linear-gradient(135deg, #10b981, #059669);
    box-shadow: 0 4px 8px rgba(16, 185, 129, 0.3);
}

.aparatur-card-pro:nth-child(2):hover .contact-btn-pro:hover {
    background: linear-gradient(135deg, #8b5cf6, #7c3aed);
    box-shadow: 0 4px 8px rgba(139, 92, 246, 0.3);
}

.aparatur-card-pro:nth-child(3):hover .contact-btn-pro:hover {
    background: linear-gradient(135deg, #f59e0b, #d97706);
    box-shadow: 0 4px 8px rgba(245, 158, 11, 0.3);
}

.aparatur-card-pro:nth-child(4):hover .contact-btn-pro:hover {
    background: linear-gradient(135deg, #ef4444, #dc2626);
    box-shadow: 0 4px 8px rgba(239, 68, 68, 0.3);
}

.aparatur-card-pro:nth-child(5):hover .contact-btn-pro:hover {
