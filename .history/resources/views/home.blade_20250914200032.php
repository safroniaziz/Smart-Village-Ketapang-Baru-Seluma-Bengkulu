...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" data-aos="fade-in">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-32" viewBox="0 0 1200 200" preserveAspectRatio="none">
            ...
            <path fill="#f8f9fa" fill-opacity="1" d="M-200,100 C50,80 150,120 300,100 C450,80 550,120 700,100 C850,80 950,120 1100,100 C1250,80 1350,120 1500,100 L1500,200 L-200,200 Z" class="animate-ocean-wave-1"></path>
            <!-- Wave Layer 2 - Middle wave (Medium curves) -->
            <path fill="#f1f3f4" fill-opacity="1" d="M-150,115 C0,95 100,135 250,115 C400,95 500,135 650,115 C800,95 900,135 1050,115 C1200,95 1300,135 1450,115 L1450,200 L-150,200 Z" class="animate-ocean-wave-2"></path>
            <!-- Wave Layer 3 - Front wave (Higher curves) -->
            <path fill="#f8f9fa" fill-opacity="1" d="M-100,130 C50,110 150,150 300,130 C450,110 550,150 700,130 C850,110 950,150 1100,130 C1250,110 1350,150 1500,130 L1500,200 L-100,200 Z" class="animate-ocean-wave-3"></path>
            <!-- Wave Layer 4 - Foam layer (Highest position) -->
            <path fill="#ffffff" fill-opacity="1" d="M-50,145 C100,125 200,165 350,145 C500,125 600,165 750,145 C900,125 1000,165 1150,145 C1300,125 1400,165 1550,145 L1550,200 L-50,200 Z" class="animate-ocean-wave-4"></path>
            <!-- Additional solid base layer to ensure no gaps -->
            <rect x="-300" y="180" width="2000" height="30" fill="#ffffff"></rect>
        </svg>
    </div>
</section>
