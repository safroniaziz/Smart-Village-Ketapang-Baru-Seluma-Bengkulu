...
@section('link')
    ...
    <li class="breadcrumb-item">
        <span class="bullet bg-gr                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Penyelesaian Surat</span>
                                            <span class="fw-bold text-warning">78%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Surat yang sudah selesai diproses</div>0 w-5px h-2px"></span>
    </li>
