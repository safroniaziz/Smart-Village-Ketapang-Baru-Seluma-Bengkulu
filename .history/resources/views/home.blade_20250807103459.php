...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden py-16 lg:py-20" style="background-color: #0086c9;"></section>
    <!-- Background Pattern -->
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0">
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-8 text-gray-900 sticky top-8 border border-gray-100 min-h-[600px] flex flex-col">
                    <div class="text-center mb-8">
                        <div class="w-24 h-24 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                            <i class="fas fa-map-marker-alt text-white text-3xl"></i>
                        </div>
                        <h3 class="text-3xl font-bold text-gray-900 mb-2">Desa Ketapang Baru</h3>
                        <p class="text-gray-600 font-medium text-lg">Kabupaten Seluma, Provinsi Bengkulu</p>
                    </div>

                    <div class="space-y-6 flex-1">
                        <div class="flex items-center space-x-4 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                            <div class="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center">
                                <i class="fas fa-user-tie text-white text-lg"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-900 text-lg">Kepala Desa</div>
                                <div class="text-gray-600">H. Ahmad Supriyadi, S.Pd</div>
                            </div>
                        </div>

                        <div class="flex items-center space-x-4 p-5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                            <div class="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center">
                                <i class="fas fa-calendar text-white text-lg"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-900 text-lg">Periode</div>
                                <div class="text-gray-600">2021 - 2027</div>
                            </div>
                        </div>

                        <div class="flex items-center space-x-4 p-5 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-100">
                            <div class="w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center">
                                <i class="fas fa-phone text-white text-lg"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-900 text-lg">Kontak</div>
                                <div class="text-gray-600">(0736) 123456</div>
                            </div>
                        </div>

                        <div class="flex items-center space-x-4 p-5 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                            <div class="w-12 h-12 bg-orange-600 rounded-lg flex items-center justify-center">
                                <i class="fas fa-envelope text-white text-lg"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-900 text-lg">Email</div>
                                <div class="text-gray-600">ketapangbaru@gmail.com</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <div class="text-center">
                            <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-full text-base font-semibold shadow-lg">
