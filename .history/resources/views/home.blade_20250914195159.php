...
.animate-ocean-wave-1 {
    animation: ocean-wave-1 8s linear infinite;
}

.animate-ocean-wave-2 {
    animation: ocean-wave-2 6s linear infinite;
    animation-delay: -2s;
}

.animate-ocean-wave-3 {
    animation: ocean-wave-3 4s linear infinite;
    animation-delay: -1s;
}

.animate-ocean-wave-4 {
    animation: ocean-wave-4 3s linear infinite;
