    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-4 animate-fade-in-up" style="animation-delay: 0.2s;">
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center animate-bounce-slow">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight animate-fade-in-up" style="animation-delay: 0.4s;">
                        Smart Village<br>
                        <span class="text-yellow-400 animate-pulse-slow">Ketapang Baru</span>
                    </h1>

                    <p class="text-xl text-blue-100 leading-relaxed max-w-2xl animate-fade-in-up" style="animation-delay: 0.6s;">
                        Sistem Informasi Pemerintahan Desa yang modern dan terintegrasi untuk memberikan pelayanan terbaik kepada masyarakat.
                    </p>
                </div>

                <div class="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style="animation-delay: 0.8s;">
                    <a href="{{ route('surat.online') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center text-lg hover:scale-105 hover:shadow-lg transform">
                        <i class="fas fa-envelope mr-2 animate-bounce-slow"></i>Layanan Surat Online
                    </a>
                    <a href="{{ route('tentang') }}" class="bg-white/20 hover:bg-white/30 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center backdrop-blur-sm text-lg hover:scale-105 hover:shadow-lg transform">
                        <i class="fas fa-info-circle mr-2 animate-bounce-slow"></i>Profil Desa
                    </a>
                </div>

                <!-- Quick Stats -->
                <div class="flex flex-wrap gap-3 pt-6 max-w-3xl animate-fade-in-up" style="animation-delay: 1s;">
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover:scale-105 transition-transform duration-300 animate-fade-in-up" style="animation-delay: 1.1s;">
                    ...
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover:scale-105 transition-transform duration-300 animate-fade-in-up" style="animation-delay: 1.2s;">
                    ...
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover:scale-105 transition-transform duration-300 animate-fade-in-up" style="animation-delay: 1.3s;">
                    ...
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover:scale-105 transition-transform duration-300 animate-fade-in-up" style="animation-delay: 1.4s;">
