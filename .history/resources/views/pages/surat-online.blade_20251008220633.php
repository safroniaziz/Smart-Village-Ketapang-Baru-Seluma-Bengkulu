...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fileInputs.forEach(input => {
            input.addEventListener('change', function(e) {
                ...
                if (file && label) {
                    ...
                    const textDiv = uploadDiv.querySelector('div:last-child');

                    // Change appearance to show file is selected
                    uploadDiv.classList.remove('border-gray-300', 'hover:border-blue-500');
                    ...
                    textDiv.innerHTML = `
                        ...
                        <p class="text-xs text-green-500">${fileSize} MB</p>
                    `;
                } else if (label) {
    ...
    function resetFileInputAppearance(label) {
        const uploadDiv = label.querySelector('.border-dashed');
        const iconDiv = label.querySelector('.bg-gradient-to-br, .from-green-500');
        const textDiv = uploadDiv.querySelector('div:last-child');

        // Reset appearance
        uploadDiv.classList.remove('border-green-500', 'bg-green-50');
        uploadDiv.classList.add('border-gray-300', 'hover:border-blue-500');
