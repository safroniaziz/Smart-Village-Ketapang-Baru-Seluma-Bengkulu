...
<style>
    ...
    /* Ocean Wave Animations - Consistent with home page */
    @keyframes ocean-wave-1 {
        0% { transform: translateX(0) scaleY(1) skewX(0deg); }
        25% { transform: translateX(-100px) scaleY(1.3) skewX(-2deg); }
        50% { transform: translateX(-200px) scaleY(0.8) skewX(1deg); }
        75% { transform: translateX(-300px) scaleY(1.2) skewX(-1deg); }
        100% { transform: translateX(-400px) scaleY(1) skewX(0deg); }
    }

    @keyframes ocean-wave-2 {
        0% { transform: translateX(0) scaleY(1) skewX(0deg); }
        25% { transform: translateX(-80px) scaleY(1.4) skewX(2deg); }
        50% { transform: translateX(-160px) scaleY(0.7) skewX(-1deg); }
        75% { transform: translateX(-240px) scaleY(1.3) skewX(1deg); }
        100% { transform: translateX(-320px) scaleY(1) skewX(0deg); }
    }

    @keyframes ocean-wave-3 {
        0% { transform: translateX(0) scaleY(1) skewX(0deg); }
        25% { transform: translateX(-60px) scaleY(1.5) skewX(-3deg); }
        50% { transform: translateX(-120px) scaleY(0.6) skewX(2deg); }
        75% { transform: translateX(-180px) scaleY(1.4) skewX(-1deg); }
        100% { transform: translateX(-240px) scaleY(1) skewX(0deg); }
    }

    @keyframes ocean-wave-4 {
        0% { transform: translateX(0) scaleY(1) skewX(0deg); }
        25% { transform: translateX(-40px) scaleY(1.6) skewX(3deg); }
        50% { transform: translateX(-80px) scaleY(0.5) skewX(-2deg); }
        75% { transform: translateX(-120px) scaleY(1.5) skewX(2deg); }
        100% { transform: translateX(-160px) scaleY(1) skewX(0deg); }
    }

    /* Wave Animation Classes */
    .animate-ocean-wave-1 { animation: ocean-wave-1 8s ease-in-out infinite; }
    .animate-ocean-wave-2 { animation: ocean-wave-2 7s ease-in-out infinite 0.5s; }
    .animate-ocean-wave-3 { animation: ocean-wave-3 6s ease-in-out infinite 1s; }
    .animate-ocean-wave-4 { animation: ocean-wave-4 5s ease-in-out infinite 1.5s; }
</style>
@endpush
