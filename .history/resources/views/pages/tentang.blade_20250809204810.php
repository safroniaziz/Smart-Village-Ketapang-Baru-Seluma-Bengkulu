                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-900">Muara Timput</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Timur:</span>
                                    <span class="font-medium text-gray-900">Talang Beringin</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Selatan:</span>
                                    <span class="font-medium text-gray-900">Padang Bakung</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Barat:</span>
                                    <span class="font-medium text-gray-900">Laut</span>
                                </div>
                            </div>
                        </div>
