...
<!-- Map Section -->
@if((isset($monografi) && $monografi && $monografi->google_street_view_url) || $mapUrl || $kontak->koordinat)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="150">
            @if(isset($monografi) && $monografi && $monografi->google_street_view_url)
                <iframe src="{{ $monografi->google_street_view_url }}" width="100%" height="500" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            @elseif($mapUrl)
