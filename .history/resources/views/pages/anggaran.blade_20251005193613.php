            ...
            <div data-aos="fade-left">
                ...
                <div class="bg-white rounded-2xl shadow p-4 border border-gray-200">
                    <div class="w-full" style="height: 860px;">
                        <iframe
                            src="{{ asset('assets/files/apbdes.pdf') }}"
                            title="APBDes PDF"
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ asset('assets/files/apbdes.pdf') }}" target="_blank" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-blue-700 hover:text-blue-900">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function togglePdfEmbed() {
        ...
        if (container && container.classList.contains('hidden')) {
            ...
            @if($pendapatan->first() && $pendapatan->first()->file_apbdes)
            iframe.src = '{{ Storage::url($pendapatan->first()->file_apbdes) }}';
            @endif
