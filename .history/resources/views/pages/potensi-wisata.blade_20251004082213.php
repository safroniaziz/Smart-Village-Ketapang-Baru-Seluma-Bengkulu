        ...
        <div class="modal-body p-0">
            <div class="pdf-viewer-container">
                ...
                <div id="pdfViewerContainer" class="w-full h-full bg-white">
                    ...
                    <!-- Simple PDF Viewer -->
                    <div class="pdf-simple-viewer bg-white overflow-hidden" style="height: calc(80vh - 120px); min-height: 500px;">
                        <!-- Direct PDF Embed with Google Docs Viewer as backup -->
                        <iframe
                            src="{{ asset('storage/' . $wisata->file_potensi_desa) }}"
                            width="100%"
                            height="100%"
                            ...
                            onerror="this.src='https://docs.google.com/gview?url={{ urlencode(asset('storage/' . $wisata->file_potensi_desa)) }}&embedded=true'">
                        </iframe>
                        ...
                        <div class="pdf-fallback flex items-center justify-center h-full bg-gray-50" style="display: none;">
                            <div class="text-center p-8 max-w-lg">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <a href="https://docs.google.com/gview?url={{ urlencode(asset('storage/' . $wisata->file_potensi_desa)) }}"
                                       target="_blank"
