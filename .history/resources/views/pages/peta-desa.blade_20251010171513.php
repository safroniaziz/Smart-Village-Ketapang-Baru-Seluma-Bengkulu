            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-5 flex flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-medium text-gray-700">Ada Foto</span>
                    </div>
                    <div class="flex items-center gap-2">
    ...
    map.on('load', () => {
        ...
        validData.forEach((item, index) => {
            ...
            if (item.foto_path && item.foto_path.trim() !== '') {
                ...
                hasImage = true; // We'll check if it actually exists in the popup
            }

            const color = colors[index % colors.length];

            // Create marker with visual indicator for image availability
                            ...
                            ">
                                <img src="${imgUrl}"
                                     ...
                                     style="
                                         ...
                                         display: block;
                                     "
                                     onerror="this.parentElement.innerHTML='<div style=&quot;height: 120px; background: #f3f4f6; display: flex; align-items: center; justify-content: center; color: #6b7280; font-size: 14px; border-radius: 12px;&quot;><div style=&quot;text-align: center;&quot;><i class=&quot;fas fa-image text-2xl mb-2&quot;></i><br>Foto tidak tersedia</div></div>'"
                                     loading="lazy"/>
                            </div>
                        ` : `
                            <div style="
