    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- MITRA KERJA label between columns -->
                <div class="flex items-center justify-center mb-6 min-w-[1024px] mx-auto">
                    <div class="w-24 h-0 border-t-4 border-dashed border-purple-500"></div>
                    <div class="bg-purple-100 border-2 border-dashed border-purple-500 rounded-full px-4 py-2 mx-3">
