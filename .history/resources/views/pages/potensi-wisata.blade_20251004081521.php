    ...
    <div class="modal-container">
        ...
        <div class="modal-body p-0">
            <div class="pdf-viewer-container">
                @if($wisata->file_potensi_desa)
                <!-- PDF Document Viewer -->
                <div id="pdfViewerContainer" class="w-full h-full bg-gradient-to-br from-gray-50 to-blue-50">
                    
                    <!-- Main PDF Display Area -->
                    <div class="flex items-center justify-center h-full p-8">
                        <div class="text-center max-w-lg">
                            <!-- PDF Icon -->
                            <div class="w-24 h-24 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                                <i class="fas fa-file-pdf text-4xl text-red-600"></i>
                            </div>
                            
                            <!-- Title -->
                            <h3 class="text-2xl font-bold text-gray-800 mb-3">
                                Berkas Lomba Desa Wisata
                            </h3>
                            <p class="text-lg text-gray-600 mb-2 font-semibold">
                                Ketapang Baru, Seluma
                            </p>
                            <p class="text-gray-500 mb-8 leading-relaxed">
                                Dokumen resmi berkas lomba desa wisata yang berisi informasi lengkap 
                                tentang potensi dan pengembangan wisata di Desa Ketapang Baru.
                            </p>
                            ...
                            <div class="space-y-4">
                                <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}" 
                                   target="_blank"
                                   class="inline-flex items-center w-full justify-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02]">
                                ...
                                <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}" 
                                   download
                                   class="inline-flex items-center w-full justify-center px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02]">
                                ...
                                <div class="flex items-center justify-center mt-6 text-sm text-gray-500">
                                    ...
                                    File resmi dan aman untuk diunduh
                                </div>
                            </div>
                            
                            <!-- Additional Info -->
                            <div class="mt-8 p-4 bg-white/60 rounded-xl border border-gray-200">
                                <div class="flex items-center justify-center text-sm text-gray-600">
                                    <i class="fas fa-info-circle mr-2 text-blue-500"></i>
                                    <span>Dokumen dalam format PDF dapat dibuka dengan browser modern atau aplikasi PDF viewer</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.openPdfModal = function() {
            ...
            if (modal) {
                ...
                // Handle PDF loading with timeout fallback
                if (iframe) {
                    let loadTimeout;
                    let hasLoaded = false;
