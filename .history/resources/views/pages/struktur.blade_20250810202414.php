...
<section class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" style="background: linear-gradient(135deg, #0086c9 0%, #0074b3 50%, #006ba3 100%);">
    ...
    <div class="relative w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50" data-aos="fade-up" data-aos-duration="1000">
    <div class="w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative w-[85%] mx-auto">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10 w-full">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 w-full pt-4">
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 w-full pt-4">
                            <div class="relative">
                        ...
                        <!-- Row 2: Kepala Dusun 3 (sendiri di tengah) -->
                        <div class="relative w-full mt-6">
                            <div class="absolute left-1/2 -top-6 -translate-x-1/2 w-px h-6 bg-red-300"></div>
                            <div class="h-px bg-red-300"></div>
                        </div>
                ...
                <div class="lg:hidden mt-12 w-[85%] mx-auto">
                    <!-- Separator -->
        ...
        <!-- Reduced bottom margin for Struktur Organisasi section -->
        <div class="mb-8"></div>
...
<section class="cta-section py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white relative overflow-hidden" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="0">
...
$(document).ready(function() {
    ...
    if (typeof AOS !== 'undefined') {
        ...
        AOS.init({
            ...
            easing: 'ease-in-out',
            once: true,
            offset: isMobile ? 0 : -100, // Negative offset for desktop to trigger earlier
            threshold: isMobile ? 0 : 0.01, // Very low threshold for desktop
            disable: false,
        ...
        console.log('AOS initialized successfully with mobile:', isMobile);
    } else {
