            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-8 shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-300 h-[420px] relative overflow-hidden">
                        ...
                        <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-blue-50 rounded-full opacity-30"></div>
                        ...
                        <div class="w-28 h-28 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl overflow-hidden border-4 border-blue-200 relative mt-4">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 h-[350px] relative overflow-hidden">
                        ...
                        <div class="absolute -top-3 -right-3 w-16 h-16 bg-green-100 rounded-full opacity-20"></div>
                        <div class="absolute -bottom-3 -left-3 w-12 h-12 bg-green-50 rounded-full opacity-30"></div>

                        <div class="w-24 h-24 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl overflow-hidden border-4 border-green-200 relative mt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-yellow-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-18 h-18 bg-yellow-500 rounded-xl border-2 border-yellow-300 flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-orange-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-18 h-18 bg-orange-500 rounded-xl border-2 border-orange-300 flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-teal-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-18 h-18 bg-teal-500 rounded-xl border-2 border-teal-300 flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-purple-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-18 h-18 bg-purple-500 rounded-xl border-2 border-purple-300 flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center mb-12">
                        <div class="relative">
                                ...
                                <div class="absolute -top-4 -right-4 w-16 h-16 bg-purple-100 rounded-full opacity-20"></div>
                                ...
                                <div class="w-24 h-24 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden border-4 border-purple-200 shadow-lg relative">
                    ...
                    <div class="flex justify-center gap-12">
                        ...
                        <div class="bg-white rounded-xl p-4 text-center shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 min-w-[160px] h-[280px] relative overflow-hidden">
                            ...
                            <div class="w-16 h-16 bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl flex items-center justify-center mx-auto mb-3 overflow-hidden border-2 border-slate-200 shadow">
