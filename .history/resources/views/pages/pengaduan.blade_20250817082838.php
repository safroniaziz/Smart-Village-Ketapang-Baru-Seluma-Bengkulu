...
<section class="py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden" data-aos="fade-up">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
            <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white text-center py-8" data-aos="fade-down" data-aos-delay="300">
                ...
                <h3 class="text-3xl font-bold mb-2">Form Pengaduan</h3>
                <p class="text-blue-100 text-lg">Sampaikan keluhan dan saran Anda untuk kemajuan desa</p>
            </div>
            
            <div class="p-8 lg:p-12" data-aos="fade-up" data-aos-delay="400">
