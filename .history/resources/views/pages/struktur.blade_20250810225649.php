                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 w-full pt-4">
                            <div class="relative">
                                ...
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-4 lg:p-6 text-center shadow-lg min-w-[200px]">
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-red-300"></div>
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-4 lg:p-6 text-center shadow-lg">
