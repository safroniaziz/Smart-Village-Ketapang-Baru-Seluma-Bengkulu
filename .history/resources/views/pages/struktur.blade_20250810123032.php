    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- Combined row: Kades and Ketua BPD with overlaid centered dotted line -->
                <div class="relative flex justify-center items-center gap-16 min-w-[1024px] mx-auto mb-6">
                    <!-- Left: Kepala Desa -->
                    ...
                    <!-- Overlay: single dotted connector perfectly centered -->
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div class="h-0 border-t-4 border-dashed border-purple-500 w-32 md:w-56 lg:w-72"></div>
                    </div>
                </div>
