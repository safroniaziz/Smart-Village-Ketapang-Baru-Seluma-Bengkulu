    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- Combined row: Kades | dotted line | Ketua BPD (perfectly aligned) -->
                <div class="grid grid-cols-[auto_1fr_auto] items-center gap-16 min-w-[1024px] mx-auto mb-8">
                    <!-- Kepala Desa -->
                    ...
                    <!-- Centered single dotted line -->
                    <div class="justify-self-center">
                        <div class="h-0 border-t-4 border-dashed border-purple-500 w-24 md:w-40 lg:w-56"></div>
                    </div>
