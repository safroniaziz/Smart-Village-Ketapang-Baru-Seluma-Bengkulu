            ...
            <div class="flex-1 relative" data-aos="fade-left" data-aos-delay="900">
                ...
                <div class="relative max-w-lg mx-auto">
                    ...
                    <div class="absolute top-1/2 -left-16 transform -translate-y-1/2 space-y-3" data-aos="fade-right" data-aos-delay="1600">
                        <button class="w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300 hover:scale-110 shadow-lg">
