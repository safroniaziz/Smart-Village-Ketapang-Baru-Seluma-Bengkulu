...
<section class="py-20 bg-white two-up-section">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <!-- Badge -->
            <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg mb-6">
            ...
            <h2 class="section-title">
                <span class="text-blue-600">Anggaran</span> Kegiatan Khusus
            </h2>
            <div class="section-title-underline"></div>
            <p class="section-subtitle">
...
<section class="py-20 bg-gradient-to-br from-purple-50 to-white two-up-section">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            <!-- Badge -->
            ...
            <h2 class="section-title">
                <span class="text-purple-600">Bantuan Langsung</span> Tunai Desa
            </h2>
            <div class="section-title-underline"></div>
            <p class="section-subtitle">
