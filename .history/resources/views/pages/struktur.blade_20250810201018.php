...
<section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50 tugas-wewenang-section" data-aos="fade-up" data-aos-duration="1000">
    <div class="w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8"></div>
        <!-- Section Header - match Home Services style -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <!-- Card: Kepala Desa -->
            <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-4 lg:p-8 transform hover:-translate-y-2" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                <!-- Header -->
            ...
            <!-- Card: BPD -->
            <div class="group bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 rounded-3xl border-2 border-purple-300 hover:border-purple-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                <!-- Header -->
