...
<section class="py-16 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
    <!-- Floating Decoration -->
    ...
    <div class="relative w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div class="space-y-8" data-aos="fade-right" data-aos-duration="600" data-aos-delay="50">
                <div>
            ...
            <!-- Batas Wilayah & Akses -->
            <div class="relative" data-aos="fade-left" data-aos-duration="600" data-aos-delay="100">
