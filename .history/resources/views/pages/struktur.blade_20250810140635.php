    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- Mobile: Separate sections with clear headers -->
                <div class="lg:hidden space-y-12">
                    <!-- Section 1: Pemerintahan Desa -->
                    <div class="text-center mb-8">
                        <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-full text-lg font-bold shadow-lg mb-6">
                            <i class="fas fa-landmark mr-3"></i>
                            PEMERINTAHAN DESA
                        </div>
                        <p class="text-gray-600 text-base leading-relaxed max-w-2xl mx-auto">
                            Pemerintahan Desa adalah pelaksana urusan pemerintahan, pembangunan, pembinaan kemasyarakatan, dan pemberdayaan masyarakat desa
                        </p>
                    </div>

                    <!-- Pemerintahan Desa Hierarchy (Mobile) -->
                    <div class="space-y-6">
                        <!-- Kepala Desa -->
                        <div class="flex flex-col items-center">
                            <div class="relative">
                                <img src="{{ asset('images/struktur/zultan.jpg') }}" alt="Kepala Desa" class="w-24 h-24 lg:w-28 lg:h-28 rounded-full object-cover border-4 border-blue-500 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <div class="crown-badge">
                                    <i class="fas fa-crown text-xs"></i>
                                </div>
                            </div>
                            <h4 class="text-lg lg:text-xl font-bold text-gray-900 mt-3 mb-1">Zultan Alhara</h4>
                            <p class="text-sm lg:text-base text-blue-600 font-semibold mb-2">Kepala Desa</p>
                            <p class="text-xs lg:text-sm text-gray-600 text-center max-w-xs">Pemimpin tertinggi pemerintahan desa yang bertanggung jawab atas seluruh urusan pemerintahan, pembangunan, dan kemasyarakatan desa</p>
                        </div>

                        <!-- Vertical line down -->
                        <div class="w-px h-8 bg-blue-400 mx-auto"></div>

                        <!-- Sekretaris Desa -->
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('images/struktur/merianto.jpg') }}" alt="Sekretaris Desa" class="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-3 border-blue-400 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                            <h5 class="text-base lg:text-lg font-bold text-gray-900 mt-3 mb-1">Merianto</h5>
                            <p class="text-sm lg:text-base text-blue-600 font-semibold mb-2">Sekretaris Desa</p>
                            <p class="text-xs lg:text-sm text-gray-600 text-center max-w-xs">Membantu kepala desa dalam administrasi, koordinasi, dan pelaksanaan tugas pemerintahan desa</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                            <!-- Kasi Pemerintahan -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/desmerti.jpg') }}" alt="Kasi Pemerintahan" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Desmerti</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kasi Pemerintahan</p>
                                <p class="text-xs text-gray-600 text-center">Urusan administrasi kependudukan, ketentraman, dan ketertiban desa</p>
                            </div>

                            <!-- Kasi Kesejahteraan -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/rozi.jpg') }}" alt="Kasi Kesejahteraan" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Rozi</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kasi Kesejahteraan</p>
                                <p class="text-xs text-gray-600 text-center">Urusan sosial, kesehatan, pendidikan, dan pemberdayaan masyarakat</p>
                            </div>

                            <!-- Kaur Keuangan -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/sapta.jpg') }}" alt="Kaur Keuangan" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Sapta Adi</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kaur Keuangan</p>
                                <p class="text-xs text-gray-600 text-center">Pengelolaan keuangan desa, APBDes, dan pertanggungjawaban keuangan</p>
                            </div>

                            <!-- Kaur Perencanaan -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/marlan.jpg') }}" alt="Kaur Perencanaan" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Marlan</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kaur Perencanaan</p>
                                <p class="text-xs text-gray-600 text-center">Perencanaan pembangunan, program kerja, dan evaluasi kinerja desa</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                            <!-- Kepala Dusun 1 -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/ajasseriani.jpg') }}" alt="Kepala Dusun 1" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Ajasseriani</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kepala Dusun 1</p>
                                <p class="text-xs text-gray-600 text-center">Pelaksana tugas di tingkat dusun untuk wilayah Dusun 1</p>
                            </div>

                            <!-- Kepala Dusun 2 -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/meri.jpg') }}" alt="Kepala Dusun 2" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Meri</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kepala Dusun 2</p>
                                <p class="text-xs text-gray-600 text-center">Pelaksana tugas di tingkat dusun untuk wilayah Dusun 2</p>
                            </div>

                            <!-- Kepala Dusun 3 -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/meri.jpg') }}" alt="Kepala Dusun 3" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-blue-300 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Meri</h6>
                                <p class="text-xs lg:text-sm text-blue-600 font-semibold mb-1">Kepala Dusun 3</p>
                                <p class="text-xs text-gray-600 text-center">Pelaksana tugas di tingkat dusun untuk wilayah Dusun 3</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                        <div class="text-center">
                            ...
                            <h4 class="text-lg font-bold text-blue-800 mb-3">Hubungan Pemerintahan Desa & BPD</h4>
                            <p class="text-gray-700 text-sm leading-relaxed">
                                <strong>Pemerintahan Desa</strong> adalah pelaksana urusan pemerintahan, sedangkan <strong>BPD</strong> adalah badan yang melaksanakan fungsi pemerintahan yang anggotanya merupakan wakil dari penduduk desa berdasarkan keterwakilan wilayah dan ditetapkan secara demokratis. Keduanya bekerja sama dalam menjalankan pemerintahan desa dengan prinsip koordinasi, kooperasi, dan informasi.
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Section 2: BPD -->
                    <div class="text-center mb-8">
                        <div class="inline-flex items-center bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-full text-lg font-bold shadow-lg mb-6">
                            <i class="fas fa-users-cog mr-3"></i>
                            BADAN PERMUSYAWARATAN DESA (BPD)
                        </div>
                        <p class="text-gray-600 text-base leading-relaxed max-w-2xl mx-auto">
                            BPD adalah badan yang melaksanakan fungsi pemerintahan yang anggotanya merupakan wakil dari penduduk desa berdasarkan keterwakilan wilayah
                        </p>
                    </div>

                    <!-- BPD Hierarchy (Mobile) -->
                    <div class="space-y-6">
                        <!-- Ketua BPD -->
                        <div class="flex flex-col items-center">
                            <div class="relative">
                                <img src="{{ asset('images/struktur/bahirman.jpg') }}" alt="Ketua BPD" class="w-24 h-24 lg:w-28 lg:h-28 rounded-full object-cover border-4 border-purple-500 shadow-lg" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <div class="crown-badge">
                                    <i class="fas fa-star text-xs"></i>
                                </div>
                            </div>
                            <h4 class="text-lg lg:text-xl font-bold text-gray-900 mt-3 mb-1">Bahirman</h4>
                            <p class="text-sm lg:text-base text-purple-600 font-semibold mb-2">Ketua BPD</p>
                            <p class="text-xs lg:text-sm text-gray-600 text-center max-w-xs">Memimpin BPD dalam melaksanakan fungsi legislasi, anggaran, dan pengawasan terhadap pemerintah desa</p>
                        </div>

                        <!-- Vertical line down -->
                        <div class="w-px h-8 bg-purple-400 mx-auto"></div>

                        <!-- Wakil Ketua BPD -->
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('images/struktur/default-person.png') }}" alt="Wakil Ketua BPD" class="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-3 border-purple-400 shadow-lg">
                            <h5 class="text-base lg:text-lg font-bold text-gray-900 mt-3 mb-1">Wakil Ketua BPD</h5>
                            <p class="text-sm lg:text-base text-purple-600 font-semibold mb-2">Belum Ditentukan</p>
                            <p class="text-xs lg:text-sm text-gray-600 text-center max-w-xs">Membantu ketua BPD dalam melaksanakan tugas dan fungsi BPD</p>
                        </div>
                        ...
                        <!-- Sekretaris BPD -->
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('images/struktur/default-person.png') }}" alt="Sekretaris BPD" class="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-3 border-purple-400 shadow-lg">
                            <h5 class="text-base lg:text-lg font-bold text-gray-900 mt-3 mb-1">Sekretaris BPD</h5>
                            <p class="text-sm lg:text-base text-purple-600 font-semibold mb-2">Belum Ditentukan</p>
                            <p class="text-xs lg:text-sm text-gray-600 text-center max-w-xs">Membantu ketua BPD dalam administrasi dan dokumentasi kegiatan BPD</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                            <!-- Anggota BPD 1 -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/default-person.png') }}" alt="Anggota BPD 1" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-purple-300 shadow-lg">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Anggota BPD</h6>
                                <p class="text-xs lg:text-sm text-purple-600 font-semibold mb-1">Belum Ditentukan</p>
                                <p class="text-xs text-gray-600 text-center">Wakil dari penduduk desa untuk keterwakilan wilayah</p>
                            </div>

                            <!-- Anggota BPD 2 -->
                            <div class="flex flex-col items-center">
                                <img src="{{ asset('images/struktur/default-person.png') }}" alt="Anggota BPD 2" class="w-16 h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 border-purple-300 shadow-lg">
                                <h6 class="text-sm lg:text-base font-bold text-gray-900 mt-2 mb-1">Anggota BPD</h6>
                                <p class="text-xs lg:text-sm text-purple-600 font-semibold mb-1">Belum Ditentukan</p>
                                <p class="text-xs text-gray-600 text-center">Wakil dari penduduk desa untuk keterwakilan wilayah</p>
                            </div>
                ...
                <div class="hidden lg:block">
                    <!-- Top row: Responsive layout for Kepala Desa and Ketua BPD -->
                    <div class="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12 mx-auto mb-8 lg:mb-4">
                        <!-- Dotted line connecting Kades and Ketua BPD -->
                        ...
                        <div class="relative z-10 flex justify-center">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 border-4 border-blue-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-xs min-h-[240px] lg:min-h-[280px] flex flex-col justify-center">
                        ...
                        <div class="relative z-10 flex justify-center">
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-xs min-h-[240px] lg:min-h-[280px] flex flex-col justify-center">
                                <div class="absolute -top-3 -right-3 w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                    <i class="fas fa-crown text-white text-xs"></i>
                                </div>
                                <img src="{{ asset('images/struktur/bahirman.jpg') }}" alt="Ketua BPD" class="w-20 h-20 lg:w-28 lg:h-28 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h4 class="font-bold text-gray-900 text-base lg:text-lg mb-1">👑 Ketua BPD</h4>
                                <p class="text-purple-600 font-semibold mb-1 text-sm lg:text-base">Bahirman</p>
                                <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 px-3">Ketua BPD, Pengawasan Pemerintahan, Penampung Aspirasi Rakyat</p>
                            </div>
                        </div>
                    </div>

                    <!-- Two independent columns below -->
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mx-auto">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="w-px h-6 lg:h-8 bg-blue-400 mb-4"></div>

                        <!-- Sekretaris -->
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-3 lg:p-4 text-center shadow-lg w-full max-w-xs">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 max-w-4xl w-full pt-4">
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-red-300"></div>
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/basri.jpg') }}" alt="Kepala Dusun 3" class="w-20 h-20 lg:w-28 lg:h-28 rounded-xl border-2 border-red-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="w-px h-6 lg:h-8 bg-purple-400 mb-4"></div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 max-w-xl w-full pt-4">
                            <div class="relative">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                            ...
                            <div class="relative">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    ...
                                    <h6 class="font-bold text-xs lg:text-sm mb-1">Sekretaris BPD</h6>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 max-w-xl w-full pt-4">
                            <div class="relative">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    ...
                                    <h6 class="font-bold text-xs lg:text-sm mb-1">Anggota BPD</h6>
...
<section class="cta-section py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white relative overflow-hidden" data-aos="fade-up" data-aos-duration="150" data-aos-offset="10">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-white/5"></div>
