...
document.addEventListener('DOMContentLoaded', function() {
    ...
    [genderFilter, ageRangeFilter, educationFilter, professionFilter, dusunFilter, religionFilter, statusFilter, statusAktifFilter].forEach(filter => {
        ...
        // Handle pagination clicks - More specific event delegation
    document.addEventListener('click', (e) => {
        ...
        if (paginationLink) {
            ...
            console.log('Pagination clicked:', paginationLink.href);
            ...
            // Use the same performSearch function with the page parameter
            performSearch(page);
    ...
    // Additional pagination handler specifically for pagination container
    document.addEventListener('click', (e) => {
