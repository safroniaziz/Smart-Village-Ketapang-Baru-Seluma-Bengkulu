            ...
            <div class="video-viewer-container flex-1 flex flex-col">
                ...
                <div class="video-player-wrapper flex-1 bg-black relative">
                    ...
                    <iframe id="videoModalPlayer"
                            src="https://www.youtube.com/embed/{{ $youtubeId }}?rel=0&controls=1&autoplay=0&mute=1"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.toggleVideoQuality = function() {
            ...
            if (modal) {
                ...
                // Pause main video first by removing src temporarily
                if (mainVideo) {
                    const mainSrc = mainVideo.src;
                    mainVideo.src = '';
                    // Store original src to restore later
                    mainVideo.dataset.originalSrc = mainSrc;
                ...
                // Load modal video with fresh iframe to avoid conflicts
                if (iframe) {
                    ...
                    iframe.src = newSrc;
                    console.log('Modal video loaded with fresh iframe');
                }
        ...
        window.closeVideoModal = function() {
            ...
            if (modal) {
                ...
                // Stop video by resetting to original src with autoplay=0 and mute=1
                if (iframe) {
                    let originalSrc = iframe.src;
                    originalSrc = originalSrc.replace('autoplay=1', 'autoplay=0');
                    originalSrc = originalSrc.replace('mute=0', 'mute=1');
                    iframe.src = originalSrc;
                }

                console.log('Video modal closed and video stopped');
            }
        };
