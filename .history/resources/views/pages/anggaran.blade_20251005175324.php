...
@if($paguEarmarks->isNotEmpty() || $bltDds->isNotEmpty())
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <!-- Shared wrapper header for both sections -->
        <div class="text-center mb-16" data-aos="fade-up">
            <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg mb-6">
                <i class="fas fa-layer-group mr-2 text-yellow-300"></i>
                Pagu Earmark & BLT Dana Desa {{ $tahun }}
            </div>
            <h2 class="section-title">Program Spesifik dan Bantuan Sosial</h2>
            <div class="section-title-underline"></div>
            <p class="section-subtitle">
                <span class="font-semibold text-slate-700">Ringkasan alokasi kegiatan khusus</span> dan <span class="font-semibold text-purple-600">penyaluran bantuan langsung tunai</span>
                sebagai bagian dari <span class="font-semibold text-blue-700">transparansi anggaran desa</span>
            </p>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
