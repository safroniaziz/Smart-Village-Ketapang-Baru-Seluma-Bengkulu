    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
            <div class="inline-flex items-center relative mb-6">
                <div class="absolute inset-0 bg-gradient-to-r from-emerald-600 to-green-600 rounded-full blur-lg opacity-15"></div>
                <div class="relative bg-gradient-to-r from-emerald-600 to-green-600 text-white px-6 py-2.5 rounded-full text-sm font-semibold shadow-md">
            ...
            <div class="w-16 h-1 bg-gradient-to-r from-emerald-500 to-green-500 rounded-full mx-auto mb-6"></div>
            ...
            <div class="flex justify-center" data-aos="fade-up" data-aos-delay="200">
                <form method="GET" action="{{ route('berita') }}" class="flex gap-3">
                    ...
                    <select name="featured" class="px-4 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent" onchange="this.form.submit()">
                ...
                @foreach($beritas as $index => $berita)
                    <article class="news-card group bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        <div class="relative overflow-hidden">
                            ...
                            @else
                                <div class="w-full h-64 bg-gradient-to-br from-emerald-500 to-green-600 relative">
                                    <!-- Decorative pattern -->
                    ...
                    <a href="{{ route('berita.show', $berita->slug) }}" class="spectacular-btn text-white px-5 py-2 rounded-lg text-sm font-semibold hover:scale-105 transition-transform" style="background: linear-gradient(135deg, #10b981, #059669);">
