...
<section id="video" class="video-section section-spacing">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            @if(config('app.debug'))
            <div class="mb-4 p-4 bg-yellow-100 border border-yellow-300 rounded-lg text-sm">
                <strong>Debug Info:</strong><br>
                Raw YouTube URL: {{ $wisata->video_youtube }}<br>
                Extracted YouTube ID: {{ $youtubeId ?? 'Not found' }}<br>
            ...
            <div class="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-2xl bg-gray-900 relative">
                <iframe class="w-full h-full"
                        ...
                        onerror="console.log('Video failed to load'); this.style.display='none'; this.parentNode.querySelector('.video-fallback').style.display='flex';">
                </iframe>
