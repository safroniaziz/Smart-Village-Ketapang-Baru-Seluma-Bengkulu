...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 w-full pt-4 mb-6">
                            <div class="relative">
                ...
                <div class="lg:hidden mt-12 w-[80%] mx-auto">
                    <!-- Separator -->
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full pt-4">
                            <div class="relative">
