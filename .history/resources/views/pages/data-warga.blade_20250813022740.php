            ...
            <div class="flex-1 max-w-4xl relative z-10">
                <div class="text-center space-y-8">
                    ...
                    <div class="flex items-center justify-center space-x-3 mb-6" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-emerald-100">DATA WARGA</h2>
                            <p class="text-sm text-emerald-100">Kecamatan Semidang Alas Maras</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="inline-flex items-center bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                    ...
                    <!-- Description -->
                    <p class="text-lg lg:text-xl text-emerald-100 leading-relaxed max-w-2xl mx-auto font-light mb-12" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="800">
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            ...
                            <div class="text-sm text-emerald-100">Total Penduduk</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            ...
                            <div class="text-sm text-emerald-100">Dusun</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                            <div class="text-2xl font-black text-yellow-400">{{ $activeWarga }}</div>
                            <div class="text-sm text-emerald-100">Status Aktif</div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="py-16 bg-gradient-to-br from-gray-50 via-white to-emerald-50">
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between">
                    <div class="flex items-center gap-4 mb-4 sm:mb-0">
                        ...
                        <div>
                            ...
                            <p class="text-emerald-100 text-sm">Kelola dan cari data penduduk dengan mudah</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="text-right text-white">
                            <div class="text-2xl font-black">{{ $wargas->total() }}</div>
                            <div class="text-sm text-emerald-100">Total Warga</div>
                        </div>
            ...
            <div class="px-8 py-8 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 border-b border-gray-100">
                <!-- Main Search Bar -->
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="searchInput"
                               ...
                               class="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-lg bg-white shadow-sm">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <select id="genderFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="dusunFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="religionFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="statusFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white shadow-sm">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="exportData" class="px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 shadow-lg flex items-center gap-2">
