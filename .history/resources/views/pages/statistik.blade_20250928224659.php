        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-emerald-700">masyarakat Desa Ketapang Baru</span>
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-purple-700">masyarakat Desa Ketapang Baru</span>
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-green-700">{{ $totalKK }} kepala keluarga Desa Ketapang Baru</span>
...
<section id="aid" class="stat-target py-20 bg-white">
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-orange-700">Desa Ketapang Baru</span>
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-12" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
            <div class="p-8">
                <div class="text-center mb-8">
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Distribusi Penerima Bantuan per Dusun</h3>
                    <p class="text-gray-600">Persebaran penerima bantuan sosial berdasarkan wilayah dusun</p>
                </div>
                <div class="chart-container relative">
                    <div class="chart-loading" id="aidDusunChartLoading">
                        <i class="fas fa-spinner fa-spin mr-2"></i>
                        Memuat data distribusi...
                    </div>
                    <div class="h-80">
                        <canvas id="aidDusunChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200 shadow-lg">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-green-700">Total Penerima Bantuan:</span>
                        <span class="font-bold text-green-800">{{ number_format($totalAidRecipients) }} orang</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-green-700">Cakupan Bantuan:</span>
                        <span class="font-bold text-green-800">{{ $aidCoverage }}%</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-green-700">Program Aktif:</span>
                        <span class="font-bold text-green-800">{{ count($aidStats) }} jenis</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-blue-700">Pendidikan Tinggi:</span>
                        <span class="font-bold text-blue-800">{{ $higherEducationRate }}%</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-blue-700">Rata-rata Usia:</span>
                        <span class="font-bold text-blue-800">{{ number_format($averageAge, 1) }} tahun</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-blue-700">Total Penduduk:</span>
                        <span class="font-bold text-blue-800">{{ number_format($totalWarga) }} orang</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-6 border border-red-200 shadow-lg">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-red-700">Rasio Ketergantungan:</span>
                        <span class="font-bold text-red-800">{{ number_format($dependencyRatio, 1) }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-red-700">Kepadatan Penduduk:</span>
                        <span class="font-bold text-red-800">{{ $populationDensity }}/km²</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-red-700">Total KK:</span>
                        <span class="font-bold text-red-800">{{ number_format($totalKK) }} keluarga</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8 shadow-2xl border border-yellow-200">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Cakupan Bantuan Terbatas</h5>
                            <p class="text-sm text-gray-600">Hanya {{ $aidCoverage }}% penduduk yang menerima bantuan dari {{ number_format($totalWarga) }} total penduduk</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Distribusi Tidak Merata</h5>
                            <p class="text-sm text-gray-600">Penerima bantuan tersebar di {{ count($dusunStats) }} dusun dengan distribusi yang belum optimal</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Diversifikasi Program</h5>
                            <p class="text-sm text-gray-600">Hanya {{ count($aidStats) }} jenis program bantuan yang tersedia untuk {{ number_format($totalWarga) }} penduduk</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 shadow-2xl border border-blue-200">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Perluas Cakupan Bantuan</h5>
                            <p class="text-sm text-gray-600">Tingkatkan dari {{ $aidCoverage }}% menjadi minimal 50% dari {{ number_format($totalWarga) }} penduduk</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Diversifikasi Program</h5>
                            <p class="text-sm text-gray-600">Tambah program bantuan dari {{ count($aidStats) }} jenis menjadi minimal 8 jenis program</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h5 class="font-semibold text-gray-900 mb-1">Optimalkan Distribusi</h5>
                            <p class="text-sm text-gray-600">Pastikan distribusi merata di semua {{ count($dusunStats) }} dusun yang ada</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <p class="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    <span class="relative inline-block">
                        <span class="relative z-10 font-semibold text-slate-700">Desa Ketapang Baru</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartConfigs = {
        ...
        aidDusun: {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Penerima Bantuan per Dusun',
    ...
    // Special handling for aid dusun chart
    const aidDusunCanvas = document.getElementById('aidDusunChart');
    const aidDusunLoadingEl = document.getElementById('aidDusunChartLoading');

    if (aidDusunCanvas && chartConfigs.aidDusun) {
        // Show loading
        if (aidDusunLoadingEl) aidDusunLoadingEl.style.display = 'block';

        // Create chart with delay for smooth loading
        setTimeout(() => {
            new Chart(aidDusunCanvas, chartConfigs.aidDusun);

            // Hide loading after chart is created
            setTimeout(() => {
                if (aidDusunLoadingEl) aidDusunLoadingEl.style.display = 'none';
            }, 500);
        }, 600);
    }
