            ...
            <div class="space-y-8" data-aos="fade-right" data-aos-duration="800">
                <div>
                    ...
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Desa Ketapang Baru terletak di <strong>Kecamatan Semidang Alas Maras, Kabupaten Seluma, Provinsi Bengkulu</strong> dengan posisi geografis yang strategis. Dengan <strong>Kode Pos 38625</strong>, desa ini memiliki aksesibilitas yang baik ke pusat-pusat pemerintahan.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Batas wilayah desa meliputi <strong>Muara Timul di Utara</strong>, <strong>Talang Bersih di Timur</strong>, <strong>Padang Limau di Selatan</strong>, dan <strong>Laut di Barat</strong>. Posisi pesisir ini memberikan keunggulan dalam sektor perikanan dan pariwisata bahari.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        Jarak tempuh ke <strong>ibukota kecamatan sejauh 22 km</strong> dan ke <strong>ibukota kabupaten 3.5 km</strong> menjadikan desa ini mudah diakses untuk berbagai keperluan administrasi dan ekonomi.
                    </p>
                </div>
            </div>
                ...
                <div class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <div class="text-center p-4 bg-white/80 rounded-2xl shadow-sm">
                            ...
                            <p class="text-gray-600 text-xs">Muara Timul</p>
                        </div>
                        ...
                        <div class="text-center p-4 bg-white/80 rounded-2xl shadow-sm">
                            ...
                            <p class="text-gray-600 text-xs">Talang Bersih</p>
                        </div>
                        ...
                        <div class="text-center p-4 bg-white/80 rounded-2xl shadow-sm">
                            ...
                            <p class="text-gray-600 text-xs">Padang Limau</p>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-xs">22 km</p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-xs">3.5 km</p>
                                </div>
                            </div>
                        </div>
                    </div>
