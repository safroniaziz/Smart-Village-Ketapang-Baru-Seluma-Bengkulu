    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div id="form-pengaduan" class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
...
<!-- Complaint Status -->
<section id="cek-status" class="py-20 bg-white relative overflow-hidden">
    <!-- Background Decorations -->
...
<!-- Recent Complaints -->
<section id="pengaduan-terbaru" class="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
    <!-- Background Decorations -->
    <div class="absolute top-20 left-10 w-64 h-64 bg-gradient-to-br from-blue-200/20 to-indigo-300/20 rounded-full blur-3xl"></div>
    <div class="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-purple-200/20 to-pink-300/20 rounded-full blur-3xl"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <!-- Sub Navigation to Sections -->
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                <a href="#form-pengaduan" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105">
                    <i class="fas fa-edit mr-2"></i>Form Pengaduan
                </a>
                <a href="#cek-status" class="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-xl">
                    <i class="fas fa-search mr-2"></i>Cek Status
                </a>
                <a href="#pengaduan-terbaru" class="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-xl">
                    <i class="fas fa-list-alt mr-2"></i>Pengaduan Terbaru
                </a>
                <a href="#statistik" class="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-xl">
...
<!-- Statistics -->
<section id="statistik" class="py-20 bg-white relative overflow-hidden">
    <!-- Background Decorations -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <!-- Sub Navigation Tabs -->
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                <button class="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 active">
                ...
                <button class="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-xl">
                    <i class="fas fa-chart-pie mr-2"></i>Kategori
                </button>
                <button class="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 font-semibold rounded-xl border border-gray-200 shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-xl">
                    <i class="fas fa-trending-up mr-2"></i>Trend
                </button>
            </div>
        </div>
