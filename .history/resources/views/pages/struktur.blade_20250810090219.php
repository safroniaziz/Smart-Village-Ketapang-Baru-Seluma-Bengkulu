        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 mb-24" data-aos="fade-up" data-aos-duration="800">
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-8 shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-300 h-[420px] relative overflow-hidden">
                        <!-- Background decoration -->
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-indigo-600"></div>
                        <div class="absolute -top-4 -right-4 w-20 h-20 bg-blue-100 rounded-full opacity-20"></div>
                        <div class="absolute -bottom-4 -left-4 w-20 h-20 bg-blue-50 rounded-full opacity-30"></div>

                        <!-- Crown decoration -->
                        <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                            <div class="w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
                                <i class="fas fa-crown text-white text-sm"></i>
                            </div>
                        </div>

                        <div class="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl overflow-hidden border-4 border-blue-200 relative mt-4">
                            ...
                            <i class="fas fa-user-tie text-blue-600 text-3xl hidden"></i>
                        </div>

                        <div class="mb-4">
                            <div class="inline-flex items-center justify-center bg-blue-100 rounded-full px-4 py-2 mb-3">
                                <span class="text-blue-700 text-sm font-bold tracking-wide">KEPALA DESA</span>
                            </div>
                            <h3 class="text-2xl font-bold text-gray-900 mb-2">Zultan Alhara</h3>
                            <p class="text-gray-600 text-sm mb-3">Pemimpin Tertinggi Pemerintahan Desa</p>
                        </div>

                        <div class="border-t border-gray-100 pt-4">
                            <div class="flex items-center justify-center space-x-1 text-blue-600 mb-2">
                                <i class="fas fa-calendar-alt text-xs"></i>
                                <span class="text-xs font-semibold">Periode: 2021 - 2027</span>
                            </div>
                            <div class="inline-flex items-center bg-gradient-to-r from-blue-500/10 to-indigo-500/10 backdrop-blur-sm border border-blue-200 rounded-full px-3 py-1">
                                <i class="fas fa-shield-alt text-blue-500 text-xs mr-2"></i>
                                <span class="text-xs text-blue-700 font-medium">Desa Mandiri 2024</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 h-[350px] relative overflow-hidden">
                        <!-- Background decoration -->
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-500 to-green-600"></div>
                        <div class="absolute -top-3 -right-3 w-20 h-20 bg-green-100 rounded-full opacity-20"></div>
                        <div class="absolute -bottom-3 -left-3 w-12 h-12 bg-green-50 rounded-full opacity-30"></div>

                        <div class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl overflow-hidden border-4 border-green-200 relative mt-4">
                            <img src="{{ asset('images/struktur/merianto.jpg') }}"
                                 alt="Merianto"
                                 class="w-full h-full object-cover"
                                 onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                            <i class="fas fa-file-alt text-green-600 text-2xl hidden"></i>
                        </div>

                        <div class="mb-4">
                            <div class="inline-flex items-center justify-center bg-green-100 rounded-full px-3 py-1 mb-3">
                                <span class="text-green-700 text-xs font-bold tracking-wide">SEKRETARIS DESA</span>
                            </div>
                            <h4 class="text-xl font-bold text-gray-900 mb-2">Merianto</h4>
                            <p class="text-gray-600 text-sm mb-3">Koordinator Administrasi & Pemerintahan</p>
                        </div>

                        <div class="border-t border-gray-100 pt-3">
                            <div class="inline-flex items-center bg-gradient-to-r from-green-500/10 to-green-600/10 backdrop-blur-sm border border-green-200 rounded-full px-3 py-1">
                                <i class="fas fa-clipboard-list text-green-500 text-xs mr-2"></i>
                                <span class="text-xs text-green-700 font-medium">Administrasi & Dokumentasi</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- Kadun 1 -->
                        <div class="text-center">
                            <div class="bg-white rounded-xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 h-[280px] relative overflow-hidden">
                                <!-- Background decoration -->
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-emerald-600"></div>
                                <div class="absolute -top-2 -right-2 w-10 h-10 bg-emerald-100 rounded-full opacity-30"></div>

                                <div class="w-20 h-20 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-xl flex items-center justify-center mx-auto mb-4 overflow-hidden border-2 border-emerald-200 shadow-md">
                                    <img src="{{ asset('images/struktur/ajasseriani.jpg') }}"
                                         alt="Ajasseriani"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-map-marker-alt text-emerald-600 text-lg hidden"></i>
                                </div>

                                <div class="mb-3">
                                    <div class="inline-flex items-center justify-center bg-emerald-100 rounded-full px-3 py-1 mb-2">
                                        <span class="text-emerald-700 text-xs font-bold">KADUN 1</span>
                                    </div>
                                    <h5 class="font-bold text-lg text-gray-900 mb-1">Ajasseriani</h5>
                                    <p class="text-gray-600 text-sm">Kepala Dusun 1</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="bg-white rounded-xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 h-[280px] relative overflow-hidden">
                                <!-- Background decoration -->
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-500 to-cyan-600"></div>
                                <div class="absolute -top-2 -right-2 w-10 h-10 bg-cyan-100 rounded-full opacity-30"></div>

                                <div class="w-20 h-20 bg-gradient-to-br from-cyan-100 to-cyan-200 rounded-xl flex items-center justify-center mx-auto mb-4 overflow-hidden border-2 border-cyan-200 shadow-md">
                                    <img src="{{ asset('images/struktur/meri.jpg') }}"
                                         alt="Meri Kusnidi"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-map-marker-alt text-cyan-600 text-lg hidden"></i>
                                </div>

                                <div class="mb-3">
                                    <div class="inline-flex items-center justify-center bg-cyan-100 rounded-full px-3 py-1 mb-2">
                                        <span class="text-cyan-700 text-xs font-bold">KADUN 2</span>
                                    </div>
                                    <h5 class="font-bold text-lg text-gray-900 mb-1">Meri Kusnidi</h5>
                                    <p class="text-gray-600 text-sm">Kepala Dusun 2</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="bg-white rounded-xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 h-[280px] relative overflow-hidden">
                                ...
                                <div class="absolute -top-2 -right-2 w-10 h-10 bg-indigo-100 rounded-full opacity-30"></div>

                                <div class="w-20 h-20 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-xl flex items-center justify-center mx-auto mb-4 overflow-hidden border-2 border-indigo-200 shadow-md">
                                    <img src="{{ asset('images/struktur/basri.jpg') }}"
                                         alt="Basri"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-map-marker-alt text-indigo-600 text-lg hidden"></i>
                                </div>

                                <div class="mb-3">
                                    <div class="inline-flex items-center justify-center bg-indigo-100 rounded-full px-3 py-1 mb-2">
                                        <span class="text-indigo-700 text-xs font-bold">KADUN 3</span>
                                    </div>
                                    <h5 class="font-bold text-lg text-gray-900 mb-1">Basri</h5>
                                    <p class="text-gray-600 text-sm">Kepala Dusun 3</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center mb-12">
                        <div class="relative">
                                                        <div class="bg-white rounded-2xl p-6 text-center shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-300 min-w-[220px] h-[400px] relative overflow-hidden">
                                <!-- Background decoration -->
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-500 to-purple-700"></div>
                                <div class="absolute -top-4 -right-4 w-20 h-20 bg-purple-100 rounded-full opacity-20"></div>
                                <div class="absolute -bottom-4 -left-4 w-12 h-12 bg-purple-50 rounded-full opacity-30"></div>
                                ...
                                <div class="w-20 h-20 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden border-4 border-purple-200 shadow-lg relative">
                                    <img src="{{ asset('images/struktur/bahirman.jpg') }}"
                                         alt="Bahirman"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                    <i class="fas fa-crown text-purple-600 text-2xl hidden"></i>
                                </div>

                                <div class="mb-4">
                                    <div class="inline-flex items-center justify-center bg-purple-100 rounded-full px-3 py-1 mb-3">
                                        <span class="text-purple-700 text-xs font-bold tracking-wide">KETUA BPD</span>
                                    </div>
                                    <h4 class="text-xl font-bold text-gray-900 mb-1">Bahirman</h4>
                                    <p class="text-gray-600 text-sm">Badan Permusyawaratan Desa</p>
                                </div>

                                <div class="border-t border-gray-100 pt-4">
                                    <div class="flex items-center justify-center space-x-1 text-purple-600">
                    ...
                    <div class="flex justify-center gap-32 mb-12">
                        <!-- Wakil Ketua -->
                        <div class="relative">
                            <div class="bg-white rounded-2xl p-5 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 min-w-[190px] h-[320px] relative overflow-hidden">
                                <!-- Background decoration -->
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-indigo-500 to-indigo-600"></div>
                                <div class="absolute -top-3 -right-3 w-12 h-12 bg-indigo-100 rounded-full opacity-20"></div>

                                <div class="w-20 h-20 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-xl flex items-center justify-center mx-auto mb-4 overflow-hidden border-3 border-indigo-200 shadow-md">
                                    <img src="{{ asset('images/struktur/halintarman.jpg') }}"
                                         alt="Halintarman"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-user-friends text-indigo-600 text-xl hidden"></i>
                                </div>

                                <div class="mb-3">
                                    <div class="inline-flex items-center justify-center bg-indigo-100 rounded-full px-3 py-1 mb-2">
                                        <span class="text-indigo-700 text-xs font-bold">WAKIL KETUA</span>
                                    </div>
                                    <h4 class="text-lg font-bold text-gray-900 mb-1">Halintarman</h4>
                                    <p class="text-gray-600 text-xs">Wakil Ketua BPD</p>
                                </div>
                            </div>
                        ...
                        <div class="relative">
                                ...
                                <!-- Background decoration -->
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-500 to-green-600"></div>
                                <div class="absolute -top-3 -right-3 w-12 h-12 bg-green-100 rounded-full opacity-20"></div>

                                <div class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-200 rounded-xl flex items-center justify-center mx-auto mb-4 overflow-hidden border-3 border-green-200 shadow-md">
                                    <img src="{{ asset('images/struktur/kebat.jpg') }}"
                                         alt="Kebat S"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-edit text-green-600 text-xl hidden"></i>
                                </div>

                                <div class="mb-3">
                                    <div class="inline-flex items-center justify-center bg-green-100 rounded-full px-3 py-1 mb-2">
                                        <span class="text-green-700 text-xs font-bold">SEKRETARIS</span>
                                    </div>
                                    <h4 class="text-lg font-bold text-gray-900 mb-1">Kebat S</h4>
                                    <p class="text-gray-600 text-xs">Sekretaris BPD</p>
                                </div>
                            </div>
