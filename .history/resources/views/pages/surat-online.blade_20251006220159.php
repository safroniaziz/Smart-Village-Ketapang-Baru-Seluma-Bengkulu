...
<div id="suratModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-blue-900/80 via-purple-900/70 to-green-900/80 backdrop-blur-sm transition-all duration-500 opacity-0" id="modalBackdrop">
        <!-- Animated particles background -->
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-4 -left-4 w-72 h-72 bg-blue-400/20 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute -top-4 -right-4 w-72 h-72 bg-purple-400/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s"></div>
            <div class="absolute -bottom-4 -left-4 w-72 h-72 bg-green-400/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s"></div>
            <div class="absolute -bottom-4 -right-4 w-72 h-72 bg-indigo-400/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 3s"></div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] p-4 relative z-10">
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden transform scale-90 transition-all duration-500 border border-white/20 relative" id="modalContent">
            
            <!-- Gradient overlay -->
            <div class="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-white/50 to-green-50/50 pointer-events-none"></div>
            
            <!-- Enhanced Header with gradient -->
            <div class="relative bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 p-6">
                <!-- Decorative elements -->
                <div class="absolute inset-0 bg-gradient-to-r from-blue-600/90 via-purple-600/90 to-green-600/90"></div>
                <div class="absolute top-0 left-0 w-full h-full">
                    ...
                    <div class="absolute bottom-4 left-1/2 w-24 h-24 bg-white/10 rounded-full blur-xl"></div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-white mb-1 flex items-center">
                                ...
                                <div class="ml-3 px-3 py-1 bg-yellow-400/20 backdrop-blur-sm rounded-full">
                                    <span class="text-yellow-200 text-sm font-semibold">✨ Digital</span>
                                </div>
                            </h3>
                            <p class="text-blue-100">Proses pengajuan surat yang mudah, cepat, dan aman</p>
                        </div>
                    </div>
                    <button onclick="closeSuratModal()" class="text-white/80 hover:text-white text-xl transition-all duration-300 hover:bg-white/10 rounded-full w-12 h-12 flex items-center justify-center backdrop-blur-sm border border-white/20 hover:border-white/40 hover:scale-110">
            ...
            <!-- Enhanced Modal Body -->
            <div class="relative p-8 overflow-y-auto max-h-[calc(90vh-200px)] bg-gradient-to-br from-gray-50/80 to-blue-50/80 backdrop-blur-sm">
                <!-- Background decoration -->
                <div class="absolute inset-0 overflow-hidden pointer-events-none">
                    <div class="absolute top-10 right-10 w-32 h-32 bg-gradient-to-br from-blue-400/10 to-purple-400/10 rounded-full blur-2xl"></div>
                    <div class="absolute bottom-10 left-10 w-40 h-40 bg-gradient-to-br from-green-400/10 to-blue-400/10 rounded-full blur-2xl"></div>
                </div>
                
                <div id="modalSuratMsg" class="hidden mb-6 rounded-2xl border p-4 text-sm backdrop-blur-sm shadow-lg"></div>

                <!-- Step 1: Enhanced Sub Jenis Selection -->
                <div id="modalStepSelectSubJenis" class="relative z-10">
                    <div class="mb-8 text-center">
                        ...
                        <h4 class="text-2xl font-bold bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent mb-3">Jenis Surat Tersedia</h4>
                        <p class="text-gray-600 max-w-2xl mx-auto">Pilih jenis surat yang sesuai dengan kebutuhan Anda. Setiap jenis memiliki form yang disesuaikan.</p>
                    </div>
                    <div id="modalSubJenisList" class="grid grid-cols-1 md:grid-cols-2 gap-6"></div>
                </div>

                <!-- Step 2: Enhanced Form -->
                <div id="modalStepFormKhusus" class="hidden relative z-10">
                    <div class="mb-8 text-center">
                        <div class="inline-flex items-center bg-gradient-to-r from-green-100 to-blue-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                            <i class="fas fa-edit mr-2 text-green-600"></i>
                            Form Pengajuan
                        </div>
                        <h4 class="text-2xl font-bold bg-gradient-to-r from-green-900 to-blue-900 bg-clip-text text-transparent mb-3" id="modalFormTitle">Lengkapi Data Pengajuan</h4>
                        <p class="text-gray-600 max-w-2xl mx-auto">Pastikan semua data yang Anda masukkan sudah benar untuk mempercepat proses verifikasi</p>
                        <button type="button" id="modalBackToSubJenis" class="inline-flex items-center bg-white/70 backdrop-blur-sm hover:bg-white text-blue-600 hover:text-blue-700 text-sm mt-4 font-medium transition-all duration-300 px-4 py-2 rounded-xl border border-blue-200 hover:border-blue-300 shadow-sm hover:shadow-md">
                    ...
                    <form id="modalFormAjukanSurat" class="space-y-6" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="bg-gradient-to-r from-blue-50/80 to-green-50/80 backdrop-blur-sm rounded-2xl p-8 mt-8 border border-blue-200/50 shadow-lg">
                            <div class="text-center mb-6">
                                <div class="bg-gradient-to-r from-blue-600 to-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-xl">
                                    <i class="fas fa-rocket text-white text-xl"></i>
                                </div>
                                <h5 class="text-lg font-bold text-gray-900 mb-2">Siap Mengirim Pengajuan?</h5>
                                <p class="text-sm text-gray-600 max-w-lg mx-auto">
                                    <i class="fas fa-shield-alt mr-2 text-green-500"></i>
                                    Data Anda akan dienkripsi dan diproses secara aman. Notifikasi akan dikirim ke WhatsApp Anda.
                                </p>
                            </div>
                            
                            <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                                <button type="button" onclick="closeSuratModal()" class="px-8 py-4 bg-white/80 backdrop-blur-sm border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-white hover:border-gray-400 font-semibold transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                                    <i class="fas fa-times mr-2"></i>
                                    Batal
                                </button>
                                <button type="submit" class="px-10 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 text-white rounded-xl hover:from-blue-700 hover:via-purple-700 hover:to-green-700 font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl relative overflow-hidden">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showModalStep(step) {
        ...
        if (step === 1) {
            step1.className = 'w-10 h-10 rounded-full bg-white text-blue-600 font-bold flex items-center justify-center mr-3 shadow-lg';
            step1.innerHTML = '<i class="fas fa-list"></i>';
            step2.className = 'w-10 h-10 rounded-full bg-white/20 text-white font-bold flex items-center justify-center mr-3 transition-all duration-300';
            step2.innerHTML = '<i class="fas fa-edit"></i>';
            progressBar.style.width = '50%';
        } else if (step === 2) {
            step1.className = 'w-10 h-10 rounded-full bg-green-500 text-white font-bold flex items-center justify-center mr-3 shadow-lg';
            step1.innerHTML = '<i class="fas fa-check"></i>';
            step2.className = 'w-10 h-10 rounded-full bg-white text-blue-600 font-bold flex items-center justify-center mr-3 shadow-lg';
            step2.innerHTML = '<i class="fas fa-edit"></i>';
            progressBar.style.width = '100%';
            progressBar.className = 'h-full bg-gradient-to-r from-green-400 to-blue-500 rounded-full transition-all duration-700 shadow-lg';
        }
    }
