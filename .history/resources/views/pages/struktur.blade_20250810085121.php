    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 mb-24" data-aos="fade-up" data-aos-duration="800">
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 h-[320px] relative">
                        <div class="w-20 h-20 bg-white/20 rounded-xl border-2 border-white/30 flex items-center justify-center mx-auto mb-4 shadow-lg overflow-hidden">
                            <img src="{{ asset('images/struktur/merianto.jpg') }}"
                                 alt="Merianto"
                                 class="w-full h-full object-cover"
                                 onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                            <i class="fas fa-file-alt text-white text-2xl hidden"></i>
                        </div>
