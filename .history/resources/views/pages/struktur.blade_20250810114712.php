        ...
        <section class="mt-16" data-aos="fade-up" data-aos-duration="800">
            <div class="w-[80%] max-w-none mx-auto">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Ringkasan profesional peran inti Pemerintah Desa dan BPD.</p>
                </div>
...
$(document).ready(function() {
    ...
    // Tab toggle for Tugas & Wewenang
    $('#tab-desa').on('click', function() {
        $('#tab-desa').addClass('bg-white shadow text-gray-900');
        $('#tab-bpd').removeClass('bg-white shadow text-gray-900').addClass('text-gray-600');
        $('#content-desa').removeClass('hidden');
        $('#content-bpd').addClass('hidden');
    });

    $('#tab-bpd').on('click', function() {
        $('#tab-bpd').addClass('bg-white shadow text-gray-900');
        $('#tab-desa').removeClass('bg-white shadow text-gray-900').addClass('text-gray-600');
        $('#content-bpd').removeClass('hidden');
        $('#content-desa').addClass('hidden');
    });
});
</script>
@endpush
