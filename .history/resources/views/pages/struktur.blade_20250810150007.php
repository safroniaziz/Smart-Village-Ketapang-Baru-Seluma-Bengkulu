            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <!-- Branch from Ketua BPD to Wakil & Sekretaris -->
                        <div class="hidden lg:block relative w-full max-w-xl mt-4">
                            <div class="absolute left-1/2 -top-6 -translate-x-1/2 w-px h-6 bg-purple-400"></div>
                            <div class="h-px bg-purple-300"></div>
                        </div>
                        <div class="hidden lg:block grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 max-w-xl w-full pt-4">
                            <div class="relative">
                        ...
                        <!-- Branch from Wakil & Sekretaris to Anggota -->
                        <div class="hidden lg:block relative w-full max-w-4xl mt-6">
                            <div class="absolute left-1/2 -top-6 -translate-x-1/2 w-px h-6 bg-purple-400"></div>
                            <div class="h-px bg-purple-300"></div>
                        </div>
                        <div class="hidden lg:block grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 max-w-4xl w-full pt-4">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-300"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/susti.jpg') }}" alt="Anggota BPD" class="w-20 h-20 lg:w-28 lg:h-28 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                    <h6 class="font-bold text-gray-900 mb-1 text-sm lg:text-base">Anggota BPD</h6>
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-300"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/dhesty.jpg') }}" alt="Anggota BPD" class="w-20 h-20 lg:w-28 lg:h-28 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                    <h6 class="font-bold text-gray-900 mb-1 text-sm lg:text-base">Anggota BPD</h6>
