                    ...
                    <div class="group relative bg-white rounded-xl p-4 shadow-md border border-gray-100 hover:shadow-lg hover:scale-[1.01] transition-all duration-300 overflow-hidden">
                        ...
                        <div class="relative flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="relative">
                                    <div class="w-10 h-10 bg-gradient-to-br {{ $program['colors']['gradient'] }} rounded-lg flex items-center justify-center shadow-md">
                                        <i class="{{ $program['icon'] }} text-white text-sm"></i>
                                    </div>
                            ...
                            <div class="text-right">
                                <div class="text-lg font-black {{ $program['colors']['amount'] }}">{{ number_format($program['unique_recipients']) }}</div>
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-3">
                            <div class="text-center">
                                <div class="text-sm font-bold {{ $program['colors']['amount'] }}">{{ $program['percentage'] }}%</div>
                                <div class="text-xs {{ $program['colors']['subtext'] }}">Cakupan</div>
                            </div>
                            <div class="text-center">
                                <div class="text-sm font-bold {{ $program['colors']['amount'] }}">{{ number_format($program['total_recipients']) }}</div>
                                <div class="text-xs {{ $program['colors']['subtext'] }}">Total</div>
                            </div>
                            <div class="text-center">
                                <div class="text-sm font-bold {{ $program['colors']['amount'] }}">Rp {{ $program['amount'] }}</div>
