...
@section('content')
<!-- Hero Section -->
<div class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" style="background: linear-gradient(135deg, #059669 0%, #047857 50%, #065f46 100%);">
    <!-- Background Pattern -->
...
<div class="py-16 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between">
                    <div class="flex items-center gap-4 mb-4 sm:mb-0">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">Kelola dan cari data penduduk dengan mudah</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="text-right text-white">
                            <div class="text-2xl font-black">{{ $wargas->total() }}</div>
                            <div class="text-sm text-green-100">Total Warga</div>
                        </div>
            ...
            <div class="px-8 py-8 bg-gradient-to-br from-gray-50 to-slate-50 border-b border-gray-100">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="searchInput"
                               ...
                               class="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-transparent text-lg bg-white shadow-sm">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <select id="genderFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="dusunFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="religionFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white shadow-sm">
                    ...
                    <div>
                        ...
                        <select id="statusFilter" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white shadow-sm">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="exportData" class="px-6 py-3 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-all duration-200 shadow-lg flex items-center gap-2">
            ...
            <div class="relative">
                ...
                <div id="loadingState" class="hidden absolute inset-0 bg-white/80 backdrop-blur-sm z-10 flex items-center justify-center">
                    <div class="inline-flex items-center gap-3 text-green-600 bg-white rounded-2xl px-6 py-4 shadow-lg">
                ...
                <div id="tableContent">
                    ...
                    <!-- Pagination -->
                    <div id="paginationContainer" class="px-6 py-6 bg-gray-50 border-t border-gray-100">
                        @if($wargas->hasPages())
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
