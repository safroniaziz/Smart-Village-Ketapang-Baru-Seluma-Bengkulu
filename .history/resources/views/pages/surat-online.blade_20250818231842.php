...
<!-- Ajukan Surat CTA Section -->
<section id="ajukan-surat" class="section-nav py-16 bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
    <!-- Floating Decorations -->
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <!-- Badge -->
            <div class="inline-flex items-center bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 px-4 py-2 rounded-full text-sm font-semibold mb-6" data-aos="fade-up">
                <i class="fas fa-file-signature mr-2 text-blue-600"></i>
                Layanan Digital
            </div>

            <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-6" data-aos="fade-up">
                <span class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Ajukan Surat</span><br>
                <span class="text-gray-700">Online Sekarang</span>
            </h2>

            <p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                Proses pengajuan surat yang mudah, cepat, dan transparan. Tanpa antri, tanpa ribet.
            </p>

            <!-- Quick Stats -->
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
                    <div class="text-2xl font-bold text-blue-600">15+</div>
                    <div class="text-sm text-gray-600">Jenis Surat</div>
                </div>
                <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
                ...
                <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
                    ...
                    <div class="text-sm text-gray-600">Hari Proses</div>
                </div>
                <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/50">
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                <button onclick="openSuratModal()" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl text-lg">
                    <i class="fas fa-file-plus mr-3"></i>Mulai Pengajuan Surat
                </button>
                <p class="text-sm text-gray-500 mt-4">Gratis • Cepat • Mudah</p>
            </div>
        </div>
    </div>
</section>
...
<div id="suratModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden opacity-0 transition-all duration-300">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden transform scale-95 transition-all duration-300" id="modalContent">
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 flex items-center justify-between">
                <div class="flex items-center">
                    <div class="bg-white/20 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                        <i class="fas fa-file-signature text-white"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold">Pengajuan Surat Online</h3>
                        <p class="text-blue-100 text-sm">Ikuti langkah-langkah berikut</p>
                    </div>
                </div>
                <button onclick="closeSuratModal()" class="text-white/70 hover:text-white p-2 hover:bg-white/10 rounded-lg transition-colors">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                <div id="modalSuratMsg" class="hidden mb-4 rounded-xl border p-4 text-sm"></div>

                <!-- Step 1: Pilih Jenis Surat -->
                <div id="modalStepSelectJenis">
                    <div class="text-center mb-6">
                        <div class="flex items-center justify-center mb-4">
                            <div class="bg-blue-100 rounded-full w-8 h-8 flex items-center justify-center text-blue-600 font-bold mr-3">1</div>
                            <h4 class="text-lg font-bold text-gray-900">Pilih Kategori Surat</h4>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button type="button" class="modal-jenis-surat-btn p-4 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 text-left" data-jenis="Surat Pengantar">
                            <div class="flex items-center">
                                <div class="bg-blue-100 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                                    <i class="fas fa-envelope text-blue-600"></i>
                                </div>
                                <div>
                                    <h5 class="font-semibold text-gray-900">Surat Pengantar</h5>
                                    <p class="text-xs text-gray-600">KTP, KK, Nikah, dll</p>
                                </div>
                            </div>
                        </button>

                        <button type="button" class="modal-jenis-surat-btn p-4 border-2 border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all duration-200 text-left" data-jenis="Surat Keterangan">
                            <div class="flex items-center">
                                <div class="bg-green-100 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                                    <i class="fas fa-file-alt text-green-600"></i>
                                </div>
                                <div>
                                    <h5 class="font-semibold text-gray-900">Surat Keterangan</h5>
                                    <p class="text-xs text-gray-600">Domisili, Usaha, dll</p>
                                </div>
                            </div>
                        </button>

                        <button type="button" class="modal-jenis-surat-btn p-4 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition-all duration-200 text-left" data-jenis="Surat Izin">
                            <div class="flex items-center">
                                <div class="bg-cyan-100 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                                    <i class="fas fa-clipboard-check text-cyan-600"></i>
                                </div>
                                <div>
                                    <h5 class="font-semibold text-gray-900">Surat Izin</h5>
                                    <p class="text-xs text-gray-600">Keramaian, Usaha, dll</p>
                                </div>
                            </div>
                        </button>

                        <button type="button" class="modal-jenis-surat-btn p-4 border-2 border-gray-200 rounded-xl hover:border-red-500 hover:bg-red-50 transition-all duration-200 text-left" data-jenis="Surat Pernyataan">
                            <div class="flex items-center">
                                <div class="bg-red-100 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                                    <i class="fas fa-handshake text-red-600"></i>
                                </div>
                                <div>
                                    <h5 class="font-semibold text-gray-900">Surat Pernyataan</h5>
                                    <p class="text-xs text-gray-600">Ahli Waris, dll</p>
                                </div>
                            </div>
                        </button>

                        <button type="button" class="modal-jenis-surat-btn p-4 border-2 border-gray-200 rounded-xl hover:border-yellow-500 hover:bg-yellow-50 transition-all duration-200 text-left" data-jenis="Surat Rekomendasi">
                            <div class="flex items-center">
                                <div class="bg-yellow-100 rounded-lg w-10 h-10 flex items-center justify-center mr-3">
                                    <i class="fas fa-thumbs-up text-yellow-600"></i>
                                </div>
                                <div>
                                    <h5 class="font-semibold text-gray-900">Surat Rekomendasi</h5>
                                    <p class="text-xs text-gray-600">Beasiswa, Kerja, dll</p>
                                </div>
                            </div>
                        </button>
                    </div>
                ...
                <div id="modalStepSelectSubJenis" class="hidden">
                    <div class="text-center mb-6">
                        <div class="flex items-center justify-center mb-4">
                            <div class="bg-blue-100 rounded-full w-8 h-8 flex items-center justify-center text-blue-600 font-bold mr-3">2</div>
                            <h4 class="text-lg font-bold text-gray-900">Pilih Jenis Surat Spesifik</h4>
                        </div>
                        <button type="button" id="modalBackToJenis" class="text-blue-600 hover:text-blue-800 underline text-sm">
                            <i class="fas fa-arrow-left mr-1"></i>Kembali ke pilihan kategori
                        </button>
                    </div>
                    <div id="modalSubJenisList" class="grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                </div>
                ...
                <div id="modalStepFormKhusus" class="hidden">
                    <div class="text-center mb-6">
                        <div class="flex items-center justify-center mb-4">
                            <div class="bg-blue-100 rounded-full w-8 h-8 flex items-center justify-center text-blue-600 font-bold mr-3">3</div>
                            <h4 class="text-lg font-bold text-gray-900">Isi Data Pengajuan</h4>
                        </div>
                        <p class="text-gray-600 text-sm" id="modalFormTitle">Lengkapi form sesuai jenis surat yang dipilih</p>
                        <button type="button" id="modalBackToSubJenis" class="text-blue-600 hover:text-blue-800 underline text-sm mt-2">
                            <i class="fas fa-arrow-left mr-1"></i>Kembali ke pilihan surat
                        </button>
                    </div>

                    <form id="modalFormAjukanSurat" class="space-y-4" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex items-center justify-between gap-4 pt-4 border-t">
                            <button type="submit" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300">
                                <i class="fas fa-paper-plane mr-2"></i>Kirim Pengajuan
                            </button>
                            <div id="modalSuratSuccess" class="hidden text-sm text-green-800 bg-green-50 border border-green-200 rounded-lg px-4 py-3">
                                <div class="flex items-center">
                                    <i class="fas fa-check-circle mr-2"></i>
                                    <div>
                                        <span class="font-semibold">Berhasil!</span><br>
                                        <span>Tracking: </span>
                                        <span id="modalSuratTrack" class="font-mono font-bold text-blue-600"></span>
                                        <button id="modalCopySuratTrack" type="button" class="ml-2 text-blue-600 underline hover:text-blue-800">Salin</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalStepSelectJenis = document.getElementById('modalStepSelectJenis');
    ...
    // Modal functions
    window.openSuratModal = function() {
    ...
    // Modal navigation
    document.getElementById('modalBackToJenis')?.addEventListener('click', () => showModalStep(1));
    document.getElementById('modalBackToSubJenis')?.addEventListener('click', () => showModalStep(2));

    function showModalStep(step) {
        modalStepSelectJenis.classList.add('hidden');
        modalStepSelectSubJenis.classList.add('hidden');
        modalStepFormKhusus.classList.add('hidden');

        if (step === 1) {
            modalStepSelectJenis.classList.remove('hidden');
            currentModalStep = 1;
        } else if (step === 2) {
    ...
    document.querySelectorAll('.modal-jenis-surat-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            selectedJenis = this.dataset.jenis;
            showModalSubJenis(selectedJenis);
            showModalStep(2);
        });
    });
    ...
    function showModalSubJenis(jenis) {
        ...
        modalSubJenisList.innerHTML = subJenisItems.map(item => `
            <button type="button" class="modal-sub-jenis-btn p-3 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 text-left" data-subjenis="${item.id}">
                <div class="flex items-center">
                    <div class="bg-blue-100 rounded-lg w-8 h-8 flex items-center justify-center mr-3">
                        <i class="${item.icon} text-blue-600 text-sm"></i>
                    </div>
                    <div>
                        <h6 class="font-semibold text-gray-900 text-sm">${item.name}</h6>
    ...
    function generateModalForm(subJenis) {
        ...
        const fieldsHtml = template.fields.map(field => {
            ...
            if (field.type === 'select') {
                ...
                inputHtml = `<select name="${field.name}" ${field.required ? 'required' : ''} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                    <option value="">Pilih ${field.label.toLowerCase()}</option>
                    ${options}
                </select>`;
            } else if (field.type === 'textarea') {
                inputHtml = `<textarea name="${field.name}" ${field.required ? 'required' : ''} rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" placeholder="Masukkan ${field.label.toLowerCase()}..."></textarea>`;
                ...
                inputHtml = `
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors">
                        ...
                        <label for="modalFileInput${field.name}" class="cursor-pointer">
                            <i class="fas fa-cloud-upload-alt text-2xl text-gray-400 mb-2"></i>
                            <p class="text-gray-600 text-sm mb-1">Klik untuk upload</p>
                            <p class="text-xs text-gray-500">PDF, JPG, PNG (maks 5MB)</p>
                        </label>
                    </div>
                `;
            } else {
                inputHtml = `<input type="${field.type}" name="${field.name}" ${field.required ? 'required' : ''} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" placeholder="Masukkan ${field.label.toLowerCase()}...">`;
            }
        ...
        modalDynamicFormContainer.innerHTML = `
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <h5 class="font-semibold text-blue-900 mb-1 text-sm flex items-center">
                    <i class="fas fa-info-circle mr-2"></i>${template.title}
                </h5>
                <p class="text-xs text-blue-800">Field dengan tanda (*) wajib diisi.</p>
            </div>
            ${fieldsHtml}
        `;
    }
