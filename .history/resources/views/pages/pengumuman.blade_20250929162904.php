        ...
        particlesJS('particles-pengumuman', {
            particles: {
                ...
                opacity: {
                    value: 0.4,
                    random: true,
                    anim: { enable: true, speed: 3, opacity_min: 0.1, sync: false }
                },
                size: {
                    value: 6,
                    random: true,
            ...
            interactivity: {
                ...
                modes: {
                    ...
                    bubble: { distance: 400, size: 20, duration: 4, opacity: 1, speed: 5 },
