        ...
        <div class="relative left-1/2 right-1/2 -mx-[50vw] w-screen">
            <section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50" data-aos="fade-up" data-aos-duration="200" data-aos-offset="20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Card: Kepala Desa -->
                    <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2" data-aos="fade-up" data-aos-duration="150" data-aos-delay="50">
                        <!-- Header -->
                        <div class="flex items-center gap-4 mb-8">
                            <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white shadow-2xl group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-crown text-3xl"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-3xl text-gray-900 mb-2">👑 Kepala Desa</h4>
                                <p class="text-blue-800 font-semibold text-lg">Pemimpin Pemerintahan Desa</p>
                            </div>
                        </div>

                        <!-- Divider -->
                        <div class="w-full h-px bg-gradient-to-r from-transparent via-blue-400 to-transparent mb-8"></div>
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h5 class="text-2xl font-bold text-blue-800">TUGAS</h5>
                            </div>
                            <div class="space-y-4">
                                <div class="flex items-start gap-4 p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1 flex-shrink-0">1</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1">Penyelenggaraan Pemerintahan</h6>
                                        <p class="text-gray-700 text-sm leading-relaxed">Memimpin dan mengkoordinasikan seluruh kegiatan pemerintahan desa secara efektif dan efisien</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4 p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1 flex-shrink-0">2</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1">Pembangunan Desa</h6>
                                        <p class="text-gray-700 text-sm leading-relaxed">Menyusun, melaksanakan, dan mengawasi program pembangunan sesuai RPJMDes dan RKPDes</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4 p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1 flex-shrink-0">3</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1">Pelayanan Publik</h6>
                                        <p class="text-gray-700 text-sm leading-relaxed">Memastikan pelayanan administrasi, kependudukan, dan kemasyarakatan berjalan optimal</p>
                                    </div>
                                </div>
                            </div>
                        </div>
