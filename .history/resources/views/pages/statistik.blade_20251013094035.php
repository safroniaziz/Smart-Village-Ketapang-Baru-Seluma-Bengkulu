...
@section('title', 'Statistik Desa - Smart Village ' . ($villageName ?? 'Ketapang Baru'))
            ...
            <div class="lg:w-[480px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="300">
                ...
                <div class="info-card group relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-6 shadow-2xl overflow-hidden hover:shadow-3xl hover:scale-105 hover:border-blue-300/70 cursor-pointer" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="relative z-10 space-y-3 mb-4">
                        ...
                        <!-- Row 2: 1 column full width - Gender Distribution -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                ...
                <p class="text-blue-100 text-sm leading-relaxed">
                    Distribusi gender {{ $totalWarga > 0 ? round((($genderStats['Laki-laki'] ?? 0) / $totalWarga) * 100, 1) : 0 }}% laki-laki vs
                    {{ $totalWarga > 0 ? round((($genderStats['Perempuan'] ?? 0) / $totalWarga) * 100, 1) : 0 }}% perempuan menunjukkan komposisi yang ideal.
                </p>
            </div>
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white">
                ...
                <p class="text-emerald-100 text-sm leading-relaxed">
                    {{ $totalWarga > 0 ? round(((($ageStats['Dewasa'] ?? 0) + ($ageStats['Remaja'] ?? 0)) / $totalWarga) * 100, 1) : 0 }}%
...
<section id="dusun" class="stat-target py-20 pb-32 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
    ...
    <div class="relative w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Comparison Matrix -->
        <div class="mt-16 bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
            <div class="p-8">
                <div class="text-center mb-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Matriks Perbandingan Antar Dusun</h3>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
                                <th class="text-left p-4 font-semibold text-gray-700 text-sm">
                                    <i class="fas fa-map-marker-alt mr-2 text-indigo-500"></i>Dusun
                                </th>
                                <th class="text-center p-4 font-semibold text-gray-700 text-sm">
                                    <i class="fas fa-users mr-2 text-blue-500"></i>Populasi
                                </th>
                                <th class="text-center p-4 font-semibold text-gray-700 text-sm">
                                    <i class="fas fa-home mr-2 text-emerald-500"></i>KK
                                </th>
                                <th class="text-center p-4 font-semibold text-gray-700 text-sm">
                                    <i class="fas fa-hand-holding-heart mr-2 text-orange-500"></i>Penerima Bantuan
                                </th>
                                <th class="text-center p-4 font-semibold text-gray-700 text-sm">
                                    <i class="fas fa-percentage mr-2 text-purple-500"></i>Persentase
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 text-center border border-blue-200">
                        <div class="text-2xl font-bold text-blue-700 mb-1">{{ array_sum($dusunStats) }}</div>
                        <div class="text-blue-600 text-sm">Total Populasi</div>
                    </div>
                    <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-4 text-center border border-emerald-200">
                        <div class="text-2xl font-bold text-emerald-700 mb-1">{{ round($totalEstimatedKK) }}</div>
                        <div class="text-emerald-600 text-sm">Total KK</div>
                    </div>
                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 text-center border border-orange-200">
                        <div class="text-2xl font-bold text-orange-700 mb-1">{{ $totalAidRecipients }}</div>
                        <div class="text-orange-600 text-sm">Penerima Bantuan</div>
                    </div>
                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 text-center border border-purple-200">
                        <div class="text-2xl font-bold text-purple-700 mb-1">{{ $overallAidPercentage }}%</div>
                        <div class="text-purple-600 text-sm">Cakupan Bantuan</div>
                    </div>
                </div>
            </div>
        </div>
...
<section id="aid" class="stat-target py-20 bg-white">
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-black">{{ $totalActivePrograms }}</div>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-violet-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-black">{{ $totalAidValueFormatted }}</div>
                        <div class="text-sm text-purple-200">Total Nilai</div>
                    </div>
                </div>
                <div class="text-purple-100 text-sm">
                    Total nilai bantuan sosial yang telah disalurkan
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-black">{{ $averageAidFormatted }}</div>
                        <div class="text-sm text-orange-200">Rata-rata/Penerima</div>
                    </div>
                </div>
                <div class="text-orange-100 text-sm">
                    Rata-rata nilai bantuan yang diterima per penerima
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            @if($recipientsByProgram->isNotEmpty())
            <div class="mt-16" data-aos="fade-up" data-aos-duration="800">
                <div class="text-center mb-8">
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Daftar Penerima Bantuan</h3>
                    <p class="text-gray-600">Detail penerima bantuan per program</p>
                </div>

                <div class="space-y-8">
                    @foreach($recipientsByProgram as $programData)
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        <!-- Program Header -->
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h4 class="text-xl font-bold text-white">{{ $programData['program'] }}</h4>
                                    <p class="text-blue-100 text-sm">
                                        {{ $programData['unique_recipients'] }} penerima •
                                        Total: Rp {{ number_format($programData['total_nominal'], 0, ',', '.') }}
                                    </p>
                                </div>
                                <div class="text-right">
                                    <div class="text-2xl font-bold text-white">{{ $programData['total_recipients'] }}</div>
                                    <div class="text-blue-100 text-sm">Total Penerima</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="w-full">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Tahun</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($programData['recipients'] as $index => $recipient)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">{{ $index + 1 }}</td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $recipient->user->nama_lengkap ?? 'N/A' }}</div>
                                            @if($recipient->user->dusun)
                                            <div class="text-sm text-gray-500">Dusun {{ $recipient->user->dusun }}</div>
                                            @endif
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">{{ $recipient->user->nik ?? 'N/A' }}</td>
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            @php
                                                ...
                                                ][$recipient->status] ?? 'bg-gray-100 text-gray-800';
                                            @endphp
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium text-gray-900">
                                            @if($recipient->nominal)
                                                Rp {{ number_format($recipient->nominal, 0, ',', '.') }}
                                            @else
                                                <span class="text-gray-400">-</span>
                                            @endif
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-500">{{ $recipient->tahun }}</td>
                                    </tr>
                                    @empty
                                    <tr>
                        ...
                        @if($programData['has_more'])
                        <div class="bg-gray-50 px-6 py-3 text-center">
                            <span class="text-sm text-gray-600">
                                <i class="fas fa-info-circle mr-1"></i>
                                Menampilkan 10 dari {{ $programData['total_recipients'] }} penerima
                            </span>
                        </div>
                        @endif
                    </div>
