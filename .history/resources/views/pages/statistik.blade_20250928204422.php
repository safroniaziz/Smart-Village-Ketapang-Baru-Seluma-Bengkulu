            ...
            <div class="stat-card bg-white rounded-3xl p-8 shadow-2xl" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100">
                ...
                <div class="flex items-center justify-center h-80">
                    <div class="text-center">
                        ...
                        <h4 class="text-lg font-semibold text-gray-700 mb-2">Data Belum Tersedia</h4>
                        <p class="text-sm text-gray-500 max-w-xs">
                            Informasi status perkawinan penduduk<br>akan segera dilengkapi
                        </p>
                        <div class="mt-4 inline-flex items-center px-4 py-2 bg-blue-50 text-blue-600 rounded-lg text-sm font-medium">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartConfigs = {
        ...
        marital: {
            type: 'pie',
            data: {
                labels: {!! json_encode(array_map(function($key) { return $key === '' ? 'Belum Diketahui' : $key; }, array_keys($maritalStats))) !!},
                datasets: [{
