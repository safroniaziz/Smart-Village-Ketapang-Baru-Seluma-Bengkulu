        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12 mx-auto mb-8 lg:mb-4">
                    ...
                    <div class="hidden lg:block pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-96 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-x-16"></div>

                    <!-- Left column: Kepala Desa -->
                    <div class="relative z-10 flex justify-center order-1 lg:order-1">
                    ...
                    <div class="relative z-10 flex justify-center order-2 lg:order-2">
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-xs min-h-[240px] lg:min-h-[280px] flex flex-col justify-center">
                            ...
                            <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 py-1 lg:px-3">Ketua BPD, Pengawasan Pemerintahan, Penampung Aspirasi Rakyat</p>
                        </div>
                    </div>
                </div>

                <!-- Two independent columns below - Mobile Responsive -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mx-auto">
                    <!-- LEFT COLUMN: Pemerintahan Desa hierarchy -->
                    <div class="flex flex-col items-center order-1 lg:order-1">
                    ...
                    <div class="flex flex-col items-center order-2 lg:order-2">
            ...
            <section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50" data-aos="fade-up" data-aos-duration="200" data-aos-offset="20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-4 lg:p-8 transform hover:-translate-y-2" data-aos="fade-up" data-aos-duration="150" data-aos-delay="50">
                        ...
                        <div>
                            <div class="flex items-center gap-3 mb-4 lg:mb-6">
                                <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white shadow-lg">
                                    <span class="font-bold text-sm lg:text-lg">B</span>
                                </div>
                                <h5 class="text-xl lg:text-2xl font-bold text-blue-800">WEWENANG</h5>
                            </div>
                            <div class="space-y-3 lg:space-y-4">
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">1</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Penetapan Kebijakan</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak menetapkan kebijakan pemerintahan, pembangunan, dan kemasyarakatan desa</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">2</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Penandatanganan Dokumen</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak menandatangani Perdes, Keputusan, dan dokumen resmi desa</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-blue-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">3</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Pengangkatan Perangkat</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak mengangkat dan memberhentikan perangkat desa sesuai ketentuan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Card: BPD -->
                    <div class="group bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 rounded-3xl border-2 border-purple-300 hover:border-purple-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-4 lg:p-8 transform hover:-translate-y-2" data-aos="fade-up" data-aos-duration="150" data-aos-delay="100">
                        <!-- Header -->
                        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-3 lg:gap-4 mb-6 lg:mb-8">
                            <div class="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl bg-gradient-to-br from-purple-600 to-purple-700 flex items-center justify-center text-white shadow-2xl group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-balance-scale text-2xl lg:text-3xl"></i>
                            </div>
                            <div class="text-center sm:text-left">
                                <h4 class="font-bold text-xl lg:text-3xl text-gray-900 mb-2">⚖️ Badan Permusyawaratan Desa</h4>
                                <p class="text-purple-800 font-semibold text-base lg:text-lg">Lembaga Perwakilan Desa</p>
                            </div>
                        </div>

                        <!-- Divider -->
                        <div class="w-full h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent mb-6 lg:mb-8"></div>

                        <!-- TUGAS Section -->
                        <div class="mb-6 lg:mb-8">
                            <div class="flex items-center gap-3 mb-4 lg:mb-6">
                                <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white shadow-lg">
                                    <span class="font-bold text-sm lg:text-lg">A</span>
                                </div>
                                <h5 class="text-xl lg:text-2xl font-bold text-purple-800">TUGAS</h5>
                            </div>
                            <div class="space-y-3 lg:space-y-4">
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">1</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Penampung Aspirasi</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Menjaring, menampung, dan menyalurkan aspirasi masyarakat desa secara sistematis</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">2</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Pengawasan</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Mengawasi pelaksanaan Perdes, APBDes, dan kinerja perangkat desa</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">3</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Musyawarah</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Memfasilitasi musyawarah desa untuk keputusan strategis dan evaluasi pembangunan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center gap-3 mb-4 lg:mb-6">
                                <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-xl bg-gradient-to-br from-purple-600 to-purple-700 flex items-center justify-center text-white shadow-lg">
                                    <span class="font-bold text-sm lg:text-lg">B</span>
                                </div>
                                <h5 class="text-xl lg:text-2xl font-bold text-purple-800">WEWENANG</h5>
                            </div>
                            <div class="space-y-3 lg:space-y-4">
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">1</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Pembahasan Perdes</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak membahas dan menyepakati Rancangan Peraturan Desa bersama pemerintah desa</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">2</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Pengawasan Kinerja</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak mengawasi dan mengevaluasi kinerja pemerintah desa secara independen</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/70 rounded-xl border border-purple-200 hover:bg-white/90 transition-colors">
                                    <div class="w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-purple-600 text-white flex items-center justify-center text-xs lg:text-sm font-bold mt-1 flex-shrink-0">3</div>
                                    <div>
                                        <h6 class="font-semibold text-gray-900 mb-1 text-sm lg:text-base">Musyawarah Desa</h6>
                                        <p class="text-gray-700 text-xs lg:text-sm leading-relaxed">Berhak memfasilitasi dan memimpin musyawarah desa untuk keputusan strategis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
.cta-section {
    ...
    visibility: visible !important;
            ...
            @media (max-width: 768px) {
                ...
                #fallback-chart .order-1 {
                    order: 1 !important;
                }

                #fallback-chart .order-2 {
                    order: 2 !important;
                }

                /* Add visual separators between sections on mobile */
                #fallback-chart .order-2::before {
                    content: '';
                    display: block;
                    width: 100%;
                    height: 2px;
