        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start">
                    <!-- LEFT COLUMN: Kepala Desa and Pemerintahan Desa hierarchy -->
                    <div class="flex flex-col items-center mb-8 lg:mb-0">
                        ...
                        <!-- Connection line down from Kepala Desa -->
                        <div class="w-px h-6 lg:h-8 bg-blue-400 mb-4"></div>

                        <!-- Ketua BPD - Below Kepala Desa on mobile, side by side on desktop -->
                        <div class="lg:hidden bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-xs min-h-[200px] flex flex-col justify-center mb-6">
                            <div class="absolute -top-3 -right-3 w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                            ...
                            <h4 class="font-bold text-gray-900 text-sm lg:text-lg mb-1">⚖️ Ketua BPD</h4>
                            <p class="text-purple-600 font-semibold mb-1 text-xs lg:text-base">Bahirman</p>
                            <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 py-1">Pengawasan Pemerintahan, Penampung Aspirasi Rakyat</p>
                        </div>

                        <!-- Connection line down from Ketua BPD (mobile) -->
                        <div class="lg:hidden w-px h-6 bg-purple-400 mb-4"></div>
                    ...
                    <div class="flex flex-col items-center">
                        <!-- Desktop: Ketua BPD side by side with Kepala Desa -->
                        <div class="hidden lg:block bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-xs min-h-[280px] flex flex-col justify-center mb-6">
                            <div class="absolute -top-3 -right-3 w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                <i class="fas fa-balance-scale text-white text-xs"></i>
                            </div>
