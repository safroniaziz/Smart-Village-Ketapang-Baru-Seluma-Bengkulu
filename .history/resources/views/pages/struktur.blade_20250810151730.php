            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="hidden lg:block relative w-full max-w-xl mb-6">
                        ...
                        <div class="hidden lg:block grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 max-w-xl w-full pt-4 mb-6">
                            <div class="relative">
