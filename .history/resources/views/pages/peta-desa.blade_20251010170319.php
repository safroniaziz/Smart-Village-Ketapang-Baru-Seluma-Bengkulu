...
function initMap() {
    ...
    map.on('load', () => {
        ...
        validData.forEach((item, index) => {
            ...
            // Create simple circular marker (exactly like potensi-wisata - no rotation issues)
            const el = document.createElement('div');
            el.className = 'marker';
            el.style.width = '30px';
            el.style.height = '30px';
            el.style.borderRadius = '50%'; // Perfect circle like potensi-wisata
            ...
            el.innerHTML = `<i class="fas fa-seedling" style="color: white; font-size: 14px;"></i>`;
            ...
            const marker = new mapboxgl.Marker({
                element: el,
                anchor: 'bottom-left', // Anchor di ujung pin (bagian yang menunjuk)
                offset: [20, 0] // Offset untuk kompensasi rotasi
            })
                .setLngLat([lng, lat])
                .setPopup(popup)
                .addTo(map);
