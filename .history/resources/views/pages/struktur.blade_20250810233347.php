            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-32 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="hidden lg:block bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[240px] flex flex-col justify-center mb-2">
