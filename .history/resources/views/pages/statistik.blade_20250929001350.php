                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gradient-to-r from-indigo-50 to-purple-50">
                                <th class="text-left p-4 font-bold text-indigo-900">Dusun</th>
                                <th class="text-center p-4 font-bold text-indigo-900">Populasi</th>
                                <th class="text-center p-4 font-bold text-indigo-900">KK</th>
                                <th class="text-center p-4 font-bold text-indigo-900">Penerima Bantuan</th>
                                <th class="text-center p-4 font-bold text-indigo-900">Persentase</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($dusunStats as $dusun => $count)
