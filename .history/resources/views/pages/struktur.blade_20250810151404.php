            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="hidden lg:block w-px h-6 lg:h-8 bg-purple-400 mb-4"></div>

                        <!-- Desktop: Row 2 - Wakil Ketua BPD + Sekretaris BPD (sejajar) -->
                        <div class="hidden lg:block grid grid-cols-2 gap-6 lg:gap-8 max-w-xl w-full mb-6">
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-3 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative min-h-[280px] flex flex-col justify-center">
                                <div class="absolute -top-3 -right-3 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                    <i class="fas fa-balance-scale text-white text-xs"></i>
                                </div>
                                <img src="{{ asset('images/struktur/halintarman.jpg') }}" alt="Wakil Ketua BPD" class="w-16 h-16 lg:w-28 lg:h-28 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h4 class="font-bold text-gray-900 text-base lg:text-lg mb-1">⚖️ Wakil Ketua BPD</h4>
                                <p class="text-purple-600 font-semibold mb-1 text-sm lg:text-base">Halintarman</p>
                                <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 py-1">Wakil Ketua BPD, Koordinasi Anggota, Pengawasan Program</p>
                            </div>
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-3 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative min-h-[280px] flex flex-col justify-center">
                                <div class="absolute -top-3 -right-3 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                    <i class="fas fa-balance-scale text-white text-xs"></i>
                                </div>
                                <img src="{{ asset('images/struktur/kebat.jpg') }}" alt="Sekretaris BPD" class="w-16 h-16 lg:w-28 lg:h-28 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h4 class="font-bold text-gray-900 text-base lg:text-lg mb-1">⚖️ Sekretaris BPD</h4>
                                <p class="text-purple-600 font-semibold mb-1 text-sm lg:text-base">Kebat S</p>
                                <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 py-1">Sekretaris BPD, Dokumentasi Rapat, Administrasi BPD</p>
                            </div>
                        </div>

                        <!-- Connection line down from Row 2 to Row 3 -->
                        <div class="hidden lg:block w-px h-6 lg:h-8 bg-purple-400 mb-4"></div>

                        <!-- Desktop: Row 3 - Anggota BPD 1 + Anggota BPD 2 (sejajar) -->
                        <div class="hidden lg:block grid grid-cols-2 gap-6 lg:gap-8 max-w-xl w-full">
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg min-h-[200px] flex flex-col justify-center">
                                <img src="{{ asset('images/struktur/susti.jpg') }}" alt="Anggota BPD" class="w-16 h-16 lg:w-24 lg:h-24 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-gray-900 text-sm lg:text-base mb-1">Anggota BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Susti</p>
                                <p class="text-xs text-gray-600">Anggota BPD, Penampung Aspirasi, Pengawasan Pemerintahan</p>
                            </div>
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg min-h-[200px] flex flex-col justify-center">
                                <img src="{{ asset('images/struktur/dhesty.jpg') }}" alt="Anggota BPD" class="w-16 h-16 lg:w-24 lg:h-24 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-gray-900 text-sm lg:text-base mb-1">Anggota BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Dhesty C</p>
                                <p class="text-xs text-gray-600">Anggota BPD, Penampung Aspirasi, Pengawasan Pemerintahan</p>
                            </div>
                        </div>
                    </div>
