    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: none;">
                                <!-- Structure Layout with BPD beside Kepala Desa -->
                <div class="text-center mb-8">
                    <h3 class="text-2xl font-bold text-gray-900 mb-6">STRUKTUR ORGANISASI DESA KETAPANG BARU</h3>

                    <!-- Level 1: Kepala Desa + BPD (Side by Side) -->
                    <div class="flex justify-center items-start gap-16 mb-8">
                        <!-- Kepala Desa -->
                        ...
                        <div class="flex items-center mt-12">
                            <div class="w-20 h-0 border-t-3 border-dashed border-purple-500"></div>
                            <div class="bg-purple-100 border-2 border-dashed border-purple-500 rounded-full px-3 py-1 mx-2">
                                <span class="text-purple-700 text-xs font-bold">MITRA KERJA</span>
                            </div>
                            <div class="w-20 h-0 border-t-3 border-dashed border-purple-500"></div>
                        </div>

                        <!-- BPD Ketua (Side by side with Kepala Desa) -->
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-6 text-center shadow-xl relative max-w-xs">
                            ...
                            <p class="text-xs text-gray-600 bg-purple-50 rounded px-2 py-1">Periode: 2021-2027</p>
                                        ...
                                        <!-- Connecting Lines from Kepala Desa to Government Structure -->
                    <div class="flex justify-center mb-6">
                        <div class="w-px h-8 bg-gray-400"></div>
                    </div>

                    <!-- Government Structure Below Kepala Desa -->
                    <div class="text-center mb-12">
                        <h4 class="text-lg font-bold text-gray-800 mb-6">PEMERINTAHAN DESA</h4>
                    </div>
                    ...
                    <!-- BPD Structure Section (Right Side) -->
                    <div class="absolute top-0 right-0 w-1/3">
                        <div class="text-center mb-6">
                            <h4 class="text-lg font-bold text-gray-800 mb-4">BADAN PERMUSYAWARATAN DESA</h4>
                        </div>

                        <!-- BPD Members under Ketua -->
                        <div class="space-y-4">
