            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 w-full pt-4">
                            <div class="relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 w-full pt-4 mb-6">
                            <div class="relative">
