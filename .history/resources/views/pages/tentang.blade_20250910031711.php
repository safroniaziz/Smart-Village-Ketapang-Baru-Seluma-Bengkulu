...
@section('content')
<!-- Hero Section - Konsisten dengan design system -->
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" data-aos="fade-in">
    <!-- Background Pattern -->
    <div class="hero-pattern" data-aos="fade-in" data-aos-delay="100"></div>

    <!-- Particle.js Container for About -->
    <div id="particles-about" class="hero-particles" data-aos="fade-in" data-aos-delay="200"></div>

    <div class="hero-content relative w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10" data-aos="fade-up" data-aos-delay="300">
