            ...
            <div class="p-8 lg:p-12">
                ...
                <div class="content-body mb-8">
                    ...
                    <div class="flex flex-wrap gap-4 mt-8 pt-6 border-t border-gray-200">
                        <button onclick="window.print()" class="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-semibold hover:bg-gray-200 transition-colors">
