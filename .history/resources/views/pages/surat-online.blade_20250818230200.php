        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
                <div class="p-8 text-center h-full flex flex-col">
                    ...
                    <a href="#ajukan-surat" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 mt-auto">Ajukan Surat</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="200">
                <div class="p-8 text-center h-full flex flex-col">
                    ...
                    <a href="#ajukan-surat" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 mt-auto">Ajukan Surat</a>
                </div>
            </div>
                    ...
                    <form id="formAjukanSurat" class="space-y-6" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-2 text-gray-700">
                                    <i class="fas fa-id-card mr-2 text-blue-500"></i>NIK
                                </label>
                                <input type="text" name="nik" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="no_hp" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" placeholder="62xxxxxxxxxxx">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-2 text-gray-700">
                                    <i class="fas fa-file-alt mr-2 text-blue-500"></i>Jenis Surat *
                                </label>
                                <select name="jenis_surat" id="jenisSurat" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        ...
                        <!-- Sub Jenis Surat (Dynamic) -->
                        <div id="subJenisContainer" class="hidden">
                            <label class="block text-sm font-semibold mb-2 text-gray-700">
                                <i class="fas fa-list mr-2 text-blue-500"></i>Sub Jenis Surat *
                            </label>
                            <select name="sub_jenis_surat" id="subJenisSurat" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                                <option value="">Pilih sub jenis surat</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2 text-gray-700">
                                <i class="fas fa-clipboard mr-2 text-blue-500"></i>Keperluan *
                            </label>
                            <textarea name="keperluan" rows="4" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" placeholder="Jelaskan keperluan surat secara detail..."></textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2 text-gray-700">
                                <i class="fas fa-paperclip mr-2 text-blue-500"></i>Lampiran Dokumen
                            </label>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition-colors duration-200">
                                <input type="file" name="lampiran" accept="application/pdf,image/*" class="hidden" id="fileInput">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const subJenisSurat = document.getElementById('subJenisSurat');
    ...
    const subJenisData = {
        'Surat Pengantar': [
            ...
            'Pengantar Izin Usaha',
            'Pengantar Nikah',
            'Pengantar Sekolah/Kuliah'
        ],
        'Surat Keterangan': [
            'Keterangan Domisili',
            'Keterangan Usaha',
    ...
    // Field khusus untuk setiap sub-jenis
    const dynamicFields = {
        'Pengantar KTP': [
            { name: 'alasan_kehilangan', label: 'Alasan (jika KTP hilang)', type: 'textarea', icon: 'fas fa-exclamation-triangle', required: false }
        ],
        'Pengantar KK': [
            { name: 'status_kk', label: 'Status dalam KK', type: 'select', icon: 'fas fa-users', required: true, options: ['Kepala Keluarga', 'Istri', 'Anak', 'Menantu', 'Cucu', 'Orangtua', 'Lainnya'] }
        ],
        'Pengantar Nikah': [
            { name: 'nama_calon', label: 'Nama Calon Pasangan', type: 'text', icon: 'fas fa-heart', required: true },
            { name: 'tempat_nikah', label: 'Tempat Pernikahan', type: 'text', icon: 'fas fa-map-marker-alt', required: true }
        ],
        'Keterangan Domisili': [
        ...
        'Keterangan Usaha': [
            ...
            { name: 'omzet_bulanan', label: 'Omzet Bulanan (Rp)', type: 'number', icon: 'fas fa-money-bill', required: false }
        ],
        'Keterangan Tidak Mampu': [
            { name: 'jumlah_tanggungan', label: 'Jumlah Tanggungan', type: 'number', icon: 'fas fa-users', required: true },
            { name: 'penghasilan_bulanan', label: 'Penghasilan Bulanan (Rp)', type: 'number', icon: 'fas fa-money-bill', required: true },
        ...
        'Izin Keramaian': [
            ...
            { name: 'tempat_acara', label: 'Tempat Acara', type: 'textarea', icon: 'fas fa-map-marker-alt', required: true },
    ...
    if (jenisSurat) {
        jenisSurat.addEventListener('change', function() {
            ...
            subJenisSurat.innerHTML = '<option value="">Pilih sub jenis surat</option>';
            dynamicFieldsContainer.innerHTML = '';
            
            if (selectedJenis && subJenisData[selectedJenis]) {
                // Show sub jenis container
                subJenisContainer.classList.remove('hidden');
                
                // Populate sub jenis options
                subJenisData[selectedJenis].forEach(subJenis => {
                    const option = document.createElement('option');
                    option.value = subJenis;
                    option.textContent = subJenis;
                    subJenisSurat.appendChild(option);
                });
            }
        });
    }
    ...
    if (subJenisSurat) {
        subJenisSurat.addEventListener('change', function() {
            const selectedSubJenis = this.value;
            dynamicFieldsContainer.innerHTML = '';
            
            if (selectedSubJenis && dynamicFields[selectedSubJenis]) {
                const fieldsHtml = dynamicFields[selectedSubJenis].map(field => {
                    let inputHtml = '';
                ...
                dynamicFieldsContainer.innerHTML = `
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                        <h4 class="font-semibold text-blue-900 mb-2 flex items-center">
                            <i class="fas fa-info-circle mr-2"></i>Data Khusus untuk ${selectedSubJenis}
                        </h4>
                        <p class="text-sm text-blue-800">Lengkapi data berikut sesuai dengan jenis surat yang Anda pilih.</p>
                    </div>
                    ${fieldsHtml}
                `;
            }
        ...
        fileInput.addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                label.innerHTML = `
                    ...
                    <p class="text-blue-600 mb-2 font-semibold">${file.name}</p>
                    <p class="text-sm text-gray-500">Ukuran: ${fileSize} MB</p>
                `;
            }
        });
    }
