                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-fish mr-3 text-blue-500"></i>
                                    <span>Memancing Tradisional</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-gamepad mr-3 text-orange-500"></i>
                                    <span>Bermain & Rekreasi</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-walking mr-3 text-teal-500"></i>
                                    <span>Jalan Santai Pantai</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-umbrella-beach mr-3 text-purple-500"></i>
                                    <span>Piknik Keluarga</span>
                                </div>
                            </div>
                        </div>
                    </div>
