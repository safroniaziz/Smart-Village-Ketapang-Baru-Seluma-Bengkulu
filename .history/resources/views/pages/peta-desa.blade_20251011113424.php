                    ...
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                        ...
                        <div style="flex: 1;">
                            ...
                            ">
                                ...
                                Rumah Warga
                                ${isKepalaKeluarga ? ' • Kepala Keluarga' : ''}
                            </div>
                            <h3 style="
                                margin: 0;
                                font-size: 18px;
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; gap: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-id-card" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>NIK:</strong> ${nik}</span>
                            </div>
                            ` : ''}
                            ${jenisKelamin ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
