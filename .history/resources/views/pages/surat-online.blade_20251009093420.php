                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="bg-white rounded-lg p-3 border border-yellow-300">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                                    <div><strong>Nama:</strong> <span class="text-gray-700">{{ auth()->user()->name ?? 'N/A' }}</span></div>
                                    <div><strong>NIK:</strong> <span class="text-gray-700">{{ auth()->user()->nik ?? 'N/A' }}</span></div>
                                    <div><strong>Umur:</strong> <span class="text-gray-700">{{ auth()->user()->tanggal_lahir ? \Carbon\Carbon::parse(auth()->user()->tanggal_lahir)->age . ' Tahun' : 'N/A' }}</span></div>
                                    <div><strong>Alamat:</strong> <span class="text-gray-700">{{ auth()->user()->alamat ?? auth()->user()->address ?? 'N/A' }}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
