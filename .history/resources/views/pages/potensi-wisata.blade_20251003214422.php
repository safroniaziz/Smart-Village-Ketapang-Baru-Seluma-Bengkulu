        ...
        <div class="relative max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="200">
            <div class="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-2xl bg-gray-900 relative">
                <iframe class="w-full h-full"
                        src="https://www.youtube.com/embed/{{ $youtubeId }}?enablejsapi=1&origin={{ request()->getSchemeAndHttpHost() }}"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen
                        loading="lazy"
                        onerror="this.style.display='none'; this.parentNode.querySelector('.video-fallback').style.display='flex';">
                </iframe>
