            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 shadow-2xl relative">
                        ...
                        <div class="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg overflow-hidden">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-6 shadow-lg border-2 border-green-200 relative">
                        <div class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-yellow-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-orange-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-teal-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-16 h-16 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-purple-200 hover:shadow-lg transition-shadow duration-300">
                            <div class="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="text-center">
                            <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-6 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                                <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center mb-12">
                        <div class="relative">
                            <div class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl p-6 text-white text-center shadow-xl min-w-[200px]">
                                <div class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
                                    <img src="{{ asset('images/struktur/bahirman.jpg') }}"
                                         ...
                                         class="w-full h-full object-cover"
                                         onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                    <i class="fas fa-crown text-white text-2xl hidden"></i>
                                </div>
                                <h4 class="text-lg font-bold mb-2">KETUA BPD</h4>
                                <p class="text-purple-100 font-semibold text-sm">Bahirman</p>
                            </div>
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="w-96 h-0.5 bg-gray-400 relative">
                            <!-- Vertical lines to Wakil and Sekretaris -->
                            <div class="absolute left-1/4 top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                            <div class="absolute right-1/4 top-0 w-0.5 h-8 bg-gray-400 transform translate-x-1/2"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center gap-32 mb-12">
                        ...
                        <div class="relative">
                            <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-6 text-white text-center shadow-xl min-w-[180px]">
                                <div class="w-18 h-18 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
                            ...
                            <div class="absolute top-full left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-gray-400"></div>
                        </div>
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="w-[400px] h-0.5 bg-gray-400 relative">
                            <!-- Vertical lines to each Anggota -->
                            <div class="absolute left-[25%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                            <div class="absolute left-[75%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center gap-12">
                        ...
                        <div class="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl p-4 text-white text-center shadow-lg min-w-[140px]">
                            <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3 overflow-hidden">
