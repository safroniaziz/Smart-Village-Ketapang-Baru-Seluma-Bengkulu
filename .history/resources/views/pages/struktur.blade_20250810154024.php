...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Test div to verify section visibility -->
        <div class="bg-red-500 text-white p-4 text-center mb-4">
            <h3 class="text-2xl font-bold">TEST SECTION - Tugas & Wewenang</h3>
            <p>Jika Anda melihat ini, section Tugas & Wewenang seharusnya muncul</p>
        </div>
