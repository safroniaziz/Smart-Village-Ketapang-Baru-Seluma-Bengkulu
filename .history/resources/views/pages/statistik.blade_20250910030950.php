...
<section class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20 hero-gradient">
    ...
    <div class="relative w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="text-center">
            ...
            <div class="inline-flex items-center relative mb-8" data-aos="fade-down" data-aos-duration="800">
                ...
                <div class="relative bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full text-sm font-bold shadow-2xl border border-white/20">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-7xl font-black mb-8 leading-tight" data-aos="fade-up" data-aos-delay="200">
                <span class="bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">
                    Data & Statistik
                </span>
                <br>
                <span class="bg-gradient-to-r from-yellow-300 via-yellow-400 to-orange-300 bg-clip-text text-transparent">
                    Desa Ketapang Baru
                </span>
            </h1>

            <!-- Enhanced Description -->
            <p class="text-lg lg:text-xl text-blue-100 leading-relaxed max-w-4xl mx-auto font-light mb-12" data-aos="fade-up" data-aos-delay="400">
                Analisis mendalam tentang <span class="font-semibold text-yellow-300">demografi, sosial, dan ekonomi</span>
                masyarakat desa untuk perencanaan pembangunan yang tepat sasaran dan berkelanjutan
            </p>

            <!-- Enhanced Quick Stats Grid -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12" data-aos="fade-up" data-aos-delay="600">
                <div class="stat-card bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-500 group">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-3xl font-black text-yellow-400 group-hover:scale-110 transition-transform duration-300">{{ number_format($totalWarga) }}</div>
                        <div class="w-12 h-12 bg-gradient-to-br from-blue-400/30 to-purple-400/30 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
                            <i class="fas fa-users text-white text-xl"></i>
                        </div>
                    </div>
                    <div class="text-sm text-blue-100 font-semibold">Total Penduduk</div>
                    <div class="text-xs text-blue-200 mt-2 flex items-center">
                ...
                <div class="stat-card bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-500 group">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-3xl font-black text-yellow-400 group-hover:scale-110 transition-transform duration-300">{{ count($dusunStats) }}</div>
                        <div class="w-12 h-12 bg-gradient-to-br from-emerald-400/30 to-teal-400/30 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
                            <i class="fas fa-map-marked-alt text-white text-xl"></i>
                        </div>
                    </div>
                    <div class="text-sm text-blue-100 font-semibold">Wilayah Dusun</div>
                    <div class="text-xs text-blue-200 mt-2 flex items-center">
                ...
                <div class="stat-card bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-500 group">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-3xl font-black text-yellow-400 group-hover:scale-110 transition-transform duration-300">{{ $aidCoverage }}%</div>
                        <div class="w-12 h-12 bg-gradient-to-br from-orange-400/30 to-red-400/30 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
                            <i class="fas fa-hands-helping text-white text-xl"></i>
                        </div>
                    </div>
                    <div class="text-sm text-blue-100 font-semibold">Cakupan Bantuan</div>
                    <div class="text-xs text-blue-200 mt-2 flex items-center">
                ...
                <div class="stat-card bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-500 group">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-3xl font-black text-yellow-400 group-hover:scale-110 transition-transform duration-300">{{ $higherEducationRate }}%</div>
                        <div class="w-12 h-12 bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
                            <i class="fas fa-graduation-cap text-white text-xl"></i>
                        </div>
                    </div>
                    <div class="text-sm text-blue-100 font-semibold">Pendidikan Tinggi</div>
                    <div class="text-xs text-blue-200 mt-2 flex items-center">
                        <div class="w-2 h-2 bg-purple-400 rounded-full mr-2 animate-pulse"></div>
                        <span>SDM Berkualitas</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4" data-aos="fade-up" data-aos-delay="800">
                <button onclick="document.getElementById('overview').scrollIntoView({behavior: 'smooth'})" class="group bg-gradient-to-r from-yellow-400 to-orange-400 hover:from-yellow-300 hover:to-orange-300 text-gray-900 font-bold px-8 py-4 rounded-xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 flex items-center">
                    <i class="fas fa-chart-line mr-3 group-hover:rotate-12 transition-transform duration-300"></i>
                    Jelajahi Data
                    <i class="fas fa-arrow-down ml-3 group-hover:translate-y-1 transition-transform duration-300"></i>
                </button>
                <button onclick="document.getElementById('dusun').scrollIntoView({behavior: 'smooth'})" class="group bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-semibold px-8 py-4 rounded-xl border-2 border-white/30 hover:border-white/50 transform hover:scale-105 transition-all duration-300 flex items-center">
                    <i class="fas fa-map mr-3 group-hover:rotate-12 transition-transform duration-300"></i>
                    Analisis per Dusun
                </button>
            </div>
        </div>
...
<nav class="stat-subnav sticky top-20 z-30" aria-label="Navigasi Statistik">
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <div class="subnav-surface">
            <ul class="flex items-center justify-center gap-2 sm:gap-4 min-w-max" id="statSubnav">
                <li>
                    <a href="#overview" class="stat-tab group" aria-current="false">
                ...
                <li>
                    <a href="#education" class="stat-tab group" aria-current="false">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <li>
                    <a href="#social" class="stat-tab group" aria-current="false">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <li>
                    <a href="#aid" class="stat-tab group" aria-current="false">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <li>
                    <a href="#dusun" class="stat-tab group" aria-current="false">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 bg-gradient-to-br from-slate-500 to-gray-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
