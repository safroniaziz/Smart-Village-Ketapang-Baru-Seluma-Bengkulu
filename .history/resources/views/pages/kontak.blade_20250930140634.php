    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center" data-aos="fade-up">
            <div class="inline-flex items-center relative mb-4">
                ...
                <div class="relative bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 py-2 rounded-full text-sm font-semibold">Informasi Kontak</div>
            </div>
            <h2 class="text-3xl lg:text-4xl font-black mb-3">Detail Kontak Desa</h2>
            <p class="text-gray-600 max-w-2xl mx-auto">Data kontak resmi kantor desa yang dapat Anda hubungi setiap hari kerja.</p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="150">
            @if(isset($embedStreetViewMapUrl) && $embedStreetViewMapUrl)
                <iframe src="{{ $embedStreetViewMapUrl }}" width="100%" height="500" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            @elseif($mapUrl)
