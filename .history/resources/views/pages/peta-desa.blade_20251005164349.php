    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold mb-4">
                <span class="text-blue-600">Peta Desa</span> Ketapang Baru
            </h2>
            <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full mx-auto mb-6"></div>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                <span class="font-semibold text-slate-700">Jelajahi wilayah desa dengan peta interaktif</span> <span class="font-semibold text-blue-600">yang menampilkan informasi lengkap</span>
                setiap dusun dan <span class="font-semibold text-blue-700">fasilitas umum</span>
            </p>
        </div>
...
<script>
function loadMap() {
    // Simulate loading map with modern Tailwind classes
    ...
    mapContainer.innerHTML = `
        <div class="flex items-center justify-center h-full bg-gradient-to-br from-gray-50 to-blue-50">
            <div class="text-center p-8">
                ...
                <h3 class="text-xl font-semibold text-blue-600 mb-2">Peta Desa Ketapang Baru</h3>
                <p class="text-gray-600 mb-6">Peta interaktif sedang dimuat...</p>
    ...
    // Simulate map loading delay with smooth transition
    setTimeout(() => {
        mapContainer.innerHTML = `
            <div class="flex items-center justify-center h-full bg-gradient-to-br from-gray-50 to-green-50 transition-all duration-500">
                <div class="text-center p-8">
                    <div class="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-map-marked-alt text-3xl text-green-600"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-green-600 mb-2">Peta Berhasil Dimuat!</h3>
                    <p class="text-gray-600 mb-6">Peta interaktif siap digunakan</p>
                    <button onclick="showMapFeatures()" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-medium rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 transform hover:scale-105 shadow-lg">
                        <i class="fas fa-eye mr-2"></i>Tampilkan Fitur
                    </button>
                </div>
            </div>
        `;
...
function showMapFeatures() {
    // Show map features with modern alert
    const modal = document.createElement('div');
    modal.className = 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50';
    modal.innerHTML = `
        <div class="bg-white rounded-2xl p-8 max-w-md mx-4 transform transition-all duration-300 scale-95 hover:scale-100">
            <div class="text-center">
                <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-map text-2xl text-blue-600"></i>
                </div>
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Fitur Peta Interaktif</h3>
                <p class="text-gray-600 mb-6">Fitur peta akan diintegrasikan dengan Leaflet.js atau Google Maps API</p>
                <button onclick="this.closest('.fixed').remove()" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
                    Tutup
                </button>
            </div>
        </div>
...
// Modern vanilla JavaScript instead of jQuery
document.addEventListener('DOMContentLoaded', function() {
    // Map controls
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            console.log('Layer changed:', this.id, this.checked);
        });
    });
