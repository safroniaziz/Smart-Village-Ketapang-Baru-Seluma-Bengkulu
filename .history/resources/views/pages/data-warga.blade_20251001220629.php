            ...
            <div class="flex-1 space-y-10 relative z-10">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8" data-aos="fade-up" data-aos-delay="700">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                        <div class="text-2xl font-black text-yellow-400 mb-1">{{ number_format($totalWarga) }}</div>
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                        <div class="text-2xl font-black text-yellow-400 mb-1">{{ number_format($totalKK) }}</div>
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 text-center">
                        <div class="text-2xl font-black text-yellow-400 mb-1">{{ number_format($activeWarga) }}</div>
                        <div class="text-sm text-blue-100">Status Aktif</div>
                        <div class="text-xs text-blue-200 mt-1">
                            <i class="fas fa-user-check text-green-300 mr-1"></i>
                            {{ $totalWarga > 0 ? round(($activeWarga / $totalWarga) * 100, 1) : 0 }}% aktif
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 relative z-20" data-aos="fade-up" data-aos-delay="800">
                    <a href="#data-table" class="group bg-white/15 hover:bg-white/25 backdrop-blur-md border-2 border-white/30 hover:border-white/50 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center justify-center">
                            <i class="fas fa-table mr-2 text-base"></i>
                            <span class="text-base">Lihat Data</span>
                        </div>
                    </a>
                ...
                <div class="info-card group relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-6 shadow-2xl overflow-hidden hover:shadow-3xl hover:scale-105 hover:border-blue-300/70 cursor-pointer" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="relative z-10 text-center mb-4">
                        <div class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl mb-3 shadow-lg group-hover:scale-110 group-hover:shadow-blue-500/40 transition-all duration-300">
                            <i class="fas fa-users text-white text-xl group-hover:text-blue-100 transition-colors duration-300"></i>
                        </div>
                        <h3 class="text-lg font-black text-gray-800 mb-1 bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">Data Warga</h3>
                        <p class="text-xs text-gray-600 font-medium">Terkini & Terverifikasi</p>
                    </div>
                    ...
                    <div class="relative z-10 space-y-3 mb-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100/50 group-hover:bg-white/90 group-hover:shadow-md transition-all duration-300">
                                <div class="flex items-center justify-center text-xs">
                                    ...
                                    <div class="text-center">
                                        <p class="font-bold text-gray-800">{{ number_format($totalWarga) }} Warga</p>
                            ...
                            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100/50 group-hover:bg-white/90 group-hover:shadow-md transition-all duration-300">
                                <div class="flex items-center justify-center text-xs">
                                    ...
                                    <div class="text-center">
                                        <p class="font-bold text-gray-800">{{ number_format($totalLaki) }} Laki-laki</p>
                                        <p class="text-gray-600">{{ $persentaseLaki }}% dari Total</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-3 shadow-sm border border-blue-100/50 group-hover:bg-white/90 group-hover:shadow-md transition-all duration-300">
                                <div class="flex items-center justify-center text-xs">
                                    <div class="w-8 h-8 bg-gradient-to-br from-pink-500 to-pink-600 rounded-lg flex items-center justify-center mr-3 shadow-sm group-hover:scale-110 group-hover:shadow-pink-500/30 transition-all duration-300">
                                        <i class="fas fa-female text-white text-xs"></i>
                                    </div>
                                    <div class="text-center">
                                        <p class="font-bold text-gray-800">{{ number_format($totalPerempuan) }} Perempuan</p>
                                        <p class="text-gray-600">{{ $persentasePerempuan }}% dari Total</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative z-10 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 rounded-2xl p-4 shadow-xl group-hover:shadow-2xl group-hover:from-gray-800 group-hover:via-blue-800 group-hover:to-indigo-800 transition-all duration-500">
                        ...
                        <div class="flex flex-col items-center space-y-3">
                            <div class="relative group-hover:scale-110 transition-transform duration-500">
                                ...
                                <div class="relative bg-white p-4 rounded-2xl shadow-2xl border-2 border-white/20 group-hover:shadow-3xl group-hover:border-white/40 transition-all duration-500">
                                    <div class="text-center">
                                        ...
                                        <h4 class="font-bold text-gray-800 text-sm mb-1">Data Lengkap</h4>
                                        <p class="text-xs text-gray-600">Search & Filter</p>
                                    </div>
                                </div>
                                <!-- Corner Decorations -->
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-xs text-gray-300">Data Lengkap • Pencarian Canggih</p>
                            </div>
                        </div>
            ...
            <div class="px-8 py-8 bg-gradient-to-br from-gray-50 to-slate-50 border-b border-gray-100">
                ...
                <div class="flex items-center justify-between text-sm text-gray-600">
                    ...
                    <div id="resultsCount" class="font-semibold text-blue-600">
                        Menampilkan {{ $wargas->firstItem() ?? 0 }} - {{ $wargas->lastItem() ?? 0 }} dari {{ $wargas->total() }} data keluarga
                    </div>
                </div>
            </div>
                    ...
                    <div class="overflow-x-auto custom-scrollbar">
                        <table class="w-full enhanced-table">
                            ...
                            <tbody id="tableBody" class="divide-y divide-gray-100">
                                @include('partials.warga-table-content', ['familyGroups' => $familyGroups ?? collect()])
                            </tbody>
                        </table>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch(page = 1) {
        ...
        .then(data => {
            ...
            if (data.html) {
                ...
                console.log('Table body content length:', tableBody.innerHTML.length);

                // Re-initialize family toggle functionality after AJAX update
            ...
            if (data.stats) {
                ...
                if (resultsCount) {
                    resultsCount.textContent = `Menampilkan ${data.stats.from || 0} - ${data.stats.to || 0} dari ${data.stats.total} data keluarga`;
                }
            }
    ...
    // Initialize family toggle functionality
    initializeFamilyToggle();
});

// Family toggle functionality
function initializeFamilyToggle() {
    $('.family-toggle').off('click').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
