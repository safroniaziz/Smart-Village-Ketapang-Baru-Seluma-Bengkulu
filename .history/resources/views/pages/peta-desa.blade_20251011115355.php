...
/* Ensure warga popup appears above all markers */
.warga-popup {
    z-index: 9999 !important;
}

.warga-popup .mapboxgl-popup-tip {
    z-index: 9999 !important;
}
...
/* Warga marker styles - smaller and on top */
.warga-marker {
    width: 20px;
    height: 20px;
    border-radius: 50%;
    ...
    z-index: 10; /* Higher than lahan markers */
}
...
/* Map-only loading overlay */
.map-loading-overlay {
    position: absolute;
    inset: 0;
    pointer-events: none; /* don't block map */
    z-index: 5;
    ...
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="flex items-center gap-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Milik warga dengan dokumentasi foto</div>
                                <div class="text-xs text-gray-500 mt-1">📷 Klik untuk melihat galeri foto</div>
                    </div>
                    </div>
                        ...
                        <div class="flex items-center gap-4 p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-100">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Jalan, sawah, perbatasan dengan foto</div>
                                <div class="text-xs text-gray-500 mt-1">📍 Klik untuk melihat dokumentasi</div>
                </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">Lahan terdaftar tanpa dokumentasi</div>
                                <div class="text-xs text-gray-500 mt-1">🌱 Klik untuk info koordinat</div>
            </div>
        </div>

                        <div class="flex items-center gap-4 p-3 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl border border-orange-100">
                            <div class="w-10 h-10 bg-gradient-to-br from-orange-500 to-yellow-600 rounded-full flex items-center justify-center shadow-lg">
                                <i class="fas fa-home text-white text-sm"></i>
                            </div>
                <div>
                                <div class="font-semibold text-gray-800">Rumah Warga</div>
                                <div class="text-sm text-gray-600">Lokasi tempat tinggal penduduk</div>
                                <div class="text-xs text-gray-500 mt-1">🏠 Klik untuk info alamat lengkap</div>
                </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl border border-yellow-200">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <div class="font-semibold text-gray-800">Warna Marker Lahan</div>
                                <div class="text-sm text-gray-600">Setiap lahan memiliki warna berbeda untuk identifikasi mudah</div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-5 gap-2 mt-3">
                            <div class="flex flex-col items-center">
                                <div class="w-6 h-6 rounded-full bg-blue-500 border-2 border-white shadow-sm"></div>
                                <span class="text-xs text-gray-600 mt-1">Biru</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-6 h-6 rounded-full bg-red-500 border-2 border-white shadow-sm"></div>
                                <span class="text-xs text-gray-600 mt-1">Merah</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-6 h-6 rounded-full bg-green-500 border-2 border-white shadow-sm"></div>
                                <span class="text-xs text-gray-600 mt-1">Hijau</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-6 h-6 rounded-full bg-yellow-500 border-2 border-white shadow-sm"></div>
                                <span class="text-xs text-gray-600 mt-1">Kuning</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-6 h-6 rounded-full bg-purple-500 border-2 border-white shadow-sm"></div>
                                <span class="text-xs text-gray-600 mt-1">Ungu</span>
                            </div>
                        </div>

                        <div class="mt-3 p-3 bg-white/50 rounded-lg">
                            <div class="text-xs text-gray-700 font-medium mb-1">💡 Informasi Penting:</div>
                            <div class="text-xs text-gray-600 leading-relaxed">
                                • Warna <strong>tidak memiliki makna khusus</strong> - hanya untuk membedakan visual<br>
                                • Yang penting adalah <strong>ikon</strong> di dalam marker<br>
                                • Marker rumah warga selalu <strong>orange</strong> dengan ikon rumah
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl border border-indigo-200">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <div class="font-semibold text-gray-800">Cara Menggunakan Peta</div>
                                <div class="text-sm text-gray-600">Panduan interaksi dengan peta</div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-2">
                                ...
                                <span><strong>Hover</strong> marker untuk melihat nama pemilik</span>
                    </div>
                    <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-indigo-500 rounded-full"></span>
                                <span><strong>Klik</strong> marker untuk membuka popup detail</span>
                    </div>
                    <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-indigo-500 rounded-full"></span>
                                <span><strong>Scroll</strong> mouse untuk zoom in/out</span>
                        </div>
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-indigo-500 rounded-full"></span>
                                <span><strong>Drag</strong> untuk menggeser peta</span>
                    </div>
                    <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-indigo-500 rounded-full"></span>
                                <span><strong>Tekan R</strong> untuk reset zoom ke semua marker</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="p-6 bg-gradient-to-r from-slate-50 via-white to-blue-50 border-b border-gray-100">
                <div class="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button
                            onclick="copyBoundaryCoordinates()"
                            class="group bg-white hover:bg-emerald-50 border-2 border-gray-200 hover:border-emerald-300 text-gray-600 hover:text-emerald-600 px-6 py-3 rounded-2xl transition-all duration-300 font-semibold text-sm flex items-center gap-3 shadow-lg hover:shadow-xl hover:scale-105"
                            title="Salin koordinat batas desa"
                        >
                            <i class="fas fa-draw-polygon group-hover:scale-110 transition-transform"></i>
                            <span class="hidden sm:inline">Salin Koordinat Batas</span>
                        </button>
                    </div>
                </div>
            ...
            <div class="p-0 relative">
                <div id="map" class="h-[700px] w-full relative"></div>
                <div id="mapLoading" class="map-loading-overlay">
                    <div class="map-loading-box">
                        <div class="map-loading-spinner"></div>
                        <span class="text-sm">Sedang Memuat Peta…</span>
                        <div class="map-progress">
                            <div id="mapProgressBar" class="map-progress-bar"></div>
                        </div>
                    </div>
                </div>
            </div>
...
// Control map loading overlay visibility
const SHOW_MAP_LOADING = false;

// Dynamic coordinates from database (kantor desa)
const DESA_CENTER = @json($desaData ? [$desaData->longitude, $desaData->latitude] : [102.7528, -4.3089]);
const DESA_NAME = @json($desaData ? $desaData->nama_desa : 'Desa Ketapang Baru');
...
function initMap() {
    ...
    const existingImages = new Set(@json($existingImages ?? []));
    ...
    // Map-only loader (always present in DOM, we just hide it later)
    ...
    map.on('load', () => {
        ...
        // Progress handling: animate until style and sources are idle
        function startProgress() {
            if (!mapLoading || !mapProgressBar) return;
            progress = 10;
        ...
        // kick off progress (non-blocking overlay)
        startProgress();

        // mark progress as finished when map idle (all sources loaded)
        map.once('idle', () => {
            finishProgress();
        });
        ...
        validData.forEach((item, index) => {
            ...
            // 1) Use storage-backed photos array if present
            if (Array.isArray(item.photos) && item.photos.length > 0) {
                item.photos.forEach((p) => {
                    if (typeof p === 'string' && p.trim() !== '') {
                        imageUrls.push(`${assetBase}${p.replace(/^\//, '')}`);
                    }
                });
            ...
            } else if (item.foto_path && item.foto_path.trim() !== '') {
                ...
                for (let i = 2; i <= 5; i++) {
                    const cand = `${nik}-${i}.jpg`;
                    if (existingImages.has(cand)) {
                        imageUrls.push(`${imgBase}/${cand}`);
                        hasImage = true;
                    }
                }
            } else if (name && name !== 'Tidak diketahui') {
                // Name-based images are disabled by default to avoid 404 noise,
                // except for explicit allowed names like 'TANPA NAMA'
                const rawName = name.trim().toUpperCase();
                if (rawName === 'TANPA NAMA') {
                    const base = 'TANPA NAMA';
                    if (existingImages.has(`${base}.jpg`)) {
                        imageUrls.push(`${imgBase}/${base}.jpg`);
                        hasImage = true;
                    }
                    for (let i = 2; i <= 5; i++) {
                        const cand = `${base}-${i}.jpg`;
                        if (existingImages.has(cand)) {
                            imageUrls.push(`${imgBase}/${cand}`);
                            hasImage = true;
                        }
        ...
        // Removed extra image availability testing to avoid console noise

        // Auto-fit map to all lahan markers on first load (no need to press R)
        setTimeout(() => {
            if (markers.length > 0) {
                const fitBoundsAll = new mapboxgl.LngLatBounds();
                markers.forEach(m => fitBoundsAll.extend(m.getLngLat()));
                map.fitBounds(fitBoundsAll, {
                    padding: 60,
                    duration: 1200,
                    maxZoom: 16
                });
    ...
    setupSearch();
        ...
        // Try to add village boundary polygon from OSM (Nominatim)
        addVillageBoundary();

        // Enable manual draw tools for capturing boundary if needed
        enableDrawTools();

        // Add dynamic village boundary from database (wait for map to be fully ready)
        map.once('idle', () => {
            setTimeout(() => {
                addDynamicVillageBoundary();
            }, 500);
        });
}

function addWargaMarkers() {
    ...
    wargaData.forEach((warga, index) => {
        const lat = parseFloat(warga.lat);
        const lng = parseFloat(warga.long);

        // Tampilkan hanya yang memiliki lat/long numerik dan dalam rentang valid
        if (
            isNaN(lat) || isNaN(lng) ||
            lat < -90 || lat > 90 ||
            lng < -180 || lng > 180
        ...
        const name = warga.nama_lengkap || 'Tidak diketahui';
        const alamat = warga.alamat || 'Alamat tidak tersedia';
        const dusun = warga.dusun || '';
        const rtRw = warga.rt_rw || '';
        const nik = warga.nik || '';
        const anggotaKeluarga = warga.anggota_keluarga || [];
        const tempatLahir = warga.tempat_lahir || '';
        const tanggalLahir = warga.tanggal_lahir || '';
        const jenisKelamin = warga.jenis_kelamin || '';
        const agama = warga.agama || '';
        const statusPerkawinan = warga.status_perkawinan || '';
        const pekerjaan = warga.mata_pencaharian || '';
        const pendidikan = warga.pendidikan || '';
        const isKepalaKeluarga = warga.is_kepala_keluarga;
        const statusRumah = warga.status_rumah || '';
        const statusSosial = warga.status_sosial || '';
        const kelayakanRumah = warga.kelayakan_rumah || '';
        const mataPencaharian = warga.mata_pencaharian || '';
        const jumlahJiwaKk = warga.jumlah_jiwa_kk || '';
        const foto = warga.foto || '';
        const statusAktif = warga.status_aktif;
        const status = warga.status || '';
        ...
        if (tanggalLahir) {
            try {
                ...
                formattedTanggalLahir = tanggalLahir;
            }
        }
        ...
        // Status rumah mapping
        const statusRumahMap = {
            'MS': 'Milik Sendiri',
            'SW': 'Sewa'
        };

        // Status sosial mapping
        const statusSosialMap = {
            'ME': 'Mampu Ekonomi',
            'MSK': 'Miskin',
            'RM': 'Rumah Miskin',
            'MK': 'Miskin Kronis',
        ...
        // Kelayakan rumah mapping
        const kelayakanRumahMap = {
        ...
        // Mata pencaharian mapping
        const mataPencaharianMap = {
            'PTN': 'Pertanian',
            'SWT': 'Swasta',
            'PNS': 'PNS',
            'NLY': 'Nelayan',
        ...
        // Create warga marker with different style
        const el = document.createElement('div');
        el.className = 'warga-marker';
        el.style.width = '20px';
        ...
        el.style.zIndex = '10';
        el.innerHTML = `<i class="fas fa-home" style="color: white; font-size: 10px;"></i>`;
        el.title = `${name} - Rumah Warga`;

        // Create popup for warga
        const popupContent = `
            <div class="warga-popup-content" style="
                font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif;
                max-width: 400px;
                padding: 0;
                border-radius: 16px;
                ...
                <div style="padding: 16px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; gap: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-${jenisKelamin === 'L' || jenisKelamin === 'Laki-laki' ? 'male' : 'female'}" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Jenis Kelamin:</strong> ${jenisKelamin}</span>
                            </div>
                            ` : ''}
                            ${tempatLahir && tanggalLahir ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-birthday-cake" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Tempat/Tgl Lahir:</strong> ${tempatLahir}, ${formattedTanggalLahir}</span>
                            </div>
                            ` : ''}
                            ${umur ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-calendar" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Umur:</strong> ${umur}</span>
                            </div>
                            ` : ''}
                            ${agama ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-mosque" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Agama:</strong> ${agama}</span>
                            </div>
                            ` : ''}
                            ${statusPerkawinan ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-heart" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Status Perkawinan:</strong> ${statusPerkawinan}</span>
                            </div>
                            ` : ''}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        ">
                            ...
                            Anggota Keluarga (${anggotaKeluarga.length} orang)
                        </h4>
                        <div style="
                            background: #f8fafc;
                            border: 1px solid #e2e8f0;
                            ...
                            overflow-y: auto;
                        ">
                            ${anggotaKeluarga.length > 0 ? anggotaKeluarga.map((anggota, index) => {
                                const isKepala = anggota.nik === nik;
                                const umurAnggota = anggota.tanggal_lahir ? (() => {
                                    try {
                                ...
                                return `
                                    <div style="
                                        ...
                                        gap: 12px;
                                        padding: 8px;
                                        background: ${isKepala ? '#fef3c7' : 'white'};
                                        border-radius: 8px;
                                        margin-bottom: ${index < anggotaKeluarga.length - 1 ? '8px' : '0'};
                                        border: ${isKepala ? '1px solid #fbbf24' : '1px solid #e5e7eb'};
                                    ">
                                        <div style="
                                            width: 32px;
                                            height: 32px;
                                            background: ${isKepala ? '#f59e0b' : '#6b7280'};
                                            border-radius: 50%;
                                            display: flex;
                                            align-items: center;
                                            justify-content: center;
                                            flex-shrink: 0;
                                        ">
                                            <i class="fas fa-${anggota.jenis_kelamin === 'L' || anggota.jenis_kelamin === 'Laki-laki' ? 'male' : 'female'}" style="color: white; font-size: 12px;"></i>
                                        </div>
                                        <div style="flex: 1; min-width: 0;">
                                            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 2px;">
                                                <span style="font-size: 13px; font-weight: 600; color: #374151;">${anggota.nama_lengkap || 'Tidak diketahui'}</span>
                                                ${isKepala ? '<span style="background: #f59e0b; color: white; padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: 600;">KEPALA</span>' : ''}
                                            </div>
                                            <div style="font-size: 11px; color: #6b7280;">
                                                ${anggota.jenis_kelamin || ''} ${umurAnggota ? `• ${umurAnggota}` : ''} ${anggota.agama ? `• ${anggota.agama}` : ''}
                                            </div>
                                        </div>
                                    </div>
                                `;
                                ...
                                <div style="text-align: center; color: #6b7280; font-size: 13px; padding: 20px;">
                                    ...
                                    Data anggota keluarga tidak tersedia
                                </div>
                            `}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        <h4 style="
                            ...
                            align-items: center;
                        ">
                            <i class="fas fa-map-marker-alt" style="color: #6b7280; margin-right: 8px;"></i>
                            Informasi Alamat
                        </h4>
                        <div style="
                            background: #fef3c7;
                        ...
                        ">
                            <div style="font-size: 13px; color: #451a03; line-height: 1.4;">
                                ${alamat}
                                ${dusun ? `<br><strong>Dusun:</strong> ${dusun}` : ''}
                                ${rtRw ? `<br><strong>RT/RW:</strong> ${rtRw}` : ''}
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        <h4 style="
                            ...
                            align-items: center;
                        ">
                            <i class="fas fa-chart-line" style="color: #6b7280; margin-right: 8px;"></i>
                            Informasi Ekonomi & Sosial
                        </h4>
                        <div style="display: grid; gap: 8px;">
                            ${pekerjaan ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-briefcase" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Mata Pencaharian:</strong> ${mataPencaharianMap[pekerjaan] || pekerjaan}</span>
                            </div>
                            ` : ''}
                            ${pendidikan ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-graduation-cap" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Pendidikan:</strong> ${pendidikan}</span>
                            </div>
                            ` : ''}
                            ${statusRumah ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-home" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Status Rumah:</strong> ${statusRumahMap[statusRumah] || statusRumah}</span>
                            </div>
                            ` : ''}
                            ${statusSosial ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-chart-line" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Status Sosial:</strong> ${statusSosialMap[statusSosial] || statusSosial}</span>
                            </div>
                            ` : ''}
                            ${kelayakanRumah ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-hammer" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Kelayakan Rumah:</strong> ${kelayakanRumahMap[kelayakanRumah] || kelayakanRumah}</span>
                            </div>
                            ` : ''}
                        </div>
                    </div>
                    ...
                    ">
                        <div style="
                            ...
                            text-align: center;
                        ">
                            <div style="font-size: 10px; color: #0369a1; font-weight: 600; margin-bottom: 4px;">LAT</div>
                            <div style="font-size: 11px; color: #0c4a6e; font-weight: 600; font-family: monospace;">${lat.toFixed(4)}°</div>
                        </div>
                        <div style="
                            background: #f0f9ff;
                            border: 1px solid #0ea5e9;
                            ...
                            text-align: center;
                        ">
                            <div style="font-size: 10px; color: #0369a1; font-weight: 600; margin-bottom: 4px;">LNG</div>
                            <div style="font-size: 11px; color: #0c4a6e; font-weight: 600; font-family: monospace;">${lng.toFixed(4)}°</div>
                        </div>
                    </div>
        ...
        const popup = new mapboxgl.Popup({
            offset: 25,
            maxWidth: '420px',
            className: 'warga-popup',
            closeButton: true,
            closeOnClick: true
        }).setHTML(popupContent);

        // Ensure popup appears above all markers
        popup.on('open', () => {
        ...
        wargaMarkers.push(marker);
    });

}

function toggleWargaLayer() {
    showWargaLayer = !showWargaLayer;
    const btn = document.getElementById('wargaToggleBtn');

    wargaMarkers.forEach(marker => {
    ...
    // Show notification
    const message = showWargaLayer ?
        '<i class="fas fa-eye mr-2"></i>Layer warga ditampilkan' :
        '<i class="fas fa-eye-slash mr-2"></i>Layer warga disembunyikan';
...
function enhanceMapInteractions() {
    ...
    document.addEventListener('keydown', (e) => {
        ...
        // Ignore when user uses browser/system shortcuts (Ctrl/Cmd)
...
// Fetch and render village boundary polygon from Nominatim (OSM)
async function addVillageBoundary() {
    if (!map) return;

    const query = encodeURIComponent('Ketapang Baru, Talo, Seluma, Bengkulu, Indonesia');
    const url = `https://nominatim.openstreetmap.org/search?format=geojson&polygon_geojson=1&q=${query}`;

    try {
        const response = await fetch(url, {
            headers: {
                'Accept': 'application/json',
                'User-Agent': 'SmartVillage/1.0 (admin@smart-village.local)'
            }
        });
        ...
        if (!data || !data.features || data.features.length === 0) {
            ...
            const overpassFeature = await fetchBoundaryFromOverpass();
            if (!overpassFeature) {
                createNotification('<i class="fas fa-info-circle mr-2"></i>Batas desa tidak ditemukan di OSM. Gunakan alat gambar polygon untuk membuat batas manual.', 'warning');
                return;
            }
            return renderBoundaryFeature(overpassFeature);
        }

        const feature = data.features.find(f => f.geometry && (f.geometry.type === 'Polygon' || f.geometry.type === 'MultiPolygon')) || data.features[0];

        renderBoundaryFeature(feature);
    } catch (error) {
        createNotification('<i class="fas fa-times mr-2"></i>Gagal mengambil batas desa dari OSM', 'error');
    }
}

// Render a GeoJSON Feature (Polygon/MultiPolygon) as fill + line layers
function renderBoundaryFeature(feature) {
    ...
    const sourceId = 'village-boundary-src';
    const fillLayerId = 'village-boundary-fill';
    const lineLayerId = 'village-boundary-line';
    ...
    try {
        ...
        createNotification(`<i class="fas fa-check mr-2"></i>Batas ${DESA_NAME} ditambahkan`, 'success');
    } catch (error) {
        createNotification('<i class="fas fa-exclamation-triangle mr-2"></i>Gagal menambahkan batas desa', 'error');
    }
}

// Overpass fallback to fetch boundary of Ketapang Baru in Seluma, Bengkulu
async function fetchBoundaryFromOverpass() {
    const query = `
        [out:json][timeout:10];
        area["name"="Kabupaten Seluma"]["boundary"="administrative"]->.seluma;
        area["name"="Talo"]["boundary"="administrative"](area.seluma)->.talo;
        (
          relation["boundary"="administrative"]["admin_level"~"9|10"]["name"="Ketapang Baru"](area.talo);
        );
        out body;
        >; out skel qt;
    `;
    ...
    try {
        ...
        const feature = overpassToFeature(json);
        return feature;
    } catch (e) {
        if (e.name === 'AbortError') {
            // Timeout - use manual drawing instead
        } else {
...
// Convert Overpass JSON (relations with ways/nodes) to a GeoJSON Feature (MultiPolygon)
function overpassToFeature(overpassJson) {
    if (!overpassJson || !overpassJson.elements) return null;
    ...
    for (const el of elements) {
        ...
        if (el.type === 'relation' && !relation) relation = el;
    }
    if (!relation) return null;

    // Assemble polygons from relation members
    const polygons = [];
    const outerWays = relation.members?.filter(m => m.type === 'way' && m.role === 'outer') || [];
    const innerWays = relation.members?.filter(m => m.type === 'way' && m.role === 'inner') || [];

    const wayToCoords = (wayId) => {
        const w = waysById.get(wayId);
        if (!w || !w.nodes) return [];
        return w.nodes.map(nid => {
            const n = nodesById.get(nid);
            return n ? [n.lon, n.lat] : null;
        }).filter(Boolean);
    };

    // Group outer rings (simple approach assumes each outer way forms a ring)
    for (const m of outerWays) {
        const ring = wayToCoords(m.ref);
        if (ring.length > 3) polygons.push([ring]);
    }

    // Add inners (holes) – naive: append to first polygon
    for (const m of innerWays) {
        const hole = wayToCoords(m.ref);
        if (hole.length > 3 && polygons.length > 0) polygons[0].push(hole);
    }
...
// Compute bbox for a GeoJSON feature (Polygon/MultiPolygon/etc.)
...
// Return only coordinates array in plain [lng, lat] rings
function extractBoundaryCoordinates(feature) {
    if (!feature || !feature.geometry) return [];
    const geom = feature.geometry;
    if (geom.type === 'Polygon') {
        // [[ [lng,lat], ... ]] -> return as is
...
// Add dynamic village boundary from database
function addDynamicVillageBoundary() {
    if (!map) return;

    const batasWilayah = @json($batasWilayah ?? []);

    if (batasWilayah.length === 0) {
        // Fallback to predefined coordinates if no database data
        addPredefinedVillageBoundary();
        return;
    }

    // Create boundary from database coordinates
    const validCoords = batasWilayah
        .filter(batas => batas.koordinat && batas.koordinat.trim() !== '')
        .map(batas => {
            try {
                const coords = batas.koordinat.split(',').map(c => parseFloat(c.trim()));
    ...
    if (validCoords.length < 3) {
        // Need at least 3 points for a polygon - use predefined coordinates
        addPredefinedVillageBoundary();
        return;
    }
    ...
    // Render the boundary
    renderBoundaryFeature(polygonFeature);
}

// Fallback predefined village boundary (keep as backup)
function addPredefinedVillageBoundary() {
    if (!map) return;

    // Convert coordinates to GeoJSON MultiPolygon
    const polygon1 = [
        [-4.323413, 102.755740], [-4.323253, 102.755740], [-4.323107, 102.755740], [-4.322940, 102.755733],
        [-4.322758, 102.755740], [-4.322619, 102.755733], [-4.322488, 102.755733], [-4.322306, 102.755740],
        [-4.322015, 102.755729], [-4.321741, 102.755711], [-4.321632, 102.755710], [-4.321104, 102.755674],
        [-4.320522, 102.755638], [-4.319506, 102.755486], [-4.318684, 102.755585], [-4.317914, 102.755823],
        [-4.317181, 102.756314], [-4.317017, 102.759975], [-4.317329, 102.763860], [-4.317832, 102.767158],
        [-4.321935, 102.785541], [-4.323563, 102.790122], [-4.333132, 102.777763], [-4.337810, 102.770539],
        [-4.337468, 102.769939], [-4.336567, 102.768679], [-4.335374, 102.767344], [-4.333177, 102.764089],
        [-4.330276, 102.757981], [-4.329908, 102.757427], [-4.329517, 102.756988], [-4.329191, 102.756856],
        [-4.328806, 102.756853], [-4.328580, 102.756879], [-4.327840, 102.757226], [-4.327228, 102.757216],
        [-4.326373, 102.757133], [-4.325728, 102.757001], [-4.324416, 102.756458], [-4.323455, 102.755746]
    ];

    const polygon2 = [
        [-4.324632, 102.755060], [-4.325111, 102.755410], [-4.325368, 102.755642], [-4.325484, 102.755750],
        [-4.325700, 102.755899], [-4.325702, 102.755901], [-4.325947, 102.755973], [-4.326263, 102.755892],
        [-4.326472, 102.755809], [-4.326839, 102.755805], [-4.327015, 102.755706], [-4.327214, 102.755371],
        [-4.327290, 102.755042], [-4.327345, 102.754564], [-4.327299, 102.753849], [-4.327233, 102.753771],
        [-4.326907, 102.753817], [-4.326389, 102.754061], [-4.326344, 102.754663], [-4.325752, 102.754674],
        [-4.325471, 102.754330], [-4.325459, 102.753840], [-4.325801, 102.753585], [-4.325892, 102.753259],
        [-4.325374, 102.753243], [-4.325097, 102.753355], [-4.325022, 102.753737], [-4.324882, 102.754235],
        [-4.324749, 102.754863], [-4.324632, 102.755056]
    ];

    // Convert to [lng, lat] format and close polygons
    const coords1 = polygon1.map(coord => [coord[1], coord[0]]);
    const coords2 = polygon2.map(coord => [coord[1], coord[0]]);

    // Close polygons (first point = last point)
    ...
    // Render the boundary
    renderBoundaryFeature(multiPolygonFeature);
}

// Copy boundary coordinates helper (prefers existing rendered boundary, fallback to last drawn)
function copyBoundaryCoordinates() {
    // Try source from OSM/Overpass render
    const src = map.getSource && map.getSource('village-boundary-src');
    let feature = null;
    if (src && src._data) feature = src._data; // mapboxgl stores as _data

    // Fallback: try last drawn polygon (Mapbox Draw stores on the map)
    if (!feature && typeof MapboxDraw !== 'undefined' && map) {
        const controls = map._controls || [];
        const drawCtrl = controls.find(c => c && c.draw); // heuristic
        try {
            const fc = drawCtrl?.draw?.getAll?.();
            if (fc && fc.features && fc.features.length > 0) feature = fc.features[0];
        } catch {}
    }

    if (!feature) {
        createNotification('<i class="fas fa-exclamation-circle mr-2"></i>Tidak ada batas desa di peta / belum digambar', 'warning');
        return;
    }

    const coords = extractBoundaryCoordinates(feature);
    try {
        navigator.clipboard?.writeText?.(JSON.stringify(coords));
        createNotification('<i class="fas fa-check mr-2"></i>Koordinat batas tersalin ke clipboard', 'success');
    } catch {
        createNotification('<i class="fas fa-info-circle mr-2"></i>Tidak bisa menyalin otomatis, silakan unduh GeoJSON', 'info');
    }
...
// Enable Mapbox Draw for manual polygon capture
function enableDrawTools() {

    if (typeof MapboxDraw === 'undefined') {
        createNotification('<i class="fas fa-exclamation-triangle mr-2"></i>Alat gambar polygon tidak tersedia', 'warning');
        return;
    }
    ...
    map.on('draw.create', (e) => handleDrawChange(e, draw));
    map.on('draw.update', (e) => handleDrawChange(e, draw));

}

function handleDrawChange(e, draw) {
    const fc = draw.getAll();
    if (!fc || !fc.features || fc.features.length === 0) return;

    const feature = fc.features.find(f => f.geometry && (f.geometry.type === 'Polygon' || f.geometry.type === 'MultiPolygon')) || fc.features[0];
    if (!feature) return;

    const coordsOnly = extractBoundaryCoordinates(feature);
    try {
        navigator.clipboard?.writeText?.(JSON.stringify(coordsOnly));
        createNotification('<i class="fas fa-check mr-2"></i>Koordinat polygon disalin ke clipboard', 'success');
    } catch {}
    ...
    try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'batas-manual.geojson';
        document.body.appendChild(a);
        a.click();
        setTimeout(() => { document.body.removeChild(a); URL.revokeObjectURL(url); }, 0);
    } catch {}
