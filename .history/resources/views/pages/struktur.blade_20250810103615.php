    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: none;">
                <!-- Clean Two-Column Layout with Clear Lines -->
                <div class="relative">

                    <!-- TOP LEVEL: Kepala Desa + BPD (Side by Side) -->
                    <div class="flex justify-center items-start gap-16 mb-16">
                        <!-- Kepala Desa -->
                    ...
                    <div class="flex justify-center gap-16 mb-12">
                        ...
                        <!-- BPD Members (Right) -->
                        <div class="space-y-3">
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 rounded-xl p-3 text-center shadow-lg">
                    ...
                    <!-- BOTTOM LEVEL: Kasi/Kaur -->
                    <div class="text-center mb-8">
                        <h4 class="text-lg font-bold text-gray-800 mb-6">KASI & KAUR</h4>
                    ...
                    <!-- VERTICAL LINE FROM KASI/KAUR -->
                    <div class="flex justify-center mb-8">
                        <div class="w-px h-12 bg-orange-400"></div>
                    </div>

                    <!-- BOTTOM LEVEL: Kepala Dusun -->
                    <div class="text-center">
                        <h4 class="text-lg font-bold text-gray-800 mb-6">KEPALA DUSUN</h4>
