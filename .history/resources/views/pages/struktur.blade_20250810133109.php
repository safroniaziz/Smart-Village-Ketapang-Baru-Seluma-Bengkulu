        ...
        <div class="relative left-1/2 right-1/2 -mx-[50vw] w-screen">
            <section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50" data-aos="fade-up" data-aos-duration="400" data-aos-offset="50">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Card: Kepala Desa -->
                    <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2">
                        <!-- Header -->
