...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden min-h-screen flex items-center hero-gradient pt-16 md:pt-20">
    <!-- Background Pattern -->
...
<!-- Sub Navigation -->
<nav class="stat-subnav sticky top-16 md:top-20 z-30" aria-label="Navigasi Statistik">
