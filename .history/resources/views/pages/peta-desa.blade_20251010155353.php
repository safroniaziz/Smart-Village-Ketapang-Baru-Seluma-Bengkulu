...
function initMap() {
    ...
    map.on('load', () => {
        ...
        validData.forEach((item, index) => {
            ...
            // Create simple marker element (following potensi-wisata approach)
            ...
            el.innerHTML = `<i class="fas fa-seedling" style="transform: rotate(45deg); color: white; font-size: 16px;"></i>`;
