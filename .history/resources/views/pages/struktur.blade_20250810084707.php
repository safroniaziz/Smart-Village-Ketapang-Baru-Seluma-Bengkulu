            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center gap-32 mb-12">
                        <!-- Wakil Ketua -->
                        <div class="relative">
                            <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-6 text-white text-center shadow-xl min-w-[180px]">
                                <div class="w-20 h-20 bg-white/20 rounded-xl border-2 border-white/30 flex items-center justify-center mx-auto mb-4 overflow-hidden">
                                ...
                                <h4 class="text-sm font-bold mb-2">WAKIL KETUA</h4>
                                <p class="text-indigo-100 font-semibold text-sm">Halintarman</p>
                            </div>
