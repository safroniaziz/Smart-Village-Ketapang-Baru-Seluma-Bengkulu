...
<section class="py-24 bg-white">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20" data-aos="fade-up" data-aos-duration="800">
            <div class="inline-flex items-center bg-yellow-50 rounded-full px-6 py-3 mb-6">
                <i class="fas fa-star text-yellow-600 mr-3"></i>
                <span class="text-yellow-800 font-semibold">Potensi Unggulan</span>
            </div>
            <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-8">
                Kekayaan <span class="text-yellow-600">Desa</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Desa Ketapang Baru memiliki berbagai potensi yang dapat dikembangkan untuk kemajuan dan kesejahteraan masyarakat
            </p>
        </div>
