                    ...
                    <form id="formAjukanSurat" class="space-y-6" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="jenis_surat" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="mt-12" data-aos="fade-up" data-aos-delay="350">
                <div class="bg-white/95 text-gray-900 rounded-3xl shadow-2xl border border-white/50 p-6 md:p-8 text-left">
                    <h3 class="text-2xl font-bold mb-4">Form Pengajuan Surat</h3>
                    <p class="text-gray-600 mb-6">Isi data berikut untuk mengajukan surat. Setelah dikirim, Anda akan mendapatkan nomor tracking.</p>
                    <div id="suratMsg" class="hidden mt-2 mb-4 rounded-xl border p-4 text-sm"></div>
                    <form id="formAjukanSurat" class="space-y-6" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-2">NIK</label>
                                <input type="text" name="nik" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="no_hp" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="62xxxxxxxxxxx">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-2">Jenis Surat *</label>
                                <select name="jenis_surat" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="">Pilih jenis surat</option>
                                    <option value="Surat Pengantar">Surat Pengantar</option>
                                    <option value="Surat Keterangan">Surat Keterangan</option>
                                    <option value="Surat Izin">Surat Izin</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2">Keperluan *</label>
                            <textarea name="keperluan" rows="4" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Jelaskan keperluan surat..."></textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold mb-2">Lampiran (PDF/JPG/PNG, maks 5MB)</label>
                            <input type="file" name="lampiran" accept="application/pdf,image/*" class="w-full px-4 py-3 border border-gray-300 rounded-xl file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                        </div>

                        <div class="flex items-center justify-between gap-4">
                            <button type="submit" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-8 rounded-xl transition-all shadow">
                                <i class="fas fa-paper-plane mr-2"></i>Kirim Pengajuan
                            </button>
                            <div id="suratSuccess" class="hidden text-sm text-blue-800 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
                                <span class="font-semibold">Sukses.</span> Nomor Tracking: <span id="suratTrack" class="font-mono font-bold"></span>
                                <button id="copySuratTrack" type="button" class="ml-2 underline">Salin</button>
                            </div>
                        </div>
                    </form>
                </div>
