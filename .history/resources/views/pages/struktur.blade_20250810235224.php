            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-32 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="group bg-gradient-to-br from-blue-50 to-blue-100 border-4 border-blue-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[240px] lg:min-h-[280px] flex flex-col justify-center mb-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-blue-500">
                        ...
                        <!-- Sekretaris -->
                        <div class="group bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-2 lg:p-3 text-center shadow-lg w-full max-w-[220px] mx-auto relative transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-green-400">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 w-full pt-2">
                            <div class="relative">
                                ...
                                <div class="group bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-orange-400">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 w-full pt-2">
                            <div class="relative">
                                ...
                                <div class="group bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-red-400">
                    ...
                    <div class="hidden lg:flex flex-col items-center relative z-10">
                        ...
                        <div class="group hidden lg:block bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[240px] flex flex-col justify-center mb-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-purple-500">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 w-full pt-2 mb-2">
                            <div class="relative">
                                ...
                                <div class="group bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-purple-400">
                ...
                <div class="lg:hidden mt-12 w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center">
                        <!-- Ketua BPD -->
                        <div class="group bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[200px] flex flex-col justify-center mb-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-purple-500">
                            <div class="absolute -top-3 -right-3 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                <i class="fas fa-balance-scale text-white text-xs"></i>
                            </div>
                            <img src="{{ asset('images/struktur/bahirman.jpg') }}" alt="Ketua BPD" class="w-28 h-28 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover transition-transform duration-300 group-hover:scale-105" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
