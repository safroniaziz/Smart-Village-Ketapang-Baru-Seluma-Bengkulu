...
@section('content')
<!-- Hero Section -->
<section class="relative text-white overflow-hidden min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] flex items-center hero-gradient pt-8 py-8 lg:py-12 pb-16 lg:pb-20 mb-4 md:mb-6" data-aos="fade-in">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-white/5" data-aos="fade-in" data-aos-delay="100"></div>

    <!-- Floating Decorations -->
    <div class="absolute top-20 right-20 w-72 h-72 bg-gradient-to-br from-blue-200/20 to-purple-300/20 rounded-full blur-3xl" data-aos="fade-in" data-aos-delay="200"></div>
    <div class="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-br from-pink-200/20 to-rose-300/20 rounded-full blur-3xl" data-aos="fade-in" data-aos-delay="300"></div>

    <!-- Particle.js Container -->
    <div id="particles-pengaduan" class="absolute inset-0" data-aos="fade-in" data-aos-delay="400"></div>

    <div class="relative w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20" data-aos="fade-up" data-aos-delay="500">
        <div class="flex flex-col lg:flex-row items-center justify-center gap-8">
            ...
            <div class="flex-1 max-w-4xl relative z-10">
                <div class="text-center space-y-8">
                    <!-- Enhanced Badge -->
                    <div class="flex items-center justify-center space-x-4 mb-8" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-white">ASPIRASI WARGA</h2>
                            <p class="text-blue-100 text-sm font-medium">Pengaduan & Saran Masyarakat</p>
                        </div>
                    </div>

                    <!-- Enhanced Main Title -->
                    <h1 class="text-5xl lg:text-7xl font-black leading-tight mb-8" data-aos="fade-up" data-aos-delay="400">
                        <span class="bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">Pengaduan</span><br>
                        <span class="bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-400 bg-clip-text text-transparent font-extrabold">Masyarakat</span>
                    </h1>

                    <!-- Enhanced Badge -->
                    <div class="mb-8" data-aos="fade-up" data-aos-delay="500">
                        <div class="inline-flex items-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-8 py-4 rounded-full text-sm font-bold shadow-2xl hover:shadow-blue-500/25 transition-all duration-300">
                            <i class="fas fa-shield-check mr-3 text-yellow-300 text-lg"></i>
                            Transparan & Responsif
                        </div>
                    </div>

                    <!-- Enhanced Description -->
                    <p class="text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-3xl mx-auto font-light mb-12" data-aos="fade-up" data-aos-delay="600">
                        Sampaikan pengaduan, saran, dan kritik untuk kemajuan Desa Ketapang Baru. Setiap aspirasi akan
                        <span class="font-bold text-yellow-300 bg-yellow-300/20 px-2 py-1 rounded-lg">ditindaklanjuti dengan responsif</span>
                        dan transparan
                    </p>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-2xl font-black text-yellow-400">{{ number_format($totalPengaduan) }}</div>
                                <i class="fas fa-inbox text-white/60 text-lg"></i>
                            </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-2xl font-black text-yellow-400">{{ number_format($pengaduanSelesai) }}</div>
                                <i class="fas fa-check-circle text-white/60 text-lg"></i>
                            </div>
                            <div class="text-sm text-blue-100">Selesai</div>
                            <div class="text-xs text-blue-200 mt-1">
                                <i class="fas fa-percent text-green-300 mr-1"></i>
                                {{ $persentaseSelesai }}% dari total
                            </div>
                        </div>

                        <!-- Rata Waktu Respon (hari) -->
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-2xl font-black text-yellow-400">{{ $avgResponseTime }}</div>
                                <i class="fas fa-hourglass-half text-white/60 text-lg"></i>
                            </div>
                            <div class="text-sm text-blue-100">Rata Waktu Respon (hari)</div>
                            <div class="text-xs text-blue-200 mt-1">
                        ...
                        <!-- Tingkat Kepuasan (estimasi) -->
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-2xl font-black text-yellow-400">{{ $satisfactionRate }}%</div>
...
<section class="relative -mt-16 z-20 mb-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 lg:p-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-2">{{ number_format($totalPengaduan) }}</h3>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-2">{{ number_format($pengaduanSelesai) }}</h3>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-2">{{ number_format($pengaduanDalamProses) }}</h3>
                    <p class="text-gray-600 font-semibold">Dalam Proses</p>
                    <div class="mt-2">
                        <span class="text-xs text-yellow-600 font-bold bg-yellow-100 px-2 py-1 rounded-full">
                            {{ $persentaseDalamProses }}% dari total
                        </span>
                    </div>
                </div>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 mb-2">{{ number_format($pengaduanMenunggu) }}</h3>
                    <p class="text-gray-600 font-semibold">Menunggu</p>
                    <div class="mt-2">
                        <span class="text-xs text-purple-600 font-bold bg-purple-100 px-2 py-1 rounded-full">
                            {{ $persentaseMenunggu }}% dari total
                        </span>
                    </div>
                </div>
            </div>
...
<!-- Statistics -->
<section id="statistik" class="section-nav py-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
    <!-- Background Decorations -->
    <div class="absolute top-20 right-10 w-72 h-72 bg-gradient-to-br from-indigo-200/20 to-purple-300/20 rounded-full blur-3xl"></div>
    <div class="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-br from-pink-200/20 to-rose-300/20 rounded-full blur-3xl"></div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <!-- Enhanced Header -->
        <div class="text-center mb-16" data-aos="fade-up">
            <!-- Modern Badge with Gradient -->
            <div class="inline-flex items-center relative mb-8">
                <div class="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full blur-lg opacity-20"></div>
                <div class="relative bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-full text-sm font-bold shadow-lg">
                    <i class="fas fa-chart-bar mr-2"></i>
                    Statistik Pengaduan
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="w-32 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto rounded-full"></div>
            </div>

            <!-- Modern Description with Highlight -->
            <div class="max-w-4xl mx-auto mb-8">
                <p class="text-xl lg:text-2xl text-indigo-700 leading-relaxed">
