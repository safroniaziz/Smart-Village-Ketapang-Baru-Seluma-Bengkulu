...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartConfigs = {
        ...
        dusunPopulation: {
            type: 'doughnut',
            data: {
                labels: {!! json_encode(empty($dusunStats) || !is_array($dusunStats) ? ['Belum Ada Data'] : array_keys($dusunStats)) !!},
                datasets: [{
                    label: 'Populasi Per Dusun',
                    data: {!! json_encode(empty($dusunStats) || !is_array($dusunStats) ? [1] : array_values($dusunStats)) !!},
                    backgroundColor: [
                        'rgba(59, 130, 246, 0.8)',
                        'rgba(16, 185, 129, 0.8)',
                        'rgba(139, 92, 246, 0.8)',
