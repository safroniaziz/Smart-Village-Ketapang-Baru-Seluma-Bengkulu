                ...
                <div style="padding: 16px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; gap: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-id-card" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>No. KK:</strong> ${noKk}</span>
                            </div>
                            ` : ''}
                            ${jumlahJiwaKk ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-user-friends" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Jumlah Anggota Keluarga:</strong> ${jumlahJiwaKk} jiwa</span>
                            </div>
                            ` : ''}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; gap: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                ...
                                <span style="font-size: 13px; color: #374151;"><strong>Pekerjaan:</strong> ${pekerjaan}</span>
                            </div>
                            ` : ''}
                            ${mataPencaharian ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <i class="fas fa-industry" style="color: #6b7280; width: 16px;"></i>
                                <span style="font-size: 13px; color: #374151;"><strong>Mata Pencaharian:</strong> ${mataPencaharianMap[mataPencaharian] || mataPencaharian}</span>
                            </div>
                            ` : ''}
                            ${pendidikan ? `
                            <div style="display: flex; align-items: center; gap: 8px;">
