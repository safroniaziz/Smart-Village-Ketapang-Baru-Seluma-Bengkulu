...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const subJenisData = {
        ...
        'Surat Khusus': [
            { id: 'surat_kehilangan', name: 'Surat Keterangan Kehilangan', desc: 'Untuk keperluan kehilangan barang/dokumen', icon: 'fas fa-search', color: 'purple' }
        ]
    };
    ...
    const formTemplates = {
        ...
        'surat_kehilangan': {
            ...
            fields: [
                { name: 'jenis_barang', label: 'Jenis Barang yang Hilang', type: 'select', icon: 'fas fa-box', required: true, options: ['KTP', 'KK', 'SIM', 'BPJS', 'Dompet', 'HP/Smartphone', 'Laptop', 'Motor', 'Mobil', 'Dokumen Penting', 'Lainnya'] },
                { name: 'nama_barang', label: 'Nama/Deskripsi Barang', type: 'text', icon: 'fas fa-tag', required: true },
                { name: 'merk_barang', label: 'Merk Barang (jika ada)', type: 'text', icon: 'fas fa-trademark', required: false },
                { name: 'warna_barang', label: 'Warna Barang', type: 'text', icon: 'fas fa-palette', required: false },
                { name: 'nomor_seri', label: 'Nomor Seri/Polisi (jika ada)', type: 'text', icon: 'fas fa-hashtag', required: false },
                { name: 'tempat_kehilangan', label: 'Tempat Kehilangan', type: 'textarea', icon: 'fas fa-map-marker-alt', required: true },
                { name: 'tanggal_kehilangan', label: 'Tanggal Kehilangan', type: 'date', icon: 'fas fa-calendar', required: true },
                { name: 'waktu_kehilangan', label: 'Perkiraan Waktu Kehilangan', type: 'time', icon: 'fas fa-clock', required: false },
                { name: 'kronologi', label: 'Kronologi Kehilangan', type: 'textarea', icon: 'fas fa-list', required: true },
                { name: 'keperluan', label: 'Keperluan Surat', type: 'textarea', icon: 'fas fa-clipboard', required: true },
                { name: 'lampiran', label: 'Lampiran (Foto Barang, Bukti Kepemilikan)', type: 'file', icon: 'fas fa-paperclip', required: true }
            ]
        }
    };
