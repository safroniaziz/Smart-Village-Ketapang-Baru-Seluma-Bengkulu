            ...
            <div class="video-viewer-container flex-1 flex flex-col">
                ...
                <div class="video-player-wrapper flex-1 bg-black relative">
                    <iframe id="videoModalPlayer"
                            src="https://www.youtube.com/embed/{{ $youtubeId }}?enablejsapi=1&rel=0&modestbranding=1&controls=1&iv_load_policy=3&cc_load_policy=0&playsinline=1&autoplay=0&mute=0&fs=1&disablekb=0"
