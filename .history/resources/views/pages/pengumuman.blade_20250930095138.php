                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-4 border-t border-gray-100">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('pengumuman.show', $pengumuman->slug) }}" class="spectacular-btn text-white px-5 py-2 rounded-lg text-sm font-semibold hover:scale-105 transition-transform">
