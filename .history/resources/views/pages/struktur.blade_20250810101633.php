...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100" data-aos="fade-up" data-aos-duration="800">
            <div id="organization-chart" class="min-h-[600px]">
...
$(document).ready(function() {
    ...
    if (typeof $.fn.orgchart === 'undefined') {
        console.error('OrgChart.js is not loaded!');
        $('#organization-chart').html('<div style="text-align: center; padding: 40px; color: #ef4444;"><h3>Loading Organizational Chart...</h3><p>Please wait while we load the chart library.</p></div>');
        return;
    }
