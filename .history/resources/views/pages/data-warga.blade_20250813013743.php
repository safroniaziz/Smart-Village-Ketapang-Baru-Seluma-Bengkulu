...
<div class="py-16 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
    <div class="w-full lg:w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl mb-8" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
            <!-- Main Search Bar -->
            <div class="mb-8">
                <div class="relative">
            ...
            <div class="px-8 py-6 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-100">
                <div class="flex flex-col sm:flex-row items-center justify-between">
                    <div class="flex items-center gap-4 mb-4 sm:mb-0">
                        ...
                        <div>
                            <div class="text-sm text-green-600 font-medium">Data Warga Desa</div>
