                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="text-center">
                            <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-6 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                                <div class="w-20 h-20 bg-white/20 rounded-xl border-2 border-white/30 flex items-center justify-center mx-auto mb-4 overflow-hidden">
                                    <img src="{{ asset('images/struktur/basri.jpg') }}"
                                         alt="Basri"
                                         class="w-full h-full object-cover"
                                         onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                    <i class="fas fa-map-marker-alt text-white text-lg hidden"></i>
                                </div>
