                ...
                <div id="pdfViewerContainer" class="w-full h-full bg-white">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <a href="{{ asset('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf') }}"
                               download
                    ...
                    <div class="pdf-simple-viewer bg-white overflow-hidden" style="height: calc(80vh - 120px); min-height: 500px;">
                        ...
                        <iframe
                            src="{{ asset('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf') }}"
                            width="100%"
                            height="100%"
                            ...
                            onerror="this.src='https://docs.google.com/gview?url={{ urlencode(asset('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf')) }}&embedded=true'">
                        </iframe>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <a href="{{ asset('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf') }}"
                                       ...
                                       class="inline-flex items-center w-full justify-center px-6 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl font-medium">
                                        ...
                                        Download PDF
                                        @if(file_exists(public_path('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf')))
                                        <span class="ml-2 text-sm opacity-80">
                                            ({{ number_format(filesize(public_path('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf')) / 1024, 0) }} KB)
                                        </span>
                                        @endif
                                    </a>

                                    <a href="https://docs.google.com/gview?url={{ urlencode(asset('assets/files/BERKAS LOMBA DESA WISATA KETAPANG BARU.pdf')) }}"
                                       target="_blank"
