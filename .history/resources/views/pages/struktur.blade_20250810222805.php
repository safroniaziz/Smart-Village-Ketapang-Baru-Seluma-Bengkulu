        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-8">
            ...
            <div class="flex-1 w-full relative z-10">
                <div class="text-center space-y-8">
                    ...
                    <!-- Description -->
                    <p class="text-lg lg:text-xl text-blue-100 leading-relaxed w-full mx-auto font-light mb-12">
                    ...
                    <!-- Quick Stats -->
                    <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 w-full mx-auto mb-8">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-32 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-20 w-full pt-4">
                            <div class="relative">
                                ...
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/ajasseriani.jpg') }}" alt="Kepala Dusun 1" class="w-16 h-16 lg:w-28 lg:h-28 rounded-xl border-2 border-red-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-red-300"></div>
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/meri.jpg') }}" alt="Kepala Dusun 2" class="w-16 h-16 lg:w-28 lg:h-28 rounded-xl border-2 border-red-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
