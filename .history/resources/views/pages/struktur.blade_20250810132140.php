    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="grid grid-cols-2 gap-4 max-w-xl w-full pt-4">
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-300"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/kebat.jpg') }}" alt="Sekretaris BPD" class="w-28 h-28 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                        ...
                        <div class="grid grid-cols-2 gap-4 max-w-xl w-full pt-4">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-300"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/susti.jpg') }}" alt="Anggota BPD" class="w-28 h-28 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                            ...
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-300"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-4 text-center shadow-lg">
                                    <img src="{{ asset('images/struktur/dhesty.jpg') }}" alt="Anggota BPD" class="w-28 h-28 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                    <h6 class="font-bold text-sm mb-1">Anggota BPD</h6>
        ...
        <div class="relative left-1/2 right-1/2 -mx-[50vw] w-screen">
            <section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50" data-aos="fade-up" data-aos-duration="800">
                ...
                <!-- Tabs for Tugas vs Wewenang -->
                <div class="flex justify-center mb-8">
                    <div class="bg-white rounded-2xl p-2 shadow-lg border border-gray-200">
                        <button id="tugas-tab" class="px-8 py-3 rounded-xl font-semibold text-blue-600 bg-blue-50 border-2 border-blue-200 transition-all duration-300 hover:bg-blue-100">
                            <i class="fas fa-tasks mr-2"></i>TUGAS
                        </button>
                        <button id="wewenang-tab" class="px-8 py-3 rounded-xl font-semibold text-purple-600 bg-transparent border-2 border-transparent transition-all duration-300 hover:bg-purple-50">
                            <i class="fas fa-gavel mr-2"></i>WEWENANG
                        </button>
                    </div>
                </div>

                <!-- Tugas Content -->
                <div id="tugas-content" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Card: Kepala Desa - TUGAS -->
                    <div class="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-500 shadow-lg hover:shadow-2xl p-8 transform hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-6">
                            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-user-tie text-2xl"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-2xl text-gray-900">👑 Kepala Desa</h4>
                                <p class="text-blue-700 font-medium">TUGAS UTAMA</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">1</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Penyelenggaraan Pemerintahan</h5>
                                    <p class="text-gray-700 text-sm">Memimpin dan mengkoordinasikan seluruh kegiatan pemerintahan desa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">2</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pembangunan Desa</h5>
                                    <p class="text-gray-700 text-sm">Menyusun dan melaksanakan program pembangunan sesuai RPJMDes</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">3</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pelayanan Publik</h5>
                                    <p class="text-gray-700 text-sm">Memastikan pelayanan administrasi dan kependudukan berjalan optimal</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Card: BPD - TUGAS -->
                    <div class="group bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-500 shadow-lg hover:shadow-2xl p-8 transform hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-6">
                            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-gavel text-2xl"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-2xl text-gray-900">⚖️ Badan Permusyawaratan Desa</h4>
                                <p class="text-purple-700 font-medium">TUGAS UTAMA</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">1</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Penampung Aspirasi</h5>
                                    <p class="text-gray-700 text-sm">Menjaring dan menyalurkan aspirasi masyarakat desa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">2</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pengawasan</h5>
                                    <p class="text-gray-700 text-sm">Mengawasi pelaksanaan Perdes, APBDes, dan kinerja perangkat</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">3</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Musyawarah</h5>
                                    <p class="text-gray-700 text-sm">Memfasilitasi musyawarah desa untuk keputusan strategis</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Wewenang Content (Hidden by default) -->
                <div id="wewenang-content" class="hidden grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Card: Kepala Desa - WEWENANG -->
                    <div class="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-500 shadow-lg hover:shadow-2xl p-8 transform hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-6">
                            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div>
                                <h4 class="font-bold text-2xl text-gray-900">👑 Kepala Desa</h4>
                                <p class="text-blue-700 font-medium">WEWENANG KHUSUS</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">1</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Penetapan Kebijakan</h5>
                                    <p class="text-gray-700 text-sm">Berhak menetapkan kebijakan pemerintahan, pembangunan, dan kemasyarakatan</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">2</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Penandatanganan Dokumen</h5>
                                    <p class="text-gray-700 text-sm">Berhak menandatangani Perdes, Keputusan, dan dokumen resmi desa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-blue-200">
                                <div class="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mt-1">3</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pengangkatan Perangkat</h5>
                                    <p class="text-gray-700 text-sm">Berhak mengangkat dan memberhentikan perangkat desa</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl border-2 border-purple-200 hover:border-purple-400 transition-all duration-500 shadow-lg hover:shadow-2xl p-8 transform hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h4 class="font-bold text-2xl text-gray-900">⚖️ Badan Permusyawaratan Desa</h4>
                                <p class="text-purple-700 font-medium">WEWENANG KHUSUS</p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">1</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pembahasan Perdes</h5>
                                    <p class="text-gray-700 text-sm">Berhak membahas dan menyepakati Rancangan Peraturan Desa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">2</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Pengawasan Kinerja</h5>
                                    <p class="text-gray-700 text-sm">Berhak mengawasi dan mengevaluasi kinerja pemerintah desa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 p-4 bg-white/60 rounded-xl border border-purple-200">
                                <div class="w-8 h-8 rounded-full bg-purple-500 text-white flex items-center justify-center text-sm font-bold mt-1">3</div>
                                <div>
                                    <h5 class="font-semibold text-gray-900 mb-1">Musyawarah Desa</h5>
                                    <p class="text-gray-700 text-sm">Berhak memfasilitasi dan memimpin musyawarah desa</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        const tugasTab = document.getElementById('tugas-tab');
                        const wewenangTab = document.getElementById('wewenang-tab');
                        const tugasContent = document.getElementById('tugas-content');
                        const wewenangContent = document.getElementById('wewenang-content');

                        tugasTab.addEventListener('click', function() {
                            tugasTab.classList.add('bg-blue-50', 'border-blue-200', 'text-blue-600');
                            tugasTab.classList.remove('bg-transparent', 'border-transparent', 'text-purple-600');
                            wewenangTab.classList.remove('bg-purple-50', 'border-purple-200', 'text-purple-600');
                            wewenangTab.classList.add('bg-transparent', 'border-transparent', 'text-purple-600');

                            tugasContent.classList.remove('hidden');
                            wewenangContent.classList.add('hidden');
                        });

                        wewenangTab.addEventListener('click', function() {
                            wewenangTab.classList.add('bg-purple-50', 'border-purple-200', 'text-purple-600');
                            wewenangTab.classList.remove('bg-transparent', 'border-transparent', 'text-purple-600');
                            tugasTab.classList.remove('bg-blue-50', 'border-blue-200', 'text-blue-600');
                            tugasTab.classList.add('bg-transparent', 'border-transparent', 'text-blue-600');

                            wewenangContent.classList.remove('hidden');
