        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8" data-aos="fade-up" data-aos-delay="700">
                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        ...
                        <div class="text-xs text-blue-200 mt-1 flex items-center justify-center">
                            ...
                            <span>{{ $pendapatan->count() }} item</span>
                        </div>
                    </div>
                    ...
                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        ...
                        <div class="text-xs text-blue-200 mt-1 flex items-center justify-center">
                            ...
                            <span>{{ $belanja->count() }} item</span>
                        </div>
                    </div>

                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-2xl font-black text-yellow-400 animate-pulse mb-1">{{ $paguEarmarks->count() }}</div>
                        <div class="text-sm text-blue-100 font-medium">Pagu Earmark</div>
                        <div class="text-xs text-blue-200 mt-1 flex items-center justify-center">
                            <i class="fas fa-clipboard-list text-blue-300 mr-1"></i>
                            <span>Kegiatan</span>
                        </div>
                    </div>

                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-2xl font-black text-yellow-400 animate-pulse mb-1">{{ $bltRecipients->count() }}</div>
                ...
                <div class="mb-8" data-aos="fade-up" data-aos-delay="800">
                    <label class="block text-lg font-semibold mb-4 text-white">Pilih Tahun Anggaran</label>
                ...
                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 pt-4" data-aos="fade-up" data-aos-delay="900">
                    <a href="#stats" class="inline-flex items-center justify-center px-8 py-4 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-2xl hover:bg-white/30 transition-all duration-300 border border-white/20">
                        <i class="fas fa-chart-bar mr-3"></i>
                        Lihat Detail Anggaran
                    </a>
                    <a href="{{ route('home') }}" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-semibold rounded-2xl hover:shadow-lg hover:scale-105 transition-all duration-300">
