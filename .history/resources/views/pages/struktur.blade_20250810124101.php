    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="relative grid grid-cols-2 items-center gap-12 min-w-[1024px] mx-auto mb-6">
                    <!-- Dotted line across center (behind cards) -->
                    <div class="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 border-t-4 border-dashed border-purple-500"></div>
