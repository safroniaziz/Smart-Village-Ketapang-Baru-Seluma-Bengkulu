        ...
        <div class="modal-body p-0">
            <div class="pdf-viewer-container">
                ...
                <div id="pdfViewerContainer" class="w-full h-full">
                    ...
                    <iframe id="pdfViewer"
                            src="/vendor/pdfjs/web/viewer.html?file={{ urlencode(asset('storage/' . $wisata->file_potensi_desa)) }}"
                            class="w-full h-full"
                            frameborder="0">
                    </iframe>
                    
                    <!-- Fallback content (hidden by default) -->
                    <div id="pdfFallback" class="flex items-center justify-center h-full bg-gradient-to-br from-blue-50 to-teal-50 p-8" style="display: none;">
                        <div class="text-center max-w-md">
                            <div class="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                <i class="fas fa-file-pdf text-3xl text-red-600"></i>
                            </div>
                            <h3 class="text-xl font-bold text-gray-800 mb-3">Preview Tidak Tersedia</h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Browser tidak dapat menampilkan preview PDF secara langsung. 
                                Gunakan opsi di bawah untuk mengakses dokumen.
                            </p>
                            <div class="space-y-3">
                                <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}" 
                                   target="_blank"
                                   class="inline-flex items-center w-full justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                                    <i class="fas fa-external-link-alt mr-2"></i>
                                    Buka di Tab Baru
                                </a>
                                <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}" 
                                   download
                                   class="inline-flex items-center w-full justify-center px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                                    <i class="fas fa-download mr-2"></i>
                                    Download PDF ({{ number_format(filesize(storage_path('app/public/' . $wisata->file_potensi_desa)) / 1024, 1) }} KB)
                                </a>
                            </div>
            ...
            if (modal) {
                ...
                if (iframe) {
                    iframe.onerror = function() {
                        console.log('PDF failed to load in iframe, trying alternative method');
                        
                        // Fallback: show error message and direct download
                        ...
                        pdfContainer.innerHTML = `
                            <div class="flex items-center justify-center h-full bg-gray-100 p-8">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-800 mb-2">PDF Tidak Dapat Ditampilkan</h3>
                                    <p class="text-gray-600 mb-4">Browser Anda tidak mendukung tampilan PDF inline.</p>
                                    <div class="space-y-3">
                                        <a href="${iframe.src}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-300">
                                            <i class="fas fa-external-link-alt mr-2"></i>
                                            Buka PDF di Tab Baru
                                        </a>
                                        <br>
                                        <a href="${iframe.src}" download class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg transition-all duration-300">
                                            <i class="fas fa-download mr-2"></i>
                                            Download PDF
                                        </a>
                                    </div>
