        ...
        <div class="modal-body p-0">
            <div class="pdf-viewer-container">
                ...
                <div id="pdfViewerContainer" class="w-full h-full">
                    <!-- Direct PDF Viewer (primary) -->
                    <iframe id="pdfViewer"
                            src="{{ asset('storage/' . $wisata->file_potensi_desa) }}#toolbar=1&navpanes=1&scrollbar=1"
                            class="w-full h-full"
                            frameborder="0"
                            type="application/pdf">
                        <p>Browser Anda tidak mendukung tampilan PDF. <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}" target="_blank">Klik di sini untuk membuka PDF</a></p>
                    </iframe>
