        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-16">
            ...
            <div class="group bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 hover:shadow-2xl hover:scale-105 transition-all duration-500" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-100">
                            @if($monografi && $monografi->google_street_view_url)
...
@else
<!-- Empty State - Profil Desa Belum Diatur -->
<section class="hero-section relative text-white overflow-hidden min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] flex items-center pt-8 py-8 lg:py-12 pb-16 lg:pb-20 mb-4 md:mb-6" data-aos="fade-in">
    <!-- Background Pattern -->
    ...
    <div class="relative w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
        ...
        <div class="space-y-6" data-aos="fade-up" data-aos-delay="200">
            <h1 class="text-4xl lg:text-5xl font-bold text-white">
                Profil Desa Belum Diatur
            </h1>
            <p class="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Informasi tentang desa belum diatur oleh administrator. Silakan kembali lagi nanti untuk melihat profil lengkap desa.
            </p>

            <!-- Default Info Card -->
            <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 max-w-md mx-auto">
                <h3 class="text-lg font-semibold text-white mb-4">Desa Ketapang Baru</h3>
                <div class="space-y-3 text-blue-100">
                    <div class="flex items-center justify-center gap-3">
                        <i class="fas fa-map-marker-alt text-yellow-400"></i>
                        <span>Kecamatan Semidang Alas Maras</span>
                    </div>
                    <div class="flex items-center justify-center gap-3">
                        <i class="fas fa-building text-yellow-400"></i>
                        <span>Kabupaten Seluma</span>
                    </div>
                </div>
            </div>
