        ...
        <div class="modal-body p-0">
            <div class="pdf-viewer-container">
                ...
                <div id="pdfViewerContainer" class="w-full h-full bg-white">
                    ...
                    <!-- PDF.js Viewer -->
                    <div class="pdf-viewer-wrapper bg-white overflow-hidden" style="height: calc(80vh - 120px); min-height: 500px;">
                        <iframe 
                            src="https://mozilla.github.io/pdf.js/web/viewer.html?file={{ urlencode(asset('storage/' . $wisata->file_potensi_desa)) }}"
                            width="100%"
                            height="100%"
                            class="pdf-viewer-frame border-0"
                            title="PDF Viewer - {{ $wisata->nama_wisata }}"
                            style="border: none;">
                            
                            <!-- Fallback for PDF.js loading issues -->
                            <div class="flex items-center justify-center h-full bg-gray-50">
                                <div class="text-center p-8 max-w-md">
                                    <div class="mb-6">
                                        ...
                                        <h5 class="text-lg font-bold text-gray-800 mb-2">Loading PDF...</h5>
                                        <div class="w-8 h-8 border-2 border-blue-200 border-t-blue-600 rounded-full animate-spin mx-auto mb-4"></div>
                                    </div>

                                    <p class="text-gray-600 mb-6 text-sm">Jika PDF tidak muncul dalam beberapa detik, silakan gunakan opsi alternatif:</p>

                                    <div class="space-y-3">
                                        <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}"
                                           target="_blank"
                                           class="inline-flex items-center w-full justify-center px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">
                                            <i class="fas fa-external-link-alt mr-2"></i>
                                            Buka di Tab Baru
                                        </a>
                                        ...
                                        <a href="{{ asset('storage/' . $wisata->file_potensi_desa) }}"
                                           download
                                           class="inline-flex items-center w-full justify-center px-4 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors text-sm font-medium">
                                    ...
                                    <div class="mt-4 p-2.5 bg-blue-50 border border-blue-200 rounded-lg">
                                        <div class="flex items-start text-xs text-blue-800">
                                            <i class="fas fa-info-circle mt-0.5 mr-2 text-blue-600"></i>
                                            <span>PDF.js memberikan pengalaman viewing yang optimal di semua browser</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
