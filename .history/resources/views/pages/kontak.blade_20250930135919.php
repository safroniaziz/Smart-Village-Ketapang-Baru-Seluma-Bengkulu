    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8" data-aos="fade-up">
            <div class="text-center md:text-left">
                ...
                <p class="text-gray-600">Lihat tampilan lokasi melalui Google Street View atau peta</p>
            </div>
            @if(isset($monografi) && $monografi && $monografi->google_street_view_url)
                <a href="{{ $monografi->google_street_view_url }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition" rel="noopener">
