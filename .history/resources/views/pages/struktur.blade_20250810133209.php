...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative left-1/2 right-1/2 -mx-[50vw] w-screen">
            <section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50" data-aos="fade-up" data-aos-duration="400" data-aos-offset="50">
                <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Section Header - match Home Services style -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <!-- Card: Kepala Desa -->
                    <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                        <!-- Header -->
                    ...
                    <!-- Card: BPD -->
                    <div class="group bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 rounded-3xl border-2 border-purple-300 hover:border-purple-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2" data-aos="fade-up" data-aos-duration="300" data-aos-delay="200">
                        <!-- Header -->
                        <div class="flex items-center gap-4 mb-8">
...
<section class="py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white relative overflow-hidden">
    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl mx-auto text-center" data-aos="fade-up" data-aos-duration="200" data-aos-offset="20">
