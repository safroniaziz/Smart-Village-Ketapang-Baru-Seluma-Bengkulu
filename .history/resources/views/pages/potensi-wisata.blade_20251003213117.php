    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6" data-aos="fade-right">
                <div class="section-badge bg-teal-100 text-teal-800">
            ...
            <div class="space-y-6" data-aos="fade-left" data-aos-delay="200">
                <div class="info-card">
                    <div class="info-card-icon bg-teal-100 text-teal-600">
                ...
                <div class="info-card">
                    <div class="info-card-icon bg-yellow-100 text-yellow-600">
                        <i class="fas fa-star"></i>
                    </div>
                    <h3>Rating Pengunjung</h3>
                    <p>4.8/5 ⭐⭐⭐⭐⭐ (Sangat Memuaskan)</p>
                </div>
            </div>
        </div>
    </div>
