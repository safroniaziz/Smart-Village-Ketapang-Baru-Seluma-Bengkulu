        ...
        <div class="overflow-x-auto">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative max-w-[85%] mx-auto">
                    ...
                    <div class="hidden lg:block absolute top-[140px] left-1/2 w-80 h-1 border-t-4 border-dashed border-purple-500 transform -translate-x-1/2 z-10 pointer-events-none" style="box-shadow: 0 0 8px rgba(139, 92, 246, 0.3);"></div>
