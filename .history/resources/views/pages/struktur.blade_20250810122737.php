    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <!-- Single centered dotted line connecting the two cards -->
                <div class="relative mb-8 min-w-[1024px] mx-auto">
                    <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] md:w-[50%] lg:w-[40%] h-0 border-t-4 border-dashed border-purple-500"></div>
                </div>
