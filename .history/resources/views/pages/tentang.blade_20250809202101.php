            ...
            <div class="flex-1 max-w-4xl relative z-10">
                <div class="text-center space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center relative z-20 mb-12" data-aos="fade-up" data-aos-delay="800">
                        <a href="{{ route('visi.misi') }}" class="group relative overflow-hidden bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:from-yellow-500 hover:via-orange-600 hover:to-red-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-500/25">
                            <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <div class="relative flex items-center justify-center">
                                <i class="fas fa-bullseye mr-2 text-base"></i>
                                <span class="text-base">Lihat Visi & Misi</span>
                            </div>
                        </a>

                        <a href="{{ route('struktur') }}" class="group bg-white/15 hover:bg-white/25 backdrop-blur-md border-2 border-white/30 hover:border-white/50 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                            <div class="flex items-center justify-center">
                                <i class="fas fa-sitemap mr-2 text-base"></i>
                                <span class="text-base">Struktur Organisasi</span>
                            </div>
                        </a>
                    </div>
                </div>
