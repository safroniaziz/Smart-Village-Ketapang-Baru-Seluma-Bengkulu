...
<!-- Complaint Form -->
<section class="py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden" data-aos="fade-up">
    <!-- Animated Background Elements -->
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-blue-400/20 to-indigo-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute top-40 right-20 w-96 h-96 bg-gradient-to-br from-purple-400/20 to-pink-500/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
        <div class="absolute bottom-20 left-1/4 w-64 h-64 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-20" data-aos="fade-up" data-aos-delay="100">
            <!-- Floating Badge -->
            <div class="inline-flex items-center relative mb-8 group">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-full blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
                <div class="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white px-8 py-4 rounded-full text-sm font-bold shadow-2xl group-hover:scale-105 transition-transform duration-300">
                    <i class="fas fa-comment-dots mr-3 text-yellow-300"></i>
            ...
            <!-- Spectacular Title -->
            <div class="mb-12">
                <h2 class="text-6xl lg:text-8xl font-black mb-6 leading-tight">
            ...
            <div class="max-w-5xl mx-auto">
                <p class="text-2xl lg:text-3xl text-gray-700 leading-relaxed font-light">
                    <span class="font-bold text-slate-800">Kirim pengaduan, saran, dan kritik</span> untuk kemajuan Desa Ketapang Baru.<br>
                    <span class="relative inline-block mt-2">
                        <span class="relative z-10 font-bold text-blue-700 text-3xl">Setiap aspirasi akan ditindaklanjuti</span>
                        <span class="absolute bottom-0 left-0 w-full h-4 bg-gradient-to-r from-blue-200 via-indigo-200 to-purple-200 opacity-60 rounded-lg"></span>
                    </span>
                </p>
            </div>
        </div>
        ...
        <div id="form-pengaduan" class="relative group" data-aos="fade-up" data-aos-delay="200">
            <!-- Glowing Background -->
            <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
            
            <!-- Main Form Container -->
            <div class="relative bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/50 rounded-3xl shadow-2xl border border-white/50 overflow-hidden backdrop-blur-sm">
                <!-- Animated Border -->
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style="padding: 2px;">
                    <div class="w-full h-full bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/50 rounded-3xl"></div>
                </div>
                
                <div class="relative p-12 lg:p-16" data-aos="fade-up" data-aos-delay="300">
                    <!-- Spectacular Form Header -->
                    <div class="text-center mb-16">
                        <div class="relative inline-block mb-8">
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-3xl blur-lg opacity-30"></div>
                            <div class="relative w-24 h-24 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 rounded-3xl flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="max-w-3xl mx-auto">
                            <p class="text-xl text-gray-700 leading-relaxed mb-4">
                                Sampaikan pengaduan Anda dengan detail dan jelas. 
                                <span class="font-bold text-blue-700">Data akan kami jaga kerahasiaannya</span> dan 
                                <span class="font-bold text-indigo-700">ditindaklanjuti dengan serius</span>.
                            </p>
