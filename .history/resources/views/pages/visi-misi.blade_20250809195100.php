...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-br from-green-600 via-emerald-700 to-teal-800 text-white overflow-hidden py-20 lg:py-32">
    <!-- Background Pattern -->
    ...
    <div class="relative w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div class="text-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="inline-flex items-center space-x-3 mb-8" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="text-left">
                    <h3 class="text-xl font-bold text-green-100">ARAH PEMBANGUNAN</h3>
                    <p class="text-sm text-green-200">Visi & Misi Desa</p>
                </div>
            </div>
            ...
            <p class="text-xl lg:text-2xl text-green-100 max-w-4xl mx-auto leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="600">
    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20" data-aos="fade-up" data-aos-duration="800">
            <div class="inline-flex items-center bg-green-50 rounded-full px-6 py-3 mb-6">
                ...
                <span class="text-green-800 font-semibold">Misi Strategis</span>
            </div>
            <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-8">
                <span class="text-green-600">9 Misi</span> Desa Ketapang Baru
            </h2>
            <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Untuk mewujudkan visi tersebut, kami menetapkan 9 misi strategis yang akan dilaksanakan secara konsisten dan berkelanjutan
            </p>
        </div>
