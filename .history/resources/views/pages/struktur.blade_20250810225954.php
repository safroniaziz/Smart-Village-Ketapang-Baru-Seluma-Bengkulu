...
<section class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" style="background: linear-gradient(135deg, #0086c9 0%, #0074b3 50%, #006ba3 100%);">
    ...
    <div class="relative w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="flex flex-col lg:flex-row items-center justify-center gap-8">
            ...
            <div class="flex-1 max-w-4xl relative z-10 mx-auto">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-32 lg:items-start relative w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 border-4 border-blue-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[240px] lg:min-h-[280px] flex flex-col justify-center mb-6">
                        ...
                        <!-- Sekretaris -->
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-2 lg:p-3 text-center shadow-lg w-full max-w-[220px] mx-auto relative">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-16 w-full pt-4">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-orange-300"></div>
                                <div class="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 w-full pt-4">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-red-300"></div>
                                <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="hidden lg:block bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 lg:p-6 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[280px] flex flex-col justify-center mb-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-16 w-full pt-4 mb-6">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-400"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-2 lg:p-3 text-center shadow-lg max-w-[220px] mx-auto">
                ...
                <div class="lg:hidden mt-12 w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center">
                        <!-- Ketua BPD -->
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-4 text-center shadow-xl relative w-full max-w-[220px] mx-auto min-h-[200px] flex flex-col justify-center mb-6">
                            <div class="absolute -top-3 -right-3 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                <i class="fas fa-balance-scale text-white text-xs"></i>
                            </div>
                            <img src="{{ asset('images/struktur/bahirman.jpg') }}" alt="Ketua BPD" class="w-28 h-28 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 w-full pt-4">
                            <div class="relative">
...
<section class="py-16 bg-gradient-to-br from-purple-50 via-white to-indigo-50 tugas-wewenang-section" data-aos="fade-up" data-aos-duration="1000">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header - match Home Services style -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <!-- Card: Kepala Desa -->
            <div class="group bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-300 hover:border-blue-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-4 lg:p-8 transform hover:-translate-y-2" data-aos="fade-right" data-aos-duration="800" data-aos-delay="0">
                <!-- Header -->
            ...
            <!-- Card: BPD -->
            <div class="group bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 rounded-3xl border-2 border-purple-300 hover:border-purple-500 transition-all duration-500 shadow-xl hover:shadow-2xl p-8 transform hover:-translate-y-2" data-aos="fade-left" data-aos-duration="800" data-aos-delay="100">
                <!-- Header -->
...
<section class="cta-section py-24 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white relative overflow-hidden" data-aos="fade-up" data-aos-duration="1000">
    <!-- Background Pattern -->
    <div class="absolute inset-0 bg-white/5"></div>
...
/* Ensure proper alignment of connecting line between Kades and Ketua BPD */
#fallback-chart .lg\\:grid {
    position: relative;
}

/* Garis penghubung antara Kepala Desa dan Ketua BPD - menggunakan multiple selectors untuk kompatibilitas */
...
/* Fallback: tambahkan garis langsung ke container */
...
/* Tambahan: garis menggunakan class yang lebih sederhana */
.connecting-line {
    content: '';
    position: absolute;
    top: 140px;
