            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-r-xl p-6 mb-8 shadow-sm">
                ...
                <div class="bg-blue-50 rounded-lg p-4 mb-4 border border-blue-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        ...
                        <div class="bg-white rounded-lg p-3 border border-blue-100">
                            <span class="text-gray-500 text-xs uppercase tracking-wide">Dusun</span>
                            <p class="font-semibold text-gray-900 mt-1">${userData.dusun || 'Belum diisi'}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-yellow-50 rounded-lg p-3">
            <div class="flex items-start">
                ...
                <div class="text-sm text-yellow-800">
                    <p class="font-medium">Notifikasi WhatsApp (jika ada keputusan):</p>
                    <ul class="mt-1 space-y-1">
                        ...
                        <li>• 📱 <strong>Pastikan nomor HP benar</strong> untuk menerima notifikasi</li>
                    </ul>
                </div>
            </div>
        </div>
