...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-purple-50">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 mb-16" data-aos="fade-up" data-aos-duration="800">
            <div class="relative overflow-x-auto">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="w-[600px] h-0.5 bg-gray-400 relative">
                            <!-- Vertical lines to each Anggota -->
                            <div class="absolute left-[12.5%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                            <div class="absolute left-[37.5%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                            <div class="absolute left-[62.5%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                            <div class="absolute left-[87.5%] top-0 w-0.5 h-8 bg-gray-400 transform -translate-x-1/2"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center gap-8">
                        ...
                        <div class="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl p-4 text-white text-center shadow-lg min-w-[140px]">
                            ...
                            <h5 class="text-xs font-bold mb-1">ANGGOTA</h5>
                            <p class="text-slate-100 font-semibold text-xs">Anggota</p>
                        </div>
        ...
        <!-- BPD Member Details (Individual Cards) -->
        ...
        <!-- Connector Lines within BPD -->
        <div class="flex justify-center mb-8">
            <div class="flex flex-col items-center">
                <div class="w-px h-8 bg-purple-300"></div>
                <div class="w-96 h-px bg-purple-300"></div>
        ...
        <div class="mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <p class="text-center text-gray-600 mb-8 text-sm italic">Dibawah koordinasi Ketua, Wakil Ketua, dan Sekretaris</p>
