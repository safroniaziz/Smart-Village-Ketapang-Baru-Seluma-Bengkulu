...
/* Spectacular Family Grouping Styles */
.family-header {
...
/* Spectacular Table Row Animations */
.family-member {
    animation: spectacularSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1);
}
...
/* Glow Effects */
.family-member:hover .group-hover\:scale-110 {
...
.family-member .inline-flex {
    position: relative;
    overflow: hidden;
}

.family-member .inline-flex::before {
    content: '';
    position: absolute;
    top: 0;
    left: -100%;
...
.family-member:hover .inline-flex::before {
    left: 100%;
}
