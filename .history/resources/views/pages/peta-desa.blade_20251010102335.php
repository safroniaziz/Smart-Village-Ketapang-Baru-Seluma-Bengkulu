                ...
                <div class="relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 rounded-3xl p-6 shadow-2xl border border-blue-200/50 hover:shadow-3xl hover:scale-105 transition-all duration-500 overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-4 border border-gray-200">
                            <div class="text-xs font-bold text-gray-600 mb-2 uppercase tracking-wider">View Mode:</div>
                            <div class="flex flex-wrap gap-2">
                                <span class="px-3 py-1 bg-white text-gray-700 text-xs font-medium rounded-full border border-gray-200">Roadmap</span>
                                <span class="px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded-full shadow-sm">Hybrid ⭐</span>
                                <span class="px-3 py-1 bg-white text-gray-700 text-xs font-medium rounded-full border border-gray-200">Satellite</span>
                                <span class="px-3 py-1 bg-white text-gray-700 text-xs font-medium rounded-full border border-gray-200">Terrain</span>
                            </div>
                        </div>
                    </div>
                </div>
...
function initMap() {
    ...
    map = L.map('map').setView([-4.314632, 102.763257], 14);
