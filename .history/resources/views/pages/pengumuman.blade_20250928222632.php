...
<!-- CTA Section -->
<section class="py-20 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 text-white relative overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="relative container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8" data-aos="fade-up">
                ...
                <span class="text-sm font-semibold">Selalu Update</span>
            </div>

            <!-- Title -->
            <h2 class="text-4xl md:text-5xl font-black mb-6" data-aos="fade-up" data-aos-delay="100">
                Jangan Sampai <span class="text-yellow-300">Terlewat!</span>
            </h2>

            <!-- Description -->
            <p class="text-xl text-purple-100 mb-8 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                Dapatkan notifikasi pengumuman penting langsung di ponsel Anda. Tetap terhubung dengan informasi terbaru dari Desa Ketapang Baru
            </p>

            <!-- CTA Buttons -->
            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-8" data-aos="fade-up" data-aos-delay="300">
                <a href="#" class="bg-white text-purple-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-xl transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    <i class="fas fa-mobile-alt mr-3"></i>
                    Aktifkan Notifikasi
                </a>
                <a href="#" class="border-2 border-white text-white hover:bg-white hover:text-purple-600 font-semibold py-4 px-8 rounded-xl transition-all duration-300 inline-flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    ...
                    <h3 class="font-semibold mb-2">Notifikasi Instan</h3>
                    <p class="text-purple-100 text-sm">Terima pengumuman penting langsung di ponsel Anda</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p class="text-purple-100 text-sm">Pilih jenis pengumuman yang ingin Anda terima</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-archive text-white text-xl"></i>
                    </div>
                    <h3 class="font-semibold mb-2">Arsip Lengkap</h3>
                    <p class="text-purple-100 text-sm">Akses semua pengumuman lama kapan saja</p>
                </div>
            </div>
        </div>
    </div>
