    ...
    <div class="w-full w-[85%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- Top row cards: Kepala Desa (left) and Ketua BPD (right) -->
                <div class="grid grid-cols-2 gap-16 justify-items-center items-start mb-4 min-w-[1024px] mx-auto">
                    <!-- Kepala Desa -->
                ...
                <!-- Dotted connection between the two cards (symmetric halves) -->
                <div class="grid grid-cols-2 gap-16 items-center mb-8 min-w-[1024px] mx-auto">
                    <div class="flex justify-end"><div class="h-0 border-t-4 border-dashed border-purple-500 w-24 md:w-40 lg:w-56"></div></div>
                    <div class="flex justify-start"><div class="h-0 border-t-4 border-dashed border-purple-500 w-24 md:w-40 lg:w-56"></div></div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start min-w-[1024px] mx-auto">
                    ...
                    <div class="flex flex-col items-center">
                        <!-- Kepala Desa -->
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 border-4 border-blue-400 rounded-xl p-6 text-center shadow-xl relative max-w-xs mb-6">
                            <div class="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                <i class="fas fa-crown text-white text-xs"></i>
                            </div>
                            <img src="{{ asset('images/struktur/zultan.jpg') }}" alt="Kepala Desa" class="w-20 h-20 rounded-xl border-2 border-blue-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                    ...
                    <div class="flex flex-col items-center">
                        <!-- Ketua BPD -->
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-4 border-purple-400 rounded-xl p-6 text-center shadow-xl relative max-w-xs mb-6">
                            <div class="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center border-2 border-white shadow-lg">
                                <i class="fas fa-crown text-white text-xs"></i>
                            </div>
                            <img src="{{ asset('images/struktur/bahirman.jpg') }}" alt="Ketua BPD" class="w-20 h-20 rounded-xl border-2 border-purple-300 mx-auto mb-3 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
