            ...
            <article class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group" 
                ...
                <div class="relative h-48 overflow-hidden">
                    ...
                    @else
                        <div class="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                            <i class="fas fa-bullhorn text-4xl text-white opacity-80"></i>
                        </div>
                    @endif
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="px-3 py-1 rounded-full text-xs font-semibold
                            @if($related->prioritas == 'Tinggi') bg-red-500 text-white
                            @elseif($related->prioritas == 'Sedang') bg-yellow-500 text-white
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center">
                        <a href="{{ route('pengumuman.show', $related->slug) }}" 
                           class="opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 bg-white text-gray-900 px-6 py-3 rounded-full font-semibold hover:bg-gray-100">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors">
                        <a href="{{ route('pengumuman.show', $related->slug) }}" class="hover:underline">
                            {{ $related->judul }}
                        </a>
                    </h3>
...
<section class="py-12 bg-gradient-to-r from-blue-600 to-purple-600">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <a href="{{ route('pengumuman') }}" 
           class="inline-flex items-center px-8 py-4 bg-white text-gray-900 text-lg font-semibold rounded-2xl hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
