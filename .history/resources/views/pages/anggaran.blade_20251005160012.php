            ...
            <div class="flex-1 space-y-10 relative z-10">
                <div class="space-y-8">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-black leading-tight mb-6" data-aos="fade-up" data-aos-delay="400">
                        <span class="text-white">Anggaran</span><br>
                    ...
                    <p class="text-lg lg:text-xl text-blue-100 leading-relaxed max-w-2xl font-light" data-aos="fade-up" data-aos-delay="600">
                        Transparansi lengkap <span class="font-semibold text-yellow-300">APBDes, Pagu Earmark, dan BLT Dana Desa</span>
                        untuk mewujudkan tata kelola pemerintahan yang akuntabel dan partisipatif
                    </p>
                </div>

                <!-- Compact Quick Stats -->
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6" data-aos="fade-up" data-aos-delay="700">
                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-lg font-black text-yellow-400 animate-pulse mb-1">Rp {{ number_format($totalPendapatan/1000000, 1) }}M</div>
                        <div class="text-xs text-blue-100 font-medium">Pendapatan</div>
                    </div>

                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-lg font-black text-yellow-400 animate-pulse mb-1">Rp {{ number_format($totalBelanja/1000000, 1) }}M</div>
                        <div class="text-xs text-blue-100 font-medium">Belanja</div>
                    </div>

                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-lg font-black text-yellow-400 animate-pulse mb-1">{{ $paguEarmarks->count() }}</div>
                        <div class="text-xs text-blue-100 font-medium">Program</div>
                    </div>

                    <div class="stat-card bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 hover:bg-white/15 transition-all duration-300 data-point text-center">
                        <div class="text-lg font-black text-yellow-400 animate-pulse mb-1">{{ $bltDds->count() }}</div>
                        <div class="text-xs text-blue-100 font-medium">Penerima BLT</div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-green-100/50 group-hover:bg-white/90 group-hover:shadow-md transition-all duration-300">
                                <div class="flex items-center justify-center text-sm">
                                    ...
                                    <div class="text-center">
                                        <p class="font-bold text-gray-800 text-xs">Rp {{ number_format($totalPendapatan/1000000, 1) }}M</p>
                                        <p class="text-gray-600 text-xs">Pendapatan</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-red-100/50 group-hover:bg-white/90 group-hover:shadow-md transition-all duration-300">
                                <div class="flex items-center justify-center text-sm">
                                    ...
                                    <div class="text-center">
                                        <p class="font-bold text-gray-800 text-xs">Rp {{ number_format($totalBelanja/1000000, 1) }}M</p>
                                        <p class="text-gray-600 text-xs">Belanja</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container mx-auto px-4">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Transparansi lengkap <span class="font-semibold text-blue-600">anggaran pendapatan, belanja, pagu earmark,</span>
                dan program bantuan langsung tunai untuk mewujudkan akuntabilitas keuangan desa
            </p>
        </div>
