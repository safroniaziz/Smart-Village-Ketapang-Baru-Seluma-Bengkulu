...
function showStatusNotification(pengajuanId) {
    ...
    notification.innerHTML = `
        ...
        <div class="bg-green-50 rounded-lg p-3">
            <div class="flex items-start">
                <i class="fas fa-whatsapp text-green-600 mr-2 mt-0.5"></i>
                <div class="text-sm text-green-800">
                    <p class="font-medium">Notifikasi akan dikirim ke: <span class="text-green-700 font-semibold">${userData.no_hp}</span></p>
                    <ul class="mt-2 space-y-1">
                        <li>• ✅ <strong>Disetujui:</strong> Admin dapat memilih kirim PDF atau notifikasi pengambilan</li>
                        <li>• ❌ <strong>Ditolak:</strong> Alasan penolakan + saran perbaikan</li>
                        <li>• ⚠️ <strong>Jika nomor salah:</strong> Hubungi admin desa untuk diperbaiki</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 rounded-lg p-3">
            <div class="flex items-start">
                ...
                <div class="text-sm text-red-800">
                    <p class="font-medium">⚠️ Nomor HP belum diisi!</p>
                    <ul class="mt-2 space-y-1">
                        <li>• Anda tidak akan menerima notifikasi WhatsApp</li>
                        <li>• Silahkan hubungi admin desa untuk melengkapi nomor HP</li>
                        <li>• Status pengajuan dapat dicek kembali di halaman ini</li>
                    </ul>
                </div>
            </div>
        </div>
