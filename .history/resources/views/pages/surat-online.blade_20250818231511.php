...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Global function untuk shortcut dari section atas
    window.selectJenisSurat = function(jenis) {
        // Scroll ke form section
        document.getElementById('ajukan-surat').scrollIntoView({ behavior: 'smooth' });

        // Wait untuk scroll selesai, lalu trigger selection
        setTimeout(() => {
            selectedJenis = jenis;
            showSubJenis(jenis);
            showStep(2);
