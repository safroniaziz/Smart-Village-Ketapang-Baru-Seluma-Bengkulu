...
<section class="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="overflow-x-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-20 lg:items-start relative w-full mx-auto px-4">
                    ...
                    <div class="flex flex-col items-center mb-8 lg:mb-0 relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10 w-full pt-4">
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 w-full pt-4">
                            <div class="relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10 w-full pt-4 mb-6">
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 w-full pt-4">
                            <div class="relative">
                                <div class="absolute -top-4 left-1/2 -translate-x-1/2 w-px h-4 bg-purple-400"></div>
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-2 lg:p-3 text-center shadow-lg">
                ...
                <div class="lg:hidden mt-12 w-full mx-auto">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full pt-4">
                            <div class="relative">
