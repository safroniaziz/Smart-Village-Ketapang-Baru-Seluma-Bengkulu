...
function initMap() {
    ...
    // Skip auto-fit to markers - let polygon boundary take over
    console.log(`Found ${validData ? validData.length : 0} markers, but letting polygon boundary control the view`);
