...
<section class="relative text-white overflow-hidden min-h-screen flex items-center hero-gradient">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-30"></div>
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            <!-- Hero Content (Left Side) -->
            <div class="flex-1 space-y-10 relative z-30"></div>
                <div class="space-y-8">
                    <!-- Badge -->
                ...
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-3 relative z-30" data-aos="fade-up" data-aos-delay="800"></div>
            ...
            <div class="lg:w-[480px] flex-shrink-0 relative z-30" data-aos="fade-left" data-aos-delay="300">
...
<!-- Sub Navigation -->
<nav class="stat-subnav sticky top-20 z-20" aria-label="Navigasi Statistik">
