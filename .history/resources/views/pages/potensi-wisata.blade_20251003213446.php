        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8" data-aos="fade-up" data-aos-delay="800">
                    <a href="#gallery" class="inline-flex items-center justify-center px-8 py-3 bg-white text-teal-600 font-semibold rounded-full hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                        <i class="fas fa-images mr-2"></i>
                        Lihat Gallery
                    </a>
                    @if($youtubeId)
                    <a href="#video" class="inline-flex items-center justify-center px-8 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-teal-600 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div class="lg:col-span-7 space-y-8" data-aos="fade-right">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                        <div class="flex items-center mb-4">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center">
                                <i class="fas fa-swimming-pool text-white text-xl"></i>
                            </div>
                            <h3 class="ml-4 text-xl font-bold text-gray-900">Air Jernih</h3>
                        </div>
                        <p class="text-gray-600">Air laut yang jernih dan bersih, perfect untuk berenang dan aktivitas air lainnya.</p>
                    </div>
            ...
            <div class="lg:col-span-5 space-y-6" data-aos="fade-left" data-aos-delay="200">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                    <div class="flex items-start space-x-4">
                        <div class="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-eye text-white text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Statistik Pengunjung</h3>
                            <div class="space-y-2">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Total Views:</span>
                                    <span class="font-bold text-2xl text-blue-600">{{ number_format($wisata->views ?? 0) }}</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-blue-500 to-indigo-500 h-2 rounded-full progress-bar" style="width: 85%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
                    <div class="flex items-start space-x-4">
                        <div class="w-16 h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-star text-white text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Rating Pengunjung</h3>
                            ...
                            <p class="text-sm text-gray-600">Berdasarkan 247 ulasan pengunjung</p>
