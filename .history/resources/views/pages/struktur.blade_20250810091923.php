        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 mb-24" data-aos="fade-up" data-aos-duration="800">
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="relative">
                        <!-- Special background with gradient -->
                        <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-3xl opacity-90"></div>
                        <div class="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-white/20 rounded-3xl"></div>

                        <!-- Floating decorations -->
                        <div class="absolute -top-6 -left-6 w-24 h-24 bg-gradient-to-br from-yellow-400/30 to-yellow-500/30 rounded-full blur-xl animate-pulse"></div>
                        <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-2xl animate-pulse" style="animation-delay: 1s;"></div>

                        <div class="relative bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 hover:shadow-4xl hover:scale-105 transition-all duration-500">
                            <!-- Premium Crown -->
                            <div class="absolute -top-8 left-1/2 transform -translate-x-1/2">
                                <div class="relative">
                                    <div class="absolute inset-0 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-full blur-lg opacity-70 animate-pulse"></div>
                                    <div class="relative w-16 h-16 bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white">
                                        <i class="fas fa-crown text-white text-xl"></i>
                                        <div class="absolute -inset-1 bg-gradient-to-br from-yellow-300 to-amber-400 rounded-full blur opacity-60 animate-ping"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative mt-6 mb-8">
                                <div class="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 rounded-3xl blur-lg opacity-30 scale-110"></div>
                                <div class="relative w-32 h-32 mx-auto">
                                    <div class="absolute inset-0 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-3xl"></div>
                                    <div class="absolute inset-1 bg-white rounded-3xl overflow-hidden shadow-xl">
                                        ...
                                        <i class="fas fa-user-tie text-blue-600 text-4xl hidden absolute inset-0 flex items-center justify-center"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mb-6">
                                <div class="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full px-6 py-2 mb-4 shadow-lg">
                                    <i class="fas fa-star text-yellow-300 mr-2"></i>
                                    <span class="font-bold text-sm tracking-wide">KEPALA DESA</span>
                                    <i class="fas fa-star text-yellow-300 ml-2"></i>
                                </div>
                                <h3 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">Zultan Alhara</h3>
                                <p class="text-gray-600 text-sm font-medium">Pemimpin Tertinggi Pemerintahan Desa Ketapang Baru</p>
                            </div>

                            <!-- Premium info cards -->
                            <div class="space-y-3">
                                <div class="flex items-center justify-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl px-4 py-3 border border-blue-200/50">
                                    <i class="fas fa-calendar-check text-blue-500 mr-3"></i>
                                    <div class="text-center">
                                        <p class="text-xs text-gray-500 font-medium">Periode Jabatan</p>
                                        <p class="text-sm font-bold text-blue-600">2021 - 2027</p>
                                    </div>
                                </div>

                                <div class="flex items-center justify-center bg-gradient-to-r from-emerald-50 to-cyan-50 rounded-xl px-4 py-3 border border-emerald-200/50">
                                    <i class="fas fa-trophy text-emerald-500 mr-3"></i>
                                    <div class="text-center">
                                        <p class="text-xs text-gray-500 font-medium">Status Desa</p>
                                        <p class="text-sm font-bold text-emerald-600">Desa Mandiri 2024</p>
                                    </div>
                                </div>
                            </div>
                        </div>
