...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-br from-indigo-600 via-purple-700 to-blue-800 text-white overflow-hidden py-20 lg:py-32">
    <!-- Background Pattern -->
    ...
    <div class="relative w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div class="text-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="inline-flex items-center space-x-3 mb-8" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="text-left">
                    <h3 class="text-xl font-bold text-indigo-100">PEMERINTAHAN DESA</h3>
                    <p class="text-sm text-indigo-200">Struktur Organisasi</p>
                </div>
            </div>
            ...
            <p class="text-xl lg:text-2xl text-indigo-100 max-w-4xl mx-auto leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="800">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                    ...
                    <div class="text-sm text-indigo-100">Kepala Desa</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                    <div class="text-2xl font-black text-yellow-400">6</div>
                    <div class="text-sm text-indigo-100">Aparatur Desa</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                    <div class="text-2xl font-black text-yellow-400">3</div>
                    <div class="text-sm text-indigo-100">Anggota BPD</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-20" data-aos="fade-up" data-aos-duration="800">
            <div class="inline-flex items-center bg-indigo-50 rounded-full px-6 py-3 mb-6">
                <i class="fas fa-org-chart text-indigo-600 mr-3"></i>
                <span class="text-indigo-800 font-semibold">Bagan Organisasi</span>
            </div>
            <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-8">
                Pemerintahan <span class="text-indigo-600">Desa</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Struktur organisasi pemerintahan desa yang menjalankan tugas dan fungsi pelayanan kepada masyarakat
            </p>
        </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 via-white to-indigo-50 rounded-3xl p-8 lg:p-12 shadow-2xl">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 shadow-2xl relative">
                        ...
                        <p class="text-blue-100 font-semibold text-lg mb-1">H. Ahmad Supriyadi, S.Pd</p>
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-white rounded-2xl p-6 shadow-lg border-2 border-green-200 relative">
                        ...
                        <p class="text-green-600 font-semibold text-lg mb-1">Drs. Bambang Sutrisno</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-yellow-200 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p class="text-yellow-600 font-semibold mb-1">Siti Nurhaliza, S.E</p>
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-orange-200 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <h5 class="font-bold text-gray-900 text-lg mb-2">Kaur Pembangunan</h5>
                            <p class="text-orange-600 font-semibold mb-1">Ahmad Fauzi, S.T</p>
                            <p class="text-gray-600 text-sm mb-3">Koordinator Infrastruktur</p>
                    ...
                    <div class="text-center">
                        <div class="bg-white rounded-xl p-6 shadow-md border border-teal-200 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <h5 class="font-bold text-gray-900 text-lg mb-2">Kaur Umum</h5>
                            <p class="text-teal-600 font-semibold mb-1">Rini Wulandari, S.Sos</p>
                            <p class="text-gray-600 text-sm mb-3">Administrasi & Kemasyarakatan</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="group bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-8 text-white shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-4">
                        ...
                        <h4 class="text-2xl font-bold mb-2">H. Suherman, S.H</h4>
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-lg border border-indigo-200 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="mb-4">
                    ...
                    <h4 class="text-2xl font-bold text-gray-900 mb-2">Dra. Mariana Sari</h4>
            ...
            <div class="group bg-white rounded-2xl p-8 shadow-lg border border-green-200 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <div class="mb-4">
                    ...
                    <h4 class="text-2xl font-bold text-gray-900 mb-2">Muhammad Rifki, S.Pd</h4>
    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-20" data-aos="fade-up" data-aos-duration="800">
            <div class="inline-flex items-center bg-blue-50 rounded-full px-6 py-3 mb-6">
                ...
                <span class="text-blue-800 font-semibold">Tim Pendukung</span>
            </div>
            <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-8">
                Staff <span class="text-blue-600">Pendukung</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <h4 class="text-xl font-bold text-gray-900 mb-2">Staff IT</h4>
                <p class="text-blue-600 font-semibold mb-1">Andi Pratama, S.Kom</p>
                <p class="text-gray-600 text-sm mb-3">Teknologi Informasi & Website</p>
                <div class="bg-blue-50 rounded-lg px-3 py-2">
                    <p class="text-blue-700 text-xs">Maintenance sistem digital desa</p>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <h4 class="text-xl font-bold text-gray-900 mb-2">Koordinator Keamanan</h4>
                <p class="text-red-600 font-semibold mb-1">Budi Santoso</p>
                <p class="text-gray-600 text-sm mb-3">Keamanan & Ketertiban</p>
                <div class="bg-red-50 rounded-lg px-3 py-2">
                    <p class="text-red-700 text-xs">Koordinasi Hansip & Siskamling</p>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                ...
                <h4 class="text-xl font-bold text-gray-900 mb-2">Koordinator Kebersihan</h4>
                <p class="text-green-600 font-semibold mb-1">Sari Indah</p>
                <p class="text-gray-600 text-sm mb-3">Lingkungan & Kebersihan</p>
                <div class="bg-green-50 rounded-lg px-3 py-2">
                    <p class="text-green-700 text-xs">Pengelolaan sampah & lingkungan</p>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    // Initialize Particles.js for Struktur page
