        ...
        for (let i = startIndex; i < endIndex; i++) {
            ...
            const row = `
                <tr>
                    ...
                    <td class="px-6 py-4 text-gray-600">${blt.alamat.length > 30 ? blt.alamat.substring(0, 30) + '...' : blt.alamat}</td>
                    <td class="px-6 py-4 text-gray-600 font-mono">${blt.no_rekening || '-'}</td>
                    <td class="px-6 py-4 text-right font-bold text-purple-600">${formatRupiah(blt.nominal_bantuan)}</td>
                </tr>
            `;
            tbody.innerHTML += row;
        }
