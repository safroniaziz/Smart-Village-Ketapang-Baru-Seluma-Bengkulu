...
@section('content')
<!-- Hero Section -->
<div class="relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-24 lg:pb-20" style="background: linear-gradient(135deg, #1e40af 0%, #3730a3 50%, #5b21b6 100%);">
    <!-- Background Pattern -->
            ...
            <div class="flex-1 max-w-4xl relative z-10">
                <div class="text-center space-y-8">
                    ...
                    <div class="mb-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
...
<div class="py-16 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
            ...
            <div class="px-8 py-8 bg-gradient-to-br from-gray-50 to-slate-50 border-b border-gray-100">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="exportData" class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all duration-200 shadow-lg flex items-center gap-2">
            ...
            <div class="relative">
                ...
                <div id="tableContent">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gradient-to-r from-blue-50 to-indigo-50">
                                <tr>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">NIK</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Nama Lengkap</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Jenis Kelamin</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Umur</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Dusun</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Agama</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Status</th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-blue-900">Pekerjaan</th>
                                </tr>
                            </thead>
                    ...
                    <!-- Pagination -->
                    <div id="paginationContainer" class="px-6 py-6 bg-blue-50 border-t border-blue-100">
                        @if($wargas->hasPages())
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
