                ...
                @foreach($pengumumans as $index => $pengumuman)
                    <article class="announcement-card group bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        <div class="relative overflow-hidden">
                            <div class="w-full h-64 bg-gradient-to-br from-{{ $pengumuman->prioritas == 'Tinggi' ? 'red' : ($pengumuman->prioritas == 'Sedang' ? 'yellow' : 'green') }}-500 to-{{ $pengumuman->prioritas == 'Tinggi' ? 'orange' : ($pengumuman->prioritas == 'Sedang' ? 'orange' : 'emerald') }}-600 flex items-center justify-center relative">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="bg-{{ $pengumuman->prioritas == 'Tinggi' ? 'red' : ($pengumuman->prioritas == 'Sedang' ? 'yellow' : 'green') }}-500 text-white px-3 py-1 rounded-full text-xs font-semibold {{ $pengumuman->prioritas == 'Tinggi' ? 'animate-pulse' : '' }}">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('pengumuman.show', $pengumuman->slug) }}" class="bg-gradient-to-r from-{{ $pengumuman->prioritas == 'Tinggi' ? 'red' : 'blue' }}-600 to-{{ $pengumuman->prioritas == 'Tinggi' ? 'orange' : 'indigo' }}-600 hover:from-{{ $pengumuman->prioritas == 'Tinggi' ? 'red' : 'blue' }}-700 hover:to-{{ $pengumuman->prioritas == 'Tinggi' ? 'orange' : 'indigo' }}-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 hover:scale-105">
