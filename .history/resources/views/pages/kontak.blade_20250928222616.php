...
<section class="relative text-white overflow-hidden min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] flex items-center pt-8 py-8 lg:py-12 pb-32 lg:pb-28 mb-8 md:mb-12" style="background: linear-gradient(135deg, #0086c9 0%, #0074b3 50%, #006ba3 100%);" data-aos="fade-in">
    ...
    <div id="particles-kontak" class="absolute inset-0" data-aos="fade-in" data-aos-delay="200"></div>
...
<!-- CTA Section -->
<section class="py-20 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white relative overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="relative container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8" data-aos="fade-up">
                <i class="fas fa-headset text-yellow-300 mr-3"></i>
                <span class="text-sm font-semibold">Layanan 24/7</span>
            </div>
            
            <!-- Title -->
            <h2 class="text-4xl md:text-5xl font-black mb-6" data-aos="fade-up" data-aos-delay="100">
                Butuh Bantuan <span class="text-yellow-300">Segera?</span>
            </h2>
            
            <!-- Description -->
            <p class="text-xl text-green-100 mb-8 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                Tim kami siap membantu Anda 24/7. Hubungi kami melalui berbagai saluran komunikasi yang tersedia
            </p>
            
            <!-- CTA Buttons -->
            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-8" data-aos="fade-up" data-aos-delay="300">
                <a href="tel:+6281234567890" class="bg-white text-green-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-xl transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    <i class="fas fa-phone mr-3"></i>
                    Telepon Sekarang
                </a>
                <a href="https://wa.me/6281234567890" class="border-2 border-white text-white hover:bg-white hover:text-green-600 font-semibold py-4 px-8 rounded-xl transition-all duration-300 inline-flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    ...
                    <p class="text-green-100 text-sm">Senin - Jumat: 08:00 - 16:00<br>Sabtu: 08:00 - 12:00</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-envelope text-white text-xl"></i>
                    </div>
                    <h3 class="font-semibold mb-2">Email Resmi</h3>
                    <p class="text-green-100 text-sm">info@ketapangbaru.desa.id<br>admin@ketapangbaru.desa.id</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-map-marker-alt text-white text-xl"></i>
                    </div>
                    <h3 class="font-semibold mb-2">Lokasi Kantor</h3>
                    <p class="text-green-100 text-sm">Jl. Raya Ketapang Baru<br>Kec. Keruak, Lombok Timur</p>
                </div>
            </div>
        </div>
    </div>
