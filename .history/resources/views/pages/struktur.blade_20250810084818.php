            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="text-center mb-16">
                    <div class="inline-block bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 shadow-2xl relative">
                        ...
                        <div class="w-24 h-24 bg-white/20 rounded-xl border-2 border-white/30 flex items-center justify-center mx-auto mb-4 shadow-lg overflow-hidden">
                            ...
                            <i class="fas fa-user-tie text-white text-3xl hidden"></i>
                        </div>
            ...
            <div class="relative overflow-x-auto">
                ...
                <div class="min-w-[800px] relative">
                    ...
                    <div class="flex justify-center mb-12">
                        <div class="relative">
                                                        <div class="bg-white rounded-2xl p-6 text-center shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-300 min-w-[220px] relative overflow-hidden">
                    ...
                    <div class="flex justify-center gap-32 mb-12">
                        <!-- Wakil Ketua -->
                        <div class="relative">
                            <div class="bg-white rounded-2xl p-5 text-center shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 min-w-[190px] relative overflow-hidden">
                                <!-- Background decoration -->
                    ...
                    <div class="flex justify-center gap-12">
                                                <!-- Anggota 1 -->
                        <div class="bg-white rounded-xl p-4 text-center shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 min-w-[160px] relative overflow-hidden">
                            <!-- Background decoration -->
                        ...
                        <!-- Anggota 2 -->
                        <div class="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl p-4 text-white text-center shadow-lg min-w-[140px]">
                            <div class="w-20 h-20 bg-white/20 rounded-xl border-2 border-white/30 flex items-center justify-center mx-auto mb-3 overflow-hidden">
                                <img src="{{ asset('images/struktur/dhesty.jpg') }}"
                                     alt="Dhesty C"
                                     class="w-full h-full object-cover"
                                     onerror="this.src='{{ asset('images/struktur/default-person.png') }}'  this.onerror=null;">
                                <i class="fas fa-user text-white text-sm hidden"></i>
                            </div>
                            <h5 class="text-xs font-bold mb-1">ANGGOTA</h5>
                            <p class="text-slate-100 font-semibold text-xs">Dhesty C</p>
                        </div>
                    </div>
