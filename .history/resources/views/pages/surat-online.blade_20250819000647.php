    ...
    const formTemplates = {
        ...
        'surat_kehilangan': {
            ...
            fields: [
                ...
                { name: 'nomor_dokumen', label: 'Nomor Dokumen/Barang', type: 'text', icon: 'fas fa-hashtag', required: true, placeholder: 'Contoh: 1705052511190005 (untuk KK), 1234567890123456 (untuk KTP)' },
                { name: 'tempat_kehilangan', label: 'Tempat Kehilangan', type: 'textarea', icon: 'fas fa-map-marker-alt', required: true, placeholder: 'Jelaskan detail lokasi kehilangan (contoh: Di pasar, Di rumah, Di jalan, dll)' },
                ...
                { name: 'keperluan', label: 'Keperluan Surat', type: 'textarea', icon: 'fas fa-clipboard', required: true, placeholder: 'Jelaskan untuk apa surat ini diperlukan (contoh: Untuk pengurusan KK baru, Untuk keperluan administrasi, dll)' },
