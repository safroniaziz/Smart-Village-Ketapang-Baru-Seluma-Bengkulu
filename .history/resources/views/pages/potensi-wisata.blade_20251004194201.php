...
<style>
    ...
    .photo-card {
        ...
        cursor: pointer;
        position: relative;
        aspect-ratio: 4/3; /* More balanced landscape ratio */
    }
    ...
    @media (max-width: 768px) {
        ...
        .modal-image-container {
            aspect-ratio: 16/9; /* Maintain landscape on mobile */
            min-height: 300px;
        }
    ...
    @media (max-width: 768px) {
        ...
        .photo-card {
            aspect-ratio: 4/3; /* Maintain balanced landscape on mobile */
        }
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-0">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                ...
                @if($wisata)
                 <!-- Enhanced Quick Stats - Consistent with Statistik Page -->
            ...
            <div class="flex-1 relative" data-aos="fade-left" data-aos-delay="900">
                ...
                <div class="relative max-w-lg mx-auto">
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative bg-white/10 backdrop-blur-sm rounded-3xl p-1">
                            <img src="{{ $galleryPhotos[0]['url'] }}"
                                 ...
                                 class="w-full rounded-3xl shadow-2xl transform group-hover:scale-105 transition-all duration-700 group-hover:rotate-1">
                    ...
                    <div class="absolute -bottom-6 -left-6 w-28 h-28 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/80 transform rotate-12 hover:rotate-0 transition-all duration-500 hover:scale-110 group cursor-pointer"
                        ...
                        <img src="{{ $galleryPhotos[1]['url'] }}" alt="Preview" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div class="absolute -top-6 -right-6 w-28 h-28 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/80 transform -rotate-12 hover:rotate-0 transition-all duration-500 hover:scale-110 group cursor-pointer"
                        ...
                        <img src="{{ $galleryPhotos[2]['url'] }}" alt="Preview" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            ...
            <div class="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">Video Tour Eksklusif</h3>
                            <p class="text-red-100 text-sm">{{ $wisata->nama }}</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="bg-white/20 rounded-full px-3 py-1">
                            <span class="text-white text-sm font-medium">HD Quality</span>
                        </div>
                        <button onclick="openVideoModal()" class="bg-white/20 hover:bg-white/30 rounded-lg p-2 transition-all duration-300">
                ...
                <div class="relative group">
                    <!-- Glow Effect -->
                    <div class="absolute -inset-1 bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-1000"></div>

                    <!-- Video Container -->
                    <div class="relative bg-gray-900 rounded-2xl m-4 overflow-hidden">
                        <div class="aspect-w-16 aspect-h-9 relative">
                            <iframe class="w-full h-full video-iframe"
                                    id="mainVideoPlayer"
                                    src="https://www.youtube.com/embed/{{ $youtubeId }}?rel=0&controls=1&autoplay=0&mute=0"
                            ...
                            <!-- Play Overlay -->
                            <div class="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                                <button onclick="openVideoModal()" class="w-20 h-20 bg-red-600/90 hover:bg-red-600 rounded-full flex items-center justify-center shadow-2xl transform hover:scale-110 transition-all duration-300">
                                    <i class="fas fa-play text-white text-2xl ml-1"></i>
                                </button>
                            </div>
                            ...
                            <!-- Video Stats Overlay -->
                            <div class="absolute top-4 right-4 bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2 text-white text-sm">
                                <div class="flex items-center space-x-2">
                                    <i class="fas fa-eye"></i>
                                    <span>{{ number_format($wisata->views ?? 0) }} views</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-2 text-gray-600">
                                ...
                                <span class="text-sm">Durasi: 3:45</span>
                            </div>
                            <div class="flex items-center space-x-2 text-gray-600">
                                <i class="fas fa-calendar"></i>
                                <span class="text-sm">Dipublikasi: {{ $wisata->created_at->format('d M Y') }}</span>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <a href="{{ $wisata->video_youtube }}"
                               target="_blank"
                               class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-all duration-300">
                                <i class="fab fa-youtube mr-2"></i>
                                Buka di YouTube
                            </a>
                            <button onclick="openVideoModal()" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium rounded-lg transition-all duration-300">
