        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[80vh]">
            ...
            <div class="flex-1 space-y-10 relative z-10">
                <div class="space-y-8">
                    ...
                    <!-- Description -->
                    <p class="text-lg lg:text-xl text-blue-100 leading-relaxed max-w-2xl font-light mb-8" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="mb-6" data-aos="fade-up" data-aos-delay="700">
                    <div class="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-2">
                        <label class="text-white text-sm font-semibold mr-3 pl-2">Tahun:</label>
                        <select id="yearSelector" class="bg-transparent text-white font-bold border-0 outline-0 cursor-pointer">
                            @foreach($availableYears as $year)
                                <option value="{{ $year }}" {{ $year == $tahun ? 'selected' : '' }} class="text-gray-800">
                                    {{ $year }}
                                </option>
                            @endforeach
                        </select>
