...
<style>
    ...
    /* Ocean Wave Animations - Seamless infinite waves */
    ...
    /* Wave Animation Classes - Perfect seamless loop */
    .animate-ocean-wave-1 { animation: ocean-wave-1 20s linear infinite; }
    .animate-ocean-wave-2 { animation: ocean-wave-2 15s linear infinite; }
    .animate-ocean-wave-3 { animation: ocean-wave-3 12s linear infinite; }
    .animate-ocean-wave-4 { animation: ocean-wave-4 10s linear infinite; }
</style>
@endpush
...
<section class="hero-section relative text-white overflow-hidden pt-8 py-8 lg:py-12 pb-32 lg:pb-36" data-aos="fade-in">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg class="relative w-full h-32" viewBox="0 0 1200 200" preserveAspectRatio="none">
            <!-- Wave Layer 1 - Seamless infinite wave -->
            <defs>
                <pattern id="wave1" x="0" y="0" width="800" height="200" patternUnits="userSpaceOnUse">
                    <path d="M0,100 C200,80 300,120 400,100 C600,80 700,120 800,100 L800,200 L0,200 Z" fill="#ffffff"/>
                </pattern>
                <pattern id="wave2" x="0" y="0" width="600" height="200" patternUnits="userSpaceOnUse">
                    <path d="M0,115 C150,95 250,135 300,115 C450,95 550,135 600,115 L600,200 L0,200 Z" fill="#f8f9fa"/>
                </pattern>
                <pattern id="wave3" x="0" y="0" width="500" height="200" patternUnits="userSpaceOnUse">
                    <path d="M0,130 C125,110 200,150 250,130 C375,110 450,150 500,130 L500,200 L0,200 Z" fill="#ffffff"/>
                </pattern>
                <pattern id="wave4" x="0" y="0" width="400" height="200" patternUnits="userSpaceOnUse">
                    <path d="M0,145 C100,125 150,165 200,145 C300,125 350,165 400,145 L400,200 L0,200 Z" fill="#ffffff"/>
                </pattern>
            </defs>
            
            <!-- Infinite seamless waves using patterns -->
            <rect x="0" y="0" width="100%" height="200" fill="url(#wave1)" class="animate-ocean-wave-1"/>
            <rect x="0" y="0" width="100%" height="200" fill="url(#wave2)" class="animate-ocean-wave-2"/>
            <rect x="0" y="0" width="100%" height="200" fill="url(#wave3)" class="animate-ocean-wave-3"/>
            <rect x="0" y="0" width="100%" height="200" fill="url(#wave4)" class="animate-ocean-wave-4"/>
            
            <!-- Solid base layer -->
            <rect x="0" y="180" width="100%" height="40" fill="#ffffff"/>
        </svg>
    </div>
</section>
