...
<style>
    ...
    /* Gallery Section - Grid Style untuk gambar seragam */
    .gallery-section {
        padding: 6rem 0;
...
<section class="gallery-section">
    <div class="gallery-container">
        ...
        <div class="gallery-grid" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="photo-card" data-aos="zoom-in" data-aos-delay="{{ 100 + ($index * 100) }}" onclick="openModal({{ $index }})">
                <img src="{{ $photo['url'] }}" 
                ...
                <div class="photo-overlay">
                    <div class="overlay-content">
                        ...
                        @if($photo['keterangan'])
                        <div class="overlay-description">{{ Str::limit($photo['keterangan'], 100) }}</div>
                        @endif
                    </div>
                </div>
