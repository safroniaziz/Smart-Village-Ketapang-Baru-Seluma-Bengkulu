        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="relative grid grid-cols-2 items-center gap-12 min-w-[1024px] mx-auto mb-4">
                    ...
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2"></div>

                    <!-- Additional dotted lines below the main connection line -->
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-6"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-12"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-18"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-24"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-30"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-36"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-42"></div>
                    <div class="pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-80 border-t-4 border-dashed border-purple-500 -translate-x-1/2 translate-y-48"></div>
