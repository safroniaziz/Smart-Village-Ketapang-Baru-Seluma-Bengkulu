            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-map-marker-alt text-2xl text-yellow-300"></i>
                    </div>
                    <h3 class="font-semibold mb-2">Lokasi</h3>
                    <p class="text-cyan-100 text-sm">Desa Ketapang Baru, Kecamatan X</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-suitcase text-2xl text-yellow-300"></i>
                    </div>
                    <h3 class="font-semibold mb-2">Wisata Alam</h3>
                    <p class="text-cyan-100 text-sm">Kunjungi destinasi wisata lokal yang menawan</p>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                    <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-camera text-2xl text-yellow-300"></i>
                    </div>
