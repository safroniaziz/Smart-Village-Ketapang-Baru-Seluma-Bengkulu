            ...
            <article class="news-card group bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                ...
                <div class="p-6">
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        ...
                        <a href="{{ route('berita.show', $related->slug) }}" class="spectacular-btn text-white px-5 py-2 rounded-lg text-sm font-semibold hover:scale-105 transition-transform" style="background: linear-gradient(135deg, #10b981, #059669);">
...
<!-- Back to News -->
<section class="py-20 bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 relative overflow-hidden">
    <!-- Background Pattern -->
    <div class="absolute inset-0 opacity-10">
    ...
    <div class="absolute inset-0">
        <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
        <div class="absolute top-1/3 right-1/3 w-1 h-1 bg-green-400 rounded-full animate-pulse" style="animation-delay: 1s;"></div>
        <div class="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-teal-400 rounded-full animate-pulse" style="animation-delay: 2s;"></div>
    </div>
