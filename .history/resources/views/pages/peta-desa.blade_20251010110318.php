    ...
    map.on('load', () => {
        ...
        allData.forEach((item, index) => {
            ...
            el.innerHTML = `<div style="position: absolute; inset: 0;">
                <div style="position: absolute; width: 32px; height: 32px; background: ${color}; border-radius: 50% 50% 50% 0; transform: rotate(-45deg); border: 3px solid white; box-shadow: 0 6px 20px rgba(0,0,0,0.3);"></div>
