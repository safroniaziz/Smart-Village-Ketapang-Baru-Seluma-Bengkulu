...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const subJenisData = {
        ...
        'ket_berkelakuan_baik': [
            { id: 'ket_berkelakuan_baik', name: 'Surat Keterangan Berkelakuan Baik', desc: 'Keterangan kelakuan baik', icon: 'fas fa-user-check' }
        ],
        'ket_domisili': [
            { id: 'ket_domisili', name: 'Surat Keterangan Domisili', desc: 'Keterangan tempat tinggal', icon: 'fas fa-home' }
        ],
        'ket_kematian': [
            { id: 'ket_kematian', name: 'Surat Keterangan Kematian', desc: 'Keterangan kematian penduduk', icon: 'fas fa-cross' }
        ],
        'ket_menikah': [
    ...
    function generateModalForm(subJenis) {
        ...
        modalDynamicFormContainer.innerHTML = `
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-r-xl p-6 mb-8 shadow-sm">
                ...
                <div class="relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 rounded-2xl p-6 mb-6 border border-blue-200 shadow-lg overflow-hidden">
                    <!-- Background Pattern -->
                    <div class="absolute inset-0 opacity-10">
                        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 25% 25%, #3b82f6 2px, transparent 2px), radial-gradient(circle at 75% 75%, #6366f1 2px, transparent 2px); background-size: 30px 30px;"></div>
                    </div>
                    
                    <!-- Header -->
                    <div class="relative z-10 flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-3 rounded-xl shadow-lg mr-4">
                                <i class="fas fa-user-circle text-white text-xl"></i>
                            </div>
                            <div>
                                <h6 class="text-lg font-bold text-gray-800 flex items-center">
                                    Data Pemohon
                                    <span class="ml-2 bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-semibold">Auto-Fill</span>
                                </h6>
                                <p class="text-sm text-gray-600">Data diambil otomatis dari akun Anda</p>
                            </div>
                        </div>
                        <div class="bg-white/80 backdrop-blur-sm p-2 rounded-lg border border-white/50 shadow-sm">
                            <i class="fas fa-check-circle text-green-500 text-lg"></i>
                        </div>
                    </div>

                    <!-- Data Cards -->
                    <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <!-- Nama Card -->
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-sm hover:shadow-md transition-all duration-200">
                            <div class="flex items-center">
                                <div class="bg-blue-100 p-2 rounded-lg mr-3">
                                    <i class="fas fa-id-badge text-blue-600"></i>
                                </div>
                                <div class="flex-1">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide font-medium">Nama Lengkap</p>
                                    <p class="text-sm font-bold text-gray-900">\${userData.nama || 'Belum diisi'}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-sm hover:shadow-md transition-all duration-200">
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide font-medium">NIK</p>
                                    <p class="text-sm font-bold text-gray-900">\${userData.nik || 'Belum diisi'}</p>
                                </div>
                            </div>
                        </div>

                        <!-- Alamat Card -->
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-sm hover:shadow-md transition-all duration-200 md:col-span-2">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-bold text-gray-900">\${userData.alamat || 'Belum diisi'}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-sm hover:shadow-md transition-all duration-200">
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    <p class="text-xs text-gray-500 uppercase tracking-wide font-medium">No. HP</p>
                                    <p class="text-sm font-bold text-gray-900">\${userData.no_hp || 'Belum diisi'}</p>
                                </div>
                            </div>
                        </div>

                        <!-- Status Card (empty slot for balance) -->
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/50 shadow-sm hover:shadow-md transition-all duration-200">
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-bold text-green-700">Terverifikasi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Info Footer -->
                    <div class="relative z-10 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 backdrop-blur-sm rounded-xl p-4 border border-blue-200/50">
                        <div class="flex items-center">
                            <div class="bg-blue-500/20 p-2 rounded-lg mr-3">
                                <i class="fas fa-info-circle text-blue-600"></i>
                            </div>
                            <div class="flex-1">
                                <p class="text-sm font-medium text-blue-800">Data Akurat & Terkini</p>
                                <p class="text-xs text-blue-600 mt-1">Data ini diambil langsung dari profil akun Anda. Jika ada kesalahan, silakan hubungi admin untuk pembaruan.</p>
                            </div>
                        </div>
                    </div>
                </div>
