...
/* Force stable markers - override any global styles */
.marker, .marker * {
...
.marker:hover {
    /* Only change opacity on hover - no transforms */
    opacity: 0.8 !important;
    z-index: 1000 !important;
    transform: none !important;
}

/* Override any Mapbox or global CSS that might affect markers */
...
function initMap() {
    ...
    map.on('load', () => {
        ...
        validData.forEach((item, index) => {
            ...
            // Create simple circular marker (force stable positioning)
            const el = document.createElement('div');
            el.className = 'marker';
            
            // Set all styles explicitly to prevent any movement
            el.style.cssText = `
            ...
            // Add icon inside marker (no rotation needed)
            el.innerHTML = `<i class="fas fa-seedling" style="color: white; font-size: 14px; transform: none !important;"></i>`;
