        ...
        <div class="overflow-x-auto" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative">
                    ...
                    <div class="hidden lg:block pointer-events-none absolute left-1/2 top-1/2 -translate-y-1/2 w-96 border-t-4 border-dashed border-purple-500 -translate-x-1/2"></div>
