        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="600">
                <div class="p-8 text-center h-full flex flex-col">
                    ...
                    <div class="space-y-2">
                        <button onclick="openSuratModal('Surat Khusus')" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-300">
                            <i class="fas fa-search mr-2"></i>Surat Kehilangan
                        </button>
                        <button onclick="openSuratModal()" class="w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-300">
                            <i class="fas fa-ellipsis-h mr-2"></i>Pilih Jenis Lain
                        </button>
                    </div>
                </div>
            </div>
    ...
    const formTemplates = {
        ...
        'surat_kehilangan': {
            ...
            fields: [
                ...
                { name: 'nomor_dokumen', label: 'Nomor Dokumen (jika ada)', type: 'text', icon: 'fas fa-hashtag', required: false },
                ...
                { name: 'keterangan_waktu', label: 'Keterangan Waktu (jika pilih Lainnya)', type: 'text', icon: 'fas fa-clock', required: false },
                { name: 'keperluan', label: 'Keperluan Surat', type: 'textarea', icon: 'fas fa-clipboard', required: true },
                { name: 'lampiran', label: 'Lampiran (Foto Dokumen/Barang)', type: 'file', icon: 'fas fa-paperclip', required: true }
            ]
        }
    };
