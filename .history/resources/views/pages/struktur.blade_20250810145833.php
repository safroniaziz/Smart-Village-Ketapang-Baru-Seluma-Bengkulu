            ...
            <div id="fallback-chart" style="display: block;">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start relative">
                    ...
                    <div class="flex flex-col items-center relative z-10">
                        ...
                        <!-- Desktop: Wakil & Sekretaris BPD -->
                        <div class="hidden lg:block grid grid-cols-2 gap-4 max-w-xl w-full mb-6">
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                <img src="{{ asset('images/struktur/halintarman.jpg') }}" alt="Wakil Ketua BPD" class="w-16 h-16 lg:w-20 lg:h-20 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-gray-900 text-sm lg:text-base mb-1">Wakil Ketua BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Halintarman</p>
                                <p class="text-xs text-gray-600">Wakil Ketua BPD, Koordinasi Anggota</p>
                            </div>
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                <img src="{{ asset('images/struktur/kebat.jpg') }}" alt="Sekretaris BPD" class="w-16 h-16 lg:w-20 lg:h-20 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-sm lg:text-base mb-1">Sekretaris BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Kebat S</p>
                                <p class="text-xs text-gray-600">Sekretaris BPD, Dokumentasi Rapat</p>
                            </div>
                        </div>

                        <!-- Desktop: Anggota BPD -->
                        <div class="hidden lg:block grid grid-cols-2 gap-4 max-w-xl w-full">
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                <img src="{{ asset('images/struktur/susti.jpg') }}" alt="Anggota BPD" class="w-16 h-16 lg:w-20 lg:h-20 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-sm lg:text-base mb-1">Anggota BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Susti</p>
                                <p class="text-xs text-gray-600">Anggota BPD, Penampung Aspirasi</p>
                            </div>
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-3 lg:p-4 text-center shadow-lg">
                                <img src="{{ asset('images/struktur/dhesty.jpg') }}" alt="Anggota BPD" class="w-16 h-16 lg:w-20 lg:h-20 rounded-xl border-2 border-purple-300 mx-auto mb-2 object-cover" onerror="this.src='{{ asset('images/struktur/default-person.png') }}'; this.onerror=null;">
                                <h6 class="font-bold text-sm lg:text-base mb-1">Anggota BPD</h6>
                                <p class="text-purple-600 font-semibold text-xs lg:text-sm mb-1">Dhesty C</p>
                                <p class="text-xs text-gray-600">Anggota BPD, Pengawasan Pemerintahan</p>
                            </div>
                        </div>
