                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-swimming-pool mr-3 text-blue-500"></i>
                                    <span>Berenang & Snorkeling</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-volleyball-ball mr-3 text-orange-500"></i>
                                    <span>Voli Pantai</span>
                                </div>
                                <div class="flex items-center text-gray-600">
                                    <i class="fas fa-fish mr-3 text-teal-500"></i>
                                    <span>Memancing</span>
                                </div>
                            </div>
                        </div>
