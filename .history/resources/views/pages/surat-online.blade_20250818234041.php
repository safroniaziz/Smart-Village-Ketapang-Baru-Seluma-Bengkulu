    ...
    function generateModalForm(subJenis) {
        ...
        const fieldsHtml = template.fields.map(field => {
            ...
            if (field.type === 'select') {
                ...
                inputHtml = `<textarea name="${field.name}" ${field.required ? 'required' : ''} rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Masukkan ${field.label.toLowerCase()}..."></textarea>`;
