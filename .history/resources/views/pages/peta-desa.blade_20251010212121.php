...
async function addVillageBoundary() {
    ...
    try {
        ...
        if (!data || !data.features || data.features.length === 0) {
            console.warn('Boundary not found on Nominatim for Ketapang Baru');
        ...
        // Fit to boundary without overriding marker fit too aggressively
        try {
        ...
        createNotification('<i class="fas fa-check mr-2"></i>Batas Desa ditambahkan dari OSM', 'success');
    } catch (error) {
