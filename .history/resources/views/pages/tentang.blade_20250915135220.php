...
<section class="section-standard">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <x-section-header 
            badge="Peruntukan Lahan Desa"
            title="Luas Wilayah"
            description="Pembagian lahan desa berdasarkan peruntukan dan penggunaan optimal untuk kesejahteraan masyarakat"
            color-scheme="emerald"
...
<section class="section-standard bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <!-- Enhanced Header -->
        <x-section-header 
            badge="Letak Geografis Strategis"
            badge-icon="fas fa-map-marked-alt"
            title="Posisi & Lokasi"
            description="Desa Ketapang Baru terletak di posisi geografis strategis dengan akses pesisir yang menguntungkan"
            color-scheme="blue"
            :aos="true"
            aos-delay="300"
        />
...
<section class="section-standard bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        <x-section-header 
            badge="Potensi Unggulan Desa"
            title="Kekayaan Desa"
            description="Berbagai potensi unggulan yang dapat dikembangkan untuk kemajuan dan kesejahteraan masyarakat Ketapang Baru"
            color-scheme="purple"
            icon="fas fa-star"
        />
