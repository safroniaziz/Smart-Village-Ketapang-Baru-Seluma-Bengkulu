            ...
            <div class="flex-1 max-w-4xl relative z-10">
                <div class="text-center space-y-8">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300" data-aos="zoom-in" data-aos-delay="1000" data-aos-duration="600"></div>
                            <div class="flex items-center justify-between mb-2">
