    ...
    <div class="w-[80%] max-w-none mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100" data-aos="fade-up" data-aos-duration="800">
            ...
            <div id="fallback-chart" style="display: block;">
                <!-- Top row: Kepala Desa & Ketua BPD with dashed connector -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div>
                        <!-- Line down from Kepala Desa -->
                        <div class="w-px h-8 bg-blue-400 mx-auto mb-4"></div>

                        <!-- Sekretaris -->
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-4 text-center shadow-lg max-w-xs mx-auto">
                        ...
                        <!-- Line down to Kasi/Kaur -->
                        <div class="w-px h-8 bg-green-400 mx-auto my-4"></div>
                        ...
                        <!-- Line down to Kepala Dusun -->
                        <div class="w-px h-8 bg-orange-400 mx-auto my-4"></div>
                    ...
                    <div>
                        <!-- Line down from Ketua BPD -->
                        <div class="w-px h-8 bg-purple-400 mx-auto mb-4"></div>
