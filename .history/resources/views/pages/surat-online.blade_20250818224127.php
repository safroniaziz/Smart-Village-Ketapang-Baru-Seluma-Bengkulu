...
<section id="jenis-surat" class="section-nav py-16 bg-gray-50 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100" id="ajukan-surat">
                <div class="p-8 text-center h-full flex flex-col">
                    ...
                    <button type="button" onclick="showForm('Surat Pengantar')" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 mt-auto">Ajukan Surat</button>
                </div>
            </div>
