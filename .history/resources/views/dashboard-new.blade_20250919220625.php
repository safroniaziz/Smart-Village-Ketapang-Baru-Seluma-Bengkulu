                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Data Warga</a>
                                                <span class="text-gray-500 fw-semibold fs-7">Kelola data penduduk</span>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            <a href="#" class="btn btn-sm btn-light-primary">Kelola</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Pengaduan</a>
                                                <span class="text-gray-500 fw-semibold fs-7">Kelola pengaduan warga</span>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            <a href="#" class="btn btn-sm btn-light-danger">Kelola</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Surat Online</a>
                                                <span class="text-gray-500 fw-semibold fs-7">Kelola pengajuan surat</span>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            <a href="#" class="btn btn-sm btn-light-warning">Kelola</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Data Desa</a>
                                                <span class="text-gray-500 fw-semibold fs-7">Kelola profil desa</span>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            <a href="#" class="btn btn-sm btn-light-success">Kelola</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
