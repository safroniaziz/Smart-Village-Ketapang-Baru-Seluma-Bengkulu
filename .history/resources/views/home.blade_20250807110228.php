...
<section class="relative text-white overflow-hidden py-12 lg:py-16" style="background-color: #0086c9;">
    ...
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-20 left-10 w-3 h-3 bg-yellow-400/30 rounded-full animate-bounce" style="animation-delay: 0s; animation-duration: 3s;"></div>
        <div class="absolute top-40 right-20 w-4 h-4 bg-white/40 rounded-full animate-bounce" style="animation-delay: 1s; animation-duration: 4s;"></div>
        <div class="absolute top-60 left-80 w-2 h-2 bg-blue-400/50 rounded-full animate-bounce" style="animation-delay: 2s; animation-duration: 2.5s;"></div>
        <div class="absolute bottom-40 left-30 w-5 h-5 bg-yellow-300/40 rounded-full animate-bounce" style="animation-delay: 0.5s; animation-duration: 3.5s;"></div>
        <div class="absolute bottom-60 right-10 w-3 h-3 bg-white/30 rounded-full animate-bounce" style="animation-delay: 1.5s; animation-duration: 2.8s;"></div>
        <div class="absolute top-80 left-60 w-4 h-4 bg-blue-300/40 rounded-full animate-bounce" style="animation-delay: 3s; animation-duration: 4.2s;"></div>
        <div class="absolute top-30 right-60 w-2 h-2 bg-yellow-400/50 rounded-full animate-bounce" style="animation-delay: 2.5s; animation-duration: 3.2s;"></div>
        <div class="absolute bottom-20 left-70 w-3 h-3 bg-white/40 rounded-full animate-bounce" style="animation-delay: 1.8s; animation-duration: 2.9s;"></div>
        <div class="absolute top-50 right-40 w-4 h-4 bg-blue-400/30 rounded-full animate-bounce" style="animation-delay: 0.8s; animation-duration: 3.8s;"></div>
        <div class="absolute bottom-80 right-30 w-2 h-2 bg-yellow-300/50 rounded-full animate-bounce" style="animation-delay: 3.2s; animation-duration: 2.6s;"></div>
    </div>
