...
<section class="hero-section relative text-white overflow-hidden min-h-screen flex items-center" data-aos="fade-in">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10" data-aos="fade-up" data-aos-delay="150">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
            <!-- Hero Content (Left Side) -->
            <div class="flex-1 space-y-12 relative z-10">
                <div class="space-y-10">
                    <!-- Badge -->
                    <div class="flex items-center space-x-4 mb-8" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-blue-100">DESA KETAPANG BARU</h2>
                            <p class="text-base text-blue-100">Kecamatan Semidang Alas Maras, Seluma, Bengkulu</p>
                        </div>
                    </div>

                    <!-- Main Title -->
                    <h1 class="text-5xl lg:text-7xl font-black leading-tight mb-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="mb-8" data-aos="fade-up" data-aos-delay="250">
                        <div class="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-full text-base font-semibold shadow-xl backdrop-blur-sm border border-white/20">
                            <i class="fas fa-star mr-3 text-yellow-300 text-lg"></i>
                            Desa Digital Terdepan
                        </div>
                    </div>

                    <!-- Description -->
                    <p class="text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-3xl font-light mb-8" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <!-- Dynamic Statistics -->
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8" data-aos="fade-up" data-aos-delay="350">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 text-center">
                            <div class="text-2xl font-black text-yellow-400">{{ $luasWilayah }}</div>
                            <div class="text-sm text-blue-100">Luas Wilayah</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 text-center">
                            <div class="text-2xl font-black text-yellow-400">{{ number_format($totalKepalaKeluarga) }}</div>
                            <div class="text-sm text-blue-100">Kepala Keluarga</div>
                        </div>
                    </div>
                </div>

                <!-- Enhanced Search Bar -->
                <div class="max-w-2xl mb-8 relative z-20" data-aos="fade-up" data-aos-delay="400">
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-white/10 rounded-2xl blur-lg"></div>
                        <div class="relative bg-white/15 backdrop-blur-md border border-white/30 rounded-2xl p-3 shadow-2xl z-20">
                            <div class="flex items-center">
                                <div class="flex-1 flex items-center">
                                    <i class="fas fa-search text-white/70 text-lg ml-4 mr-4"></i>
                                    <input type="text" placeholder="Cari layanan desa, berita, atau informasi..."
                                           class="w-full bg-transparent text-white placeholder-white/60 text-lg font-medium py-4 pr-4 border-0 outline-0 focus:outline-none focus:ring-0 focus:border-0">
                                </div>
                                <button class="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                ...
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 relative z-20" data-aos="fade-up" data-aos-delay="450">
                    <a href="{{ route('tentang') }}" class="group bg-white/15 hover:bg-white/25 backdrop-blur-md border-2 border-white/30 hover:border-white/50 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center justify-center">
                            <i class="fas fa-info-circle mr-3 text-lg"></i>
                            <span class="text-lg">Profil Desa</span>
                        </div>
                    </a>
                    <a href="{{ route('visi.misi') }}" class="group bg-gradient-to-r from-yellow-400/20 to-orange-500/20 hover:from-yellow-400/30 hover:to-orange-500/30 backdrop-blur-md border-2 border-yellow-400/30 hover:border-yellow-400/50 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center justify-center">
                            <i class="fas fa-bullseye mr-3 text-lg"></i>
                            <span class="text-lg">Visi & Misi</span>
                        </div>
                    </a>
                </div>
            </div>

            <!-- Right Side - Info Cards & News -->
            <div class="lg:w-[520px] flex-shrink-0 relative z-10 space-y-6" data-aos="fade-left" data-aos-delay="300">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20 shadow-2xl" data-aos="fade-up" data-aos-delay="500">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-white">Berita & Pengumuman</h3>
                        <div class="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></div>
                    </div>

                    <div class="space-y-4">
                        <!-- Sample News Items -->
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 cursor-pointer">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-white font-semibold text-sm mb-1 line-clamp-2">Pembangunan Jembatan Penghubung Dusun 1 & 2</h4>
                                    <p class="text-blue-100 text-xs mb-2">Proyek infrastruktur strategis untuk meningkatkan konektivitas antar dusun</p>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 cursor-pointer">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-white font-semibold text-sm mb-1 line-clamp-2">Musyawarah Desa Tahunan 2025</h4>
                                    <p class="text-blue-100 text-xs mb-2">Evaluasi program dan perencanaan pembangunan desa tahun depan</p>
                                    <div class="flex items-center text-xs text-blue-200">
                                        <i class="fas fa-calendar mr-1"></i>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 cursor-pointer">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-white font-semibold text-sm mb-1 line-clamp-2">Program Pelatihan Digital untuk UMKM</h4>
                                    <p class="text-blue-100 text-xs mb-2">Peningkatan kapasitas wirausaha dalam era digital</p>
                                    <div class="flex items-center text-xs text-blue-200">
                                        <i class="fas fa-calendar mr-1"></i>
                    ...
                    <div class="mt-6 text-center">
                        <a href="#" class="inline-flex items-center text-yellow-300 hover:text-yellow-200 text-sm font-semibold transition-colors duration-300">
                ...
                <!-- Quick Stats Card -->
                <div class="bg-gradient-to-br from-yellow-400/20 to-orange-500/20 backdrop-blur-sm rounded-3xl p-6 border border-yellow-400/30 shadow-2xl" data-aos="fade-up" data-aos-delay="600">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-bold text-white mb-4">Pencapaian Desa</h3>

                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-center">
                                <div class="text-2xl font-black text-yellow-300">95%</div>
                                <div class="text-xs text-yellow-100">Kepuasan Masyarakat</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-black text-yellow-300">12</div>
                                <div class="text-xs text-yellow-100">Program Aktif</div>
                            </div>
                        </div>
                    </div>
                </div>
