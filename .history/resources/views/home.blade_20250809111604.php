    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                <!-- Single Clean Stats Card -->
                <div class="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="flex justify-between items-center mb-3">
                                <span class="text-white font-semibold">Digitalisasi</span>
                                <span class="text-yellow-300 font-bold text-lg">85%</span>
                            </div>
                            <div class="w-full bg-white/20 rounded-full h-4">
                                <div class="bg-gradient-to-r from-yellow-400 to-orange-500 h-4 rounded-full shadow-lg" style="width: 85%"></div>
                            </div>
                        </div>

                        <div>
                            <div class="flex justify-between items-center mb-3">
                                <span class="text-white font-semibold">Layanan Online</span>
                                <span class="text-green-300 font-bold text-lg">92%</span>
                            </div>
                            <div class="w-full bg-white/20 rounded-full h-4">
                                <div class="bg-gradient-to-r from-green-400 to-emerald-500 h-4 rounded-full shadow-lg" style="width: 92%"></div>
                            </div>
                        </div>
                    </div>
