...
$(document).ready(function() {
    ...
    // Initialize Charts - Simple version like statistik.blade.php
    function initializeCharts() {
        console.log('Initializing charts - Simple version');
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: function(context) {
                                    ...
                                    return 'Jumlah: ' + context.parsed.y + ' orang (' + percentage + '%)';
                                }
                            }
                        }
                    },
