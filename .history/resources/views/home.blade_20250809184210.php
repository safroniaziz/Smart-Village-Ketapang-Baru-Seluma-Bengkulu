    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-20">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-8">
            ...
            <div class="lg:w-[420px] flex-shrink-0 relative z-10" data-aos="fade-left" data-aos-delay="600">
                <!-- Mini Stats Grid - 4 Compact Cards -->
                <div class="grid grid-cols-2 gap-2 mb-4">
                    <div class="group text-center p-3 bg-white/95 backdrop-blur-sm border border-blue-200 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:border-blue-300">
                        <div class="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                            <i class="fas fa-users text-white text-sm"></i>
                        </div>
                        <div class="text-xl font-black text-gray-800 mb-1">
                            <span class="counter" data-count="2847">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-xs">Total Warga</div>
                    </div>

                    <div class="group text-center p-3 bg-white/95 backdrop-blur-sm border border-emerald-200 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:border-emerald-300">
                        <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                            <i class="fas fa-map-marked-alt text-white text-sm"></i>
                        </div>
                        <div class="text-xl font-black text-gray-800 mb-1">
                            <span class="counter" data-count="8">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-xs">Dusun</div>
                    </div>

                    <div class="group text-center p-3 bg-white/95 backdrop-blur-sm border border-purple-200 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:border-purple-300">
                        <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                            <i class="fas fa-home text-white text-sm"></i>
                        </div>
                        <div class="text-xl font-black text-gray-800 mb-1">
                            <span class="counter" data-count="1250">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-xs">Keluarga</div>
                    </div>

                    <div class="group text-center p-3 bg-white/95 backdrop-blur-sm border border-orange-200 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:border-orange-300">
                        <div class="w-8 h-8 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                            <i class="fas fa-seedling text-white text-sm"></i>
                        </div>
                        <div class="text-xl font-black text-gray-800 mb-1">
                            <span class="counter" data-count="450">0</span>
                        </div>
                        <div class="text-gray-700 font-bold text-xs">Hektar</div>
                    </div>
                </div>
