...
<section class="hero-section relative text-white overflow-hidden min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] flex items-center pt-8 py-8 lg:py-12 pb-32 lg:pb-28 mb-8 md:mb-12" data-aos="fade-in">
    <!-- Background Pattern -->
...
<!-- Services Section -->
<section class="py-20 mt-16 md:mt-0 bg-gradient-to-br from-gray-50 via-white to-blue-50" data-aos="fade-up">
