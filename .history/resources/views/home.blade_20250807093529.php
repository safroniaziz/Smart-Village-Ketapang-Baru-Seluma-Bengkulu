...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white overflow-hidden py-16 lg:py-24">
    <!-- Background Pattern -->
...
<section class="py-16 bg-gray-50">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
            <a href="{{ route('berita') }}" class="bg-white hover:bg-gray-50 text-blue-600 font-medium px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-gray-200">
                <i class="fas fa-newspaper mr-2"></i>Tampilkan Semua Artikel
            </a>
        </div>
    </div>
</section>
