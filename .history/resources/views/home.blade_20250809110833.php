    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="flex-1 space-y-8">
                ...
                <!-- Enhanced Search Bar -->
                <div class="max-w-xl mb-8" data-aos="fade-up" data-aos-delay="700">
                    <div class="relative">
                        <div class="relative bg-white/15 backdrop-blur-md border border-white/30 rounded-xl p-2 shadow-xl">
                            <div class="flex items-center">
                                <div class="flex-1 flex items-center">
                                    <i class="fas fa-search text-white/70 text-lg ml-4 mr-3"></i>
                                    <input type="text" placeholder="Cari layanan desa..."
                                           class="w-full bg-transparent text-white placeholder-white/60 text-base font-medium focus:outline-none py-3 pr-3">
                                </div>
                                <button class="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white font-bold px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                    ...
                    <div class="flex flex-wrap gap-2 mt-3">
                        <span class="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 rounded-full px-3 py-1 text-xs text-white/90 cursor-pointer transition-all duration-300">
                            📄 Surat Domisili
                        </span>
                        <span class="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 rounded-full px-3 py-1 text-xs text-white/90 cursor-pointer transition-all duration-300">
                            👥 Data Warga
                ...
                <div class="flex flex-col sm:flex-row gap-4" data-aos="fade-up" data-aos-delay="800">
                    <a href="{{ route('surat.online') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center text-lg hover:scale-105 transform shadow-lg">
                        <i class="fas fa-envelope mr-2"></i>Layanan Surat Online
                    </a>
                    <a href="{{ route('tentang') }}" class="bg-white/20 hover:bg-white/30 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center backdrop-blur-sm text-lg hover:scale-105 transform border border-white/30">
                        <i class="fas fa-info-circle mr-2"></i>Profil Desa
                    </a>
                </div>

                <!-- Quick Stats -->
                <div class="flex flex-wrap gap-3 pt-6 pb-8 max-w-3xl" data-aos="fade-up" data-aos-delay="1000">
                    <div class="text-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 min-w-[140px] hover:scale-105 transition-transform duration-300 hover:bg-white/15">
            ...
            <!-- Professional Info Card (Right Side) -->
...
@keyframes glow {
    ...
    50% { box-shadow: 0 0 40px rgba(255, 255, 255, 0.3), 0 0 60px rgba(59, 130, 246, 0.2); }
}
