        ...
        <tr class="bg-blue-50 border-l-4 border-blue-500 family-header" data-family="{{ $noKK }}" style="cursor: pointer;" title="Klik untuk melihat detail keluarga">
            <td colspan="7" class="py-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-home text-blue-600 me-3 text-xl"></i>
                    <div>
                        <div class="fw-bold text-lg text-blue-800 d-flex align-items-center">
                            Keluarga {{ $namaKepala }}
                            @if($noKK && $noKK !== '-')
                                <span class="text-gray-500 text-sm ms-2">({{ $noKK }})</span>
                            @endif
                        </div>
                    ...
                    <div class="ms-auto d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center me-3">
                            <div class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium me-2">
                        ...
                        {{-- Toggle Button --}}
                        <button class="btn btn-sm bg-blue-100 text-blue-800 hover:bg-blue-200 family-toggle d-flex align-items-center px-3 py-2 font-medium rounded-lg transition-colors"
                                data-family="{{ $noKK }}"
