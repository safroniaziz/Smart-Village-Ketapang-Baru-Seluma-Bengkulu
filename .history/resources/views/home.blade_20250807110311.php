...
<section class="relative text-white overflow-hidden py-12 lg:py-16" style="background-color: #0086c9;">
    ...
    <div class="absolute inset-0">
        <div class="absolute top-0 left-0 w-72 h-72 bg-white/5 rounded-full blur-3xl bg-glow"></div>
        <div class="absolute top-1/4 right-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl bg-glow" style="animation-delay: 1s;"></div>
        <div class="absolute bottom-0 left-1/3 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl bg-glow" style="animation-delay: 2s;"></div>
    </div>

    <!-- Floating Particles -->
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-20 left-10 w-3 h-3 bg-yellow-400/60 rounded-full animate-bounce particle-glow" style="animation-delay: 0s; animation-duration: 3s; color: #fbbf24;"></div>
        <div class="absolute top-40 right-20 w-4 h-4 bg-white/70 rounded-full animate-bounce particle-sparkle" style="animation-delay: 1s; animation-duration: 4s;"></div>
        <div class="absolute top-60 left-80 w-2 h-2 bg-blue-400/80 rounded-full animate-bounce particle-glow" style="animation-delay: 2s; animation-duration: 2.5s; color: #60a5fa;"></div>
        <div class="absolute bottom-40 left-30 w-5 h-5 bg-yellow-300/60 rounded-full animate-bounce particle-sparkle" style="animation-delay: 0.5s; animation-duration: 3.5s;"></div>
        <div class="absolute bottom-60 right-10 w-3 h-3 bg-white/50 rounded-full animate-bounce particle-glow" style="animation-delay: 1.5s; animation-duration: 2.8s; color: #ffffff;"></div>
        <div class="absolute top-80 left-60 w-4 h-4 bg-blue-300/60 rounded-full animate-bounce particle-sparkle" style="animation-delay: 3s; animation-duration: 4.2s;"></div>
        <div class="absolute top-30 right-60 w-2 h-2 bg-yellow-400/80 rounded-full animate-bounce particle-glow" style="animation-delay: 2.5s; animation-duration: 3.2s; color: #fbbf24;"></div>
        <div class="absolute bottom-20 left-70 w-3 h-3 bg-white/60 rounded-full animate-bounce particle-sparkle" style="animation-delay: 1.8s; animation-duration: 2.9s;"></div>
        <div class="absolute top-50 right-40 w-4 h-4 bg-blue-400/50 rounded-full animate-bounce particle-glow" style="animation-delay: 0.8s; animation-duration: 3.8s; color: #60a5fa;"></div>
        <div class="absolute bottom-80 right-30 w-2 h-2 bg-yellow-300/80 rounded-full animate-bounce particle-sparkle" style="animation-delay: 3.2s; animation-duration: 2.6s;"></div>

        <!-- Additional sparkle particles -->
        <div class="absolute top-10 right-10 w-1 h-1 bg-yellow-400/90 rounded-full animate-ping" style="animation-delay: 0.3s;"></div>
        <div class="absolute top-70 left-20 w-1 h-1 bg-white/90 rounded-full animate-ping" style="animation-delay: 1.7s;"></div>
        <div class="absolute bottom-10 left-10 w-1 h-1 bg-blue-400/90 rounded-full animate-ping" style="animation-delay: 2.1s;"></div>
        <div class="absolute top-90 right-50 w-1 h-1 bg-yellow-300/90 rounded-full animate-ping" style="animation-delay: 0.9s;"></div>
        <div class="absolute bottom-30 right-60 w-1 h-1 bg-white/90 rounded-full animate-ping" style="animation-delay: 3.5s;"></div>
    </div>
