        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400">
                <div class="relative z-10 animate-float">
                    <div class="w-full h-96 lg:h-[500px] bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl shadow-2xl flex items-center justify-center overflow-hidden">
                        <!-- Background Pattern -->
                        <div class="absolute inset-0 bg-white/10"></div>

                        <!-- Main Content -->
                        <div class="text-center text-white relative z-10">
                            <!-- Profile Circle with Dummy Image -->
                            <div class="w-32 h-32 rounded-full mx-auto mb-6 border-4 border-white/30 overflow-hidden bg-white/20">
                                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&h=256&q=80"
                                     alt="Kepala Desa"
                                     class="w-full h-full object-cover"
                                     onerror="this.src='https://ui-avatars.com/api/?name=Kepala+Desa&background=1e40af&color=ffffff&size=128&bold=true'">
                            </div>

                            <!-- Title -->
                            <h3 class="text-2xl font-bold mb-2">Kepala Desa</h3>
                            <p class="text-blue-100 mb-4">Ketapang Baru</p>

                            <!-- Name -->
                            <div class="bg-white/20 rounded-lg px-4 py-2 inline-block">
                                <p class="font-semibold">H. Ahmad Supriyadi, S.Pd</p>
