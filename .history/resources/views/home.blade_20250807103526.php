    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-12">
            ...
            <div class="lg:w-96 flex-shrink-0">
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-6 text-gray-900 sticky top-8 border border-gray-100">
                    <div class="text-center mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                            <i class="fas fa-map-marker-alt text-white text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-1">Desa Ketapang Baru</h3>
                        <p class="text-gray-600 font-medium">Kabupaten Seluma, Provinsi Bengkulu</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                            ...
                            <div>
                                <div class="font-bold text-gray-900">Kepala Desa</div>
                                <div class="text-sm text-gray-600">H. Ahmad Supriyadi, S.Pd</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                            ...
                            <div>
                                <div class="font-bold text-gray-900">Periode</div>
                                <div class="text-sm text-gray-600">2021 - 2027</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-100">
                            ...
                            <div>
                                <div class="font-bold text-gray-900">Kontak</div>
                                <div class="text-sm text-gray-600">(0736) 123456</div>
                            </div>
                        </div>

                        <div class="flex items-center space-x-4 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                            <div class="w-10 h-10 bg-orange-600 rounded-lg flex items-center justify-center">
                                <i class="fas fa-envelope text-white"></i>
                            </div>
                            <div>
                                <div class="font-bold text-gray-900">Email</div>
                                <div class="text-sm text-gray-600">ketapangbaru@gmail.com</div>
                            </div>
                        </div>
                    </div>
