...
class PotensiWisataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $wisataData = [
            ...
            [
                'nama' => 'Warung Kuliner Khas Seluma',
                'kategori' => 'Wisata Kuliner',
                'deskripsi' => 'Pusat kuliner tradisional Seluma yang menyajikan berbagai makanan khas daerah dengan cita rasa autentik. Pengunjung dapat menikmati gulai tempoyak, ikan bakar, dan berbagai camilan tradisional.',
                'lokasi' => 'Pasar Ketapang Baru, Seluma, Bengkulu',
                'aktivitas_wisata' => 'Wisata kuliner, mencicipi makanan tradisional, belajar memasak, berbelanja oleh-oleh khas, dan food photography.',
                'nomor_telepon' => '+62 815-9876-5432',
                'whatsapp' => '+62 815-9876-5432',
                'info_guide' => 'Pemilik warung dapat menjelaskan asal-usul dan resep makanan tradisional',
                'jam_buka' => '06:00 - 20:00',
                'harga_tiket' => 'Sesuai pesanan makanan',
                'fasilitas_parkir' => 'Tersedia di area pasar',
                'warung_makan' => 'Berbagai pilihan warung kuliner',
                'gambar' => $this->processKulinerGallery(),
                'fitur_unggulan' => [
                    [
                        'icon' => 'fas fa-utensils',
                        'judul' => 'Makanan Autentik',
                        'deskripsi' => 'Cita rasa makanan tradisional Seluma yang telah diwariskan turun temurun.'
                    ],
                    [
                        'icon' => 'fas fa-heart',
                        'judul' => 'Resep Keluarga',
                        'deskripsi' => 'Dibuat dengan resep rahasia keluarga yang telah bertahun-tahun.'
                    ],
                    [
                        'icon' => 'fas fa-star',
                        'judul' => 'Bahan Segar',
                        'deskripsi' => 'Menggunakan bahan-bahan segar dari hasil kebun dan laut setempat.'
                    ]
                ],
                'video_youtube' => 'https://www.youtube.com/watch?v=example4',
                'sumber_video' => 'Kuliner Nusantara Channel',
                'views' => 623
            ],
            [
                'nama' => 'Agrowisata Kebun Karet Rakyat',
                'kategori' => 'Wisata Edukasi',
                'deskripsi' => 'Wisata edukasi yang memperkenalkan pengunjung pada proses budidaya karet dari penanaman hingga panen. Pengalaman langsung menyadap karet dan mempelajari industri karet rakyat.',
                'lokasi' => 'Perkebunan Rakyat, Ketapang Baru, Seluma',
                'aktivitas_wisata' => 'Tur kebun karet, praktik menyadap karet, edukasi pengolahan karet, workshop kerajinan karet, dan farming experience.',
                'nomor_telepon' => '+62 816-1234-5678',
                'whatsapp' => '+62 816-1234-5678',
                'info_guide' => 'Petani karet berpengalaman yang akan membimbing seluruh aktivitas',
                'jam_buka' => '07:00 - 16:00',
                'harga_tiket' => 'Rp 25.000/orang (termasuk snack)',
                'fasilitas_parkir' => 'Area parkir luas di pinggir kebun',
                'warung_makan' => 'Gazebo tempat istirahat dan makan',
                'gambar' => $this->processEdukasiGallery(),
                'fitur_unggulan' => [
                    [
                        'icon' => 'fas fa-seedling',
                        'judul' => 'Edukasi Pertanian',
                        'deskripsi' => 'Pembelajaran langsung tentang budidaya dan pengolahan karet.'
                    ],
                    [
                        'icon' => 'fas fa-hands',
                        'judul' => 'Hands-on Experience',
                        'deskripsi' => 'Praktik langsung menyadap karet dengan bimbingan ahli.'
                    ],
                    [
                        'icon' => 'fas fa-leaf',
                        'judul' => 'Ramah Lingkungan',
                        'deskripsi' => 'Sistem pertanian berkelanjutan yang menjaga kelestarian alam.'
                    ]
                ],
                'video_youtube' => 'https://www.youtube.com/watch?v=example5',
                'sumber_video' => 'Agro Education TV',
                'views' => 428
            ]
        ];
    ...
    private function processKulinerGallery()
    {
        $imageProcessor = new ImageProcessingService();
        $kulinerGallery = [
            [
                'url' => 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800',
                'judul' => 'Gulai Tempoyak Khas Seluma',
                'keterangan' => 'Gulai tempoyak adalah makanan khas Seluma dengan cita rasa yang unik dan kaya rempah.'
            ],
            [
                'url' => 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=800',
                'judul' => 'Ikan Bakar Bumbu Kuning',
                'keterangan' => 'Ikan segar dari laut Seluma yang dibakar dengan bumbu kuning tradisional.'
            ],
            [
                'url' => 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=800',
                'judul' => 'Kue Tradisional Bengkulu',
                'keterangan' => 'Berbagai kue tradisional yang dibuat dengan resep turun temurun.'
            ]
        ];
        return $imageProcessor->processGalleryImages($kulinerGallery);
    }

    private function processEdukasiGallery()
    {
        $imageProcessor = new ImageProcessingService();
        $edukasiGallery = [
            [
                'url' => 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=800',
                'judul' => 'Kebun Karet Rakyat',
                'keterangan' => 'Hamparan kebun karet rakyat yang hijau dan terawat dengan baik.'
            ],
            [
                'url' => 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800',
                'judul' => 'Proses Penyadapan Karet',
                'keterangan' => 'Aktivitas penyadapan karet tradisional yang dilakukan setiap pagi hari.'
            ],
            [
                'url' => 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800',
                'judul' => 'Workshop Pengolahan Karet',
                'keterangan' => 'Pembelajaran tentang pengolahan getah karet menjadi berbagai produk.'
            ]
        ];
        return $imageProcessor->processGalleryImages($edukasiGallery);
    }
