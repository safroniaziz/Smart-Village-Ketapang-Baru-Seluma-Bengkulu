...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('pendidikan', ['Tidak Sekolah', 'SD', 'SMP', 'SMA', 'SLTP', 'SLTA', 'D3', 'DIPLOMA', 'S1', 'S2', 'S3', 'TS'])->nullable()->index();
            ...
            // Mata Pencaharian
            $table->enum('mata_pencaharian', ['PTN', 'SWT', 'PNS', 'NLY', 'LN', 'PETANI', 'SWASTA', 'NELAYAN', 'DLL'])->nullable()->index();
