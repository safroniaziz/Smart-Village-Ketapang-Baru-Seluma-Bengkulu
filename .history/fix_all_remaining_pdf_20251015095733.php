...
/**
 * Script untuk memperbaiki semua file PDF yang memiliki logika TTD
 */

$pdfFiles = [
    'surat-bersih-diri.blade.php',
...
echo "Memperbaiki logika TTD di semua file PDF yang memiliki TTD...\n";
