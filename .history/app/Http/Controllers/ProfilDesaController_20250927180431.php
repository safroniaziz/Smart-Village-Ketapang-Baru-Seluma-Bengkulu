...
class ProfilDesaController extends Controller
{
    public function index(Request $request)
    {
        ...
        $batasWilayah = BatasWilayah::ordered()->get(); // Remove active() filter temporarily to debug
    ...
    public function storeFasilitas(Request $request)
    {
        $request->validate([
            ...
            'kondisi' => 'nullable|string|in:baik,rusak_ringan,rusak_berat',
    ...
    public function storeBatas(Request $request)
    {
        try {
            $validated = $request->validate([
                'arah' => 'required|string|in:utara,selatan,timur,barat',
                'berbatasan_dengan' => 'required|string|max:255',
                'jenis_wilayah' => 'required|string|in:desa,kelurahan,kecamatan,kabupaten',
            ...
            return response()->json([
                'success' => true,
                'message' => 'Data batas wilayah berhasil disimpan'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
