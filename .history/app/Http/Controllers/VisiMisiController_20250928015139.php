...
class VisiMisiController extends Controller
{
    ...
    public function indexVisi()
    {
        ...
        return view('admin.visi-misi.partials.visi-list', compact('visi'));
    }
    ...
    public function indexMisi()
    {
        ...
        return view('admin.visi-misi.partials.misi-list', compact('misi'));
    }
    ...
    public function indexPendekatan()
    {
        ...
        return view('admin.visi-misi.partials.pendekatan-list', compact('pendekatan'));
    }
    ...
    public function indexTahapan()
    {
        ...
        return view('admin.visi-misi.partials.tahapan-list', compact('tahapan'));
    }
