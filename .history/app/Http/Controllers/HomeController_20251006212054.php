...
class HomeController extends Controller
{
    ...
    {
        // Get distinct jenis surat untuk menampilkan statistik
        $surat = \App\Models\Surat::select('jenis_surat')
            ->distinct()
            ->get();
        
        // Data statistik surat online
        $totalPengajuan = \App\Models\PengajuanSurat::count();
        $pengajuanDiterima = \App\Models\PengajuanSurat::where('status', 'approved')->count();
        $pengajuanMenunggu = \App\Models\PengajuanSurat::where('status', 'pending')->count();
        
        return view('pages.surat-online', compact('surat', 'totalPengajuan', 'pengajuanDiterima', 'pengajuanMenunggu'));
    }
