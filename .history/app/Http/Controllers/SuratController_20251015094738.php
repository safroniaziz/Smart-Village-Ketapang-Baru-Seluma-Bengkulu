...
class SuratController extends Controller
{
    ...
    public function generatePDFBersihDiri($pengajuanId)
    {
        ...
        if ($pengajuan->jenis_ttd === 'qrcode') {
            ...
            $ttdData = [
                'jenis_ttd' => 'gambar',
                'ttd_image_path' => 'assets/images/ttd.png'  // Path relatif untuk template
            ];
        }

        // Generate QR Code for verification surat (untuk tracking, bukan TTD)
        // Hanya generate jika diperlukan untuk verifikasi surat
