...
class PotensiWisataPublicController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $categories = PotensiWisata::active()
    ...
    public function show($slug)
    {
        ...
        return view('potensi-wisata.show', compact('wisata', 'related'));
    }
    ...
    /**
     * Get map data for all active destinations
     */
