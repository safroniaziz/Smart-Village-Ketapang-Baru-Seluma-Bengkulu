...
class AnggaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Reindex collections to ensure table numbering starts at 1
        $pendapatan = $apbdes->where('jenis_anggaran', 'pendapatan')->values();
        $belanja = $apbdes->where('jenis_anggaran', 'belanja')->values();
        ...
        // Village information
        $villageName = 'Ketapang Baru';
        $districtName = 'Kecamatan Semidang Alas Maras';
