    ...
    public function index(Request $request)
    {
        ...
        if ($wisata) {
            ...
            if ($wisata->video_youtube) {
                ...
                elseif (preg_match('/(?:youtube\.com\/watch\?v=|youtu\.be\/|youtube\.com\/embed\/)([a-zA-Z0-9_-]{11})/', $url, $matches)) {
                    $youtubeId = $matches[1];
                }
                // Pattern 3: Direct video ID (if someone just puts the ID)
                ...
                \Log::info('Extracted YouTube ID: ' . $youtubeId);
            }
