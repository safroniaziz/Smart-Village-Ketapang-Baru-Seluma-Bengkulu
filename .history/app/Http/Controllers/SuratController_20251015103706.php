...
class SuratController extends Controller
{
        ...
        if ($pengajuan->jenis_ttd === 'gambar') {
            ...
            if (file_exists($ttdImagePath)) {
                try {
                    ...
                    // Debug: Log pengajuan data
                    \Log::info('Generating QR TTD for pengajuan', [
                        'id' => $pengajuan->id,
                        'tracking_number' => $pengajuan->tracking_number,
                    ...
                    // Debug: Log result
                    \Log::info('QR TTD generated', [
                        'success' => !empty($ttdBase64),
                        'length' => strlen($ttdBase64 ?? ''),
                        'starts_with' => substr($ttdBase64 ?? '', 0, 50)
                    ]);
    ...
    public function generatePDFSPPD($pengajuanId)
    {
        ...
        // QR Code verifikasi surat dihapus - tidak diperlukan
        $trackingQrCode = null;
