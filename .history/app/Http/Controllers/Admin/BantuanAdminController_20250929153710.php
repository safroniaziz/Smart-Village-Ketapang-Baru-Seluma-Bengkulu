...
class BantuanAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'tidak_aktif' => PenerimaBantuan::where('status', 'Tidak Aktif')->count(),
            'selesai' => PenerimaBantuan::where('status', 'Selesai')->count(),
            'total_nominal' => PenerimaBantuan::where('status', 'Aktif')->sum('nominal'),
        ];
        ...
        return view('admin.bantuan.index', compact('bantuans', 'programs', 'years', 'stats'));
    }
    ...
    public function show(PenerimaBantuan $bantuan)
    {
        $bantuan->load('user');
