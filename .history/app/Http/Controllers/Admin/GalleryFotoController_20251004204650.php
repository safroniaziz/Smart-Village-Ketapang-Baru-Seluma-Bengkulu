...
class GalleryFotoController extends Controller
{
    ...
    {
        $categories = GalleryFoto::getKategoriList();
        $currentHero = GalleryFoto::getHeroPhoto();
        return view('admin.gallery-foto.create', compact('categories', 'currentHero'));
    }
    ...
    public function edit(GalleryFoto $galleryFoto)
    {
        $categories = GalleryFoto::getKategoriList();
        $currentHero = GalleryFoto::getHeroPhoto();
        return view('admin.gallery-foto.edit', compact('galleryFoto', 'categories', 'currentHero'));
    }
     ...
     * Set photo as hero
     */
    public function setHero(GalleryFoto $galleryFoto)
    {
        $galleryFoto->setAsHero();

        return response()->json([
            'success' => true,
            'message' => '✅ Foto berhasil dijadikan hero!'
        ]);
    }
