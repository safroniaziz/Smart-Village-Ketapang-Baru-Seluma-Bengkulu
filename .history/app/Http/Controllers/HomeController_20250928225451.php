...
class HomeController extends Controller
{
    ...
    public function statistik()
    {
        ...
        $programDetails = PenerimaBantuan::with('user')
            ...
            ->get()
            ->map(function($item) {
                // Calculate average amount per program (simulated based on program type)
                $baseAmounts = [
                    'PKH' => 750000,
                    'BPNT' => 200000,
                    'BLT' => 300000,
                    ...
                    'BPUM' => 1200000,
                    'Bansos' => 100000,
                    'Kartu Prakerja' => 3500000
                ];
                
                $baseAmount = $baseAmounts[$item->program] ?? 200000;
                $amount = number_format($baseAmount);
                
                // Program descriptions
                $descriptions = [
                    'PKH' => 'Bantuan pendidikan & kesehatan',
                    'BPNT' => 'Bantuan sembako elektronik',
                ...
                $colors = [
                    ...
                    'BLT' => ['bg' => 'from-purple-50 to-violet-50', 'border' => 'border-purple-200', 'text' => 'text-purple-900', 'subtext' => 'text-purple-700', 'amount' => 'text-purple-600', 'subamount' => 'text-purple-500', 'gradient' => 'from-purple-500 to-violet-600', 'bar' => 'from-purple-500 to-violet-600'],
                    'BST' => ['bg' => 'from-orange-50 to-amber-50', 'border' => 'border-orange-200', 'text' => 'text-orange-900', 'subtext' => 'text-orange-700', 'amount' => 'text-orange-600', 'subamount' => 'text-orange-500', 'gradient' => 'from-orange-500 to-amber-600', 'bar' => 'from-orange-500 to-amber-600'],
                    'BSU' => ['bg' => 'from-cyan-50 to-sky-50', 'border' => 'border-cyan-200', 'text' => 'text-cyan-900', 'subtext' => 'text-cyan-700', 'amount' => 'text-cyan-600', 'subamount' => 'text-cyan-500', 'gradient' => 'from-cyan-500 to-sky-600', 'bar' => 'from-cyan-500 to-sky-600'],
                ...
                return [
                    ...
                    'colors' => $colors[$item->program] ?? $colors['Bansos'],
        ...
        return view('pages.statistik', compact(
            ...
            'houseStatusStats', 'houseQualityStats'
        ));
    }
