...
class ProfilDesaController extends Controller
{
    ...
    public function storeFasilitas(Request $request)
    {
        ...
        $request->validate([
            ...
            'kategori.required' => 'Kategori fasilitas wajib diisi.',
            'kategori.max' => 'Kategori maksimal 100 karakter.',
            'alamat.max' => 'Alamat maksimal 500 karakter.',
            'kondisi.required' => 'Kondisi fasilitas wajib dipilih.',
            'kondisi.in' => 'Kondisi fasilitas harus salah satu dari: Baik, Rusak Ringan, Rusak Berat, atau Tidak Layak.',
            'tahun_dibangun.integer' => 'Tahun dibangun harus berupa angka.',
            'tahun_dibangun.min' => 'Tahun dibangun minimal 1900.',
            'tahun_dibangun.max' => 'Tahun dibangun maksimal ' . date('Y') . '.',
            'luas_bangunan.numeric' => 'Luas bangunan harus berupa angka.',
            'luas_bangunan.min' => 'Luas bangunan tidak boleh kurang dari 0.',
            'luas_tanah.numeric' => 'Luas tanah harus berupa angka.',
            'luas_tanah.min' => 'Luas tanah tidak boleh kurang dari 0.',
            'status_kepemilikan.in' => 'Status kepemilikan harus salah satu dari: milik desa, pemerintah, swasta, atau hibah.',
            'kapasitas.integer' => 'Kapasitas harus berupa angka.',
            'kapasitas.min' => 'Kapasitas tidak boleh kurang dari 0.',
            'pengelola.max' => 'Pengelola maksimal 255 karakter.',
            'foto.image' => 'File harus berupa gambar.',
            'foto.mimes' => 'Format gambar harus JPEG, PNG, JPG, atau GIF.',
            'foto.max' => 'Ukuran gambar maksimal 2MB.',
            'koordinat.max' => 'Koordinat maksimal 255 karakter.',
    ...
    public function storeIklim(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'kelembaban' => 'nullable|numeric|min:0|max:100',
                'kecepatan_angin' => 'nullable|numeric|min:0',
                'arah_angin' => 'nullable|string|max:255',
                'musim' => 'nullable|string|max:255',
            ]);
