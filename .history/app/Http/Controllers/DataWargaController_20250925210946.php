...
class DataWargaController extends BaseController
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        // Create Excel content using view
        ...
        $callback = function() use ($groupedWargas) {
            ...
            // Header row
            echo '<Row>' . "\n";
            $headers = ['No', 'NIK', 'No. KK', 'Nama Lengkap', 'Jenis Kelamin', 'Umur', 'Alamat', 'RT/RW', 'Dusun', 'Agama', 'Status Perkawinan', 'Pendidikan', 'Mata Pencaharian', 'Status', 'Kepala Keluarga'];
            ...
            foreach ($groupedWargas as $noKk => $keluarga) {
                ...
                echo '<Cell><Data ss:Type="String"></Data></Cell>' . "\n";
                echo '<Cell><Data ss:Type="String"></Data></Cell>' . "\n";
                echo '<Cell><Data ss:Type="String">=== KELUARGA: ' . htmlspecialchars($noKk) . ' - ' . htmlspecialchars($namaKepala) . ' ===</Data></Cell>' . "\n";
                for ($i = 0; $i < 11; $i++) {
                    echo '<Cell><Data ss:Type="String"></Data></Cell>' . "\n";
                }
                echo '</Row>' . "\n";
                ...
                foreach ($sortedKeluarga as $warga) {
                    ...
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->nik) . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->no_kk) . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->nama_lengkap) . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->jenis_kelamin) . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($ageData['age'] . ' tahun') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->alamat ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->rt_rw ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->dusun ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->agama ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->status_perkawinan ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->pendidikan ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->mata_pencaharian ?? '-') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->status_aktif ? 'Aktif' : 'Tidak Aktif') . '</Data></Cell>' . "\n";
                    echo '<Cell><Data ss:Type="String">' . htmlspecialchars($warga->is_kepala_keluarga ? 'Ya' : 'Tidak') . '</Data></Cell>' . "\n";
                    echo '</Row>' . "\n";
                }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf->loadView('admin.data-warga.export-pdf', compact('wargas'));
