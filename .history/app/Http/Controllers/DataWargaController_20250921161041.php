...
class DataWargaController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        // Check if grouping by family is requested
        $groupByFamily = $request->get('group_by_family', false);

        if ($groupByFamily) {
            // Group by family (no_kk) and order kepala keluarga first
        ...
        // Group data by family if requested
