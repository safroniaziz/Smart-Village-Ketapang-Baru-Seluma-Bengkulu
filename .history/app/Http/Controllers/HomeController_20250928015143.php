...
class HomeController extends Controller
{
    ...
    {
        $visi = VisiDesa::active()->ordered()->first();
        $misi = MisiDesa::active()->ordered()->get();
        $pendekatan = PendekatanDesa::active()->ordered()->get();
        $tahapan = TahapanDesa::active()->ordered()->get();

        return view('pages.visi-misi', compact('visi', 'misi', 'pendekatan', 'tahapan'));
    }
