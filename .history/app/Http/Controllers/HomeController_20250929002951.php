...
class HomeController extends Controller
{
    ...
    public function statistik()
    {
        ...
        // Calculate active program rate (dynamic from database)
        $totalAidRecords = PenerimaBantuan::count();
        $activeAidRecords = PenerimaBantuan::where('status', 'Aktif')->count();
        $activeProgramRate = $totalAidRecords > 0 ? round(($activeAidRecords / $totalAidRecords) * 100, 0) : 0;
        ...
        return view('pages.statistik', compact(
            ...
            'houseStatusStats', 'houseQualityStats', 'villageName', 'districtName', 'totalAidValueFormatted', 'effectivenessRate'
        ));
    }
