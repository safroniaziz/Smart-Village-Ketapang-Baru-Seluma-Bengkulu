...
class PotensiWisataPublicController extends Controller
{
    ...
    {
        // Get all destinations as paginated collection
        $wisata = PotensiWisata::paginate(12);
        ...
        return view('potensi-wisata.index', compact('wisata', 'galleryCategories', 'galleryPhotos', 'galleryCount', 'youtubeId', 'heroPhoto', 'randomPantaiPhotos'));
    }
