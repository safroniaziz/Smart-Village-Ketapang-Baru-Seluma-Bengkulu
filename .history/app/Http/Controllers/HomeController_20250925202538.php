...
class HomeController extends Controller
{
    ...
    {
        // Ambil data dari database (semua user)
        $totalWarga = User::count();
        $totalLakiLaki = User::whereIn('jenis_kelamin', ['Laki-laki', 'L'])->count();
        $totalPerempuan = User::whereIn('jenis_kelamin', ['Perempuan', 'P'])->count();
    ...
    public function tentang()
    {
        // Ambil data dari database (semua user)
        $totalWarga = User::count();
        $totalLakiLaki = User::where(function($q) {
            $q->where('jenis_kelamin', 'Laki-laki')->orWhere('jenis_kelamin', 'L');
        })->count();
        $totalPerempuan = User::where(function($q) {
