...
class SuratController extends Controller
{
    ...
    public function generatePDFSPPD($pengajuanId)
    {
        ...
        // Generate nomor surat dengan format khusus SPPD
        $nomorSurat = sprintf('%03d', $pengajuanId);
        ...
        if ($pengajuan->tracking_number) {
            ...
            $trackingQrCode = $qrCodeService->generateQRCode($verifyUrl);
        }
        ...
        if ($pengajuan->jenis_ttd === 'qrcode') {
            ...
            $qrCode = $qrCodeService->generateQRCode(json_encode($qrData));
