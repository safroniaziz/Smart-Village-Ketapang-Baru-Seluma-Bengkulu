...
class StoreDataWargaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mata_pencaharian' => 'required|in:PETANI,SWASTA,PNS,NELAYAN,DLL',
            'pendidikan' => 'required|in:TS,SD,SLTP,SLTA,DIPLOMA,S1,S2,S3',
            'kewarganegaraan' => 'required|string|max:255',
            'foto' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'email' => 'nullable|email|unique:users,email|max:255',
            'password' => 'required|string|min:8',
            'is_kepala_keluarga' => 'boolean',
            'status_rumah' => 'nullable|in:MS,SEWA',
            'status_sosial' => 'nullable|in:ME,MISKIN,RM,MK',
