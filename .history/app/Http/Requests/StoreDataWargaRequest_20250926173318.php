...
class StoreDataWargaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'foto' => 'nullable|image|mimes:jpeg,png,jpg|max:2048|dimensions:width=300,height=400',
    ...
    public function messages(): array
    {
        return [
            ...
            'foto.dimensions' => 'Foto harus berukuran 300x400 pixel. Upload ulang atau pilih foto lain.',
