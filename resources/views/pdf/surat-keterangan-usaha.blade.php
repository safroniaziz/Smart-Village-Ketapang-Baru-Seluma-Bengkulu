...
<body>
    <div class="page">
        ...
        <div class="document-title">
            <div class="title-main">Surat Keterangan Usaha</div>
        ...
        <div class="closing-text">
            Orang tersebut adalah benar penduduk Desa Ketapang Baru, Kecamatan Semidang Alas Maras, Kabupaten Seluma dan memang mempunyai usaha <strong>{{ $nama_usaha ?? '-' }}</strong> yang bergerak di bidang <strong>{{ $jenis_usaha ?? '-' }}</strong>.
        </div>
