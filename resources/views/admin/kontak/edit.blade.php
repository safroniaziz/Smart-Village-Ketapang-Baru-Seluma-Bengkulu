                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-5">
                                    <div class="symbol-label bg-light-warning">
                                        <i class="fas fa-edit fs-2x text-warning"></i>
                                    </div>
                                </div>
                                <div>
                                    <h2 class="fw-bold text-gray-900 mb-1">Edit Kontak Desa</h2>
                                    <p class="text-muted mb-0">Perbarui informasi kontak desa</p>
                                </div>
                            </div>
                        </div>
