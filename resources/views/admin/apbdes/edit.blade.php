        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">Form Edit Data APBDes</h3>
                ...
                <form action="{{ route('admin.apbdes.update', $apbdes) }}" method="POST" class="form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="jenis_anggaran" class="form-select form-select-solid @error('jenis_anggaran') is-invalid @enderror">
                                        ...
                                        <option value="pendapatan" {{ (old('jenis_anggaran') ?? $apbdes->jenis_anggaran) == 'pendapatan' ? 'selected' : '' }}>Pendapatan</option>
                                        <option value="belanja" {{ (old('jenis_anggaran') ?? $apbdes->jenis_anggaran) == 'belanja' ? 'selected' : '' }}>Belanja</option>
                                    </select>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="keterangan" class="form-control form-control-solid @error('keterangan') is-invalid @enderror"
                                   value="{{ old('keterangan') ?? $apbdes->keterangan }}" placeholder="Masukkan keterangan anggaran">
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="anggaran" class="form-control form-control-solid @error('anggaran') is-invalid @enderror"
                                       value="{{ old('anggaran') ?? $apbdes->anggaran }}" placeholder="0" min="0" step="0.01">
                            </div>
                            @error('anggaran')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="keterangan_detail" class="form-control form-control-solid @error('keterangan_detail') is-invalid @enderror"
                                      rows="4" placeholder="Masukkan keterangan detail (opsional)">{{ old('keterangan_detail') ?? $apbdes->keterangan_detail }}</textarea>
