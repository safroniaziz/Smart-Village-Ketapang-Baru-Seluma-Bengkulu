    ...
    window.loadVisiData = function() {
        $.get('/visi-misi/visi-data', function(response) {
            if (response && response.visi) {
                ...
                // Update deskripsi_section if exists
                if (response.deskripsi_section) {
                    $('#deskripsi-section-display').text(response.deskripsi_section);
                    $('#deskripsi-section-display').closest('.mb-5').show();
                } else {
                    $('#deskripsi-section-display').closest('.mb-5').hide();
                }

                // Update pendekatan_deskripsi if exists
                if (response.pendekatan_deskripsi) {
                    $('#pendekatan-deskripsi-display').text(response.pendekatan_deskripsi);
                    $('#pendekatan-deskripsi-display').closest('.mb-5').show();
                } else {
                    $('#pendekatan-deskripsi-display').closest('.mb-5').hide();
                }
            } else {
