    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content" style="border: none; border-radius: 2rem; overflow: hidden; box-shadow: 0 30px 60px rgba(0,0,0,0.3); background: linear-gradient(145deg, #ffffff 0%, #f8fafc 100%);">
            <form id="pendekatanForm">
                <input type="hidden" name="_method" id="pendekatan_method" value="POST">
...
(function() {
    ...
    $('#pendekatanModal').on('hidden.bs.modal', function () {
        ...
        $('#pendekatan_method').val('POST'); // Reset method to POST for add
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        if (typeof loadPendekatanData === 'function') {
                            loadPendekatanData();
                        } else {
    ...
    window.editPendekatan = function(id) {
        ...
        $('#pendekatan_method').val('PUT'); // Set method to PUT for edit
