...
<body>
    ...
    <div class="kop-surat">
        ...
        <div class="header-text">
            ...
            <h3>KECAMATAN SEMIDANG ALAS MARAS</h3>
            <h3>DESA KETAPANG BARU</h3>
            <p>Alamat: Jl. Raya Ketapang Baru No. 123, Kec. Semidang Alas Maras, Kab. Seluma</p>
    ...
    </div>    <!-- QR CODE UNTUK VERIFIKASI (pojok kanan bawah) -->
    @if($tracking_qr_code)
    <div class="qr-code">
