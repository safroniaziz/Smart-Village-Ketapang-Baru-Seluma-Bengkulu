...
/**
 * Script untuk memperbaiki QR code TTD display di semua template PDF
 */
...
echo "Memperbaiki QR code TTD display di " . count($files) . " template PDF...\n";
...
foreach ($files as $file) {
    ...
    $pattern = '/@elseif\(\$jenis_ttd == \'qrcode\'\)\s*<!-- QR Code TTD.*?<img src="data:image\/png;base64,\{\{ \$qr_ttd_base64 \}\}"[^>]*>/s';

    $replacement = '@elseif($jenis_ttd == \'qrcode\')
